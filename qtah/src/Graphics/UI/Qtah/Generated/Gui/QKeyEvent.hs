...
foreign import ccall "genpop__QKeyEvent_newWithText" newWithText' ::  HoppyFC.CInt -> HoppyFC.CInt -> HoppyFC.CInt -> HoppyF.Ptr M52.QStringConst -> HoppyFHR.CBool -> HoppyFC.CUShort -> HoppyP.IO (HoppyF.Ptr QKeyEvent)
...
foreign import ccall "genpop__QKeyEvent_newNativeWithText" newNativeWithText' ::  HoppyFC.CInt -> HoppyFC.CInt -> HoppyFC.CInt -> HoppyDW.Word32 -> HoppyDW.Word32 -> HoppyDW.Word32 -> HoppyF.Ptr M52.QStringConst -> HoppyFHR.CBool -> HoppyFC.CUShort -> HoppyP.IO (HoppyF.Ptr QKeyEvent)
...
foreign import ccall "genpop__QKeyEvent_text" text' ::  HoppyF.Ptr QKeyEventConst -> HoppyP.IO (HoppyF.Ptr M52.QStringConst)
foreign import ccall "gencast__QKeyEvent__QInputEvent" castQKeyEventToQInputEvent :: HoppyF.Ptr QKeyEventConst -> HoppyF.Ptr M124.QInputEventConst
foreign import ccall "gencast__QInputEvent__QKeyEvent" castQInputEventToQKeyEvent :: HoppyF.Ptr M124.QInputEventConst -> HoppyF.Ptr QKeyEventConst
...
class (M124.QInputEventConstPtr this) => QKeyEventConstPtr this where
...
modifiers :: (QKeyEventValue arg'1) => arg'1 -> HoppyP.IO M66.QtKeyboardModifiers
modifiers arg'1 =
  withQKeyEventPtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
...
class (QKeyEventConstPtr this, M124.QInputEventPtr this) => QKeyEventPtr this where
...
instance M124.QInputEventConstPtr QKeyEventConst where
  toQInputEventConst (QKeyEventConst ptr') = M124.QInputEventConst $ castQKeyEventToQInputEvent ptr'
  toQInputEventConst (QKeyEventConstGc fptr' ptr') = M124.QInputEventConstGc fptr' $ castQKeyEventToQInputEvent ptr'
...
instance M124.QInputEventConstPtr QKeyEvent where
  toQInputEventConst (QKeyEvent ptr') = M124.QInputEventConst $ castQKeyEventToQInputEvent $ (HoppyF.castPtr :: HoppyF.Ptr QKeyEvent -> HoppyF.Ptr QKeyEventConst) ptr'
  toQInputEventConst (QKeyEventGc fptr' ptr') = M124.QInputEventConstGc fptr' $ castQKeyEventToQInputEvent $ (HoppyF.castPtr :: HoppyF.Ptr QKeyEvent -> HoppyF.Ptr QKeyEventConst) ptr'

instance M124.QInputEventPtr QKeyEvent where
  toQInputEvent (QKeyEvent ptr') = M124.QInputEvent $ (HoppyF.castPtr :: HoppyF.Ptr M124.QInputEventConst -> HoppyF.Ptr M124.QInputEvent) $ castQKeyEventToQInputEvent $ (HoppyF.castPtr :: HoppyF.Ptr QKeyEvent -> HoppyF.Ptr QKeyEventConst) ptr'
  toQInputEvent (QKeyEventGc fptr' ptr') = M124.QInputEventGc fptr' $ (HoppyF.castPtr :: HoppyF.Ptr M124.QInputEventConst -> HoppyF.Ptr M124.QInputEvent) $ castQKeyEventToQInputEvent $ (HoppyF.castPtr :: HoppyF.Ptr QKeyEvent -> HoppyF.Ptr QKeyEventConst) ptr'
...
new :: (M66.IsQtKeyboardModifiers arg'3) => M20.QEventType -> HoppyP.Int -> arg'3 -> HoppyP.IO QKeyEvent
new arg'1 arg'2 arg'3 =
  let arg'1' = HoppyFHR.coerceIntegral $ HoppyP.fromEnum arg'1 in
  let arg'2' = HoppyFHR.coerceIntegral arg'2 in
  let arg'3' = M66.fromQtKeyboardModifiers $ M66.toQtKeyboardModifiers arg'3 in
  HoppyP.fmap QKeyEvent
  (new' arg'1' arg'2' arg'3')

newWithText :: (M66.IsQtKeyboardModifiers arg'3, M52.QStringValue arg'4) => M20.QEventType -> HoppyP.Int -> arg'3 -> arg'4 -> HoppyP.Bool -> HoppyFC.CUShort -> HoppyP.IO QKeyEvent
...
newNative :: (M66.IsQtKeyboardModifiers arg'3) => M20.QEventType -> HoppyP.Int -> arg'3 -> HoppyDW.Word32 -> HoppyDW.Word32 -> HoppyDW.Word32 -> HoppyP.IO QKeyEvent
...
newNativeWithText :: (M66.IsQtKeyboardModifiers arg'3, M52.QStringValue arg'7) => M20.QEventType -> HoppyP.Int -> arg'3 -> HoppyDW.Word32 -> HoppyDW.Word32 -> HoppyDW.Word32 -> arg'7 -> HoppyP.Bool -> HoppyFC.CUShort -> HoppyP.IO QKeyEvent
newNativeWithText arg'1 arg'2 arg'3 arg'4 arg'5 arg'6 arg'7 arg'8 arg'9 =
  ...
  let arg'5' = arg'5 in
  let arg'6' = arg'6 in
  M52.withQStringPtr arg'7 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'7' ->
...
instance QKeyEventSuper M124.QInputEvent where
  downToQKeyEvent = castQKeyEventToNonconst . cast' . M124.castQInputEventToConst
    where
      cast' (M124.QInputEventConst ptr') = QKeyEventConst $ castQInputEventToQKeyEvent ptr'
      cast' (M124.QInputEventConstGc fptr' ptr') = QKeyEventConstGc fptr' $ castQInputEventToQKeyEvent ptr'
...
instance QKeyEventSuperConst M124.QInputEventConst where
