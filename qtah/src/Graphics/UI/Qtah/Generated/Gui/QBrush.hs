...
foreign import ccall "genpop__QBrush_newWithColor" newWithColor' ::  HoppyF.Ptr M104.QColorConst -> HoppyP.IO (HoppyF.Ptr QBrush)
foreign import ccall "genpop__QBrush_newCopy" newCopy' ::  HoppyF.Ptr QBrushConst -> HoppyP.IO (HoppyF.Ptr QBrush)
foreign import ccall "genpop__QBrush_color" color' ::  HoppyF.Ptr QBrushConst -> HoppyP.IO (HoppyF.Ptr M104.QColorConst)
foreign import ccall "genpop__QBrush_setColor" setColor' ::  HoppyF.Ptr QBrush -> HoppyF.Ptr M104.QColorConst -> HoppyP.IO ()
...
foreign import ccall "genpop__QBrush_texture" texture' ::  HoppyF.Ptr QBrushConst -> HoppyP.IO (HoppyF.Ptr M146.QPixmapConst)
foreign import ccall "genpop__QBrush_setTexture" setTexture' ::  HoppyF.Ptr QBrush -> HoppyF.Ptr M146.QPixmapConst -> HoppyP.IO ()
foreign import ccall "genpop__QBrush_textureImage" textureImage' ::  HoppyF.Ptr QBrushConst -> HoppyP.IO (HoppyF.Ptr M122.QImageConst)
foreign import ccall "genpop__QBrush_setTextureImage" setTextureImage' ::  HoppyF.Ptr QBrush -> HoppyF.Ptr M122.QImageConst -> HoppyP.IO ()
foreign import ccall "genpop__QBrush_transform" transform' ::  HoppyF.Ptr QBrushConst -> HoppyP.IO (HoppyF.Ptr M166.QTransformConst)
foreign import ccall "genpop__QBrush_setTransform" setTransform' ::  HoppyF.Ptr QBrush -> HoppyF.Ptr M166.QTransformConst -> HoppyP.IO ()
...
style :: (QBrushValue arg'1) => arg'1 -> HoppyP.IO M66.QtBrushStyle
style arg'1 =
  withQBrushPtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
  HoppyP.fmap (HoppyP.toEnum . HoppyFHR.coerceIntegral)
  (style' arg'1')

texture :: (QBrushValue arg'1) => arg'1 -> HoppyP.IO M146.QPixmap
texture arg'1 =
  withQBrushPtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
  (HoppyFHR.decodeAndDelete . M146.QPixmapConst) =<<
  (texture' arg'1')

textureImage :: (QBrushValue arg'1) => arg'1 -> HoppyP.IO M122.QImage
textureImage arg'1 =
  withQBrushPtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
  (HoppyFHR.decodeAndDelete . M122.QImageConst) =<<
  (textureImage' arg'1')

transform :: (QBrushValue arg'1) => arg'1 -> HoppyP.IO M166.QTransform
transform arg'1 =
  withQBrushPtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
...
setColor :: (QBrushPtr arg'1, M104.QColorValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO ()
...
setGlobalColor :: (QBrushPtr arg'1) => arg'1 -> M66.QtGlobalColor -> HoppyP.IO ()
setGlobalColor arg'1 arg'2 =
  HoppyFHR.withCppPtr (toQBrush arg'1) $ \arg'1' ->
  let arg'2' = HoppyFHR.coerceIntegral $ HoppyP.fromEnum arg'2 in
  (setGlobalColor' arg'1' arg'2')

setStyle :: (QBrushPtr arg'1) => arg'1 -> M66.QtBrushStyle -> HoppyP.IO ()
...
setTexture :: (QBrushPtr arg'1, M146.QPixmapValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO ()
setTexture arg'1 arg'2 =
  HoppyFHR.withCppPtr (toQBrush arg'1) $ \arg'1' ->
  M146.withQPixmapPtr arg'2 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'2' ->
  (setTexture' arg'1' arg'2')

setTextureImage :: (QBrushPtr arg'1, M122.QImageValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO ()
setTextureImage arg'1 arg'2 =
  HoppyFHR.withCppPtr (toQBrush arg'1) $ \arg'1' ->
  M122.withQImagePtr arg'2 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'2' ->
  (setTextureImage' arg'1' arg'2')

setTransform :: (QBrushPtr arg'1, M166.QTransformValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO ()
...
newWithColor :: (M104.QColorValue arg'1) => arg'1 -> HoppyP.IO QBrush
newWithColor arg'1 =
  M104.withQColorPtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
  HoppyP.fmap QBrush
  (newWithColor' arg'1')
