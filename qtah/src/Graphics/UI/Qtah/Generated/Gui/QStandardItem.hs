...
import {-# SOURCE #-} qualified Graphics.UI.Qtah.Generated.Gui.QStandardItemModel as M158
import Prelude (($), (.), (/=), (=<<), (==))
import qualified Prelude as HoppyP
import qualified Prelude as QtahP

foreign import ccall "genpop__QStandardItem_new" new' ::  HoppyP.IO (HoppyF.Ptr QStandardItem)
foreign import ccall "genpop__QStandardItem_newWithText" newWithText' ::  HoppyF.Ptr M52.QStringConst -> HoppyP.IO (HoppyF.Ptr QStandardItem)
foreign import ccall "genpop__QStandardItem_newWithIconAndText" newWithIconAndText' ::  HoppyF.Ptr M120.QIconConst -> HoppyF.Ptr M52.QStringConst -> HoppyP.IO (HoppyF.Ptr QStandardItem)
...
foreign import ccall "genpop__QStandardItem_accessibleDescription" accessibleDescription' ::  HoppyF.Ptr QStandardItemConst -> HoppyP.IO (HoppyF.Ptr M52.QStringConst)
foreign import ccall "genpop__QStandardItem_accessibleText" accessibleText' ::  HoppyF.Ptr QStandardItemConst -> HoppyP.IO (HoppyF.Ptr M52.QStringConst)
foreign import ccall "genpop__QStandardItem_appendColumn" appendColumn' ::  HoppyF.Ptr QStandardItem -> HoppyF.Ptr M162.QListQStandardItemConst -> HoppyP.IO ()
foreign import ccall "genpop__QStandardItem_appendRowItems" appendRowItems' ::  HoppyF.Ptr QStandardItem -> HoppyF.Ptr M162.QListQStandardItemConst -> HoppyP.IO ()
...
foreign import ccall "genpop__QStandardItem_appendRows" appendRows' ::  HoppyF.Ptr QStandardItem -> HoppyF.Ptr M162.QListQStandardItemConst -> HoppyP.IO ()
foreign import ccall "genpop__QStandardItem_background" background' ::  HoppyF.Ptr QStandardItemConst -> HoppyP.IO (HoppyF.Ptr M98.QBrushConst)
...
foreign import ccall "genpop__QStandardItem_getData" getData' ::  HoppyF.Ptr QStandardItemConst -> HoppyP.IO (HoppyF.Ptr M64.QVariantConst)
foreign import ccall "genpop__QStandardItem_getDataWithRole" getDataWithRole' ::  HoppyF.Ptr QStandardItemConst -> HoppyFC.CInt -> HoppyP.IO (HoppyF.Ptr M64.QVariantConst)
foreign import ccall "genpop__QStandardItem_flags" flags' ::  HoppyF.Ptr QStandardItemConst -> HoppyP.IO HoppyFC.CInt
foreign import ccall "genpop__QStandardItem_font" font' ::  HoppyF.Ptr QStandardItemConst -> HoppyP.IO (HoppyF.Ptr M114.QFontConst)
foreign import ccall "genpop__QStandardItem_foreground" foreground' ::  HoppyF.Ptr QStandardItemConst -> HoppyP.IO (HoppyF.Ptr M98.QBrushConst)
...
foreign import ccall "genpop__QStandardItem_icon" icon' ::  HoppyF.Ptr QStandardItemConst -> HoppyP.IO (HoppyF.Ptr M120.QIconConst)
...
foreign import ccall "genpop__QStandardItem_insertColumn" insertColumn' ::  HoppyF.Ptr QStandardItem -> HoppyFC.CInt -> HoppyF.Ptr M162.QListQStandardItemConst -> HoppyP.IO ()
...
foreign import ccall "genpop__QStandardItem_insertRowItems" insertRowItems' ::  HoppyF.Ptr QStandardItem -> HoppyFC.CInt -> HoppyF.Ptr M162.QListQStandardItemConst -> HoppyP.IO ()
...
foreign import ccall "genpop__QStandardItem_insertRowsItems" insertRowsItems' ::  HoppyF.Ptr QStandardItem -> HoppyFC.CInt -> HoppyF.Ptr M162.QListQStandardItemConst -> HoppyP.IO ()
...
foreign import ccall "genpop__QStandardItem_model" model' ::  HoppyF.Ptr QStandardItemConst -> HoppyP.IO (HoppyF.Ptr M158.QStandardItemModel)
...
foreign import ccall "genpop__QStandardItem_setAccessibleDescription" setAccessibleDescription' ::  HoppyF.Ptr QStandardItem -> HoppyF.Ptr M52.QStringConst -> HoppyP.IO ()
foreign import ccall "genpop__QStandardItem_setAccessibleText" setAccessibleText' ::  HoppyF.Ptr QStandardItem -> HoppyF.Ptr M52.QStringConst -> HoppyP.IO ()
...
foreign import ccall "genpop__QStandardItem_setBackground" setBackground' ::  HoppyF.Ptr QStandardItem -> HoppyF.Ptr M98.QBrushConst -> HoppyP.IO ()
...
foreign import ccall "genpop__QStandardItem_setData" setData' ::  HoppyF.Ptr QStandardItem -> HoppyF.Ptr M64.QVariantConst -> HoppyP.IO ()
foreign import ccall "genpop__QStandardItem_setDataWithRole" setDataWithRole' ::  HoppyF.Ptr QStandardItem -> HoppyF.Ptr M64.QVariantConst -> HoppyFC.CInt -> HoppyP.IO ()
...
foreign import ccall "genpop__QStandardItem_setFont" setFont' ::  HoppyF.Ptr QStandardItem -> HoppyF.Ptr M114.QFontConst -> HoppyP.IO ()
foreign import ccall "genpop__QStandardItem_setForeground" setForeground' ::  HoppyF.Ptr QStandardItem -> HoppyF.Ptr M98.QBrushConst -> HoppyP.IO ()
foreign import ccall "genpop__QStandardItem_setIcon" setIcon' ::  HoppyF.Ptr QStandardItem -> HoppyF.Ptr M120.QIconConst -> HoppyP.IO ()
...
foreign import ccall "genpop__QStandardItem_setSizeHint" setSizeHint' ::  HoppyF.Ptr QStandardItem -> HoppyF.Ptr M48.QSizeConst -> HoppyP.IO ()
foreign import ccall "genpop__QStandardItem_setStatusTip" setStatusTip' ::  HoppyF.Ptr QStandardItem -> HoppyF.Ptr M52.QStringConst -> HoppyP.IO ()
foreign import ccall "genpop__QStandardItem_setText" setText' ::  HoppyF.Ptr QStandardItem -> HoppyF.Ptr M52.QStringConst -> HoppyP.IO ()
...
foreign import ccall "genpop__QStandardItem_setToolTip" setToolTip' ::  HoppyF.Ptr QStandardItem -> HoppyF.Ptr M52.QStringConst -> HoppyP.IO ()
...
foreign import ccall "genpop__QStandardItem_setWhatsThis" setWhatsThis' ::  HoppyF.Ptr QStandardItem -> HoppyF.Ptr M52.QStringConst -> HoppyP.IO ()
foreign import ccall "genpop__QStandardItem_sizeHint" sizeHint' ::  HoppyF.Ptr QStandardItemConst -> HoppyP.IO (HoppyF.Ptr M48.QSizeConst)
...
foreign import ccall "genpop__QStandardItem_statusTip" statusTip' ::  HoppyF.Ptr QStandardItemConst -> HoppyP.IO (HoppyF.Ptr M52.QStringConst)
...
foreign import ccall "genpop__QStandardItem_takeColumn" takeColumn' ::  HoppyF.Ptr QStandardItem -> HoppyFC.CInt -> HoppyP.IO (HoppyF.Ptr M162.QListQStandardItemConst)
foreign import ccall "genpop__QStandardItem_takeRow" takeRow' ::  HoppyF.Ptr QStandardItem -> HoppyFC.CInt -> HoppyP.IO (HoppyF.Ptr M162.QListQStandardItemConst)
foreign import ccall "genpop__QStandardItem_text" text' ::  HoppyF.Ptr QStandardItemConst -> HoppyP.IO (HoppyF.Ptr M52.QStringConst)
...
foreign import ccall "genpop__QStandardItem_toolTip" toolTip' ::  HoppyF.Ptr QStandardItemConst -> HoppyP.IO (HoppyF.Ptr M52.QStringConst)
foreign import ccall "genpop__QStandardItem_getType" getType' ::  HoppyF.Ptr QStandardItemConst -> HoppyP.IO HoppyFC.CInt
foreign import ccall "genpop__QStandardItem_whatsThis" whatsThis' ::  HoppyF.Ptr QStandardItemConst -> HoppyP.IO (HoppyF.Ptr M52.QStringConst)
...
background :: (QStandardItemValue arg'1) => arg'1 -> HoppyP.IO M98.QBrush
background arg'1 =
  withQStandardItemPtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
  (HoppyFHR.decodeAndDelete . M98.QBrushConst) =<<
  (background' arg'1')

checkState :: (QStandardItemValue arg'1) => arg'1 -> HoppyP.IO M66.QtCheckState
checkState arg'1 =
  withQStandardItemPtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
...
getData :: (QStandardItemValue arg'1) => arg'1 -> HoppyP.IO M64.QVariant
getData arg'1 =
  withQStandardItemPtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
  (HoppyFHR.decodeAndDelete . M64.QVariantConst) =<<
  (getData' arg'1')

getDataWithRole :: (QStandardItemValue arg'1) => arg'1 -> HoppyP.Int -> HoppyP.IO M64.QVariant
...
flags :: (QStandardItemValue arg'1) => arg'1 -> HoppyP.IO M66.QtItemFlags
flags arg'1 =
  withQStandardItemPtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
  HoppyP.fmap M66.QtItemFlags
  (flags' arg'1')

font :: (QStandardItemValue arg'1) => arg'1 -> HoppyP.IO M114.QFont
font arg'1 =
  withQStandardItemPtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
  (HoppyFHR.decodeAndDelete . M114.QFontConst) =<<
  (font' arg'1')

foreground :: (QStandardItemValue arg'1) => arg'1 -> HoppyP.IO M98.QBrush
foreground arg'1 =
  withQStandardItemPtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
  (HoppyFHR.decodeAndDelete . M98.QBrushConst) =<<
  (foreground' arg'1')
...
icon :: (QStandardItemValue arg'1) => arg'1 -> HoppyP.IO M120.QIcon
icon arg'1 =
  withQStandardItemPtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
...
model :: (QStandardItemValue arg'1) => arg'1 -> HoppyP.IO M158.QStandardItemModel
model arg'1 =
  withQStandardItemPtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
  HoppyP.fmap M158.QStandardItemModel
  (model' arg'1')
...
textAlignment :: (QStandardItemValue arg'1) => arg'1 -> HoppyP.IO M66.QtAlignment
textAlignment arg'1 =
  withQStandardItemPtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
...
appendColumn :: (QStandardItemPtr arg'1, M162.QListQStandardItemValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO ()
...
appendRowItems :: (QStandardItemPtr arg'1, M162.QListQStandardItemValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO ()
...
appendRows :: (QStandardItemPtr arg'1, M162.QListQStandardItemValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO ()
appendRows arg'1 arg'2 =
  HoppyFHR.withCppPtr (toQStandardItem arg'1) $ \arg'1' ->
  M162.withQListQStandardItemPtr arg'2 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'2' ->
  (appendRows' arg'1' arg'2')

insertColumn :: (QStandardItemPtr arg'1, M162.QListQStandardItemValue arg'3) => arg'1 -> HoppyP.Int -> arg'3 -> HoppyP.IO ()
...
insertRowItems :: (QStandardItemPtr arg'1, M162.QListQStandardItemValue arg'3) => arg'1 -> HoppyP.Int -> arg'3 -> HoppyP.IO ()
...
insertRowsItems :: (QStandardItemPtr arg'1, M162.QListQStandardItemValue arg'3) => arg'1 -> HoppyP.Int -> arg'3 -> HoppyP.IO ()
...
setAccessibleDescription :: (QStandardItemPtr arg'1, M52.QStringValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO ()
setAccessibleDescription arg'1 arg'2 =
  HoppyFHR.withCppPtr (toQStandardItem arg'1) $ \arg'1' ->
  M52.withQStringPtr arg'2 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'2' ->
  (setAccessibleDescription' arg'1' arg'2')

setAccessibleText :: (QStandardItemPtr arg'1, M52.QStringValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO ()
...
setBackground :: (QStandardItemPtr arg'1, M98.QBrushValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO ()
setBackground arg'1 arg'2 =
  HoppyFHR.withCppPtr (toQStandardItem arg'1) $ \arg'1' ->
  M98.withQBrushPtr arg'2 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'2' ->
  (setBackground' arg'1' arg'2')

setCheckState :: (QStandardItemPtr arg'1) => arg'1 -> M66.QtCheckState -> HoppyP.IO ()
...
setData :: (QStandardItemPtr arg'1, M64.QVariantValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO ()
setData arg'1 arg'2 =
  HoppyFHR.withCppPtr (toQStandardItem arg'1) $ \arg'1' ->
  M64.withQVariantPtr arg'2 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'2' ->
  (setData' arg'1' arg'2')

setDataWithRole :: (QStandardItemPtr arg'1, M64.QVariantValue arg'2) => arg'1 -> arg'2 -> HoppyP.Int -> HoppyP.IO ()
...
setFlags :: (QStandardItemPtr arg'1, M66.IsQtItemFlags arg'2) => arg'1 -> arg'2 -> HoppyP.IO ()
setFlags arg'1 arg'2 =
  HoppyFHR.withCppPtr (toQStandardItem arg'1) $ \arg'1' ->
  let arg'2' = M66.fromQtItemFlags $ M66.toQtItemFlags arg'2 in
  (setFlags' arg'1' arg'2')

setFont :: (QStandardItemPtr arg'1, M114.QFontValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO ()
setFont arg'1 arg'2 =
  HoppyFHR.withCppPtr (toQStandardItem arg'1) $ \arg'1' ->
  M114.withQFontPtr arg'2 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'2' ->
  (setFont' arg'1' arg'2')

setForeground :: (QStandardItemPtr arg'1, M98.QBrushValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO ()
setForeground arg'1 arg'2 =
  HoppyFHR.withCppPtr (toQStandardItem arg'1) $ \arg'1' ->
  M98.withQBrushPtr arg'2 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'2' ->
  (setForeground' arg'1' arg'2')

setIcon :: (QStandardItemPtr arg'1, M120.QIconValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO ()
setIcon arg'1 arg'2 =
  HoppyFHR.withCppPtr (toQStandardItem arg'1) $ \arg'1' ->
...
setSizeHint :: (QStandardItemPtr arg'1, M48.QSizeValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO ()
setSizeHint arg'1 arg'2 =
  HoppyFHR.withCppPtr (toQStandardItem arg'1) $ \arg'1' ->
  M48.withQSizePtr arg'2 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'2' ->
  (setSizeHint' arg'1' arg'2')

setStatusTip :: (QStandardItemPtr arg'1, M52.QStringValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO ()
setStatusTip arg'1 arg'2 =
  HoppyFHR.withCppPtr (toQStandardItem arg'1) $ \arg'1' ->
  M52.withQStringPtr arg'2 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'2' ->
  (setStatusTip' arg'1' arg'2')

setText :: (QStandardItemPtr arg'1, M52.QStringValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO ()
setText arg'1 arg'2 =
  HoppyFHR.withCppPtr (toQStandardItem arg'1) $ \arg'1' ->
  M52.withQStringPtr arg'2 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'2' ->
  (setText' arg'1' arg'2')

setTextAlignment :: (QStandardItemPtr arg'1, M66.IsQtAlignment arg'2) => arg'1 -> arg'2 -> HoppyP.IO ()
setTextAlignment arg'1 arg'2 =
  HoppyFHR.withCppPtr (toQStandardItem arg'1) $ \arg'1' ->
  let arg'2' = M66.fromQtAlignment $ M66.toQtAlignment arg'2 in
  (setTextAlignment' arg'1' arg'2')

setToolTip :: (QStandardItemPtr arg'1, M52.QStringValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO ()
...
setWhatsThis :: (QStandardItemPtr arg'1, M52.QStringValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO ()
...
sortChildrenWithOrder :: (QStandardItemPtr arg'1) => arg'1 -> HoppyP.Int -> M66.QtSortOrder -> HoppyP.IO ()
...
newWithText :: (M52.QStringValue arg'1) => arg'1 -> HoppyP.IO QStandardItem
newWithText arg'1 =
  M52.withQStringPtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
  HoppyP.fmap QStandardItem
  (newWithText' arg'1')

newWithIconAndText :: (M120.QIconValue arg'1, M52.QStringValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO QStandardItem
newWithIconAndText arg'1 arg'2 =
  M120.withQIconPtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
  M52.withQStringPtr arg'2 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'2' ->
  HoppyP.fmap QStandardItem
  (newWithIconAndText' arg'1' arg'2')
