...
foreign import ccall "genpop__QRegion_newFromPolygon" newFromPolygon' ::  HoppyF.Ptr M148.QPolygonConst -> HoppyP.IO (HoppyF.Ptr QRegion)
foreign import ccall "genpop__QRegion_newFromPolygonAll" newFromPolygonAll' ::  HoppyF.Ptr M148.QPolygonConst -> HoppyFC.CInt -> HoppyP.IO (HoppyF.Ptr QRegion)
foreign import ccall "genpop__QRegion_newFromRect" newFromRect' ::  HoppyF.Ptr M42.QRectConst -> HoppyFC.CInt -> HoppyP.IO (HoppyF.Ptr QRegion)
foreign import ccall "genpop__QRegion_newCopy" newCopy' ::  HoppyF.Ptr QRegionConst -> HoppyP.IO (HoppyF.Ptr QRegion)
foreign import ccall "genpop__QRegion_boundingRect" boundingRect' ::  HoppyF.Ptr QRegionConst -> HoppyP.IO (HoppyF.Ptr M42.QRectConst)
foreign import ccall "genpop__QRegion_containsPoint" containsPoint' ::  HoppyF.Ptr QRegionConst -> HoppyF.Ptr M38.QPointConst -> HoppyP.IO HoppyFHR.CBool
foreign import ccall "genpop__QRegion_containsRect" containsRect' ::  HoppyF.Ptr QRegionConst -> HoppyF.Ptr M42.QRectConst -> HoppyP.IO HoppyFHR.CBool
...
foreign import ccall "genpop__QRegion_intersectedWithRect" intersectedWithRect' ::  HoppyF.Ptr QRegionConst -> HoppyF.Ptr M42.QRectConst -> HoppyP.IO (HoppyF.Ptr QRegionConst)
...
foreign import ccall "genpop__QRegion_intersectsRect" intersectsRect' ::  HoppyF.Ptr QRegionConst -> HoppyF.Ptr M42.QRectConst -> HoppyP.IO HoppyFHR.CBool
...
foreign import ccall "genpop__QRegion_translateByPoint" translateByPoint' ::  HoppyF.Ptr QRegion -> HoppyF.Ptr M38.QPointConst -> HoppyP.IO ()
...
foreign import ccall "genpop__QRegion_translatedByPoint" translatedByPoint' ::  HoppyF.Ptr QRegionConst -> HoppyF.Ptr M38.QPointConst -> HoppyP.IO (HoppyF.Ptr QRegionConst)
...
foreign import ccall "genpop__QRegion_unitedWithRect" unitedWithRect' ::  HoppyF.Ptr QRegionConst -> HoppyF.Ptr M42.QRectConst -> HoppyP.IO (HoppyF.Ptr QRegionConst)
...
containsPoint :: (QRegionValue arg'1, M38.QPointValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO HoppyP.Bool
...
containsRect :: (QRegionValue arg'1, M42.QRectValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO HoppyP.Bool
...
intersectedWithRect :: (QRegionValue arg'1, M42.QRectValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO QRegion
...
intersectsRect :: (QRegionValue arg'1, M42.QRectValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO HoppyP.Bool
...
translatedByPoint :: (QRegionValue arg'1, M38.QPointValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO QRegion
...
unitedWithRect :: (QRegionValue arg'1, M42.QRectValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO QRegion
...
translateByPoint :: (QRegionPtr arg'1, M38.QPointValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO ()
...
newFromPolygon :: (M148.QPolygonValue arg'1) => arg'1 -> HoppyP.IO QRegion
newFromPolygon arg'1 =
  M148.withQPolygonPtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
  HoppyP.fmap QRegion
  (newFromPolygon' arg'1')

newFromPolygonAll :: (M148.QPolygonValue arg'1) => arg'1 -> M66.QtFillRule -> HoppyP.IO QRegion
...
newFromRect :: (M42.QRectValue arg'1) => arg'1 -> QRegionRegionType -> HoppyP.IO QRegion
