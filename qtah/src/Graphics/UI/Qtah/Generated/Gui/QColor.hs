...
foreign import ccall "genpop__QColor_newNamedColor" newNamedColor' ::  HoppyF.Ptr M52.QStringConst -> HoppyP.IO (HoppyF.Ptr QColor)
...
foreign import ccall "genpop__QColor_colorNames" colorNames' ::  HoppyP.IO (HoppyF.Ptr M54.QStringListConst)
...
foreign import ccall "genpop__QColor_isValidColor" isValidColor' ::  HoppyF.Ptr M52.QStringConst -> HoppyP.IO HoppyFHR.CBool
...
foreign import ccall "genpop__QColor_name" name' ::  HoppyF.Ptr QColorConst -> HoppyP.IO (HoppyF.Ptr M52.QStringConst)
foreign import ccall "genpop__QColor_nameWithFormat" nameWithFormat' ::  HoppyF.Ptr QColorConst -> HoppyFC.CInt -> HoppyP.IO (HoppyF.Ptr M52.QStringConst)
...
foreign import ccall "genpop__QColor_setNamedColor" setNamedColor' ::  HoppyF.Ptr QColor -> HoppyF.Ptr M52.QStringConst -> HoppyP.IO ()
...
setNamedColor :: (QColorPtr arg'1, M52.QStringValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO ()
...
isValidColor :: (M52.QStringValue arg'1) => arg'1 -> HoppyP.IO HoppyP.Bool
isValidColor arg'1 =
...
newNamedColor :: (M52.QStringValue arg'1) => arg'1 -> HoppyP.IO QColor
newNamedColor arg'1 =
  M52.withQStringPtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
  HoppyP.fmap QColor
  (newNamedColor' arg'1')

newGlobalColor ::  M66.QtGlobalColor -> HoppyP.IO QColor
