...
import {-# SOURCE #-} qualified Graphics.UI.Qtah.Generated.Core.QList.QStandardItem as M162
...
import {-# SOURCE #-} qualified Graphics.UI.Qtah.Generated.Gui.QStandardItem as M160
import Prelude (($), (.), (/=), (=<<), (==))
...
foreign import ccall "genpop__QStandardItemModel_appendColumn" appendColumn' ::  HoppyF.Ptr QStandardItemModel -> HoppyF.Ptr M162.QListQStandardItemConst -> HoppyP.IO ()
foreign import ccall "genpop__QStandardItemModel_appendRowItems" appendRowItems' ::  HoppyF.Ptr QStandardItemModel -> HoppyF.Ptr M162.QListQStandardItemConst -> HoppyP.IO ()
foreign import ccall "genpop__QStandardItemModel_appendRowItem" appendRowItem' ::  HoppyF.Ptr QStandardItemModel -> HoppyF.Ptr M160.QStandardItem -> HoppyP.IO ()
foreign import ccall "genpop__QStandardItemModel_clear" clear' ::  HoppyF.Ptr QStandardItemModel -> HoppyP.IO ()
foreign import ccall "genpop__QStandardItemModel_findItems" findItems' ::  HoppyF.Ptr QStandardItemModelConst -> HoppyF.Ptr M52.QStringConst -> HoppyP.IO (HoppyF.Ptr M162.QListQStandardItemConst)
foreign import ccall "genpop__QStandardItemModel_findItemsWithFlags" findItemsWithFlags' ::  HoppyF.Ptr QStandardItemModelConst -> HoppyF.Ptr M52.QStringConst -> HoppyFC.CInt -> HoppyP.IO (HoppyF.Ptr M162.QListQStandardItemConst)
foreign import ccall "genpop__QStandardItemModel_findItemsWithFlagsAndColumn" findItemsWithFlagsAndColumn' ::  HoppyF.Ptr QStandardItemModelConst -> HoppyF.Ptr M52.QStringConst -> HoppyFC.CInt -> HoppyFC.CInt -> HoppyP.IO (HoppyF.Ptr M162.QListQStandardItemConst)
foreign import ccall "genpop__QStandardItemModel_horizontalHeaderItem" horizontalHeaderItem' ::  HoppyF.Ptr QStandardItemModelConst -> HoppyFC.CInt -> HoppyP.IO (HoppyF.Ptr M160.QStandardItem)
foreign import ccall "genpop__QStandardItemModel_indexFromItem" indexFromItem' ::  HoppyF.Ptr QStandardItemModelConst -> HoppyF.Ptr M160.QStandardItemConst -> HoppyP.IO (HoppyF.Ptr M32.QModelIndexConst)
foreign import ccall "genpop__QStandardItemModel_insertColumnWithItems" insertColumnWithItems' ::  HoppyF.Ptr QStandardItemModel -> HoppyFC.CInt -> HoppyF.Ptr M162.QListQStandardItemConst -> HoppyP.IO ()
...
foreign import ccall "genpop__QStandardItemModel_insertRowWithItems" insertRowWithItems' ::  HoppyF.Ptr QStandardItemModel -> HoppyFC.CInt -> HoppyF.Ptr M162.QListQStandardItemConst -> HoppyP.IO ()
foreign import ccall "genpop__QStandardItemModel_insertRowWithItem" insertRowWithItem' ::  HoppyF.Ptr QStandardItemModel -> HoppyFC.CInt -> HoppyF.Ptr M160.QStandardItem -> HoppyP.IO ()
...
foreign import ccall "genpop__QStandardItemModel_invisibleRootItem" invisibleRootItem' ::  HoppyF.Ptr QStandardItemModelConst -> HoppyP.IO (HoppyF.Ptr M160.QStandardItem)
foreign import ccall "genpop__QStandardItemModel_item" item' ::  HoppyF.Ptr QStandardItemModelConst -> HoppyFC.CInt -> HoppyP.IO (HoppyF.Ptr M160.QStandardItem)
foreign import ccall "genpop__QStandardItemModel_itemWithColumn" itemWithColumn' ::  HoppyF.Ptr QStandardItemModelConst -> HoppyFC.CInt -> HoppyFC.CInt -> HoppyP.IO (HoppyF.Ptr M160.QStandardItem)
foreign import ccall "genpop__QStandardItemModel_itemFromIndex" itemFromIndex' ::  HoppyF.Ptr QStandardItemModelConst -> HoppyF.Ptr M32.QModelIndexConst -> HoppyP.IO (HoppyF.Ptr M160.QStandardItem)
foreign import ccall "genpop__QStandardItemModel_itemPrototype" itemPrototype' ::  HoppyF.Ptr QStandardItemModelConst -> HoppyP.IO (HoppyF.Ptr M160.QStandardItemConst)
...
foreign import ccall "genpop__QStandardItemModel_setHorizontalHeaderItem" setHorizontalHeaderItem' ::  HoppyF.Ptr QStandardItemModel -> HoppyFC.CInt -> HoppyF.Ptr M160.QStandardItem -> HoppyP.IO ()
foreign import ccall "genpop__QStandardItemModel_setHorizontalHeaderLabels" setHorizontalHeaderLabels' ::  HoppyF.Ptr QStandardItemModel -> HoppyF.Ptr M54.QStringListConst -> HoppyP.IO ()
foreign import ccall "genpop__QStandardItemModel_setItemWithColumn" setItemWithColumn' ::  HoppyF.Ptr QStandardItemModel -> HoppyFC.CInt -> HoppyFC.CInt -> HoppyF.Ptr M160.QStandardItem -> HoppyP.IO ()
foreign import ccall "genpop__QStandardItemModel_setItem" setItem' ::  HoppyF.Ptr QStandardItemModel -> HoppyFC.CInt -> HoppyF.Ptr M160.QStandardItem -> HoppyP.IO ()
foreign import ccall "genpop__QStandardItemModel_setItemPrototype" setItemPrototype' ::  HoppyF.Ptr QStandardItemModel -> HoppyF.Ptr M160.QStandardItemConst -> HoppyP.IO ()
...
foreign import ccall "genpop__QStandardItemModel_setVerticalHeaderItem" setVerticalHeaderItem' ::  HoppyF.Ptr QStandardItemModel -> HoppyFC.CInt -> HoppyF.Ptr M160.QStandardItem -> HoppyP.IO ()
foreign import ccall "genpop__QStandardItemModel_setVerticalHeaderLabels" setVerticalHeaderLabels' ::  HoppyF.Ptr QStandardItemModel -> HoppyF.Ptr M54.QStringListConst -> HoppyP.IO ()
foreign import ccall "genpop__QStandardItemModel_takeColumn" takeColumn' ::  HoppyF.Ptr QStandardItemModel -> HoppyFC.CInt -> HoppyP.IO (HoppyF.Ptr M162.QListQStandardItemConst)
foreign import ccall "genpop__QStandardItemModel_takeHorizontalHeaderItem" takeHorizontalHeaderItem' ::  HoppyF.Ptr QStandardItemModel -> HoppyFC.CInt -> HoppyP.IO (HoppyF.Ptr M160.QStandardItem)
foreign import ccall "genpop__QStandardItemModel_takeItem" takeItem' ::  HoppyF.Ptr QStandardItemModel -> HoppyFC.CInt -> HoppyP.IO (HoppyF.Ptr M160.QStandardItem)
foreign import ccall "genpop__QStandardItemModel_takeItemWithColumn" takeItemWithColumn' ::  HoppyF.Ptr QStandardItemModel -> HoppyFC.CInt -> HoppyFC.CInt -> HoppyP.IO (HoppyF.Ptr M160.QStandardItem)
foreign import ccall "genpop__QStandardItemModel_takeRow" takeRow' ::  HoppyF.Ptr QStandardItemModel -> HoppyFC.CInt -> HoppyP.IO (HoppyF.Ptr M162.QListQStandardItemConst)
foreign import ccall "genpop__QStandardItemModel_takeVerticalHeaderItem" takeVerticalHeaderItem' ::  HoppyF.Ptr QStandardItemModel -> HoppyFC.CInt -> HoppyP.IO (HoppyF.Ptr M160.QStandardItem)
foreign import ccall "genpop__QStandardItemModel_verticalHeaderItem" verticalHeaderItem' ::  HoppyF.Ptr QStandardItemModelConst -> HoppyFC.CInt -> HoppyP.IO (HoppyF.Ptr M160.QStandardItem)
...
findItems :: (QStandardItemModelValue arg'1, M52.QStringValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO [M160.QStandardItem]
findItems arg'1 arg'2 =
  withQStandardItemModelPtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
  M52.withQStringPtr arg'2 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'2' ->
  (HoppyFHR.decodeAndDelete . M162.QListQStandardItemConst) =<<
  (findItems' arg'1' arg'2')

findItemsWithFlags :: (QStandardItemModelValue arg'1, M52.QStringValue arg'2, M66.IsQtMatchFlags arg'3) => arg'1 -> arg'2 -> arg'3 -> HoppyP.IO [M160.QStandardItem]
findItemsWithFlags arg'1 arg'2 arg'3 =
  withQStandardItemModelPtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
  M52.withQStringPtr arg'2 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'2' ->
  let arg'3' = M66.fromQtMatchFlags $ M66.toQtMatchFlags arg'3 in
  (HoppyFHR.decodeAndDelete . M162.QListQStandardItemConst) =<<
  (findItemsWithFlags' arg'1' arg'2' arg'3')

findItemsWithFlagsAndColumn :: (QStandardItemModelValue arg'1, M52.QStringValue arg'2, M66.IsQtMatchFlags arg'3) => arg'1 -> arg'2 -> arg'3 -> HoppyP.Int -> HoppyP.IO [M160.QStandardItem]
...
horizontalHeaderItem :: (QStandardItemModelValue arg'1) => arg'1 -> HoppyP.Int -> HoppyP.IO M160.QStandardItem
horizontalHeaderItem arg'1 arg'2 =
  withQStandardItemModelPtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
  let arg'2' = HoppyFHR.coerceIntegral arg'2 in
  HoppyP.fmap M160.QStandardItem
  (horizontalHeaderItem' arg'1' arg'2')

indexFromItem :: (QStandardItemModelValue arg'1, M160.QStandardItemValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO M32.QModelIndex
indexFromItem arg'1 arg'2 =
  withQStandardItemModelPtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
  M160.withQStandardItemPtr arg'2 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'2' ->
  (HoppyFHR.decodeAndDelete . M32.QModelIndexConst) =<<
  (indexFromItem' arg'1' arg'2')

invisibleRootItem :: (QStandardItemModelValue arg'1) => arg'1 -> HoppyP.IO M160.QStandardItem
invisibleRootItem arg'1 =
  withQStandardItemModelPtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
  HoppyP.fmap M160.QStandardItem
  (invisibleRootItem' arg'1')

item :: (QStandardItemModelValue arg'1) => arg'1 -> HoppyP.Int -> HoppyP.IO M160.QStandardItem
item arg'1 arg'2 =
  withQStandardItemModelPtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
  let arg'2' = HoppyFHR.coerceIntegral arg'2 in
  HoppyP.fmap M160.QStandardItem
...
itemWithColumn :: (QStandardItemModelValue arg'1) => arg'1 -> HoppyP.Int -> HoppyP.Int -> HoppyP.IO M160.QStandardItem
...
itemFromIndex :: (QStandardItemModelValue arg'1, M32.QModelIndexValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO M160.QStandardItem
...
itemPrototype :: (QStandardItemModelValue arg'1) => arg'1 -> HoppyP.IO M160.QStandardItemConst
itemPrototype arg'1 =
  withQStandardItemModelPtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
  HoppyP.fmap M160.QStandardItemConst
  (itemPrototype' arg'1')

verticalHeaderItem :: (QStandardItemModelValue arg'1) => arg'1 -> HoppyP.Int -> HoppyP.IO M160.QStandardItem
...
appendColumn :: (QStandardItemModelPtr arg'1, M162.QListQStandardItemValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO ()
appendColumn arg'1 arg'2 =
  HoppyFHR.withCppPtr (toQStandardItemModel arg'1) $ \arg'1' ->
  M162.withQListQStandardItemPtr arg'2 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'2' ->
  (appendColumn' arg'1' arg'2')

appendRowItems :: (QStandardItemModelPtr arg'1, M162.QListQStandardItemValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO ()
appendRowItems arg'1 arg'2 =
  HoppyFHR.withCppPtr (toQStandardItemModel arg'1) $ \arg'1' ->
  M162.withQListQStandardItemPtr arg'2 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'2' ->
  (appendRowItems' arg'1' arg'2')

appendRowItem :: (QStandardItemModelPtr arg'1, M160.QStandardItemPtr arg'2) => arg'1 -> arg'2 -> HoppyP.IO ()
appendRowItem arg'1 arg'2 =
  HoppyFHR.withCppPtr (toQStandardItemModel arg'1) $ \arg'1' ->
  HoppyFHR.withCppPtr (M160.toQStandardItem arg'2) $ \arg'2' ->
  (appendRowItem' arg'1' arg'2')
...
insertColumnWithItems :: (QStandardItemModelPtr arg'1, M162.QListQStandardItemValue arg'3) => arg'1 -> HoppyP.Int -> arg'3 -> HoppyP.IO ()
insertColumnWithItems arg'1 arg'2 arg'3 =
  HoppyFHR.withCppPtr (toQStandardItemModel arg'1) $ \arg'1' ->
  let arg'2' = HoppyFHR.coerceIntegral arg'2 in
  M162.withQListQStandardItemPtr arg'3 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'3' ->
  (insertColumnWithItems' arg'1' arg'2' arg'3')
...
insertRowWithItems :: (QStandardItemModelPtr arg'1, M162.QListQStandardItemValue arg'3) => arg'1 -> HoppyP.Int -> arg'3 -> HoppyP.IO ()
...
insertRowWithItem :: (QStandardItemModelPtr arg'1, M160.QStandardItemPtr arg'3) => arg'1 -> HoppyP.Int -> arg'3 -> HoppyP.IO ()
insertRowWithItem arg'1 arg'2 arg'3 =
  HoppyFHR.withCppPtr (toQStandardItemModel arg'1) $ \arg'1' ->
  let arg'2' = HoppyFHR.coerceIntegral arg'2 in
  HoppyFHR.withCppPtr (M160.toQStandardItem arg'3) $ \arg'3' ->
  (insertRowWithItem' arg'1' arg'2' arg'3')
...
setHorizontalHeaderItem :: (QStandardItemModelPtr arg'1, M160.QStandardItemPtr arg'3) => arg'1 -> HoppyP.Int -> arg'3 -> HoppyP.IO ()
...
setHorizontalHeaderLabels :: (QStandardItemModelPtr arg'1, M54.QStringListValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO ()
setHorizontalHeaderLabels arg'1 arg'2 =
  HoppyFHR.withCppPtr (toQStandardItemModel arg'1) $ \arg'1' ->
  M54.withQStringListPtr arg'2 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'2' ->
  (setHorizontalHeaderLabels' arg'1' arg'2')

setItemWithColumn :: (QStandardItemModelPtr arg'1, M160.QStandardItemPtr arg'4) => arg'1 -> HoppyP.Int -> HoppyP.Int -> arg'4 -> HoppyP.IO ()
setItemWithColumn arg'1 arg'2 arg'3 arg'4 =
  HoppyFHR.withCppPtr (toQStandardItemModel arg'1) $ \arg'1' ->
  let arg'2' = HoppyFHR.coerceIntegral arg'2 in
  let arg'3' = HoppyFHR.coerceIntegral arg'3 in
  HoppyFHR.withCppPtr (M160.toQStandardItem arg'4) $ \arg'4' ->
  (setItemWithColumn' arg'1' arg'2' arg'3' arg'4')

setItem :: (QStandardItemModelPtr arg'1, M160.QStandardItemPtr arg'3) => arg'1 -> HoppyP.Int -> arg'3 -> HoppyP.IO ()
...
setItemPrototype :: (QStandardItemModelPtr arg'1, M160.QStandardItemValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO ()
...
setVerticalHeaderItem :: (QStandardItemModelPtr arg'1, M160.QStandardItemPtr arg'3) => arg'1 -> HoppyP.Int -> arg'3 -> HoppyP.IO ()
...
setVerticalHeaderLabels :: (QStandardItemModelPtr arg'1, M54.QStringListValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO ()
setVerticalHeaderLabels arg'1 arg'2 =
  HoppyFHR.withCppPtr (toQStandardItemModel arg'1) $ \arg'1' ->
  M54.withQStringListPtr arg'2 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'2' ->
  (setVerticalHeaderLabels' arg'1' arg'2')

takeColumn :: (QStandardItemModelPtr arg'1) => arg'1 -> HoppyP.Int -> HoppyP.IO [M160.QStandardItem]
...
takeHorizontalHeaderItem :: (QStandardItemModelPtr arg'1) => arg'1 -> HoppyP.Int -> HoppyP.IO M160.QStandardItem
...
takeItem :: (QStandardItemModelPtr arg'1) => arg'1 -> HoppyP.Int -> HoppyP.IO M160.QStandardItem
...
takeItemWithColumn :: (QStandardItemModelPtr arg'1) => arg'1 -> HoppyP.Int -> HoppyP.Int -> HoppyP.IO M160.QStandardItem
...
takeRow :: (QStandardItemModelPtr arg'1) => arg'1 -> HoppyP.Int -> HoppyP.IO [M160.QStandardItem]
takeRow arg'1 arg'2 =
  HoppyFHR.withCppPtr (toQStandardItemModel arg'1) $ \arg'1' ->
  let arg'2' = HoppyFHR.coerceIntegral arg'2 in
  (HoppyFHR.decodeAndDelete . M162.QListQStandardItemConst) =<<
...
takeVerticalHeaderItem :: (QStandardItemModelPtr arg'1) => arg'1 -> HoppyP.Int -> HoppyP.IO M160.QStandardItem
