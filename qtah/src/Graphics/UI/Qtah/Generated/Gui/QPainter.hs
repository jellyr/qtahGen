...
foreign import ccall "genpop__QPainter_newWithDevice" newWithDevice' ::  HoppyF.Ptr M134.QPaintDevice -> HoppyP.IO (HoppyF.Ptr QPainter)
foreign import ccall "genpop__QPainter_drawImageAtRaw" drawImageAtRaw' ::  HoppyF.Ptr QPainter -> HoppyFC.CInt -> HoppyFC.CInt -> HoppyF.Ptr M122.QImageConst -> HoppyP.IO ()
foreign import ccall "genpop__QPainter_drawImageAtRawAll" drawImageAtRawAll' ::  HoppyF.Ptr QPainter -> HoppyFC.CInt -> HoppyFC.CInt -> HoppyF.Ptr M122.QImageConst -> HoppyFC.CInt -> HoppyFC.CInt -> HoppyFC.CInt -> HoppyFC.CInt -> HoppyFC.CInt -> HoppyP.IO ()
foreign import ccall "genpop__QPainter_fillRectWithGlobalColor" fillRectWithGlobalColor' ::  HoppyF.Ptr QPainter -> HoppyF.Ptr M42.QRectConst -> HoppyFC.CInt -> HoppyP.IO ()
...
drawImageAtRaw :: (QPainterPtr arg'1, M122.QImageValue arg'4) => arg'1 -> HoppyP.Int -> HoppyP.Int -> arg'4 -> HoppyP.IO ()
drawImageAtRaw arg'1 arg'2 arg'3 arg'4 =
  HoppyFHR.withCppPtr (toQPainter arg'1) $ \arg'1' ->
  let arg'2' = HoppyFHR.coerceIntegral arg'2 in
  let arg'3' = HoppyFHR.coerceIntegral arg'3 in
  M122.withQImagePtr arg'4 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'4' ->
  (drawImageAtRaw' arg'1' arg'2' arg'3' arg'4')

drawImageAtRawAll :: (QPainterPtr arg'1, M122.QImageValue arg'4, M66.IsQtImageConversionFlags arg'9) => arg'1 -> HoppyP.Int -> HoppyP.Int -> arg'4 -> HoppyP.Int -> HoppyP.Int -> HoppyP.Int -> HoppyP.Int -> arg'9 -> HoppyP.IO ()
drawImageAtRawAll arg'1 arg'2 arg'3 arg'4 arg'5 arg'6 arg'7 arg'8 arg'9 =
  ...
  let arg'9' = M66.fromQtImageConversionFlags $ M66.toQtImageConversionFlags arg'9 in
  (drawImageAtRawAll' arg'1' arg'2' arg'3' arg'4' arg'5' arg'6' arg'7' arg'8' arg'9')

fillRectWithGlobalColor :: (QPainterPtr arg'1, M42.QRectValue arg'2) => arg'1 -> arg'2 -> M66.QtGlobalColor -> HoppyP.IO ()
...
newWithDevice :: (M134.QPaintDevicePtr arg'1) => arg'1 -> HoppyP.IO QPainter
newWithDevice arg'1 =
  HoppyFHR.withCppPtr (M134.toQPaintDevice arg'1) $ \arg'1' ->
  HoppyP.fmap QPainter
  (newWithDevice' arg'1')
