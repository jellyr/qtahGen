...
foreign import ccall "genpop__QValidator_fixup" fixup' ::  HoppyF.Ptr QValidatorConst -> HoppyF.Ptr M52.QString -> HoppyP.IO ()
foreign import ccall "genpop__QValidator_validate" validate' ::  HoppyF.Ptr QValidatorConst -> HoppyF.Ptr M52.QString -> HoppyF.Ptr HoppyFC.CInt -> HoppyP.IO HoppyFC.CInt
...
fixup :: (QValidatorValue arg'1, M52.QStringPtr arg'2) => arg'1 -> arg'2 -> HoppyP.IO ()
fixup arg'1 arg'2 =
  withQValidatorPtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
  HoppyFHR.withCppPtr (M52.toQString arg'2) $ \arg'2' ->
  (fixup' arg'1' arg'2')

validate :: (QValidatorValue arg'1, M52.QStringPtr arg'2) => arg'1 -> arg'2 -> HoppyF.Ptr HoppyFC.CInt -> HoppyP.IO QValidatorState
