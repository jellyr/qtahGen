...
foreign import ccall "gencast__QDoubleValidator__QValidator" castQDoubleValidatorToQValidator :: HoppyF.Ptr QDoubleValidatorConst -> HoppyF.Ptr M168.QValidatorConst
foreign import ccall "gencast__QValidator__QDoubleValidator" castQValidatorToQDoubleValidator :: HoppyF.Ptr M168.QValidatorConst -> HoppyF.Ptr QDoubleValidatorConst
...
class (M168.QValidatorConstPtr this) => QDoubleValidatorConstPtr this where
...
class (QDoubleValidatorConstPtr this, M168.QValidatorPtr this) => QDoubleValidatorPtr this where
...
instance M168.QValidatorConstPtr QDoubleValidatorConst where
  toQValidatorConst (QDoubleValidatorConst ptr') = M168.QValidatorConst $ castQDoubleValidatorToQValidator ptr'
  toQValidatorConst (QDoubleValidatorConstGc fptr' ptr') = M168.QValidatorConstGc fptr' $ castQDoubleValidatorToQValidator ptr'
...
instance M168.QValidatorConstPtr QDoubleValidator where
  toQValidatorConst (QDoubleValidator ptr') = M168.QValidatorConst $ castQDoubleValidatorToQValidator $ (HoppyF.castPtr :: HoppyF.Ptr QDoubleValidator -> HoppyF.Ptr QDoubleValidatorConst) ptr'
  toQValidatorConst (QDoubleValidatorGc fptr' ptr') = M168.QValidatorConstGc fptr' $ castQDoubleValidatorToQValidator $ (HoppyF.castPtr :: HoppyF.Ptr QDoubleValidator -> HoppyF.Ptr QDoubleValidatorConst) ptr'

instance M168.QValidatorPtr QDoubleValidator where
  toQValidator (QDoubleValidator ptr') = M168.QValidator $ (HoppyF.castPtr :: HoppyF.Ptr M168.QValidatorConst -> HoppyF.Ptr M168.QValidator) $ castQDoubleValidatorToQValidator $ (HoppyF.castPtr :: HoppyF.Ptr QDoubleValidator -> HoppyF.Ptr QDoubleValidatorConst) ptr'
  toQValidator (QDoubleValidatorGc fptr' ptr') = M168.QValidatorGc fptr' $ (HoppyF.castPtr :: HoppyF.Ptr M168.QValidatorConst -> HoppyF.Ptr M168.QValidator) $ castQDoubleValidatorToQValidator $ (HoppyF.castPtr :: HoppyF.Ptr QDoubleValidator -> HoppyF.Ptr QDoubleValidatorConst) ptr'
...
instance QDoubleValidatorSuper M168.QValidator where
  downToQDoubleValidator = castQDoubleValidatorToNonconst . cast' . M168.castQValidatorToConst
    where
      cast' (M168.QValidatorConst ptr') = QDoubleValidatorConst $ castQValidatorToQDoubleValidator ptr'
      cast' (M168.QValidatorConstGc fptr' ptr') = QDoubleValidatorConstGc fptr' $ castQValidatorToQDoubleValidator ptr'
...
instance QDoubleValidatorSuperConst M168.QValidatorConst where
