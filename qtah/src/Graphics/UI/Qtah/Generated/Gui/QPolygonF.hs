...
import qualified Graphics.UI.Qtah.Generated.Core.QVector.QPointF as M92
...
foreign import ccall "genpop__QPolygonF_newWithPoints" newWithPoints' ::  HoppyF.Ptr M92.QVectorQPointFConst -> HoppyP.IO (HoppyF.Ptr QPolygonF)
foreign import ccall "genpop__QPolygonF_newWithPolygon" newWithPolygon' ::  HoppyF.Ptr M148.QPolygonConst -> HoppyP.IO (HoppyF.Ptr QPolygonF)
foreign import ccall "genpop__QPolygonF_newWithRectangle" newWithRectangle' ::  HoppyF.Ptr M44.QRectFConst -> HoppyP.IO (HoppyF.Ptr QPolygonF)
foreign import ccall "genpop__QPolygonF_newCopy" newCopy' ::  HoppyF.Ptr QPolygonFConst -> HoppyP.IO (HoppyF.Ptr QPolygonF)
foreign import ccall "genpop__QPolygonF_boundingRect" boundingRect' ::  HoppyF.Ptr QPolygonFConst -> HoppyP.IO (HoppyF.Ptr M44.QRectFConst)
foreign import ccall "genpop__QPolygonF_containsPoint" containsPoint' ::  HoppyF.Ptr QPolygonFConst -> HoppyF.Ptr M40.QPointFConst -> HoppyFC.CInt -> HoppyP.IO HoppyFHR.CBool
...
foreign import ccall "genpop__QPolygonF_toPolygon" toPolygon' ::  HoppyF.Ptr QPolygonFConst -> HoppyP.IO (HoppyF.Ptr M148.QPolygonConst)
...
foreign import ccall "genpop__QPolygonF_translateByPoint" translateByPoint' ::  HoppyF.Ptr QPolygonF -> HoppyF.Ptr M40.QPointFConst -> HoppyP.IO ()
...
foreign import ccall "genpop__QPolygonF_translatedByPoint" translatedByPoint' ::  HoppyF.Ptr QPolygonFConst -> HoppyF.Ptr M40.QPointFConst -> HoppyP.IO (HoppyF.Ptr QPolygonFConst)
...
foreign import ccall "gencast__QPolygonF__QVectorQPointF" castQPolygonFToQVectorQPointF :: HoppyF.Ptr QPolygonFConst -> HoppyF.Ptr M92.QVectorQPointFConst
...
class (M92.QVectorQPointFConstPtr this) => QPolygonFConstPtr this where
  toQPolygonFConst :: this -> QPolygonFConst

boundingRect :: (QPolygonFValue arg'1) => arg'1 -> HoppyP.IO M44.QRectF
boundingRect arg'1 =
  withQPolygonFPtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
  (HoppyFHR.decodeAndDelete . M44.QRectFConst) =<<
  (boundingRect' arg'1')

containsPoint :: (QPolygonFValue arg'1, M40.QPointFValue arg'2) => arg'1 -> arg'2 -> M66.QtFillRule -> HoppyP.IO HoppyP.Bool
...
toPolygon :: (QPolygonFValue arg'1) => arg'1 -> HoppyP.IO M148.QPolygon
toPolygon arg'1 =
  withQPolygonFPtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
...
translatedByPoint :: (QPolygonFValue arg'1, M40.QPointFValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO QPolygonF
...
class (QPolygonFConstPtr this, M92.QVectorQPointFPtr this) => QPolygonFPtr this where
...
translateByPoint :: (QPolygonFPtr arg'1, M40.QPointFValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO ()
...
instance M92.QVectorQPointFConstPtr QPolygonFConst where
  toQVectorQPointFConst (QPolygonFConst ptr') = M92.QVectorQPointFConst $ castQPolygonFToQVectorQPointF ptr'
  toQVectorQPointFConst (QPolygonFConstGc fptr' ptr') = M92.QVectorQPointFConstGc fptr' $ castQPolygonFToQVectorQPointF ptr'
...
instance M92.QVectorQPointFConstPtr QPolygonF where
  toQVectorQPointFConst (QPolygonF ptr') = M92.QVectorQPointFConst $ castQPolygonFToQVectorQPointF $ (HoppyF.castPtr :: HoppyF.Ptr QPolygonF -> HoppyF.Ptr QPolygonFConst) ptr'
  toQVectorQPointFConst (QPolygonFGc fptr' ptr') = M92.QVectorQPointFConstGc fptr' $ castQPolygonFToQVectorQPointF $ (HoppyF.castPtr :: HoppyF.Ptr QPolygonF -> HoppyF.Ptr QPolygonFConst) ptr'

instance M92.QVectorQPointFPtr QPolygonF where
  toQVectorQPointF (QPolygonF ptr') = M92.QVectorQPointF $ (HoppyF.castPtr :: HoppyF.Ptr M92.QVectorQPointFConst -> HoppyF.Ptr M92.QVectorQPointF) $ castQPolygonFToQVectorQPointF $ (HoppyF.castPtr :: HoppyF.Ptr QPolygonF -> HoppyF.Ptr QPolygonFConst) ptr'
  toQVectorQPointF (QPolygonFGc fptr' ptr') = M92.QVectorQPointFGc fptr' $ (HoppyF.castPtr :: HoppyF.Ptr M92.QVectorQPointFConst -> HoppyF.Ptr M92.QVectorQPointF) $ castQPolygonFToQVectorQPointF $ (HoppyF.castPtr :: HoppyF.Ptr QPolygonF -> HoppyF.Ptr QPolygonFConst) ptr'
...
newWithPoints :: (M92.QVectorQPointFValue arg'1) => arg'1 -> HoppyP.IO QPolygonF
newWithPoints arg'1 =
  M92.withQVectorQPointFPtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
  HoppyP.fmap QPolygonF
  (newWithPoints' arg'1')

newWithPolygon :: (M148.QPolygonValue arg'1) => arg'1 -> HoppyP.IO QPolygonF
newWithPolygon arg'1 =
  M148.withQPolygonPtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
  HoppyP.fmap QPolygonF
  (newWithPolygon' arg'1')

newWithRectangle :: (M44.QRectFValue arg'1) => arg'1 -> HoppyP.IO QPolygonF
