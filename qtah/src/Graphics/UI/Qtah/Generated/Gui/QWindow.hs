...
foreign import ccall "genpop__QWindow_baseSize" baseSize' ::  HoppyF.Ptr QWindowConst -> HoppyP.IO (HoppyF.Ptr M48.QSizeConst)
foreign import ccall "genpop__QWindow_setBaseSize" setBaseSize' ::  HoppyF.Ptr QWindow -> HoppyF.Ptr M48.QSizeConst -> HoppyP.IO ()
...
foreign import ccall "genpop__QWindow_filePath" filePath' ::  HoppyF.Ptr QWindowConst -> HoppyP.IO (HoppyF.Ptr M52.QStringConst)
foreign import ccall "genpop__QWindow_setFilePath" setFilePath' ::  HoppyF.Ptr QWindow -> HoppyF.Ptr M52.QStringConst -> HoppyP.IO ()
...
foreign import ccall "genpop__QWindow_frameGeometry" frameGeometry' ::  HoppyF.Ptr QWindowConst -> HoppyP.IO (HoppyF.Ptr M42.QRectConst)
...
foreign import ccall "genpop__QWindow_framePosition" framePosition' ::  HoppyF.Ptr QWindowConst -> HoppyP.IO (HoppyF.Ptr M38.QPointConst)
foreign import ccall "genpop__QWindow_setFramePosition" setFramePosition' ::  HoppyF.Ptr QWindow -> HoppyF.Ptr M38.QPointConst -> HoppyP.IO ()
foreign import ccall "genpop__QWindow_geometry" geometry' ::  HoppyF.Ptr QWindowConst -> HoppyP.IO (HoppyF.Ptr M42.QRectConst)
foreign import ccall "genpop__QWindow_setGeometry" setGeometry' ::  HoppyF.Ptr QWindow -> HoppyF.Ptr M42.QRectConst -> HoppyP.IO ()
...
foreign import ccall "genpop__QWindow_icon" icon' ::  HoppyF.Ptr QWindowConst -> HoppyP.IO (HoppyF.Ptr M120.QIconConst)
foreign import ccall "genpop__QWindow_setIcon" setIcon' ::  HoppyF.Ptr QWindow -> HoppyF.Ptr M120.QIconConst -> HoppyP.IO ()
...
foreign import ccall "genpop__QWindow_mapFromGlobal" mapFromGlobal' ::  HoppyF.Ptr QWindowConst -> HoppyF.Ptr M38.QPointConst -> HoppyP.IO (HoppyF.Ptr M38.QPointConst)
foreign import ccall "genpop__QWindow_mapToGlobal" mapToGlobal' ::  HoppyF.Ptr QWindowConst -> HoppyF.Ptr M38.QPointConst -> HoppyP.IO (HoppyF.Ptr M38.QPointConst)
foreign import ccall "genpop__QWindow_mask" mask' ::  HoppyF.Ptr QWindowConst -> HoppyP.IO (HoppyF.Ptr M154.QRegionConst)
foreign import ccall "genpop__QWindow_setMask" setMask' ::  HoppyF.Ptr QWindow -> HoppyF.Ptr M154.QRegionConst -> HoppyP.IO ()
...
foreign import ccall "genpop__QWindow_maximumSize" maximumSize' ::  HoppyF.Ptr QWindowConst -> HoppyP.IO (HoppyF.Ptr M48.QSizeConst)
foreign import ccall "genpop__QWindow_setMaximumSize" setMaximumSize' ::  HoppyF.Ptr QWindow -> HoppyF.Ptr M48.QSizeConst -> HoppyP.IO ()
...
foreign import ccall "genpop__QWindow_minimumSize" minimumSize' ::  HoppyF.Ptr QWindowConst -> HoppyP.IO (HoppyF.Ptr M48.QSizeConst)
foreign import ccall "genpop__QWindow_setMinimumSize" setMinimumSize' ::  HoppyF.Ptr QWindow -> HoppyF.Ptr M48.QSizeConst -> HoppyP.IO ()
...
foreign import ccall "genpop__QWindow_position" position' ::  HoppyF.Ptr QWindowConst -> HoppyP.IO (HoppyF.Ptr M38.QPointConst)
foreign import ccall "genpop__QWindow_setPosition" setPosition' ::  HoppyF.Ptr QWindow -> HoppyF.Ptr M38.QPointConst -> HoppyP.IO ()
...
foreign import ccall "genpop__QWindow_resize" resize' ::  HoppyF.Ptr QWindow -> HoppyF.Ptr M48.QSizeConst -> HoppyP.IO ()
...
foreign import ccall "genpop__QWindow_sizeIncrement" sizeIncrement' ::  HoppyF.Ptr QWindowConst -> HoppyP.IO (HoppyF.Ptr M48.QSizeConst)
foreign import ccall "genpop__QWindow_setSizeIncrement" setSizeIncrement' ::  HoppyF.Ptr QWindow -> HoppyF.Ptr M48.QSizeConst -> HoppyP.IO ()
foreign import ccall "genpop__QWindow_title" title' ::  HoppyF.Ptr QWindowConst -> HoppyP.IO (HoppyF.Ptr M52.QStringConst)
foreign import ccall "genpop__QWindow_setTitle" setTitle' ::  HoppyF.Ptr QWindow -> HoppyF.Ptr M52.QStringConst -> HoppyP.IO ()
...
foreign import ccall "gencast__QWindow__QSurface" castQWindowToQSurface :: HoppyF.Ptr QWindowConst -> HoppyF.Ptr M164.QSurfaceConst
foreign import ccall "gencast__QSurface__QWindow" castQSurfaceToQWindow :: HoppyF.Ptr M164.QSurfaceConst -> HoppyF.Ptr QWindowConst
...
class (M34.QObjectConstPtr this, M164.QSurfaceConstPtr this) => QWindowConstPtr this where
...
contentOrientation :: (QWindowValue arg'1) => arg'1 -> HoppyP.IO M66.QtScreenOrientation
...
flags :: (QWindowValue arg'1) => arg'1 -> HoppyP.IO M66.QtWindowFlags
flags arg'1 =
  withQWindowPtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
...
icon :: (QWindowValue arg'1) => arg'1 -> HoppyP.IO M120.QIcon
icon arg'1 =
  withQWindowPtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
...
mapFromGlobal :: (QWindowValue arg'1, M38.QPointValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO HPoint.HPoint
...
mapToGlobal :: (QWindowValue arg'1, M38.QPointValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO HPoint.HPoint
...
mask :: (QWindowValue arg'1) => arg'1 -> HoppyP.IO M154.QRegion
mask arg'1 =
  withQWindowPtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
  (HoppyFHR.decodeAndDelete . M154.QRegionConst) =<<
  (mask' arg'1')
...
modality :: (QWindowValue arg'1) => arg'1 -> HoppyP.IO M66.QtWindowModality
modality arg'1 =
  withQWindowPtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
  HoppyP.fmap (HoppyP.toEnum . HoppyFHR.coerceIntegral)
  (modality' arg'1')
...
getType :: (QWindowValue arg'1) => arg'1 -> HoppyP.IO M66.QtWindowType
getType arg'1 =
  withQWindowPtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
  HoppyP.fmap (HoppyP.toEnum . HoppyFHR.coerceIntegral)
  (getType' arg'1')
...
windowState :: (QWindowValue arg'1) => arg'1 -> HoppyP.IO M66.QtWindowState
windowState arg'1 =
  withQWindowPtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
  HoppyP.fmap (HoppyP.toEnum . HoppyFHR.coerceIntegral)
  (windowState' arg'1')
...
class (QWindowConstPtr this, M34.QObjectPtr this, M164.QSurfacePtr this) => QWindowPtr this where
...
setBaseSize :: (QWindowPtr arg'1, M48.QSizeValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO ()
...
setFilePath :: (QWindowPtr arg'1, M52.QStringValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO ()
setFilePath arg'1 arg'2 =
  HoppyFHR.withCppPtr (toQWindow arg'1) $ \arg'1' ->
  M52.withQStringPtr arg'2 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'2' ->
  (setFilePath' arg'1' arg'2')

setFlags :: (QWindowPtr arg'1, M66.IsQtWindowFlags arg'2) => arg'1 -> arg'2 -> HoppyP.IO ()
setFlags arg'1 arg'2 =
  HoppyFHR.withCppPtr (toQWindow arg'1) $ \arg'1' ->
  let arg'2' = M66.fromQtWindowFlags $ M66.toQtWindowFlags arg'2 in
  (setFlags' arg'1' arg'2')

setFramePosition :: (QWindowPtr arg'1, M38.QPointValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO ()
setFramePosition arg'1 arg'2 =
  HoppyFHR.withCppPtr (toQWindow arg'1) $ \arg'1' ->
  M38.withQPointPtr arg'2 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'2' ->
  (setFramePosition' arg'1' arg'2')

setGeometry :: (QWindowPtr arg'1, M42.QRectValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO ()
...
setIcon :: (QWindowPtr arg'1, M120.QIconValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO ()
setIcon arg'1 arg'2 =
  HoppyFHR.withCppPtr (toQWindow arg'1) $ \arg'1' ->
...
setMask :: (QWindowPtr arg'1, M154.QRegionValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO ()
setMask arg'1 arg'2 =
  HoppyFHR.withCppPtr (toQWindow arg'1) $ \arg'1' ->
...
setMaximumSize :: (QWindowPtr arg'1, M48.QSizeValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO ()
...
setMinimumSize :: (QWindowPtr arg'1, M48.QSizeValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO ()
...
setModality :: (QWindowPtr arg'1) => arg'1 -> M66.QtWindowModality -> HoppyP.IO ()
...
setPosition :: (QWindowPtr arg'1, M38.QPointValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO ()
...
reportContentOrientationChange :: (QWindowPtr arg'1) => arg'1 -> M66.QtScreenOrientation -> HoppyP.IO ()
...
resize :: (QWindowPtr arg'1, M48.QSizeValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO ()
resize arg'1 arg'2 =
  HoppyFHR.withCppPtr (toQWindow arg'1) $ \arg'1' ->
  M48.withQSizePtr arg'2 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'2' ->
  (resize' arg'1' arg'2')
...
setSurfaceType :: (QWindowPtr arg'1) => arg'1 -> M164.QSurfaceSurfaceType -> HoppyP.IO ()
...
setSizeIncrement :: (QWindowPtr arg'1, M48.QSizeValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO ()
setSizeIncrement arg'1 arg'2 =
  HoppyFHR.withCppPtr (toQWindow arg'1) $ \arg'1' ->
  M48.withQSizePtr arg'2 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'2' ->
  (setSizeIncrement' arg'1' arg'2')

setTitle :: (QWindowPtr arg'1, M52.QStringValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO ()
...
setWindowState :: (QWindowPtr arg'1) => arg'1 -> M66.QtWindowState -> HoppyP.IO ()
...
instance M164.QSurfaceConstPtr QWindowConst where
  toQSurfaceConst (QWindowConst ptr') = M164.QSurfaceConst $ castQWindowToQSurface ptr'
  toQSurfaceConst (QWindowConstGc fptr' ptr') = M164.QSurfaceConstGc fptr' $ castQWindowToQSurface ptr'
...
instance M164.QSurfaceConstPtr QWindow where
  toQSurfaceConst (QWindow ptr') = M164.QSurfaceConst $ castQWindowToQSurface $ (HoppyF.castPtr :: HoppyF.Ptr QWindow -> HoppyF.Ptr QWindowConst) ptr'
  toQSurfaceConst (QWindowGc fptr' ptr') = M164.QSurfaceConstGc fptr' $ castQWindowToQSurface $ (HoppyF.castPtr :: HoppyF.Ptr QWindow -> HoppyF.Ptr QWindowConst) ptr'

instance M164.QSurfacePtr QWindow where
  toQSurface (QWindow ptr') = M164.QSurface $ (HoppyF.castPtr :: HoppyF.Ptr M164.QSurfaceConst -> HoppyF.Ptr M164.QSurface) $ castQWindowToQSurface $ (HoppyF.castPtr :: HoppyF.Ptr QWindow -> HoppyF.Ptr QWindowConst) ptr'
  toQSurface (QWindowGc fptr' ptr') = M164.QSurfaceGc fptr' $ (HoppyF.castPtr :: HoppyF.Ptr M164.QSurfaceConst -> HoppyF.Ptr M164.QSurface) $ castQWindowToQSurface $ (HoppyF.castPtr :: HoppyF.Ptr QWindow -> HoppyF.Ptr QWindowConst) ptr'
...
instance QWindowSuper M164.QSurface where
  downToQWindow = castQWindowToNonconst . cast' . M164.castQSurfaceToConst
    where
      cast' (M164.QSurfaceConst ptr') = QWindowConst $ castQSurfaceToQWindow ptr'
      cast' (M164.QSurfaceConstGc fptr' ptr') = QWindowConstGc fptr' $ castQSurfaceToQWindow ptr'
...
instance QWindowSuperConst M34.QObjectConst where
  downToQWindowConst = cast'
    where
      cast' (M34.QObjectConst ptr') = QWindowConst $ castQObjectToQWindow ptr'
      cast' (M34.QObjectConstGc fptr' ptr') = QWindowConstGc fptr' $ castQObjectToQWindow ptr'
instance QWindowSuperConst M164.QSurfaceConst where
  downToQWindowConst = cast'
    where
      cast' (M164.QSurfaceConst ptr') = QWindowConst $ castQSurfaceToQWindow ptr'
      cast' (M164.QSurfaceConstGc fptr' ptr') = QWindowConstGc fptr' $ castQSurfaceToQWindow ptr'
