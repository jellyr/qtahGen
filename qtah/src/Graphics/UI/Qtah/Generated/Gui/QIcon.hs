...
import qualified Graphics.UI.Qtah.Generated.Core.QList.QSize as M80
...
foreign import ccall "genpop__QIcon_newWithFile" newWithFile' ::  HoppyF.Ptr M52.QStringConst -> HoppyP.IO (HoppyF.Ptr QIcon)
foreign import ccall "genpop__QIcon_newWithPixmap" newWithPixmap' ::  HoppyF.Ptr M146.QPixmapConst -> HoppyP.IO (HoppyF.Ptr QIcon)
foreign import ccall "genpop__QIcon_newCopy" newCopy' ::  HoppyF.Ptr QIconConst -> HoppyP.IO (HoppyF.Ptr QIcon)
foreign import ccall "genpop__QIcon_actualSize" actualSize' ::  HoppyF.Ptr QIconConst -> HoppyF.Ptr M48.QSizeConst -> HoppyP.IO (HoppyF.Ptr M48.QSizeConst)
foreign import ccall "genpop__QIcon_actualSizeAll" actualSizeAll' ::  HoppyF.Ptr QIconConst -> HoppyF.Ptr M48.QSizeConst -> HoppyFC.CInt -> HoppyFC.CInt -> HoppyP.IO (HoppyF.Ptr M48.QSizeConst)
foreign import ccall "genpop__QIcon_actualSizeWithWindow" actualSizeWithWindow' ::  HoppyF.Ptr QIconConst -> HoppyF.Ptr M172.QWindow -> HoppyF.Ptr M48.QSizeConst -> HoppyP.IO (HoppyF.Ptr M48.QSizeConst)
foreign import ccall "genpop__QIcon_actualSizeWithWindowAll" actualSizeWithWindowAll' ::  HoppyF.Ptr QIconConst -> HoppyF.Ptr M172.QWindow -> HoppyF.Ptr M48.QSizeConst -> HoppyFC.CInt -> HoppyFC.CInt -> HoppyP.IO (HoppyF.Ptr M48.QSizeConst)
foreign import ccall "genpop__QIcon_addFile" addFile' ::  HoppyF.Ptr QIcon -> HoppyF.Ptr M52.QStringConst -> HoppyP.IO ()
foreign import ccall "genpop__QIcon_addFileAll" addFileAll' ::  HoppyF.Ptr QIcon -> HoppyF.Ptr M52.QStringConst -> HoppyF.Ptr M48.QSizeConst -> HoppyFC.CInt -> HoppyFC.CInt -> HoppyP.IO ()
foreign import ccall "genpop__QIcon_addPixmap" addPixmap' ::  HoppyF.Ptr QIcon -> HoppyF.Ptr M146.QPixmapConst -> HoppyP.IO ()
foreign import ccall "genpop__QIcon_addPixmapAll" addPixmapAll' ::  HoppyF.Ptr QIcon -> HoppyF.Ptr M146.QPixmapConst -> HoppyFC.CInt -> HoppyFC.CInt -> HoppyP.IO ()
foreign import ccall "genpop__QIcon_availableSizes" availableSizes' ::  HoppyF.Ptr QIconConst -> HoppyP.IO (HoppyF.Ptr M80.QListQSizeConst)
foreign import ccall "genpop__QIcon_availableSizesAll" availableSizesAll' ::  HoppyF.Ptr QIconConst -> HoppyFC.CInt -> HoppyFC.CInt -> HoppyP.IO (HoppyF.Ptr M80.QListQSizeConst)
foreign import ccall "genpop__QIcon_cacheKey" cacheKey' ::  HoppyF.Ptr QIconConst -> HoppyP.IO HoppyDI.Int64
foreign import ccall "genpop__QIcon_fromTheme" fromTheme' ::  HoppyF.Ptr M52.QStringConst -> HoppyP.IO (HoppyF.Ptr QIconConst)
foreign import ccall "genpop__QIcon_fromThemeWithFallback" fromThemeWithFallback' ::  HoppyF.Ptr M52.QStringConst -> HoppyF.Ptr QIconConst -> HoppyP.IO (HoppyF.Ptr QIconConst)
foreign import ccall "genpop__QIcon_hasThemeIcon" hasThemeIcon' ::  HoppyF.Ptr M52.QStringConst -> HoppyP.IO HoppyFHR.CBool
...
foreign import ccall "genpop__QIcon_name" name' ::  HoppyF.Ptr QIconConst -> HoppyP.IO (HoppyF.Ptr M52.QStringConst)
foreign import ccall "genpop__QIcon_paintWithRect" paintWithRect' ::  HoppyF.Ptr QIconConst -> HoppyF.Ptr M140.QPainter -> HoppyF.Ptr M42.QRectConst -> HoppyP.IO ()
foreign import ccall "genpop__QIcon_paintWithRectAll" paintWithRectAll' ::  HoppyF.Ptr QIconConst -> HoppyF.Ptr M140.QPainter -> HoppyF.Ptr M42.QRectConst -> HoppyFC.CInt -> HoppyFC.CInt -> HoppyFC.CInt -> HoppyP.IO ()
foreign import ccall "genpop__QIcon_paintWithRaw" paintWithRaw' ::  HoppyF.Ptr QIconConst -> HoppyF.Ptr M140.QPainter -> HoppyFC.CInt -> HoppyFC.CInt -> HoppyFC.CInt -> HoppyFC.CInt -> HoppyP.IO ()
foreign import ccall "genpop__QIcon_paintWithRawAll" paintWithRawAll' ::  HoppyF.Ptr QIconConst -> HoppyF.Ptr M140.QPainter -> HoppyFC.CInt -> HoppyFC.CInt -> HoppyFC.CInt -> HoppyFC.CInt -> HoppyFC.CInt -> HoppyFC.CInt -> HoppyFC.CInt -> HoppyP.IO ()
foreign import ccall "genpop__QIcon_pixmapExtent" pixmapExtent' ::  HoppyF.Ptr QIconConst -> HoppyFC.CInt -> HoppyP.IO (HoppyF.Ptr M146.QPixmapConst)
foreign import ccall "genpop__QIcon_pixmapExtentAll" pixmapExtentAll' ::  HoppyF.Ptr QIconConst -> HoppyFC.CInt -> HoppyFC.CInt -> HoppyFC.CInt -> HoppyP.IO (HoppyF.Ptr M146.QPixmapConst)
foreign import ccall "genpop__QIcon_pixmapRaw" pixmapRaw' ::  HoppyF.Ptr QIconConst -> HoppyFC.CInt -> HoppyFC.CInt -> HoppyP.IO (HoppyF.Ptr M146.QPixmapConst)
foreign import ccall "genpop__QIcon_pixmapRawAll" pixmapRawAll' ::  HoppyF.Ptr QIconConst -> HoppyFC.CInt -> HoppyFC.CInt -> HoppyFC.CInt -> HoppyFC.CInt -> HoppyP.IO (HoppyF.Ptr M146.QPixmapConst)
foreign import ccall "genpop__QIcon_pixmapSize" pixmapSize' ::  HoppyF.Ptr QIconConst -> HoppyF.Ptr M48.QSizeConst -> HoppyP.IO (HoppyF.Ptr M146.QPixmapConst)
foreign import ccall "genpop__QIcon_pixmapSizeAll" pixmapSizeAll' ::  HoppyF.Ptr QIconConst -> HoppyF.Ptr M48.QSizeConst -> HoppyFC.CInt -> HoppyFC.CInt -> HoppyP.IO (HoppyF.Ptr M146.QPixmapConst)
foreign import ccall "genpop__QIcon_setIsMask" setIsMask' ::  HoppyF.Ptr QIcon -> HoppyFHR.CBool -> HoppyP.IO ()
foreign import ccall "genpop__QIcon_setThemeName" setThemeName' ::  HoppyF.Ptr M52.QStringConst -> HoppyP.IO ()
foreign import ccall "genpop__QIcon_setThemeSearchPaths" setThemeSearchPaths' ::  HoppyF.Ptr M54.QStringListConst -> HoppyP.IO ()
foreign import ccall "genpop__QIcon_swap" swap' ::  HoppyF.Ptr QIcon -> HoppyF.Ptr QIcon -> HoppyP.IO ()
foreign import ccall "genpop__QIcon_themeName" themeName' ::  HoppyP.IO (HoppyF.Ptr M52.QStringConst)
foreign import ccall "genpop__QIcon_themeSearchPaths" themeSearchPaths' ::  HoppyP.IO (HoppyF.Ptr M54.QStringListConst)
...
actualSize :: (QIconValue arg'1, M48.QSizeValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO HSize.HSize
...
actualSizeAll :: (QIconValue arg'1, M48.QSizeValue arg'2) => arg'1 -> arg'2 -> QIconMode -> QIconState -> HoppyP.IO HSize.HSize
...
actualSizeWithWindow :: (QIconValue arg'1, M172.QWindowPtr arg'2, M48.QSizeValue arg'3) => arg'1 -> arg'2 -> arg'3 -> HoppyP.IO HSize.HSize
actualSizeWithWindow arg'1 arg'2 arg'3 =
  withQIconPtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
  HoppyFHR.withCppPtr (M172.toQWindow arg'2) $ \arg'2' ->
  M48.withQSizePtr arg'3 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'3' ->
  (HoppyFHR.decodeAndDelete . M48.QSizeConst) =<<
  (actualSizeWithWindow' arg'1' arg'2' arg'3')

actualSizeWithWindowAll :: (QIconValue arg'1, M172.QWindowPtr arg'2, M48.QSizeValue arg'3) => arg'1 -> arg'2 -> arg'3 -> QIconMode -> QIconState -> HoppyP.IO HSize.HSize
...
availableSizes arg'1 =
  withQIconPtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
  (HoppyFHR.decodeAndDelete . M80.QListQSizeConst) =<<
  (availableSizes' arg'1')
...
paintWithRect :: (QIconValue arg'1, M140.QPainterPtr arg'2, M42.QRectValue arg'3) => arg'1 -> arg'2 -> arg'3 -> HoppyP.IO ()
paintWithRect arg'1 arg'2 arg'3 =
  withQIconPtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
  HoppyFHR.withCppPtr (M140.toQPainter arg'2) $ \arg'2' ->
  M42.withQRectPtr arg'3 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'3' ->
  (paintWithRect' arg'1' arg'2' arg'3')

paintWithRectAll :: (QIconValue arg'1, M140.QPainterPtr arg'2, M42.QRectValue arg'3, M66.IsQtAlignment arg'4) => arg'1 -> arg'2 -> arg'3 -> arg'4 -> QIconMode -> QIconState -> HoppyP.IO ()
paintWithRectAll arg'1 arg'2 arg'3 arg'4 arg'5 arg'6 =
  withQIconPtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
  HoppyFHR.withCppPtr (M140.toQPainter arg'2) $ \arg'2' ->
  M42.withQRectPtr arg'3 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'3' ->
  let arg'4' = M66.fromQtAlignment $ M66.toQtAlignment arg'4 in
  let arg'5' = HoppyFHR.coerceIntegral $ HoppyP.fromEnum arg'5 in
  let arg'6' = HoppyFHR.coerceIntegral $ HoppyP.fromEnum arg'6 in
  (paintWithRectAll' arg'1' arg'2' arg'3' arg'4' arg'5' arg'6')

paintWithRaw :: (QIconValue arg'1, M140.QPainterPtr arg'2) => arg'1 -> arg'2 -> HoppyP.Int -> HoppyP.Int -> HoppyP.Int -> HoppyP.Int -> HoppyP.IO ()
...
paintWithRawAll :: (QIconValue arg'1, M140.QPainterPtr arg'2, M66.IsQtAlignment arg'7) => arg'1 -> arg'2 -> HoppyP.Int -> HoppyP.Int -> HoppyP.Int -> HoppyP.Int -> arg'7 -> QIconMode -> QIconState -> HoppyP.IO ()
paintWithRawAll arg'1 arg'2 arg'3 arg'4 arg'5 arg'6 arg'7 arg'8 arg'9 =
  ...
  let arg'5' = HoppyFHR.coerceIntegral arg'5 in
  let arg'6' = HoppyFHR.coerceIntegral arg'6 in
  let arg'7' = M66.fromQtAlignment $ M66.toQtAlignment arg'7 in
  let arg'8' = HoppyFHR.coerceIntegral $ HoppyP.fromEnum arg'8 in
  let arg'9' = HoppyFHR.coerceIntegral $ HoppyP.fromEnum arg'9 in
  (paintWithRawAll' arg'1' arg'2' arg'3' arg'4' arg'5' arg'6' arg'7' arg'8' arg'9')

pixmapExtent :: (QIconValue arg'1) => arg'1 -> HoppyP.Int -> HoppyP.IO M146.QPixmap
...
pixmapExtentAll :: (QIconValue arg'1) => arg'1 -> HoppyP.Int -> QIconMode -> QIconState -> HoppyP.IO M146.QPixmap
...
pixmapRaw :: (QIconValue arg'1) => arg'1 -> HoppyP.Int -> HoppyP.Int -> HoppyP.IO M146.QPixmap
...
pixmapRawAll :: (QIconValue arg'1) => arg'1 -> HoppyP.Int -> HoppyP.Int -> QIconMode -> QIconState -> HoppyP.IO M146.QPixmap
...
pixmapSize :: (QIconValue arg'1, M48.QSizeValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO M146.QPixmap
...
pixmapSizeAll :: (QIconValue arg'1, M48.QSizeValue arg'2) => arg'1 -> arg'2 -> QIconMode -> QIconState -> HoppyP.IO M146.QPixmap
...
addFile :: (QIconPtr arg'1, M52.QStringValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO ()
addFile arg'1 arg'2 =
  HoppyFHR.withCppPtr (toQIcon arg'1) $ \arg'1' ->
  M52.withQStringPtr arg'2 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'2' ->
  (addFile' arg'1' arg'2')

addFileAll :: (QIconPtr arg'1, M52.QStringValue arg'2, M48.QSizeValue arg'3) => arg'1 -> arg'2 -> arg'3 -> QIconMode -> QIconState -> HoppyP.IO ()
...
addPixmap :: (QIconPtr arg'1, M146.QPixmapValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO ()
addPixmap arg'1 arg'2 =
  HoppyFHR.withCppPtr (toQIcon arg'1) $ \arg'1' ->
  M146.withQPixmapPtr arg'2 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'2' ->
  (addPixmap' arg'1' arg'2')

addPixmapAll :: (QIconPtr arg'1, M146.QPixmapValue arg'2) => arg'1 -> arg'2 -> QIconMode -> QIconState -> HoppyP.IO ()
...
fromTheme :: (M52.QStringValue arg'1) => arg'1 -> HoppyP.IO QIcon
fromTheme arg'1 =
  M52.withQStringPtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
  (HoppyFHR.decodeAndDelete . QIconConst) =<<
  (fromTheme' arg'1')

fromThemeWithFallback :: (M52.QStringValue arg'1, QIconValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO QIcon
...
hasThemeIcon :: (M52.QStringValue arg'1) => arg'1 -> HoppyP.IO HoppyP.Bool
hasThemeIcon arg'1 =
  M52.withQStringPtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
  HoppyP.fmap (/= 0)
  (hasThemeIcon' arg'1')

setThemeName :: (M52.QStringValue arg'1) => arg'1 -> HoppyP.IO ()
setThemeName arg'1 =
  M52.withQStringPtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
  (setThemeName' arg'1')

setThemeSearchPaths :: (M54.QStringListValue arg'1) => arg'1 -> HoppyP.IO ()
setThemeSearchPaths arg'1 =
  M54.withQStringListPtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
  (setThemeSearchPaths' arg'1')
...
newWithFile :: (M52.QStringValue arg'1) => arg'1 -> HoppyP.IO QIcon
newWithFile arg'1 =
  M52.withQStringPtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
  HoppyP.fmap QIcon
  (newWithFile' arg'1')

newWithPixmap :: (M146.QPixmapValue arg'1) => arg'1 -> HoppyP.IO QIcon
newWithPixmap arg'1 =
  M146.withQPixmapPtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
  HoppyP.fmap QIcon
  (newWithPixmap' arg'1')
