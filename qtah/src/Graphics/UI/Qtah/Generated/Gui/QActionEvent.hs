...
foreign import ccall "genpop__QActionEvent_new" new' ::  HoppyFC.CInt -> HoppyF.Ptr M198.QAction -> HoppyP.IO (HoppyF.Ptr QActionEvent)
foreign import ccall "genpop__QActionEvent_newBefore" newBefore' ::  HoppyFC.CInt -> HoppyF.Ptr M198.QAction -> HoppyP.IO (HoppyF.Ptr QActionEvent)
foreign import ccall "genpop__QActionEvent_action" action' ::  HoppyF.Ptr QActionEventConst -> HoppyP.IO (HoppyF.Ptr M198.QAction)
foreign import ccall "genpop__QActionEvent_before" before' ::  HoppyF.Ptr QActionEventConst -> HoppyP.IO (HoppyF.Ptr M198.QAction)
...
action :: (QActionEventValue arg'1) => arg'1 -> HoppyP.IO M198.QAction
action arg'1 =
  withQActionEventPtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
  HoppyP.fmap M198.QAction
  (action' arg'1')

before :: (QActionEventValue arg'1) => arg'1 -> HoppyP.IO M198.QAction
before arg'1 =
  withQActionEventPtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
  HoppyP.fmap M198.QAction
  (before' arg'1')
...
new :: (M198.QActionPtr arg'2) => M20.QEventType -> arg'2 -> HoppyP.IO QActionEvent
new arg'1 arg'2 =
...
newBefore :: (M198.QActionPtr arg'2) => M20.QEventType -> arg'2 -> HoppyP.IO QActionEvent
