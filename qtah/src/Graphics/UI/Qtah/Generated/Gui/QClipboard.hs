...
foreign import ccall "genpop__QClipboard_image" image' ::  HoppyF.Ptr QClipboardConst -> HoppyP.IO (HoppyF.Ptr M122.QImageConst)
foreign import ccall "genpop__QClipboard_imageAll" imageAll' ::  HoppyF.Ptr QClipboardConst -> HoppyFC.CInt -> HoppyP.IO (HoppyF.Ptr M122.QImageConst)
...
foreign import ccall "genpop__QClipboard_pixmap" pixmap' ::  HoppyF.Ptr QClipboardConst -> HoppyP.IO (HoppyF.Ptr M146.QPixmapConst)
foreign import ccall "genpop__QClipboard_pixmapAll" pixmapAll' ::  HoppyF.Ptr QClipboardConst -> HoppyFC.CInt -> HoppyP.IO (HoppyF.Ptr M146.QPixmapConst)
foreign import ccall "genpop__QClipboard_setImage" setImage' ::  HoppyF.Ptr QClipboard -> HoppyF.Ptr M122.QImageConst -> HoppyP.IO ()
foreign import ccall "genpop__QClipboard_setImageAll" setImageAll' ::  HoppyF.Ptr QClipboard -> HoppyF.Ptr M122.QImageConst -> HoppyFC.CInt -> HoppyP.IO ()
foreign import ccall "genpop__QClipboard_setPixmap" setPixmap' ::  HoppyF.Ptr QClipboard -> HoppyF.Ptr M146.QPixmapConst -> HoppyP.IO ()
foreign import ccall "genpop__QClipboard_setPixmapAll" setPixmapAll' ::  HoppyF.Ptr QClipboard -> HoppyF.Ptr M146.QPixmapConst -> HoppyFC.CInt -> HoppyP.IO ()
foreign import ccall "genpop__QClipboard_setText" setText' ::  HoppyF.Ptr QClipboard -> HoppyF.Ptr M52.QStringConst -> HoppyP.IO ()
foreign import ccall "genpop__QClipboard_setTextWithMode" setTextWithMode' ::  HoppyF.Ptr QClipboard -> HoppyF.Ptr M52.QStringConst -> HoppyFC.CInt -> HoppyP.IO ()
...
foreign import ccall "genpop__QClipboard_text" text' ::  HoppyF.Ptr QClipboardConst -> HoppyP.IO (HoppyF.Ptr M52.QStringConst)
foreign import ccall "genpop__QClipboard_textWithMode" textWithMode' ::  HoppyF.Ptr QClipboardConst -> HoppyFC.CInt -> HoppyP.IO (HoppyF.Ptr M52.QStringConst)
foreign import ccall "genpop__QClipboard_textSubtype" textSubtype' ::  HoppyF.Ptr QClipboardConst -> HoppyF.Ptr M52.QString -> HoppyP.IO (HoppyF.Ptr M52.QStringConst)
foreign import ccall "genpop__QClipboard_textSubtypeWithMode" textSubtypeWithMode' ::  HoppyF.Ptr QClipboardConst -> HoppyF.Ptr M52.QString -> HoppyFC.CInt -> HoppyP.IO (HoppyF.Ptr M52.QStringConst)
...
image :: (QClipboardValue arg'1) => arg'1 -> HoppyP.IO M122.QImage
image arg'1 =
  withQClipboardPtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
  (HoppyFHR.decodeAndDelete . M122.QImageConst) =<<
  (image' arg'1')

imageAll :: (QClipboardValue arg'1) => arg'1 -> QClipboardMode -> HoppyP.IO M122.QImage
...
pixmap :: (QClipboardValue arg'1) => arg'1 -> HoppyP.IO M146.QPixmap
pixmap arg'1 =
  withQClipboardPtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
  (HoppyFHR.decodeAndDelete . M146.QPixmapConst) =<<
  (pixmap' arg'1')

pixmapAll :: (QClipboardValue arg'1) => arg'1 -> QClipboardMode -> HoppyP.IO M146.QPixmap
...
textSubtype :: (QClipboardValue arg'1, M52.QStringPtr arg'2) => arg'1 -> arg'2 -> HoppyP.IO QtahP.String
...
textSubtypeWithMode :: (QClipboardValue arg'1, M52.QStringPtr arg'2) => arg'1 -> arg'2 -> QClipboardMode -> HoppyP.IO QtahP.String
...
setImage :: (QClipboardPtr arg'1, M122.QImageValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO ()
setImage arg'1 arg'2 =
  HoppyFHR.withCppPtr (toQClipboard arg'1) $ \arg'1' ->
  M122.withQImagePtr arg'2 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'2' ->
  (setImage' arg'1' arg'2')

setImageAll :: (QClipboardPtr arg'1, M122.QImageValue arg'2) => arg'1 -> arg'2 -> QClipboardMode -> HoppyP.IO ()
...
setPixmap :: (QClipboardPtr arg'1, M146.QPixmapValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO ()
setPixmap arg'1 arg'2 =
  HoppyFHR.withCppPtr (toQClipboard arg'1) $ \arg'1' ->
  M146.withQPixmapPtr arg'2 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'2' ->
  (setPixmap' arg'1' arg'2')

setPixmapAll :: (QClipboardPtr arg'1, M146.QPixmapValue arg'2) => arg'1 -> arg'2 -> QClipboardMode -> HoppyP.IO ()
...
setText :: (QClipboardPtr arg'1, M52.QStringValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO ()
setText arg'1 arg'2 =
  HoppyFHR.withCppPtr (toQClipboard arg'1) $ \arg'1' ->
  M52.withQStringPtr arg'2 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'2' ->
  (setText' arg'1' arg'2')

setTextWithMode :: (QClipboardPtr arg'1, M52.QStringValue arg'2) => arg'1 -> arg'2 -> QClipboardMode -> HoppyP.IO ()
