...
import qualified Graphics.UI.Qtah.Generated.Core.QVector.QPoint as M90
...
foreign import ccall "genpop__QPolygon_newWithPoints" newWithPoints' ::  HoppyF.Ptr M90.QVectorQPointConst -> HoppyP.IO (HoppyF.Ptr QPolygon)
foreign import ccall "genpop__QPolygon_newWithRectangle" newWithRectangle' ::  HoppyF.Ptr M42.QRectConst -> HoppyFHR.CBool -> HoppyP.IO (HoppyF.Ptr QPolygon)
foreign import ccall "genpop__QPolygon_newCopy" newCopy' ::  HoppyF.Ptr QPolygonConst -> HoppyP.IO (HoppyF.Ptr QPolygon)
foreign import ccall "genpop__QPolygon_boundingRect" boundingRect' ::  HoppyF.Ptr QPolygonConst -> HoppyP.IO (HoppyF.Ptr M42.QRectConst)
foreign import ccall "genpop__QPolygon_containsPoint" containsPoint' ::  HoppyF.Ptr QPolygonConst -> HoppyF.Ptr M38.QPointConst -> HoppyFC.CInt -> HoppyP.IO HoppyFHR.CBool
...
foreign import ccall "genpop__QPolygon_point" point' ::  HoppyF.Ptr QPolygonConst -> HoppyFC.CInt -> HoppyP.IO (HoppyF.Ptr M38.QPointConst)
...
foreign import ccall "genpop__QPolygon_setPoint" setPoint' ::  HoppyF.Ptr QPolygon -> HoppyFC.CInt -> HoppyF.Ptr M38.QPointConst -> HoppyP.IO ()
...
foreign import ccall "genpop__QPolygon_translateByPoint" translateByPoint' ::  HoppyF.Ptr QPolygon -> HoppyF.Ptr M38.QPointConst -> HoppyP.IO ()
...
foreign import ccall "genpop__QPolygon_translatedByPoint" translatedByPoint' ::  HoppyF.Ptr QPolygonConst -> HoppyF.Ptr M38.QPointConst -> HoppyP.IO (HoppyF.Ptr QPolygonConst)
...
foreign import ccall "gencast__QPolygon__QVectorQPoint" castQPolygonToQVectorQPoint :: HoppyF.Ptr QPolygonConst -> HoppyF.Ptr M90.QVectorQPointConst
...
class (M90.QVectorQPointConstPtr this) => QPolygonConstPtr this where
...
containsPoint :: (QPolygonValue arg'1, M38.QPointValue arg'2) => arg'1 -> arg'2 -> M66.QtFillRule -> HoppyP.IO HoppyP.Bool
...
translatedByPoint :: (QPolygonValue arg'1, M38.QPointValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO QPolygon
...
class (QPolygonConstPtr this, M90.QVectorQPointPtr this) => QPolygonPtr this where
...
setPoint :: (QPolygonPtr arg'1, M38.QPointValue arg'3) => arg'1 -> HoppyP.Int -> arg'3 -> HoppyP.IO ()
...
translateByPoint :: (QPolygonPtr arg'1, M38.QPointValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO ()
...
instance M90.QVectorQPointConstPtr QPolygonConst where
  toQVectorQPointConst (QPolygonConst ptr') = M90.QVectorQPointConst $ castQPolygonToQVectorQPoint ptr'
  toQVectorQPointConst (QPolygonConstGc fptr' ptr') = M90.QVectorQPointConstGc fptr' $ castQPolygonToQVectorQPoint ptr'
...
instance M90.QVectorQPointConstPtr QPolygon where
  toQVectorQPointConst (QPolygon ptr') = M90.QVectorQPointConst $ castQPolygonToQVectorQPoint $ (HoppyF.castPtr :: HoppyF.Ptr QPolygon -> HoppyF.Ptr QPolygonConst) ptr'
  toQVectorQPointConst (QPolygonGc fptr' ptr') = M90.QVectorQPointConstGc fptr' $ castQPolygonToQVectorQPoint $ (HoppyF.castPtr :: HoppyF.Ptr QPolygon -> HoppyF.Ptr QPolygonConst) ptr'

instance M90.QVectorQPointPtr QPolygon where
  toQVectorQPoint (QPolygon ptr') = M90.QVectorQPoint $ (HoppyF.castPtr :: HoppyF.Ptr M90.QVectorQPointConst -> HoppyF.Ptr M90.QVectorQPoint) $ castQPolygonToQVectorQPoint $ (HoppyF.castPtr :: HoppyF.Ptr QPolygon -> HoppyF.Ptr QPolygonConst) ptr'
  toQVectorQPoint (QPolygonGc fptr' ptr') = M90.QVectorQPointGc fptr' $ (HoppyF.castPtr :: HoppyF.Ptr M90.QVectorQPointConst -> HoppyF.Ptr M90.QVectorQPoint) $ castQPolygonToQVectorQPoint $ (HoppyF.castPtr :: HoppyF.Ptr QPolygon -> HoppyF.Ptr QPolygonConst) ptr'
...
newWithPoints :: (M90.QVectorQPointValue arg'1) => arg'1 -> HoppyP.IO QPolygon
newWithPoints arg'1 =
  M90.withQVectorQPointPtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
  HoppyP.fmap QPolygon
  (newWithPoints' arg'1')

newWithRectangle :: (M42.QRectValue arg'1) => arg'1 -> HoppyP.Bool -> HoppyP.IO QPolygon
