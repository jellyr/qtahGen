...
foreign import ccall "genpop__QExposeEvent_new" new' ::  HoppyF.Ptr M154.QRegionConst -> HoppyP.IO (HoppyF.Ptr QExposeEvent)
foreign import ccall "genpop__QExposeEvent_region" region' ::  HoppyF.Ptr QExposeEventConst -> HoppyP.IO (HoppyF.Ptr M154.QRegionConst)
...
region :: (QExposeEventValue arg'1) => arg'1 -> HoppyP.IO M154.QRegion
region arg'1 =
...
new :: (M154.QRegionValue arg'1) => arg'1 -> HoppyP.IO QExposeEvent
new arg'1 =
