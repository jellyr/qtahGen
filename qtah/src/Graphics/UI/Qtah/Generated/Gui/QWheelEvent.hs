...
foreign import ccall "genpop__QWheelEvent_new" new' ::  HoppyF.Ptr M40.QPointFConst -> HoppyF.Ptr M40.QPointFConst -> HoppyF.Ptr M38.QPointConst -> HoppyF.Ptr M38.QPointConst -> HoppyFC.CInt -> HoppyFC.CInt -> HoppyFC.CInt -> HoppyFC.CInt -> HoppyP.IO (HoppyF.Ptr QWheelEvent)
foreign import ccall "genpop__QWheelEvent_newWithPhase" newWithPhase' ::  HoppyF.Ptr M40.QPointFConst -> HoppyF.Ptr M40.QPointFConst -> HoppyF.Ptr M38.QPointConst -> HoppyF.Ptr M38.QPointConst -> HoppyFC.CInt -> HoppyFC.CInt -> HoppyFC.CInt -> HoppyFC.CInt -> HoppyFC.CInt -> HoppyP.IO (HoppyF.Ptr QWheelEvent)
foreign import ccall "genpop__QWheelEvent_angleDelta" angleDelta' ::  HoppyF.Ptr QWheelEventConst -> HoppyP.IO (HoppyF.Ptr M38.QPointConst)
foreign import ccall "genpop__QWheelEvent_buttons" buttons' ::  HoppyF.Ptr QWheelEventConst -> HoppyP.IO HoppyFC.CInt
foreign import ccall "genpop__QWheelEvent_globalPos" globalPos' ::  HoppyF.Ptr QWheelEventConst -> HoppyP.IO (HoppyF.Ptr M38.QPointConst)
foreign import ccall "genpop__QWheelEvent_globalPosF" globalPosF' ::  HoppyF.Ptr QWheelEventConst -> HoppyP.IO (HoppyF.Ptr M40.QPointFConst)
...
foreign import ccall "genpop__QWheelEvent_pixelDelta" pixelDelta' ::  HoppyF.Ptr QWheelEventConst -> HoppyP.IO (HoppyF.Ptr M38.QPointConst)
foreign import ccall "genpop__QWheelEvent_pos" pos' ::  HoppyF.Ptr QWheelEventConst -> HoppyP.IO (HoppyF.Ptr M38.QPointConst)
foreign import ccall "genpop__QWheelEvent_posF" posF' ::  HoppyF.Ptr QWheelEventConst -> HoppyP.IO (HoppyF.Ptr M40.QPointFConst)
...
foreign import ccall "gencast__QWheelEvent__QInputEvent" castQWheelEventToQInputEvent :: HoppyF.Ptr QWheelEventConst -> HoppyF.Ptr M124.QInputEventConst
foreign import ccall "gencast__QInputEvent__QWheelEvent" castQInputEventToQWheelEvent :: HoppyF.Ptr M124.QInputEventConst -> HoppyF.Ptr QWheelEventConst
...
class (M124.QInputEventConstPtr this) => QWheelEventConstPtr this where
...
buttons :: (QWheelEventValue arg'1) => arg'1 -> HoppyP.IO M66.QtMouseButtons
buttons arg'1 =
  withQWheelEventPtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
...
phase :: (QWheelEventValue arg'1) => arg'1 -> HoppyP.IO M66.QtScrollPhase
phase arg'1 =
  withQWheelEventPtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
...
class (QWheelEventConstPtr this, M124.QInputEventPtr this) => QWheelEventPtr this where
...
instance M124.QInputEventConstPtr QWheelEventConst where
  toQInputEventConst (QWheelEventConst ptr') = M124.QInputEventConst $ castQWheelEventToQInputEvent ptr'
  toQInputEventConst (QWheelEventConstGc fptr' ptr') = M124.QInputEventConstGc fptr' $ castQWheelEventToQInputEvent ptr'
...
instance M124.QInputEventConstPtr QWheelEvent where
  toQInputEventConst (QWheelEvent ptr') = M124.QInputEventConst $ castQWheelEventToQInputEvent $ (HoppyF.castPtr :: HoppyF.Ptr QWheelEvent -> HoppyF.Ptr QWheelEventConst) ptr'
  toQInputEventConst (QWheelEventGc fptr' ptr') = M124.QInputEventConstGc fptr' $ castQWheelEventToQInputEvent $ (HoppyF.castPtr :: HoppyF.Ptr QWheelEvent -> HoppyF.Ptr QWheelEventConst) ptr'

instance M124.QInputEventPtr QWheelEvent where
  toQInputEvent (QWheelEvent ptr') = M124.QInputEvent $ (HoppyF.castPtr :: HoppyF.Ptr M124.QInputEventConst -> HoppyF.Ptr M124.QInputEvent) $ castQWheelEventToQInputEvent $ (HoppyF.castPtr :: HoppyF.Ptr QWheelEvent -> HoppyF.Ptr QWheelEventConst) ptr'
  toQInputEvent (QWheelEventGc fptr' ptr') = M124.QInputEventGc fptr' $ (HoppyF.castPtr :: HoppyF.Ptr M124.QInputEventConst -> HoppyF.Ptr M124.QInputEvent) $ castQWheelEventToQInputEvent $ (HoppyF.castPtr :: HoppyF.Ptr QWheelEvent -> HoppyF.Ptr QWheelEventConst) ptr'
...
new :: (M40.QPointFValue arg'1, M40.QPointFValue arg'2, M38.QPointValue arg'3, M38.QPointValue arg'4, M66.IsQtMouseButtons arg'7, M66.IsQtKeyboardModifiers arg'8) => arg'1 -> arg'2 -> arg'3 -> arg'4 -> HoppyP.Int -> M66.QtOrientation -> arg'7 -> arg'8 -> HoppyP.IO QWheelEvent
new arg'1 arg'2 arg'3 arg'4 arg'5 arg'6 arg'7 arg'8 =
  ...
  let arg'7' = M66.fromQtMouseButtons $ M66.toQtMouseButtons arg'7 in
  let arg'8' = M66.fromQtKeyboardModifiers $ M66.toQtKeyboardModifiers arg'8 in
  HoppyP.fmap QWheelEvent
  (new' arg'1' arg'2' arg'3' arg'4' arg'5' arg'6' arg'7' arg'8')

newWithPhase :: (M40.QPointFValue arg'1, M40.QPointFValue arg'2, M38.QPointValue arg'3, M38.QPointValue arg'4, M66.IsQtMouseButtons arg'7, M66.IsQtKeyboardModifiers arg'8) => arg'1 -> arg'2 -> arg'3 -> arg'4 -> HoppyP.Int -> M66.QtOrientation -> arg'7 -> arg'8 -> M66.QtScrollPhase -> HoppyP.IO QWheelEvent
...
instance QWheelEventSuper M124.QInputEvent where
  downToQWheelEvent = castQWheelEventToNonconst . cast' . M124.castQInputEventToConst
    where
      cast' (M124.QInputEventConst ptr') = QWheelEventConst $ castQInputEventToQWheelEvent ptr'
      cast' (M124.QInputEventConstGc fptr' ptr') = QWheelEventConstGc fptr' $ castQInputEventToQWheelEvent ptr'
...
instance QWheelEventSuperConst M124.QInputEventConst where
