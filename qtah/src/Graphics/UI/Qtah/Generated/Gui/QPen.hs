...
foreign import ccall "genpop__QPen_newWithColor" newWithColor' ::  HoppyF.Ptr M104.QColorConst -> HoppyP.IO (HoppyF.Ptr QPen)
...
newWithColor :: (M104.QColorValue arg'1) => arg'1 -> HoppyP.IO QPen
newWithColor arg'1 =
