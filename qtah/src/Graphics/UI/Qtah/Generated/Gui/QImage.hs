...
import qualified Graphics.UI.Qtah.Generated.Core.QVector.QRgb as M94
import qualified Graphics.UI.Qtah.Generated.Core.Types as M66
import qualified Graphics.UI.Qtah.Generated.Gui.QColor as M104
...
import {-# SOURCE #-} qualified Graphics.UI.Qtah.Internal.Callback as M178
import Prelude (($), (++), (.), (/=), (=<<), (==), (>>), (>>=))
import qualified Prelude as HoppyP
import qualified Prelude as QtahP

foreign import ccall "genpop__QImage_new" new' ::  HoppyP.IO (HoppyF.Ptr QImage)
foreign import ccall "genpop__QImage_newWithSize" newWithSize' ::  HoppyF.Ptr M48.QSizeConst -> HoppyFC.CInt -> HoppyP.IO (HoppyF.Ptr QImage)
...
foreign import ccall "genpop__QImage_newWithFile" newWithFile' ::  HoppyF.Ptr M52.QStringConst -> HoppyP.IO (HoppyF.Ptr QImage)
...
foreign import ccall "genpop__QImage_newWithFileAndFormat" newWithFileAndFormat' ::  HoppyF.Ptr M52.QStringConst -> HoppyF.Ptr M52.QStringConst -> HoppyP.IO (HoppyF.Ptr QImage)
...
foreign import ccall "genpop__QImage_colorTable" colorTable' ::  HoppyF.Ptr QImageConst -> HoppyP.IO (HoppyF.Ptr M94.QVectorQRgb)
...
foreign import ccall "genpop__QImage_copyRect" copyRect' ::  HoppyF.Ptr QImageConst -> HoppyF.Ptr M42.QRectConst -> HoppyP.IO (HoppyF.Ptr QImageConst)
...
foreign import ccall "genpop__QImage_fillWithColor" fillWithColor' ::  HoppyF.Ptr QImage -> HoppyF.Ptr M104.QColorConst -> HoppyP.IO ()
...
foreign import ccall "genpop__QImage_fromDataByteArrayWithFormat" fromDataByteArrayWithFormat' ::  HoppyF.Ptr M8.QByteArrayConst -> HoppyF.Ptr M52.QStringConst -> HoppyP.IO (HoppyF.Ptr QImage)
...
foreign import ccall "genpop__QImage_fromDataRawWithFormat" fromDataRawWithFormat' ::  HoppyF.Ptr HoppyFC.CUChar -> HoppyFC.CInt -> HoppyF.Ptr M52.QStringConst -> HoppyP.IO (HoppyF.Ptr QImage)
...
foreign import ccall "genpop__QImage_load" load' ::  HoppyF.Ptr QImage -> HoppyF.Ptr M52.QStringConst -> HoppyP.IO HoppyFHR.CBool
foreign import ccall "genpop__QImage_loadWithFormat" loadWithFormat' ::  HoppyF.Ptr QImage -> HoppyF.Ptr M52.QStringConst -> HoppyF.Ptr M52.QStringConst -> HoppyP.IO HoppyFHR.CBool
...
foreign import ccall "genpop__QImage_loadFromDataByteArrayWithFormat" loadFromDataByteArrayWithFormat' ::  HoppyF.Ptr QImage -> HoppyF.Ptr M8.QByteArrayConst -> HoppyF.Ptr M52.QStringConst -> HoppyP.IO HoppyFHR.CBool
...
foreign import ccall "genpop__QImage_loadFromDataRawWithFormat" loadFromDataRawWithFormat' ::  HoppyF.Ptr QImage -> HoppyF.Ptr HoppyFC.CUChar -> HoppyFC.CInt -> HoppyF.Ptr M52.QStringConst -> HoppyP.IO HoppyFHR.CBool
...
foreign import ccall "genpop__QImage_offset" offset' ::  HoppyF.Ptr QImageConst -> HoppyP.IO (HoppyF.Ptr M38.QPointConst)
foreign import ccall "genpop__QImage_setOffset" setOffset' ::  HoppyF.Ptr QImage -> HoppyF.Ptr M38.QPointConst -> HoppyP.IO ()
foreign import ccall "genpop__QImage_pixelAtPoint" pixelAtPoint' ::  HoppyF.Ptr QImageConst -> HoppyF.Ptr M38.QPointConst -> HoppyP.IO HoppyFC.CUInt
...
foreign import ccall "genpop__QImage_pixelColorAtPoint" pixelColorAtPoint' ::  HoppyF.Ptr QImageConst -> HoppyF.Ptr M38.QPointConst -> HoppyP.IO (HoppyF.Ptr M104.QColorConst)
foreign import ccall "genpop__QImage_pixelColorAtRaw" pixelColorAtRaw' ::  HoppyF.Ptr QImageConst -> HoppyFC.CInt -> HoppyFC.CInt -> HoppyP.IO (HoppyF.Ptr M104.QColorConst)
foreign import ccall "genpop__QImage_pixelIndexAtPoint" pixelIndexAtPoint' ::  HoppyF.Ptr QImageConst -> HoppyF.Ptr M38.QPointConst -> HoppyP.IO HoppyFC.CInt
...
foreign import ccall "genpop__QImage_rect" rect' ::  HoppyF.Ptr QImageConst -> HoppyP.IO (HoppyF.Ptr M42.QRectConst)
foreign import ccall "genpop__QImage_rgbSwapped" rgbSwapped' ::  HoppyF.Ptr QImageConst -> HoppyP.IO (HoppyF.Ptr QImageConst)
foreign import ccall "genpop__QImage_save" save' ::  HoppyF.Ptr QImage -> HoppyF.Ptr M52.QStringConst -> HoppyP.IO HoppyFHR.CBool
foreign import ccall "genpop__QImage_saveAll" saveAll' ::  HoppyF.Ptr QImage -> HoppyF.Ptr M52.QStringConst -> HoppyF.Ptr M52.QStringConst -> HoppyFC.CInt -> HoppyP.IO HoppyFHR.CBool
foreign import ccall "genpop__QImage_scaled" scaled' ::  HoppyF.Ptr QImageConst -> HoppyF.Ptr M48.QSizeConst -> HoppyP.IO (HoppyF.Ptr QImageConst)
foreign import ccall "genpop__QImage_scaledAll" scaledAll' ::  HoppyF.Ptr QImageConst -> HoppyF.Ptr M48.QSizeConst -> HoppyFC.CInt -> HoppyFC.CInt -> HoppyP.IO (HoppyF.Ptr QImageConst)
...
foreign import ccall "genpop__QImage_setColorTable" setColorTable' ::  HoppyF.Ptr QImage -> HoppyF.Ptr M94.QVectorQRgbConst -> HoppyP.IO ()
foreign import ccall "genpop__QImage_setPixelAtPoint" setPixelAtPoint' ::  HoppyF.Ptr QImage -> HoppyF.Ptr M38.QPointConst -> HoppyFC.CUInt -> HoppyP.IO ()
...
foreign import ccall "genpop__QImage_setPixelColorAtPoint" setPixelColorAtPoint' ::  HoppyF.Ptr QImage -> HoppyF.Ptr M38.QPointConst -> HoppyF.Ptr M104.QColorConst -> HoppyP.IO ()
foreign import ccall "genpop__QImage_setPixelColorAtRaw" setPixelColorAtRaw' ::  HoppyF.Ptr QImage -> HoppyFC.CInt -> HoppyFC.CInt -> HoppyF.Ptr M104.QColorConst -> HoppyP.IO ()
foreign import ccall "genpop__QImage_setText" setText' ::  HoppyF.Ptr QImage -> HoppyF.Ptr M52.QStringConst -> HoppyF.Ptr M52.QStringConst -> HoppyP.IO ()
foreign import ccall "genpop__QImage_size" size' ::  HoppyF.Ptr QImageConst -> HoppyP.IO (HoppyF.Ptr M48.QSizeConst)
foreign import ccall "genpop__QImage_swap" swap' ::  HoppyF.Ptr QImage -> HoppyF.Ptr QImage -> HoppyP.IO ()
foreign import ccall "genpop__QImage_text" text' ::  HoppyF.Ptr QImageConst -> HoppyF.Ptr M52.QStringConst -> HoppyP.IO (HoppyF.Ptr M52.QStringConst)
foreign import ccall "genpop__QImage_textKeys" textKeys' ::  HoppyF.Ptr QImageConst -> HoppyP.IO (HoppyF.Ptr M54.QStringListConst)
foreign import ccall "genpop__QImage_transformedWithTransform" transformedWithTransform' ::  HoppyF.Ptr QImageConst -> HoppyF.Ptr M166.QTransformConst -> HoppyP.IO (HoppyF.Ptr QImageConst)
foreign import ccall "genpop__QImage_transformedWithTransformAll" transformedWithTransformAll' ::  HoppyF.Ptr QImageConst -> HoppyF.Ptr M166.QTransformConst -> HoppyFC.CInt -> HoppyP.IO (HoppyF.Ptr QImageConst)
foreign import ccall "genpop__QImage_trueMatrixWithTransform" trueMatrixWithTransform' ::  HoppyF.Ptr M166.QTransformConst -> HoppyFC.CInt -> HoppyFC.CInt -> HoppyP.IO (HoppyF.Ptr M166.QTransformConst)
foreign import ccall "genpop__QImage_validAtPoint" validAtPoint' ::  HoppyF.Ptr QImageConst -> HoppyF.Ptr M38.QPointConst -> HoppyP.IO HoppyFHR.CBool
...
foreign import ccall "gencast__QImage__QPaintDevice" castQImageToQPaintDevice :: HoppyF.Ptr QImageConst -> HoppyF.Ptr M134.QPaintDeviceConst
foreign import ccall "gencast__QPaintDevice__QImage" castQPaintDeviceToQImage :: HoppyF.Ptr M134.QPaintDeviceConst -> HoppyF.Ptr QImageConst
...
class (M134.QPaintDeviceConstPtr this) => QImageConstPtr this where
...
colorTable :: (QImageValue arg'1) => arg'1 -> HoppyP.IO M94.QVectorQRgb
colorTable arg'1 =
  withQImagePtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
  HoppyFHR.toGc =<<
  HoppyP.fmap M94.QVectorQRgb
  (colorTable' arg'1')
...
copyRect :: (QImageValue arg'1, M42.QRectValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO QImage
...
createMaskFromColorWithMode :: (QImageValue arg'1) => arg'1 -> HoppyFC.CUInt -> M66.QtMaskMode -> HoppyP.IO QImage
...
pixelAtPoint :: (QImageValue arg'1, M38.QPointValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO HoppyFC.CUInt
...
pixelColorAtPoint :: (QImageValue arg'1, M38.QPointValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO HColor.HColor
pixelColorAtPoint arg'1 arg'2 =
  withQImagePtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
  M38.withQPointPtr arg'2 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'2' ->
  (HoppyFHR.decodeAndDelete . M104.QColorConst) =<<
  (pixelColorAtPoint' arg'1' arg'2')
...
pixelIndexAtPoint :: (QImageValue arg'1, M38.QPointValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO HoppyP.Int
...
scaled :: (QImageValue arg'1, M48.QSizeValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO QImage
scaled arg'1 arg'2 =
  withQImagePtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
...
scaledAll :: (QImageValue arg'1, M48.QSizeValue arg'2) => arg'1 -> arg'2 -> M66.QtAspectRatioMode -> M66.QtTransformationMode -> HoppyP.IO QImage
...
scaledWithRawAll :: (QImageValue arg'1) => arg'1 -> HoppyP.Int -> HoppyP.Int -> M66.QtAspectRatioMode -> M66.QtTransformationMode -> HoppyP.IO QImage
...
scaledToHeightAll :: (QImageValue arg'1) => arg'1 -> HoppyP.Int -> M66.QtTransformationMode -> HoppyP.IO QImage
...
scaledToWidthAll :: (QImageValue arg'1) => arg'1 -> HoppyP.Int -> M66.QtTransformationMode -> HoppyP.IO QImage
...
text :: (QImageValue arg'1, M52.QStringValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO QtahP.String
text arg'1 arg'2 =
  withQImagePtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
...
transformedWithTransform :: (QImageValue arg'1, M166.QTransformValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO QImage
...
transformedWithTransformAll :: (QImageValue arg'1, M166.QTransformValue arg'2) => arg'1 -> arg'2 -> M66.QtTransformationMode -> HoppyP.IO QImage
...
validAtPoint :: (QImageValue arg'1, M38.QPointValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO HoppyP.Bool
...
class (QImageConstPtr this, M134.QPaintDevicePtr this) => QImagePtr this where
...
fillWithColor :: (QImagePtr arg'1, M104.QColorValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO ()
fillWithColor arg'1 arg'2 =
  HoppyFHR.withCppPtr (toQImage arg'1) $ \arg'1' ->
  M104.withQColorPtr arg'2 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'2' ->
  (fillWithColor' arg'1' arg'2')

fillWithGlobalColor :: (QImagePtr arg'1) => arg'1 -> M66.QtGlobalColor -> HoppyP.IO ()
...
load :: (QImagePtr arg'1, M52.QStringValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO HoppyP.Bool
load arg'1 arg'2 =
  HoppyFHR.withCppPtr (toQImage arg'1) $ \arg'1' ->
  M52.withQStringPtr arg'2 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'2' ->
  HoppyP.fmap (/= 0)
...
setOffset :: (QImagePtr arg'1, M38.QPointValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO ()
setOffset arg'1 arg'2 =
  HoppyFHR.withCppPtr (toQImage arg'1) $ \arg'1' ->
  M38.withQPointPtr arg'2 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'2' ->
  (setOffset' arg'1' arg'2')

save :: (QImagePtr arg'1, M52.QStringValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO HoppyP.Bool
save arg'1 arg'2 =
  HoppyFHR.withCppPtr (toQImage arg'1) $ \arg'1' ->
  M52.withQStringPtr arg'2 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'2' ->
  HoppyP.fmap (/= 0)
...
setColorTable :: (QImagePtr arg'1, M94.QVectorQRgbValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO ()
setColorTable arg'1 arg'2 =
  HoppyFHR.withCppPtr (toQImage arg'1) $ \arg'1' ->
  M94.withQVectorQRgbPtr arg'2 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'2' ->
  (setColorTable' arg'1' arg'2')

setPixelAtPoint :: (QImagePtr arg'1, M38.QPointValue arg'2) => arg'1 -> arg'2 -> HoppyFC.CUInt -> HoppyP.IO ()
...
setPixelColorAtPoint :: (QImagePtr arg'1, M38.QPointValue arg'2, M104.QColorValue arg'3) => arg'1 -> arg'2 -> arg'3 -> HoppyP.IO ()
setPixelColorAtPoint arg'1 arg'2 arg'3 =
  HoppyFHR.withCppPtr (toQImage arg'1) $ \arg'1' ->
  M38.withQPointPtr arg'2 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'2' ->
  M104.withQColorPtr arg'3 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'3' ->
  (setPixelColorAtPoint' arg'1' arg'2' arg'3')

setPixelColorAtRaw :: (QImagePtr arg'1, M104.QColorValue arg'4) => arg'1 -> HoppyP.Int -> HoppyP.Int -> arg'4 -> HoppyP.IO ()
setPixelColorAtRaw arg'1 arg'2 arg'3 arg'4 =
  HoppyFHR.withCppPtr (toQImage arg'1) $ \arg'1' ->
  let arg'2' = HoppyFHR.coerceIntegral arg'2 in
  let arg'3' = HoppyFHR.coerceIntegral arg'3 in
  M104.withQColorPtr arg'4 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'4' ->
  (setPixelColorAtRaw' arg'1' arg'2' arg'3' arg'4')

setText :: (QImagePtr arg'1, M52.QStringValue arg'2, M52.QStringValue arg'3) => arg'1 -> arg'2 -> arg'3 -> HoppyP.IO ()
...
newWithDataAndCleanup arg'1 arg'2 arg'3 arg'4 arg'5 =
  ...
  let arg'3' = HoppyFHR.coerceIntegral arg'3 in
  let arg'4' = HoppyFHR.coerceIntegral $ HoppyP.fromEnum arg'4 in
  M178.callbackVoid_new arg'5 >>= \arg'5' ->
  HoppyP.fmap QImage
  (newWithDataAndCleanup' arg'1' arg'2' arg'3' arg'4' arg'5')
...
newWithDataAndBytesPerLineAndCleanup arg'1 arg'2 arg'3 arg'4 arg'5 arg'6 =
  ...
  let arg'4' = HoppyFHR.coerceIntegral arg'4 in
  let arg'5' = HoppyFHR.coerceIntegral $ HoppyP.fromEnum arg'5 in
  M178.callbackVoid_new arg'6 >>= \arg'6' ->
  HoppyP.fmap QImage
  (newWithDataAndBytesPerLineAndCleanup' arg'1' arg'2' arg'3' arg'4' arg'5' arg'6')
...
newWithFileAndFormat :: (M52.QStringValue arg'1, M52.QStringValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO QImage
newWithFileAndFormat arg'1 arg'2 =
  M52.withQStringPtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
  M52.withQStringPtr arg'2 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'2' ->
  HoppyP.fmap QImage
  (newWithFileAndFormat' arg'1' arg'2')
...
fromDataByteArrayWithFormat :: (M8.QByteArrayValue arg'1, M52.QStringValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO QImage
...
fromDataRawWithFormat :: (M52.QStringValue arg'3) => HoppyF.Ptr HoppyFC.CUChar -> HoppyP.Int -> arg'3 -> HoppyP.IO QImage
...
loadWithFormat :: (QImagePtr arg'1, M52.QStringValue arg'2, M52.QStringValue arg'3) => arg'1 -> arg'2 -> arg'3 -> HoppyP.IO HoppyP.Bool
...
loadFromDataByteArrayWithFormat :: (QImagePtr arg'1, M8.QByteArrayValue arg'2, M52.QStringValue arg'3) => arg'1 -> arg'2 -> arg'3 -> HoppyP.IO HoppyP.Bool
...
loadFromDataRawWithFormat :: (QImagePtr arg'1, M52.QStringValue arg'4) => arg'1 -> HoppyF.Ptr HoppyFC.CUChar -> HoppyP.Int -> arg'4 -> HoppyP.IO HoppyP.Bool
...
saveAll :: (QImagePtr arg'1, M52.QStringValue arg'2, M52.QStringValue arg'3) => arg'1 -> arg'2 -> arg'3 -> HoppyP.Int -> HoppyP.IO HoppyP.Bool
...
trueMatrixWithTransform :: (M166.QTransformValue arg'1) => arg'1 -> HoppyP.Int -> HoppyP.Int -> HoppyP.IO M166.QTransform
trueMatrixWithTransform arg'1 arg'2 arg'3 =
  M166.withQTransformPtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
  let arg'2' = HoppyFHR.coerceIntegral arg'2 in
  let arg'3' = HoppyFHR.coerceIntegral arg'3 in
...
instance M134.QPaintDeviceConstPtr QImageConst where
  toQPaintDeviceConst (QImageConst ptr') = M134.QPaintDeviceConst $ castQImageToQPaintDevice ptr'
  toQPaintDeviceConst (QImageConstGc fptr' ptr') = M134.QPaintDeviceConstGc fptr' $ castQImageToQPaintDevice ptr'
...
instance M134.QPaintDeviceConstPtr QImage where
  toQPaintDeviceConst (QImage ptr') = M134.QPaintDeviceConst $ castQImageToQPaintDevice $ (HoppyF.castPtr :: HoppyF.Ptr QImage -> HoppyF.Ptr QImageConst) ptr'
  toQPaintDeviceConst (QImageGc fptr' ptr') = M134.QPaintDeviceConstGc fptr' $ castQImageToQPaintDevice $ (HoppyF.castPtr :: HoppyF.Ptr QImage -> HoppyF.Ptr QImageConst) ptr'

instance M134.QPaintDevicePtr QImage where
  toQPaintDevice (QImage ptr') = M134.QPaintDevice $ (HoppyF.castPtr :: HoppyF.Ptr M134.QPaintDeviceConst -> HoppyF.Ptr M134.QPaintDevice) $ castQImageToQPaintDevice $ (HoppyF.castPtr :: HoppyF.Ptr QImage -> HoppyF.Ptr QImageConst) ptr'
  toQPaintDevice (QImageGc fptr' ptr') = M134.QPaintDeviceGc fptr' $ (HoppyF.castPtr :: HoppyF.Ptr M134.QPaintDeviceConst -> HoppyF.Ptr M134.QPaintDevice) $ castQImageToQPaintDevice $ (HoppyF.castPtr :: HoppyF.Ptr QImage -> HoppyF.Ptr QImageConst) ptr'
...
newWithSize :: (M48.QSizeValue arg'1) => arg'1 -> QImageFormat -> HoppyP.IO QImage
newWithSize arg'1 arg'2 =
  M48.withQSizePtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
  let arg'2' = HoppyFHR.coerceIntegral $ HoppyP.fromEnum arg'2 in
  HoppyP.fmap QImage
  (newWithSize' arg'1' arg'2')
...
newWithFile :: (M52.QStringValue arg'1) => arg'1 -> HoppyP.IO QImage
newWithFile arg'1 =
  M52.withQStringPtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
  HoppyP.fmap QImage
  (newWithFile' arg'1')
...
instance QImageSuper M134.QPaintDevice where
  downToQImage = castQImageToNonconst . cast' . M134.castQPaintDeviceToConst
    where
      cast' (M134.QPaintDeviceConst ptr') = QImageConst $ castQPaintDeviceToQImage ptr'
      cast' (M134.QPaintDeviceConstGc fptr' ptr') = QImageConstGc fptr' $ castQPaintDeviceToQImage ptr'

class QImageSuperConst a where
  downToQImageConst :: a -> QImageConst

instance QImageSuperConst M134.QPaintDeviceConst where
