...
foreign import ccall "genpop__QEnterEvent_new" new' ::  HoppyF.Ptr M40.QPointFConst -> HoppyF.Ptr M40.QPointFConst -> HoppyF.Ptr M40.QPointFConst -> HoppyP.IO (HoppyF.Ptr QEnterEvent)
foreign import ccall "genpop__QEnterEvent_globalPos" globalPos' ::  HoppyF.Ptr QEnterEventConst -> HoppyP.IO (HoppyF.Ptr M38.QPointConst)
...
foreign import ccall "genpop__QEnterEvent_localPos" localPos' ::  HoppyF.Ptr QEnterEventConst -> HoppyP.IO (HoppyF.Ptr M40.QPointFConst)
foreign import ccall "genpop__QEnterEvent_pos" pos' ::  HoppyF.Ptr QEnterEventConst -> HoppyP.IO (HoppyF.Ptr M38.QPointConst)
foreign import ccall "genpop__QEnterEvent_screenPos" screenPos' ::  HoppyF.Ptr QEnterEventConst -> HoppyP.IO (HoppyF.Ptr M40.QPointFConst)
foreign import ccall "genpop__QEnterEvent_windowPos" windowPos' ::  HoppyF.Ptr QEnterEventConst -> HoppyP.IO (HoppyF.Ptr M40.QPointFConst)
...
new :: (M40.QPointFValue arg'1, M40.QPointFValue arg'2, M40.QPointFValue arg'3) => arg'1 -> arg'2 -> arg'3 -> HoppyP.IO QEnterEvent
