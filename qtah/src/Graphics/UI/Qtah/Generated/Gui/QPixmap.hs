...
import {-# SOURCE #-} qualified Graphics.UI.Qtah.Generated.Gui.QImage as M122
...
foreign import ccall "genpop__QPixmap_newWithSize" newWithSize' ::  HoppyF.Ptr M48.QSizeConst -> HoppyP.IO (HoppyF.Ptr QPixmap)
...
foreign import ccall "genpop__QPixmap_newWithFile" newWithFile' ::  HoppyF.Ptr M52.QStringConst -> HoppyP.IO (HoppyF.Ptr QPixmap)
...
foreign import ccall "genpop__QPixmap_convertFromImage" convertFromImage' ::  HoppyF.Ptr QPixmap -> HoppyF.Ptr M122.QImageConst -> HoppyP.IO HoppyFHR.CBool
foreign import ccall "genpop__QPixmap_convertFromImageAll" convertFromImageAll' ::  HoppyF.Ptr QPixmap -> HoppyF.Ptr M122.QImageConst -> HoppyFC.CInt -> HoppyP.IO HoppyFHR.CBool
foreign import ccall "genpop__QPixmap_copyRect" copyRect' ::  HoppyF.Ptr QPixmapConst -> HoppyF.Ptr M42.QRectConst -> HoppyP.IO (HoppyF.Ptr QPixmapConst)
...
foreign import ccall "genpop__QPixmap_fillWithColor" fillWithColor' ::  HoppyF.Ptr QPixmap -> HoppyF.Ptr M104.QColorConst -> HoppyP.IO ()
foreign import ccall "genpop__QPixmap_fromImage" fromImage' ::  HoppyF.Ptr M122.QImageConst -> HoppyP.IO (HoppyF.Ptr QPixmapConst)
foreign import ccall "genpop__QPixmap_fromImageAll" fromImageAll' ::  HoppyF.Ptr M122.QImageConst -> HoppyFC.CInt -> HoppyP.IO (HoppyF.Ptr QPixmapConst)
...
foreign import ccall "genpop__QPixmap_load" load' ::  HoppyF.Ptr QPixmap -> HoppyF.Ptr M52.QStringConst -> HoppyP.IO HoppyFHR.CBool
foreign import ccall "genpop__QPixmap_rect" rect' ::  HoppyF.Ptr QPixmapConst -> HoppyP.IO (HoppyF.Ptr M42.QRectConst)
foreign import ccall "genpop__QPixmap_save" save' ::  HoppyF.Ptr QPixmapConst -> HoppyF.Ptr M52.QStringConst -> HoppyP.IO HoppyFHR.CBool
...
foreign import ccall "genpop__QPixmap_scaledSize" scaledSize' ::  HoppyF.Ptr QPixmapConst -> HoppyF.Ptr M48.QSizeConst -> HoppyP.IO (HoppyF.Ptr QPixmapConst)
foreign import ccall "genpop__QPixmap_scaledSizeAll" scaledSizeAll' ::  HoppyF.Ptr QPixmapConst -> HoppyF.Ptr M48.QSizeConst -> HoppyFC.CInt -> HoppyFC.CInt -> HoppyP.IO (HoppyF.Ptr QPixmapConst)
...
foreign import ccall "genpop__QPixmap_scrollRawAll" scrollRawAll' ::  HoppyF.Ptr QPixmap -> HoppyFC.CInt -> HoppyFC.CInt -> HoppyFC.CInt -> HoppyFC.CInt -> HoppyFC.CInt -> HoppyFC.CInt -> HoppyF.Ptr M154.QRegion -> HoppyP.IO ()
foreign import ccall "genpop__QPixmap_scrollRect" scrollRect' ::  HoppyF.Ptr QPixmap -> HoppyFC.CInt -> HoppyFC.CInt -> HoppyF.Ptr M42.QRectConst -> HoppyP.IO ()
foreign import ccall "genpop__QPixmap_scrollRectAll" scrollRectAll' ::  HoppyF.Ptr QPixmap -> HoppyFC.CInt -> HoppyFC.CInt -> HoppyF.Ptr M42.QRectConst -> HoppyF.Ptr M154.QRegion -> HoppyP.IO ()
foreign import ccall "genpop__QPixmap_size" size' ::  HoppyF.Ptr QPixmapConst -> HoppyP.IO (HoppyF.Ptr M48.QSizeConst)
foreign import ccall "genpop__QPixmap_swap" swap' ::  HoppyF.Ptr QPixmap -> HoppyF.Ptr QPixmap -> HoppyP.IO ()
foreign import ccall "genpop__QPixmap_toImage" toImage' ::  HoppyF.Ptr QPixmapConst -> HoppyP.IO (HoppyF.Ptr M122.QImageConst)
foreign import ccall "genpop__QPixmap_transformed" transformed' ::  HoppyF.Ptr QPixmapConst -> HoppyF.Ptr M166.QTransformConst -> HoppyP.IO (HoppyF.Ptr QPixmapConst)
foreign import ccall "genpop__QPixmap_transformedAll" transformedAll' ::  HoppyF.Ptr QPixmapConst -> HoppyF.Ptr M166.QTransformConst -> HoppyFC.CInt -> HoppyP.IO (HoppyF.Ptr QPixmapConst)
foreign import ccall "genpop__QPixmap_trueMatrixTransform" trueMatrixTransform' ::  HoppyF.Ptr M166.QTransformConst -> HoppyFC.CInt -> HoppyFC.CInt -> HoppyP.IO (HoppyF.Ptr M166.QTransformConst)
...
foreign import ccall "gencast__QPixmap__QPaintDevice" castQPixmapToQPaintDevice :: HoppyF.Ptr QPixmapConst -> HoppyF.Ptr M134.QPaintDeviceConst
foreign import ccall "gencast__QPaintDevice__QPixmap" castQPaintDeviceToQPixmap :: HoppyF.Ptr M134.QPaintDeviceConst -> HoppyF.Ptr QPixmapConst
...
class (M134.QPaintDeviceConstPtr this) => QPixmapConstPtr this where
...
copyRect :: (QPixmapValue arg'1, M42.QRectValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO QPixmap
...
save :: (QPixmapValue arg'1, M52.QStringValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO HoppyP.Bool
save arg'1 arg'2 =
  withQPixmapPtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
...
scaledRawAll :: (QPixmapValue arg'1) => arg'1 -> HoppyP.Int -> HoppyP.Int -> M66.QtAspectRatioMode -> M66.QtTransformationMode -> HoppyP.IO QPixmap
...
scaledSize :: (QPixmapValue arg'1, M48.QSizeValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO QPixmap
...
scaledSizeAll :: (QPixmapValue arg'1, M48.QSizeValue arg'2) => arg'1 -> arg'2 -> M66.QtAspectRatioMode -> M66.QtTransformationMode -> HoppyP.IO QPixmap
...
scaledToHeightAll :: (QPixmapValue arg'1) => arg'1 -> HoppyP.Int -> M66.QtTransformationMode -> HoppyP.IO QPixmap
...
scaledToWidthAll :: (QPixmapValue arg'1) => arg'1 -> HoppyP.Int -> M66.QtTransformationMode -> HoppyP.IO QPixmap
...
toImage :: (QPixmapValue arg'1) => arg'1 -> HoppyP.IO M122.QImage
toImage arg'1 =
  withQPixmapPtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
  (HoppyFHR.decodeAndDelete . M122.QImageConst) =<<
  (toImage' arg'1')

transformed :: (QPixmapValue arg'1, M166.QTransformValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO QPixmap
...
transformedAll :: (QPixmapValue arg'1, M166.QTransformValue arg'2) => arg'1 -> arg'2 -> M66.QtTransformationMode -> HoppyP.IO QPixmap
...
class (QPixmapConstPtr this, M134.QPaintDevicePtr this) => QPixmapPtr this where
  toQPixmap :: this -> QPixmap

convertFromImage :: (QPixmapPtr arg'1, M122.QImageValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO HoppyP.Bool
convertFromImage arg'1 arg'2 =
  HoppyFHR.withCppPtr (toQPixmap arg'1) $ \arg'1' ->
  M122.withQImagePtr arg'2 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'2' ->
  HoppyP.fmap (/= 0)
  (convertFromImage' arg'1' arg'2')

convertFromImageAll :: (QPixmapPtr arg'1, M122.QImageValue arg'2, M66.IsQtImageConversionFlags arg'3) => arg'1 -> arg'2 -> arg'3 -> HoppyP.IO HoppyP.Bool
convertFromImageAll arg'1 arg'2 arg'3 =
  HoppyFHR.withCppPtr (toQPixmap arg'1) $ \arg'1' ->
  M122.withQImagePtr arg'2 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'2' ->
  let arg'3' = M66.fromQtImageConversionFlags $ M66.toQtImageConversionFlags arg'3 in
  HoppyP.fmap (/= 0)
  (convertFromImageAll' arg'1' arg'2' arg'3')
...
fillWithColor :: (QPixmapPtr arg'1, M104.QColorValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO ()
fillWithColor arg'1 arg'2 =
  HoppyFHR.withCppPtr (toQPixmap arg'1) $ \arg'1' ->
  M104.withQColorPtr arg'2 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'2' ->
  (fillWithColor' arg'1' arg'2')

load :: (QPixmapPtr arg'1, M52.QStringValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO HoppyP.Bool
load arg'1 arg'2 =
  HoppyFHR.withCppPtr (toQPixmap arg'1) $ \arg'1' ->
  M52.withQStringPtr arg'2 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'2' ->
  HoppyP.fmap (/= 0)
...
scrollRawAll :: (QPixmapPtr arg'1, M154.QRegionPtr arg'8) => arg'1 -> HoppyP.Int -> HoppyP.Int -> HoppyP.Int -> HoppyP.Int -> HoppyP.Int -> HoppyP.Int -> arg'8 -> HoppyP.IO ()
scrollRawAll arg'1 arg'2 arg'3 arg'4 arg'5 arg'6 arg'7 arg'8 =
  ...
  let arg'6' = HoppyFHR.coerceIntegral arg'6 in
  let arg'7' = HoppyFHR.coerceIntegral arg'7 in
  HoppyFHR.withCppPtr (M154.toQRegion arg'8) $ \arg'8' ->
  (scrollRawAll' arg'1' arg'2' arg'3' arg'4' arg'5' arg'6' arg'7' arg'8')

scrollRect :: (QPixmapPtr arg'1, M42.QRectValue arg'4) => arg'1 -> HoppyP.Int -> HoppyP.Int -> arg'4 -> HoppyP.IO ()
...
scrollRectAll :: (QPixmapPtr arg'1, M42.QRectValue arg'4, M154.QRegionPtr arg'5) => arg'1 -> HoppyP.Int -> HoppyP.Int -> arg'4 -> arg'5 -> HoppyP.IO ()
scrollRectAll arg'1 arg'2 arg'3 arg'4 arg'5 =
  HoppyFHR.withCppPtr (toQPixmap arg'1) $ \arg'1' ->
  let arg'2' = HoppyFHR.coerceIntegral arg'2 in
  let arg'3' = HoppyFHR.coerceIntegral arg'3 in
  M42.withQRectPtr arg'4 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'4' ->
  HoppyFHR.withCppPtr (M154.toQRegion arg'5) $ \arg'5' ->
  (scrollRectAll' arg'1' arg'2' arg'3' arg'4' arg'5')
...
fromImage :: (M122.QImageValue arg'1) => arg'1 -> HoppyP.IO QPixmap
fromImage arg'1 =
  M122.withQImagePtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
  (HoppyFHR.decodeAndDelete . QPixmapConst) =<<
  (fromImage' arg'1')

fromImageAll :: (M122.QImageValue arg'1, M66.IsQtImageConversionFlags arg'2) => arg'1 -> arg'2 -> HoppyP.IO QPixmap
fromImageAll arg'1 arg'2 =
  M122.withQImagePtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
  let arg'2' = M66.fromQtImageConversionFlags $ M66.toQtImageConversionFlags arg'2 in
  (HoppyFHR.decodeAndDelete . QPixmapConst) =<<
  (fromImageAll' arg'1' arg'2')

trueMatrixTransform :: (M166.QTransformValue arg'1) => arg'1 -> HoppyP.Int -> HoppyP.Int -> HoppyP.IO M166.QTransform
...
instance M134.QPaintDeviceConstPtr QPixmapConst where
  toQPaintDeviceConst (QPixmapConst ptr') = M134.QPaintDeviceConst $ castQPixmapToQPaintDevice ptr'
  toQPaintDeviceConst (QPixmapConstGc fptr' ptr') = M134.QPaintDeviceConstGc fptr' $ castQPixmapToQPaintDevice ptr'
...
instance M134.QPaintDeviceConstPtr QPixmap where
  toQPaintDeviceConst (QPixmap ptr') = M134.QPaintDeviceConst $ castQPixmapToQPaintDevice $ (HoppyF.castPtr :: HoppyF.Ptr QPixmap -> HoppyF.Ptr QPixmapConst) ptr'
  toQPaintDeviceConst (QPixmapGc fptr' ptr') = M134.QPaintDeviceConstGc fptr' $ castQPixmapToQPaintDevice $ (HoppyF.castPtr :: HoppyF.Ptr QPixmap -> HoppyF.Ptr QPixmapConst) ptr'

instance M134.QPaintDevicePtr QPixmap where
  toQPaintDevice (QPixmap ptr') = M134.QPaintDevice $ (HoppyF.castPtr :: HoppyF.Ptr M134.QPaintDeviceConst -> HoppyF.Ptr M134.QPaintDevice) $ castQPixmapToQPaintDevice $ (HoppyF.castPtr :: HoppyF.Ptr QPixmap -> HoppyF.Ptr QPixmapConst) ptr'
  toQPaintDevice (QPixmapGc fptr' ptr') = M134.QPaintDeviceGc fptr' $ (HoppyF.castPtr :: HoppyF.Ptr M134.QPaintDeviceConst -> HoppyF.Ptr M134.QPaintDevice) $ castQPixmapToQPaintDevice $ (HoppyF.castPtr :: HoppyF.Ptr QPixmap -> HoppyF.Ptr QPixmapConst) ptr'
...
newWithSize :: (M48.QSizeValue arg'1) => arg'1 -> HoppyP.IO QPixmap
newWithSize arg'1 =
...
newWithFile :: (M52.QStringValue arg'1) => arg'1 -> HoppyP.IO QPixmap
newWithFile arg'1 =
...
instance QPixmapSuper M134.QPaintDevice where
  downToQPixmap = castQPixmapToNonconst . cast' . M134.castQPaintDeviceToConst
    where
      cast' (M134.QPaintDeviceConst ptr') = QPixmapConst $ castQPaintDeviceToQPixmap ptr'
      cast' (M134.QPaintDeviceConstGc fptr' ptr') = QPixmapConstGc fptr' $ castQPaintDeviceToQPixmap ptr'

class QPixmapSuperConst a where
  downToQPixmapConst :: a -> QPixmapConst

instance QPixmapSuperConst M134.QPaintDeviceConst where
