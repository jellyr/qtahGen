...
foreign import ccall "gencast__QIntValidator__QValidator" castQIntValidatorToQValidator :: HoppyF.Ptr QIntValidatorConst -> HoppyF.Ptr M168.QValidatorConst
foreign import ccall "gencast__QValidator__QIntValidator" castQValidatorToQIntValidator :: HoppyF.Ptr M168.QValidatorConst -> HoppyF.Ptr QIntValidatorConst
...
class (M168.QValidatorConstPtr this) => QIntValidatorConstPtr this where
...
class (QIntValidatorConstPtr this, M168.QValidatorPtr this) => QIntValidatorPtr this where
...
instance M168.QValidatorConstPtr QIntValidatorConst where
  toQValidatorConst (QIntValidatorConst ptr') = M168.QValidatorConst $ castQIntValidatorToQValidator ptr'
  toQValidatorConst (QIntValidatorConstGc fptr' ptr') = M168.QValidatorConstGc fptr' $ castQIntValidatorToQValidator ptr'
...
instance M168.QValidatorConstPtr QIntValidator where
  toQValidatorConst (QIntValidator ptr') = M168.QValidatorConst $ castQIntValidatorToQValidator $ (HoppyF.castPtr :: HoppyF.Ptr QIntValidator -> HoppyF.Ptr QIntValidatorConst) ptr'
  toQValidatorConst (QIntValidatorGc fptr' ptr') = M168.QValidatorConstGc fptr' $ castQIntValidatorToQValidator $ (HoppyF.castPtr :: HoppyF.Ptr QIntValidator -> HoppyF.Ptr QIntValidatorConst) ptr'

instance M168.QValidatorPtr QIntValidator where
  toQValidator (QIntValidator ptr') = M168.QValidator $ (HoppyF.castPtr :: HoppyF.Ptr M168.QValidatorConst -> HoppyF.Ptr M168.QValidator) $ castQIntValidatorToQValidator $ (HoppyF.castPtr :: HoppyF.Ptr QIntValidator -> HoppyF.Ptr QIntValidatorConst) ptr'
  toQValidator (QIntValidatorGc fptr' ptr') = M168.QValidatorGc fptr' $ (HoppyF.castPtr :: HoppyF.Ptr M168.QValidatorConst -> HoppyF.Ptr M168.QValidator) $ castQIntValidatorToQValidator $ (HoppyF.castPtr :: HoppyF.Ptr QIntValidator -> HoppyF.Ptr QIntValidatorConst) ptr'
...
instance QIntValidatorSuper M168.QValidator where
  downToQIntValidator = castQIntValidatorToNonconst . cast' . M168.castQValidatorToConst
    where
      cast' (M168.QValidatorConst ptr') = QIntValidatorConst $ castQValidatorToQIntValidator ptr'
      cast' (M168.QValidatorConstGc fptr' ptr') = QIntValidatorConstGc fptr' $ castQValidatorToQIntValidator ptr'
...
instance QIntValidatorSuperConst M168.QValidatorConst where
