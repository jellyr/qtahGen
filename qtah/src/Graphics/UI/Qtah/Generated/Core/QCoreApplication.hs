...
foreign import ccall "genpop__QCoreApplication_new" new' ::  HoppyF.Ptr M54.QStringListConst -> HoppyP.IO (HoppyF.Ptr QCoreApplication)
foreign import ccall "genpop__QCoreApplication_applicationName" applicationName' ::  HoppyP.IO (HoppyF.Ptr M52.QStringConst)
foreign import ccall "genpop__QCoreApplication_applicationVersion" applicationVersion' ::  HoppyP.IO (HoppyF.Ptr M52.QStringConst)
foreign import ccall "genpop__QCoreApplication_arguments" arguments' ::  HoppyP.IO (HoppyF.Ptr M54.QStringListConst)
...
foreign import ccall "genpop__QCoreApplication_organizationDomain" organizationDomain' ::  HoppyP.IO (HoppyF.Ptr M52.QStringConst)
foreign import ccall "genpop__QCoreApplication_organizationName" organizationName' ::  HoppyP.IO (HoppyF.Ptr M52.QStringConst)
...
foreign import ccall "genpop__QCoreApplication_setApplicationName" setApplicationName' ::  HoppyF.Ptr M52.QStringConst -> HoppyP.IO ()
foreign import ccall "genpop__QCoreApplication_setApplicationVersion" setApplicationVersion' ::  HoppyF.Ptr M52.QStringConst -> HoppyP.IO ()
foreign import ccall "genpop__QCoreApplication_setOrganizationDomain" setOrganizationDomain' ::  HoppyF.Ptr M52.QStringConst -> HoppyP.IO ()
foreign import ccall "genpop__QCoreApplication_setOrganizationName" setOrganizationName' ::  HoppyF.Ptr M52.QStringConst -> HoppyP.IO ()
...
new :: (M54.QStringListValue arg'1) => arg'1 -> HoppyP.IO QCoreApplication
new arg'1 =
...
setApplicationName :: (M52.QStringValue arg'1) => arg'1 -> HoppyP.IO ()
setApplicationName arg'1 =
  M52.withQStringPtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
  (setApplicationName' arg'1')

setApplicationVersion :: (M52.QStringValue arg'1) => arg'1 -> HoppyP.IO ()
setApplicationVersion arg'1 =
  M52.withQStringPtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
  (setApplicationVersion' arg'1')

setOrganizationDomain :: (M52.QStringValue arg'1) => arg'1 -> HoppyP.IO ()
setOrganizationDomain arg'1 =
  M52.withQStringPtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
  (setOrganizationDomain' arg'1')

setOrganizationName :: (M52.QStringValue arg'1) => arg'1 -> HoppyP.IO ()
