...
foreign import ccall "genpop__QStringListModel_newWithContents" newWithContents' ::  HoppyF.Ptr M54.QStringListConst -> HoppyP.IO (HoppyF.Ptr QStringListModel)
foreign import ccall "genpop__QStringListModel_newWithContentsAndParent" newWithContentsAndParent' ::  HoppyF.Ptr M54.QStringListConst -> HoppyF.Ptr M34.QObject -> HoppyP.IO (HoppyF.Ptr QStringListModel)
foreign import ccall "genpop__QStringListModel_stringList" stringList' ::  HoppyF.Ptr QStringListModelConst -> HoppyP.IO (HoppyF.Ptr M54.QStringListConst)
foreign import ccall "genpop__QStringListModel_setStringList" setStringList' ::  HoppyF.Ptr QStringListModel -> HoppyF.Ptr M54.QStringListConst -> HoppyP.IO ()
...
setStringList :: (QStringListModelPtr arg'1, M54.QStringListValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO ()
...
newWithContents :: (M54.QStringListValue arg'1) => arg'1 -> HoppyP.IO QStringListModel
newWithContents arg'1 =
  M54.withQStringListPtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
  HoppyP.fmap QStringListModel
  (newWithContents' arg'1')

newWithContentsAndParent :: (M54.QStringListValue arg'1, M34.QObjectPtr arg'2) => arg'1 -> arg'2 -> HoppyP.IO QStringListModel
