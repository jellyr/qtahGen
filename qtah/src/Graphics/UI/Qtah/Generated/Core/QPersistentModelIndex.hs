...
foreign import ccall "genpop__QPersistentModelIndex_getData" getData' ::  HoppyF.Ptr QPersistentModelIndexConst -> HoppyP.IO (HoppyF.Ptr M64.QVariantConst)
foreign import ccall "genpop__QPersistentModelIndex_getDataWithRole" getDataWithRole' ::  HoppyF.Ptr QPersistentModelIndexConst -> HoppyFC.CInt -> HoppyP.IO (HoppyF.Ptr M64.QVariantConst)
...
getData :: (QPersistentModelIndexValue arg'1) => arg'1 -> HoppyP.IO M64.QVariant
getData arg'1 =
  withQPersistentModelIndexPtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
  (HoppyFHR.decodeAndDelete . M64.QVariantConst) =<<
  (getData' arg'1')

getDataWithRole :: (QPersistentModelIndexValue arg'1) => arg'1 -> M66.QtItemDataRole -> HoppyP.IO M64.QVariant
...
flags :: (QPersistentModelIndexValue arg'1) => arg'1 -> HoppyP.IO M66.QtItemFlags
flags arg'1 =
  withQPersistentModelIndexPtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
