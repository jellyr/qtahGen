...
foreign import ccall "genpop__QRectF_newFromPoints" newFromPoints' ::  HoppyF.Ptr M40.QPointFConst -> HoppyF.Ptr M40.QPointFConst -> HoppyP.IO (HoppyF.Ptr QRectF)
foreign import ccall "genpop__QRectF_newWithPointAndSize" newWithPointAndSize' ::  HoppyF.Ptr M40.QPointFConst -> HoppyF.Ptr M50.QSizeFConst -> HoppyP.IO (HoppyF.Ptr QRectF)
foreign import ccall "genpop__QRectF_newWithRect" newWithRect' ::  HoppyF.Ptr M42.QRectConst -> HoppyP.IO (HoppyF.Ptr QRectF)
...
foreign import ccall "genpop__QRectF_bottomLeft" bottomLeft' ::  HoppyF.Ptr QRectFConst -> HoppyP.IO (HoppyF.Ptr M40.QPointFConst)
foreign import ccall "genpop__QRectF_setBottomLeft" setBottomLeft' ::  HoppyF.Ptr QRectF -> HoppyF.Ptr M40.QPointFConst -> HoppyP.IO ()
foreign import ccall "genpop__QRectF_bottomRight" bottomRight' ::  HoppyF.Ptr QRectFConst -> HoppyP.IO (HoppyF.Ptr M40.QPointFConst)
foreign import ccall "genpop__QRectF_setBottomRight" setBottomRight' ::  HoppyF.Ptr QRectF -> HoppyF.Ptr M40.QPointFConst -> HoppyP.IO ()
foreign import ccall "genpop__QRectF_center" center' ::  HoppyF.Ptr QRectFConst -> HoppyP.IO (HoppyF.Ptr M40.QPointFConst)
foreign import ccall "genpop__QRectF_containsPoint" containsPoint' ::  HoppyF.Ptr QRectFConst -> HoppyF.Ptr M40.QPointFConst -> HoppyP.IO HoppyFHR.CBool
...
foreign import ccall "genpop__QRectF_moveBottomLeft" moveBottomLeft' ::  HoppyF.Ptr QRectF -> HoppyF.Ptr M40.QPointFConst -> HoppyP.IO ()
foreign import ccall "genpop__QRectF_moveBottomRight" moveBottomRight' ::  HoppyF.Ptr QRectF -> HoppyF.Ptr M40.QPointFConst -> HoppyP.IO ()
foreign import ccall "genpop__QRectF_moveCenter" moveCenter' ::  HoppyF.Ptr QRectF -> HoppyF.Ptr M40.QPointFConst -> HoppyP.IO ()
...
foreign import ccall "genpop__QRectF_moveTo" moveTo' ::  HoppyF.Ptr QRectF -> HoppyF.Ptr M40.QPointFConst -> HoppyP.IO ()
foreign import ccall "genpop__QRectF_moveTop" moveTop' ::  HoppyF.Ptr QRectF -> HoppyFC.CDouble -> HoppyP.IO ()
foreign import ccall "genpop__QRectF_moveTopLeft" moveTopLeft' ::  HoppyF.Ptr QRectF -> HoppyF.Ptr M40.QPointFConst -> HoppyP.IO ()
foreign import ccall "genpop__QRectF_moveTopRight" moveTopRight' ::  HoppyF.Ptr QRectF -> HoppyF.Ptr M40.QPointFConst -> HoppyP.IO ()
...
foreign import ccall "genpop__QRectF_size" size' ::  HoppyF.Ptr QRectFConst -> HoppyP.IO (HoppyF.Ptr M50.QSizeFConst)
foreign import ccall "genpop__QRectF_setSize" setSize' ::  HoppyF.Ptr QRectF -> HoppyF.Ptr M50.QSizeFConst -> HoppyP.IO ()
foreign import ccall "genpop__QRectF_toAlignedRect" toAlignedRect' ::  HoppyF.Ptr QRectFConst -> HoppyP.IO (HoppyF.Ptr M42.QRectConst)
...
foreign import ccall "genpop__QRectF_topLeft" topLeft' ::  HoppyF.Ptr QRectFConst -> HoppyP.IO (HoppyF.Ptr M40.QPointFConst)
foreign import ccall "genpop__QRectF_setTopLeft" setTopLeft' ::  HoppyF.Ptr QRectF -> HoppyF.Ptr M40.QPointFConst -> HoppyP.IO ()
foreign import ccall "genpop__QRectF_topRight" topRight' ::  HoppyF.Ptr QRectFConst -> HoppyP.IO (HoppyF.Ptr M40.QPointFConst)
foreign import ccall "genpop__QRectF_setTopRight" setTopRight' ::  HoppyF.Ptr QRectF -> HoppyF.Ptr M40.QPointFConst -> HoppyP.IO ()
foreign import ccall "genpop__QRectF_translate" translate' ::  HoppyF.Ptr QRectF -> HoppyF.Ptr M40.QPointFConst -> HoppyP.IO ()
foreign import ccall "genpop__QRectF_translated" translated' ::  HoppyF.Ptr QRectFConst -> HoppyF.Ptr M40.QPointFConst -> HoppyP.IO (HoppyF.Ptr QRectFConst)
...
containsPoint :: (QRectFValue arg'1, M40.QPointFValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO HoppyP.Bool
...
size :: (QRectFValue arg'1) => arg'1 -> HoppyP.IO M50.QSizeF
size arg'1 =
  withQRectFPtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
...
translated :: (QRectFValue arg'1, M40.QPointFValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO QRectF
...
setBottomLeft :: (QRectFPtr arg'1, M40.QPointFValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO ()
setBottomLeft arg'1 arg'2 =
  HoppyFHR.withCppPtr (toQRectF arg'1) $ \arg'1' ->
  M40.withQPointFPtr arg'2 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'2' ->
  (setBottomLeft' arg'1' arg'2')

setBottomRight :: (QRectFPtr arg'1, M40.QPointFValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO ()
...
moveBottomLeft :: (QRectFPtr arg'1, M40.QPointFValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO ()
moveBottomLeft arg'1 arg'2 =
  HoppyFHR.withCppPtr (toQRectF arg'1) $ \arg'1' ->
  M40.withQPointFPtr arg'2 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'2' ->
  (moveBottomLeft' arg'1' arg'2')

moveBottomRight :: (QRectFPtr arg'1, M40.QPointFValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO ()
moveBottomRight arg'1 arg'2 =
  HoppyFHR.withCppPtr (toQRectF arg'1) $ \arg'1' ->
  M40.withQPointFPtr arg'2 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'2' ->
  (moveBottomRight' arg'1' arg'2')

moveCenter :: (QRectFPtr arg'1, M40.QPointFValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO ()
...
moveTo :: (QRectFPtr arg'1, M40.QPointFValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO ()
moveTo arg'1 arg'2 =
  HoppyFHR.withCppPtr (toQRectF arg'1) $ \arg'1' ->
  M40.withQPointFPtr arg'2 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'2' ->
  (moveTo' arg'1' arg'2')
...
moveTopLeft :: (QRectFPtr arg'1, M40.QPointFValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO ()
moveTopLeft arg'1 arg'2 =
  HoppyFHR.withCppPtr (toQRectF arg'1) $ \arg'1' ->
  M40.withQPointFPtr arg'2 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'2' ->
  (moveTopLeft' arg'1' arg'2')

moveTopRight :: (QRectFPtr arg'1, M40.QPointFValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO ()
...
setSize :: (QRectFPtr arg'1, M50.QSizeFValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO ()
setSize arg'1 arg'2 =
  HoppyFHR.withCppPtr (toQRectF arg'1) $ \arg'1' ->
...
setTopLeft :: (QRectFPtr arg'1, M40.QPointFValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO ()
setTopLeft arg'1 arg'2 =
  HoppyFHR.withCppPtr (toQRectF arg'1) $ \arg'1' ->
  M40.withQPointFPtr arg'2 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'2' ->
  (setTopLeft' arg'1' arg'2')

setTopRight :: (QRectFPtr arg'1, M40.QPointFValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO ()
setTopRight arg'1 arg'2 =
  HoppyFHR.withCppPtr (toQRectF arg'1) $ \arg'1' ->
  M40.withQPointFPtr arg'2 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'2' ->
  (setTopRight' arg'1' arg'2')

translate :: (QRectFPtr arg'1, M40.QPointFValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO ()
...
newFromPoints :: (M40.QPointFValue arg'1, M40.QPointFValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO QRectF
...
newWithPointAndSize :: (M40.QPointFValue arg'1, M50.QSizeFValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO QRectF
...
newWithRect :: (M42.QRectValue arg'1) => arg'1 -> HoppyP.IO QRectF
newWithRect arg'1 =
