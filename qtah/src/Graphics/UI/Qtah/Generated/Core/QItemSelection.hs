...
import qualified Graphics.UI.Qtah.Generated.Core.QList.QItemSelectionRange as M74
import qualified Graphics.UI.Qtah.Generated.Core.QList.QModelIndex as M76
...
foreign import ccall "genpop__QItemSelection_indexes" indexes' ::  HoppyF.Ptr QItemSelectionConst -> HoppyP.IO (HoppyF.Ptr M76.QListQModelIndexConst)
...
foreign import ccall "gencast__QItemSelection__QListQItemSelectionRange" castQItemSelectionToQListQItemSelectionRange :: HoppyF.Ptr QItemSelectionConst -> HoppyF.Ptr M74.QListQItemSelectionRangeConst
...
class (M74.QListQItemSelectionRangeConstPtr this) => QItemSelectionConstPtr this where
...
indexes arg'1 =
  withQItemSelectionPtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
  (HoppyFHR.decodeAndDelete . M76.QListQModelIndexConst) =<<
  (indexes' arg'1')

class (QItemSelectionConstPtr this, M74.QListQItemSelectionRangePtr this) => QItemSelectionPtr this where
...
instance M74.QListQItemSelectionRangeConstPtr QItemSelectionConst where
  toQListQItemSelectionRangeConst (QItemSelectionConst ptr') = M74.QListQItemSelectionRangeConst $ castQItemSelectionToQListQItemSelectionRange ptr'
  toQListQItemSelectionRangeConst (QItemSelectionConstGc fptr' ptr') = M74.QListQItemSelectionRangeConstGc fptr' $ castQItemSelectionToQListQItemSelectionRange ptr'
...
instance M74.QListQItemSelectionRangeConstPtr QItemSelection where
  toQListQItemSelectionRangeConst (QItemSelection ptr') = M74.QListQItemSelectionRangeConst $ castQItemSelectionToQListQItemSelectionRange $ (HoppyF.castPtr :: HoppyF.Ptr QItemSelection -> HoppyF.Ptr QItemSelectionConst) ptr'
  toQListQItemSelectionRangeConst (QItemSelectionGc fptr' ptr') = M74.QListQItemSelectionRangeConstGc fptr' $ castQItemSelectionToQListQItemSelectionRange $ (HoppyF.castPtr :: HoppyF.Ptr QItemSelection -> HoppyF.Ptr QItemSelectionConst) ptr'

instance M74.QListQItemSelectionRangePtr QItemSelection where
  toQListQItemSelectionRange (QItemSelection ptr') = M74.QListQItemSelectionRange $ (HoppyF.castPtr :: HoppyF.Ptr M74.QListQItemSelectionRangeConst -> HoppyF.Ptr M74.QListQItemSelectionRange) $ castQItemSelectionToQListQItemSelectionRange $ (HoppyF.castPtr :: HoppyF.Ptr QItemSelection -> HoppyF.Ptr QItemSelectionConst) ptr'
  toQListQItemSelectionRange (QItemSelectionGc fptr' ptr') = M74.QListQItemSelectionRangeGc fptr' $ (HoppyF.castPtr :: HoppyF.Ptr M74.QListQItemSelectionRangeConst -> HoppyF.Ptr M74.QListQItemSelectionRange) $ castQItemSelectionToQListQItemSelectionRange $ (HoppyF.castPtr :: HoppyF.Ptr QItemSelection -> HoppyF.Ptr QItemSelectionConst) ptr'
...
instance QtahFHR.HasContents QItemSelectionConst (M26.QItemSelectionRange) where
  toContents = QtahFHR.toContents . M74.toQListQItemSelectionRangeConst
instance QtahFHR.HasContents QItemSelection (M26.QItemSelectionRange) where
  toContents = QtahFHR.toContents . M74.toQListQItemSelectionRange