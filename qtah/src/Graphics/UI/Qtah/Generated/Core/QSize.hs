...
scaled :: (QSizeValue arg'1, QSizeValue arg'2) => arg'1 -> arg'2 -> M66.QtAspectRatioMode -> HoppyP.IO HSize.HSize
...
scale :: (QSizePtr arg'1, QSizeValue arg'2) => arg'1 -> arg'2 -> M66.QtAspectRatioMode -> HoppyP.IO ()
