...
foreign import ccall "genpop__QSizeF_newWithSize" newWithSize' ::  HoppyF.Ptr M48.QSizeConst -> HoppyP.IO (HoppyF.Ptr QSizeF)
...
foreign import ccall "genpop__QSizeF_toSize" toSize' ::  HoppyF.Ptr QSizeFConst -> HoppyP.IO (HoppyF.Ptr M48.QSizeConst)
...
scaled :: (QSizeFValue arg'1, QSizeFValue arg'2) => arg'1 -> arg'2 -> M66.QtAspectRatioMode -> HoppyP.IO QSizeF
...
scale :: (QSizeFPtr arg'1, QSizeFValue arg'2) => arg'1 -> arg'2 -> M66.QtAspectRatioMode -> HoppyP.IO ()
...
newWithSize :: (M48.QSizeValue arg'1) => arg'1 -> HoppyP.IO QSizeF
newWithSize arg'1 =
