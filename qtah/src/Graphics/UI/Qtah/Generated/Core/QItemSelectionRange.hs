...
foreign import ccall "genpop__QItemSelectionRange_bottomRight" bottomRight' ::  HoppyF.Ptr QItemSelectionRangeConst -> HoppyP.IO (HoppyF.Ptr M36.QPersistentModelIndexConst)
...
foreign import ccall "genpop__QItemSelectionRange_indexes" indexes' ::  HoppyF.Ptr QItemSelectionRangeConst -> HoppyP.IO (HoppyF.Ptr M76.QListQModelIndexConst)
...
foreign import ccall "genpop__QItemSelectionRange_topLeft" topLeft' ::  HoppyF.Ptr QItemSelectionRangeConst -> HoppyP.IO (HoppyF.Ptr M36.QPersistentModelIndexConst)
...
bottomRight :: (QItemSelectionRangeValue arg'1) => arg'1 -> HoppyP.IO M36.QPersistentModelIndexConst
bottomRight arg'1 =
  withQItemSelectionRangePtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
  HoppyP.fmap M36.QPersistentModelIndexConst
  (bottomRight' arg'1')
...
topLeft :: (QItemSelectionRangeValue arg'1) => arg'1 -> HoppyP.IO M36.QPersistentModelIndexConst
topLeft arg'1 =
  withQItemSelectionRangePtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
  HoppyP.fmap M36.QPersistentModelIndexConst
  (topLeft' arg'1')
