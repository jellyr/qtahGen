...
foreign import ccall "genpop__QPointF_newFromPoint" newFromPoint' ::  HoppyF.Ptr M38.QPointConst -> HoppyP.IO (HoppyF.Ptr QPointF)
...
foreign import ccall "genpop__QPointF_toPoint" toPoint' ::  HoppyF.Ptr QPointFConst -> HoppyP.IO (HoppyF.Ptr M38.QPointConst)
...
newFromPoint :: (M38.QPointValue arg'1) => arg'1 -> HoppyP.IO QPointF
newFromPoint arg'1 =
