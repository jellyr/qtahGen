...
import {-# SOURCE #-} qualified Graphics.UI.Qtah.Generated.Core.QString as M52
import Prelude (($), (++), (.), (/=), (=<<), (==), (>>))
...
foreign import ccall "genpop__QChar_decomposition" decomposition' ::  HoppyF.Ptr QCharConst -> HoppyP.IO (HoppyF.Ptr M52.QStringConst)
