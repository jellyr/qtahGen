...
import {-# SOURCE #-} qualified Graphics.UI.Qtah.Generated.Core.QList.QObject as M78
...
foreign import ccall "genpop__QObject_children" children' ::  HoppyF.Ptr QObject -> HoppyP.IO (HoppyF.Ptr M78.QListQObjectConst)
...
foreign import ccall "genpop__QObject_objectName" objectName' ::  HoppyF.Ptr QObjectConst -> HoppyP.IO (HoppyF.Ptr M52.QStringConst)
foreign import ccall "genpop__QObject_setObjectName" setObjectName' ::  HoppyF.Ptr QObject -> HoppyF.Ptr M52.QStringConst -> HoppyP.IO ()
...
children arg'1 =
  HoppyFHR.withCppPtr (toQObject arg'1) $ \arg'1' ->
  (HoppyFHR.decodeAndDelete . M78.QListQObjectConst) =<<
  (children' arg'1')
...
setObjectName :: (QObjectPtr arg'1, M52.QStringValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO ()
