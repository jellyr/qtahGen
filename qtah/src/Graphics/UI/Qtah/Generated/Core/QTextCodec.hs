...
import qualified Graphics.UI.Qtah.Generated.Core.QList.QByteArray as M72
import qualified Graphics.UI.Qtah.Generated.Core.QString as M52
import Prelude (($), (.), (/=), (=<<), (==))
import qualified Prelude as HoppyP
import qualified Prelude as QtahP

foreign import ccall "genpop__QTextCodec_aliases" aliases' ::  HoppyF.Ptr QTextCodecConst -> HoppyP.IO (HoppyF.Ptr M72.QListQByteArrayConst)
...
foreign import ccall "genpop__QTextCodec_canEncodeString" canEncodeString' ::  HoppyF.Ptr QTextCodecConst -> HoppyF.Ptr M52.QStringConst -> HoppyP.IO HoppyFHR.CBool
foreign import ccall "genpop__QTextCodec_fromUnicode" fromUnicode' ::  HoppyF.Ptr QTextCodecConst -> HoppyF.Ptr M52.QStringConst -> HoppyP.IO (HoppyF.Ptr M8.QByteArrayConst)
...
foreign import ccall "genpop__QTextCodec_toUnicode" toUnicode' ::  HoppyF.Ptr QTextCodecConst -> HoppyF.Ptr M8.QByteArrayConst -> HoppyP.IO (HoppyF.Ptr M52.QStringConst)
foreign import ccall "genpop__QTextCodec_availableCodecs" availableCodecs' ::  HoppyP.IO (HoppyF.Ptr M72.QListQByteArrayConst)
foreign import ccall "genpop__QTextCodec_availableMibs" availableMibs' ::  HoppyP.IO (HoppyF.Ptr M68.QListIntConst)
...
aliases arg'1 =
  ...
  (HoppyFHR.decodeAndDelete . M72.QListQByteArrayConst) =<<
  (aliases' arg'1')
...
canEncodeString :: (QTextCodecValue arg'1, M52.QStringValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO HoppyP.Bool
...
fromUnicode :: (QTextCodecValue arg'1, M52.QStringValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO QtahDBS.ByteString
