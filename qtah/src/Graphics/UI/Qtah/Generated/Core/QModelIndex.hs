...
foreign import ccall "genpop__QModelIndex_getData" getData' ::  HoppyF.Ptr QModelIndexConst -> HoppyP.IO (HoppyF.Ptr M64.QVariantConst)
foreign import ccall "genpop__QModelIndex_getDataWithRole" getDataWithRole' ::  HoppyF.Ptr QModelIndexConst -> HoppyFC.CInt -> HoppyP.IO (HoppyF.Ptr M64.QVariantConst)
...
getData :: (QModelIndexValue arg'1) => arg'1 -> HoppyP.IO M64.QVariant
getData arg'1 =
  withQModelIndexPtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
  (HoppyFHR.decodeAndDelete . M64.QVariantConst) =<<
  (getData' arg'1')

getDataWithRole :: (QModelIndexValue arg'1) => arg'1 -> M66.QtItemDataRole -> HoppyP.IO M64.QVariant
...
flags :: (QModelIndexValue arg'1) => arg'1 -> HoppyP.IO M66.QtItemFlags
flags arg'1 =
  withQModelIndexPtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
