...
foreign import ccall "genpop__QDir_new" new' ::  HoppyF.Ptr M52.QStringConst -> HoppyP.IO (HoppyF.Ptr QDir)
foreign import ccall "genpop__QDir_newCopy" newCopy' ::  HoppyF.Ptr QDirConst -> HoppyP.IO (HoppyF.Ptr QDir)
foreign import ccall "genpop__QDir_absoluteFilePath" absoluteFilePath' ::  HoppyF.Ptr QDirConst -> HoppyF.Ptr M52.QStringConst -> HoppyP.IO (HoppyF.Ptr M52.QStringConst)
foreign import ccall "genpop__QDir_absolutePath" absolutePath' ::  HoppyF.Ptr QDirConst -> HoppyP.IO (HoppyF.Ptr M52.QStringConst)
foreign import ccall "genpop__QDir_addSearchPath" addSearchPath' ::  HoppyF.Ptr M52.QStringConst -> HoppyF.Ptr M52.QStringConst -> HoppyP.IO ()
foreign import ccall "genpop__QDir_canonicalPath" canonicalPath' ::  HoppyF.Ptr QDirConst -> HoppyP.IO (HoppyF.Ptr M52.QStringConst)
foreign import ccall "genpop__QDir_cd" cd' ::  HoppyF.Ptr QDir -> HoppyF.Ptr M52.QStringConst -> HoppyP.IO HoppyFHR.CBool
foreign import ccall "genpop__QDir_cdUp" cdUp' ::  HoppyF.Ptr QDir -> HoppyP.IO HoppyFHR.CBool
foreign import ccall "genpop__QDir_cleanPath" cleanPath' ::  HoppyF.Ptr M52.QStringConst -> HoppyP.IO (HoppyF.Ptr M52.QStringConst)
...
foreign import ccall "genpop__QDir_currentPath" currentPath' ::  HoppyP.IO (HoppyF.Ptr M52.QStringConst)
foreign import ccall "genpop__QDir_dirName" dirName' ::  HoppyF.Ptr QDirConst -> HoppyP.IO (HoppyF.Ptr M52.QStringConst)
foreign import ccall "genpop__QDir_exists" exists' ::  HoppyF.Ptr QDirConst -> HoppyP.IO HoppyFHR.CBool
foreign import ccall "genpop__QDir_entryExists" entryExists' ::  HoppyF.Ptr QDirConst -> HoppyF.Ptr M52.QStringConst -> HoppyP.IO HoppyFHR.CBool
foreign import ccall "genpop__QDir_filePath" filePath' ::  HoppyF.Ptr QDirConst -> HoppyF.Ptr M52.QStringConst -> HoppyP.IO (HoppyF.Ptr M52.QStringConst)
...
foreign import ccall "genpop__QDir_fromNativeSeparators" fromNativeSeparators' ::  HoppyF.Ptr M52.QStringConst -> HoppyP.IO (HoppyF.Ptr M52.QStringConst)
foreign import ccall "genpop__QDir_home" home' ::  HoppyP.IO (HoppyF.Ptr QDirConst)
foreign import ccall "genpop__QDir_homePath" homePath' ::  HoppyP.IO (HoppyF.Ptr M52.QStringConst)
foreign import ccall "genpop__QDir_isAbsolute" isAbsolute' ::  HoppyF.Ptr QDirConst -> HoppyP.IO HoppyFHR.CBool
foreign import ccall "genpop__QDir_isAbsolutePath" isAbsolutePath' ::  HoppyF.Ptr M52.QStringConst -> HoppyP.IO HoppyFHR.CBool
...
foreign import ccall "genpop__QDir_isRelativePath" isRelativePath' ::  HoppyF.Ptr M52.QStringConst -> HoppyP.IO HoppyFHR.CBool
...
foreign import ccall "genpop__QDir_match" match' ::  HoppyF.Ptr M52.QStringConst -> HoppyF.Ptr M52.QStringConst -> HoppyP.IO HoppyFHR.CBool
foreign import ccall "genpop__QDir_mkdir" mkdir' ::  HoppyF.Ptr QDirConst -> HoppyF.Ptr M52.QStringConst -> HoppyP.IO HoppyFHR.CBool
foreign import ccall "genpop__QDir_mkpath" mkpath' ::  HoppyF.Ptr QDirConst -> HoppyF.Ptr M52.QStringConst -> HoppyP.IO HoppyFHR.CBool
foreign import ccall "genpop__QDir_path" path' ::  HoppyF.Ptr QDirConst -> HoppyP.IO (HoppyF.Ptr M52.QStringConst)
foreign import ccall "genpop__QDir_setPath" setPath' ::  HoppyF.Ptr QDir -> HoppyF.Ptr M52.QStringConst -> HoppyP.IO ()
foreign import ccall "genpop__QDir_refresh" refresh' ::  HoppyF.Ptr QDir -> HoppyP.IO ()
foreign import ccall "genpop__QDir_relativeFilePath" relativeFilePath' ::  HoppyF.Ptr QDirConst -> HoppyF.Ptr M52.QStringConst -> HoppyP.IO (HoppyF.Ptr M52.QStringConst)
foreign import ccall "genpop__QDir_remove" remove' ::  HoppyF.Ptr QDir -> HoppyF.Ptr M52.QStringConst -> HoppyP.IO HoppyFHR.CBool
foreign import ccall "genpop__QDir_removeRecursively" removeRecursively' ::  HoppyF.Ptr QDir -> HoppyP.IO HoppyFHR.CBool
foreign import ccall "genpop__QDir_rename" rename' ::  HoppyF.Ptr QDir -> HoppyF.Ptr M52.QStringConst -> HoppyF.Ptr M52.QStringConst -> HoppyP.IO HoppyFHR.CBool
foreign import ccall "genpop__QDir_rmdir" rmdir' ::  HoppyF.Ptr QDirConst -> HoppyF.Ptr M52.QStringConst -> HoppyP.IO HoppyFHR.CBool
foreign import ccall "genpop__QDir_rmpath" rmpath' ::  HoppyF.Ptr QDirConst -> HoppyF.Ptr M52.QStringConst -> HoppyP.IO HoppyFHR.CBool
foreign import ccall "genpop__QDir_root" root' ::  HoppyP.IO (HoppyF.Ptr QDirConst)
foreign import ccall "genpop__QDir_rootPath" rootPath' ::  HoppyP.IO (HoppyF.Ptr M52.QStringConst)
foreign import ccall "genpop__QDir_separator" separator' ::  HoppyP.IO (HoppyF.Ptr M10.QCharConst)
foreign import ccall "genpop__QDir_setCurrent" setCurrent' ::  HoppyF.Ptr M52.QStringConst -> HoppyP.IO HoppyFHR.CBool
...
foreign import ccall "genpop__QDir_tempPath" tempPath' ::  HoppyP.IO (HoppyF.Ptr M52.QStringConst)
foreign import ccall "genpop__QDir_toNativeSeparators" toNativeSeparators' ::  HoppyF.Ptr M52.QStringConst -> HoppyP.IO (HoppyF.Ptr M52.QStringConst)
foreign import ccall "genpop__QDir_ARRAY" aRRAY' ::  HoppyF.Ptr QDirConst -> HoppyFC.CInt -> HoppyP.IO (HoppyF.Ptr M52.QStringConst)
...
absoluteFilePath :: (QDirValue arg'1, M52.QStringValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO QtahP.String
...
entryExists :: (QDirValue arg'1, M52.QStringValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO HoppyP.Bool
...
filePath :: (QDirValue arg'1, M52.QStringValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO QtahP.String
...
mkdir :: (QDirValue arg'1, M52.QStringValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO HoppyP.Bool
mkdir arg'1 arg'2 =
  withQDirPtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
  M52.withQStringPtr arg'2 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'2' ->
  HoppyP.fmap (/= 0)
...
mkpath :: (QDirValue arg'1, M52.QStringValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO HoppyP.Bool
mkpath arg'1 arg'2 =
  withQDirPtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
  M52.withQStringPtr arg'2 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'2' ->
  HoppyP.fmap (/= 0)
...
relativeFilePath :: (QDirValue arg'1, M52.QStringValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO QtahP.String
...
rmdir :: (QDirValue arg'1, M52.QStringValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO HoppyP.Bool
rmdir arg'1 arg'2 =
  withQDirPtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
  M52.withQStringPtr arg'2 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'2' ->
  HoppyP.fmap (/= 0)
...
rmpath :: (QDirValue arg'1, M52.QStringValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO HoppyP.Bool
rmpath arg'1 arg'2 =
  withQDirPtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
  M52.withQStringPtr arg'2 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'2' ->
  HoppyP.fmap (/= 0)
...
cd :: (QDirPtr arg'1, M52.QStringValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO HoppyP.Bool
cd arg'1 arg'2 =
...
setPath :: (QDirPtr arg'1, M52.QStringValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO ()
setPath arg'1 arg'2 =
  HoppyFHR.withCppPtr (toQDir arg'1) $ \arg'1' ->
  M52.withQStringPtr arg'2 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'2' ->
  (setPath' arg'1' arg'2')
...
remove :: (QDirPtr arg'1, M52.QStringValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO HoppyP.Bool
remove arg'1 arg'2 =
  HoppyFHR.withCppPtr (toQDir arg'1) $ \arg'1' ->
  M52.withQStringPtr arg'2 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'2' ->
  HoppyP.fmap (/= 0)
...
rename :: (QDirPtr arg'1, M52.QStringValue arg'2, M52.QStringValue arg'3) => arg'1 -> arg'2 -> arg'3 -> HoppyP.IO HoppyP.Bool
...
addSearchPath :: (M52.QStringValue arg'1, M52.QStringValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO ()
addSearchPath arg'1 arg'2 =
  M52.withQStringPtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
  M52.withQStringPtr arg'2 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'2' ->
  (addSearchPath' arg'1' arg'2')

cleanPath :: (M52.QStringValue arg'1) => arg'1 -> HoppyP.IO QtahP.String
cleanPath arg'1 =
  M52.withQStringPtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
  (HoppyFHR.decodeAndDelete . M52.QStringConst) =<<
  (cleanPath' arg'1')
...
fromNativeSeparators :: (M52.QStringValue arg'1) => arg'1 -> HoppyP.IO QtahP.String
...
isAbsolutePath :: (M52.QStringValue arg'1) => arg'1 -> HoppyP.IO HoppyP.Bool
isAbsolutePath arg'1 =
  M52.withQStringPtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
  HoppyP.fmap (/= 0)
  (isAbsolutePath' arg'1')

isRelativePath :: (M52.QStringValue arg'1) => arg'1 -> HoppyP.IO HoppyP.Bool
isRelativePath arg'1 =
  M52.withQStringPtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
  HoppyP.fmap (/= 0)
  (isRelativePath' arg'1')

match :: (M52.QStringValue arg'1, M52.QStringValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO HoppyP.Bool
match arg'1 arg'2 =
  M52.withQStringPtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
  M52.withQStringPtr arg'2 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'2' ->
  HoppyP.fmap (/= 0)
...
setCurrent :: (M52.QStringValue arg'1) => arg'1 -> HoppyP.IO HoppyP.Bool
setCurrent arg'1 =
  M52.withQStringPtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
  HoppyP.fmap (/= 0)
  (setCurrent' arg'1')
...
toNativeSeparators :: (M52.QStringValue arg'1) => arg'1 -> HoppyP.IO QtahP.String
...
new :: (M52.QStringValue arg'1) => arg'1 -> HoppyP.IO QDir
new arg'1 =
  M52.withQStringPtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
  HoppyP.fmap QDir
  (new' arg'1')
