...
foreign import ccall "genpop__QListQString_append" append' ::  HoppyF.Ptr QListQString -> HoppyF.Ptr M52.QStringConst -> HoppyP.IO ()
...
foreign import ccall "genpop__QListQString_at" at' ::  HoppyF.Ptr QListQString -> HoppyFC.CInt -> HoppyP.IO (HoppyF.Ptr M52.QString)
foreign import ccall "genpop__QListQString_atConst" atConst' ::  HoppyF.Ptr QListQStringConst -> HoppyFC.CInt -> HoppyP.IO (HoppyF.Ptr M52.QStringConst)
foreign import ccall "genpop__QListQString_clear" clear' ::  HoppyF.Ptr QListQString -> HoppyP.IO ()
foreign import ccall "genpop__QListQString_contains" contains' ::  HoppyF.Ptr QListQStringConst -> HoppyF.Ptr M52.QStringConst -> HoppyP.IO HoppyFHR.CBool
foreign import ccall "genpop__QListQString_count" count' ::  HoppyF.Ptr QListQStringConst -> HoppyF.Ptr M52.QStringConst -> HoppyP.IO HoppyFC.CInt
foreign import ccall "genpop__QListQString_endsWith" endsWith' ::  HoppyF.Ptr QListQStringConst -> HoppyF.Ptr M52.QStringConst -> HoppyP.IO HoppyFHR.CBool
foreign import ccall "genpop__QListQString_first" first' ::  HoppyF.Ptr QListQString -> HoppyP.IO (HoppyF.Ptr M52.QString)
foreign import ccall "genpop__QListQString_firstConst" firstConst' ::  HoppyF.Ptr QListQStringConst -> HoppyP.IO (HoppyF.Ptr M52.QStringConst)
foreign import ccall "genpop__QListQString_get" get' ::  HoppyF.Ptr QListQStringConst -> HoppyFC.CInt -> HoppyP.IO (HoppyF.Ptr M52.QStringConst)
foreign import ccall "genpop__QListQString_indexOf" indexOf' ::  HoppyF.Ptr QListQStringConst -> HoppyF.Ptr M52.QStringConst -> HoppyP.IO HoppyFC.CInt
foreign import ccall "genpop__QListQString_indexOfFrom" indexOfFrom' ::  HoppyF.Ptr QListQStringConst -> HoppyF.Ptr M52.QStringConst -> HoppyFC.CInt -> HoppyP.IO HoppyFC.CInt
foreign import ccall "genpop__QListQString_insert" insert' ::  HoppyF.Ptr QListQString -> HoppyFC.CInt -> HoppyF.Ptr M52.QStringConst -> HoppyP.IO ()
foreign import ccall "genpop__QListQString_isEmpty" isEmpty' ::  HoppyF.Ptr QListQStringConst -> HoppyP.IO HoppyFHR.CBool
foreign import ccall "genpop__QListQString_last" last' ::  HoppyF.Ptr QListQString -> HoppyP.IO (HoppyF.Ptr M52.QString)
foreign import ccall "genpop__QListQString_lastConst" lastConst' ::  HoppyF.Ptr QListQStringConst -> HoppyP.IO (HoppyF.Ptr M52.QStringConst)
foreign import ccall "genpop__QListQString_lastIndexOf" lastIndexOf' ::  HoppyF.Ptr QListQStringConst -> HoppyF.Ptr M52.QStringConst -> HoppyP.IO HoppyFC.CInt
foreign import ccall "genpop__QListQString_lastIndexOfFrom" lastIndexOfFrom' ::  HoppyF.Ptr QListQStringConst -> HoppyF.Ptr M52.QStringConst -> HoppyFC.CInt -> HoppyP.IO HoppyFC.CInt
...
foreign import ccall "genpop__QListQString_prepend" prepend' ::  HoppyF.Ptr QListQString -> HoppyF.Ptr M52.QStringConst -> HoppyP.IO ()
foreign import ccall "genpop__QListQString_removeAll" removeAll' ::  HoppyF.Ptr QListQString -> HoppyF.Ptr M52.QStringConst -> HoppyP.IO HoppyFC.CInt
...
foreign import ccall "genpop__QListQString_removeOne" removeOne' ::  HoppyF.Ptr QListQString -> HoppyF.Ptr M52.QStringConst -> HoppyP.IO HoppyFHR.CBool
foreign import ccall "genpop__QListQString_replace" replace' ::  HoppyF.Ptr QListQString -> HoppyFC.CInt -> HoppyF.Ptr M52.QStringConst -> HoppyP.IO ()
...
foreign import ccall "genpop__QListQString_startsWith" startsWith' ::  HoppyF.Ptr QListQStringConst -> HoppyF.Ptr M52.QStringConst -> HoppyP.IO HoppyFHR.CBool
foreign import ccall "genpop__QListQString_swap" swap' ::  HoppyF.Ptr QListQString -> HoppyFC.CInt -> HoppyFC.CInt -> HoppyP.IO ()
foreign import ccall "genpop__QListQString_takeAt" takeAt' ::  HoppyF.Ptr QListQString -> HoppyFC.CInt -> HoppyP.IO (HoppyF.Ptr M52.QStringConst)
foreign import ccall "genpop__QListQString_takeFirst" takeFirst' ::  HoppyF.Ptr QListQString -> HoppyP.IO (HoppyF.Ptr M52.QStringConst)
foreign import ccall "genpop__QListQString_takeLast" takeLast' ::  HoppyF.Ptr QListQString -> HoppyP.IO (HoppyF.Ptr M52.QStringConst)
foreign import ccall "genpop__QListQString_value" value' ::  HoppyF.Ptr QListQStringConst -> HoppyFC.CInt -> HoppyP.IO (HoppyF.Ptr M52.QStringConst)
foreign import ccall "genpop__QListQString_valueOr" valueOr' ::  HoppyF.Ptr QListQStringConst -> HoppyFC.CInt -> HoppyF.Ptr M52.QStringConst -> HoppyP.IO (HoppyF.Ptr M52.QStringConst)
...
atConst :: (QListQStringValue arg'1) => arg'1 -> HoppyP.Int -> HoppyP.IO M52.QStringConst
atConst arg'1 arg'2 =
  withQListQStringPtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
  let arg'2' = HoppyFHR.coerceIntegral arg'2 in
  HoppyP.fmap M52.QStringConst
  (atConst' arg'1' arg'2')

contains :: (QListQStringValue arg'1, M52.QStringValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO HoppyP.Bool
...
count :: (QListQStringValue arg'1, M52.QStringValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO HoppyP.Int
count arg'1 arg'2 =
  withQListQStringPtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
  M52.withQStringPtr arg'2 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'2' ->
...
endsWith :: (QListQStringValue arg'1, M52.QStringValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO HoppyP.Bool
...
firstConst :: (QListQStringValue arg'1) => arg'1 -> HoppyP.IO M52.QStringConst
firstConst arg'1 =
  withQListQStringPtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
  HoppyP.fmap M52.QStringConst
  (firstConst' arg'1')
...
indexOf :: (QListQStringValue arg'1, M52.QStringValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO HoppyP.Int
indexOf arg'1 arg'2 =
  withQListQStringPtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
  M52.withQStringPtr arg'2 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'2' ->
  HoppyP.fmap HoppyFHR.coerceIntegral
...
indexOfFrom :: (QListQStringValue arg'1, M52.QStringValue arg'2) => arg'1 -> arg'2 -> HoppyP.Int -> HoppyP.IO HoppyP.Int
...
lastConst :: (QListQStringValue arg'1) => arg'1 -> HoppyP.IO M52.QStringConst
lastConst arg'1 =
  withQListQStringPtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
  HoppyP.fmap M52.QStringConst
  (lastConst' arg'1')

lastIndexOf :: (QListQStringValue arg'1, M52.QStringValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO HoppyP.Int
...
lastIndexOfFrom :: (QListQStringValue arg'1, M52.QStringValue arg'2) => arg'1 -> arg'2 -> HoppyP.Int -> HoppyP.IO HoppyP.Int
...
startsWith :: (QListQStringValue arg'1, M52.QStringValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO HoppyP.Bool
...
valueOr :: (QListQStringValue arg'1, M52.QStringValue arg'3) => arg'1 -> HoppyP.Int -> arg'3 -> HoppyP.IO QtahP.String
...
append :: (QListQStringPtr arg'1, M52.QStringValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO ()
append arg'1 arg'2 =
...
at :: (QListQStringPtr arg'1) => arg'1 -> HoppyP.Int -> HoppyP.IO M52.QString
at arg'1 arg'2 =
  HoppyFHR.withCppPtr (toQListQString arg'1) $ \arg'1' ->
  let arg'2' = HoppyFHR.coerceIntegral arg'2 in
  HoppyP.fmap M52.QString
  (at' arg'1' arg'2')
...
first :: (QListQStringPtr arg'1) => arg'1 -> HoppyP.IO M52.QString
first arg'1 =
  HoppyFHR.withCppPtr (toQListQString arg'1) $ \arg'1' ->
  HoppyP.fmap M52.QString
  (first' arg'1')

insert :: (QListQStringPtr arg'1, M52.QStringValue arg'3) => arg'1 -> HoppyP.Int -> arg'3 -> HoppyP.IO ()
...
last :: (QListQStringPtr arg'1) => arg'1 -> HoppyP.IO M52.QString
last arg'1 =
  HoppyFHR.withCppPtr (toQListQString arg'1) $ \arg'1' ->
  HoppyP.fmap M52.QString
  (last' arg'1')
...
prepend :: (QListQStringPtr arg'1, M52.QStringValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO ()
prepend arg'1 arg'2 =
  HoppyFHR.withCppPtr (toQListQString arg'1) $ \arg'1' ->
  M52.withQStringPtr arg'2 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'2' ->
  (prepend' arg'1' arg'2')

removeAll :: (QListQStringPtr arg'1, M52.QStringValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO HoppyP.Int
...
removeOne :: (QListQStringPtr arg'1, M52.QStringValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO HoppyP.Bool
...
replace :: (QListQStringPtr arg'1, M52.QStringValue arg'3) => arg'1 -> HoppyP.Int -> arg'3 -> HoppyP.IO ()
