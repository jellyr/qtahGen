...
#if MIN_VERSION_base(4,8,0)
instance {-# OVERLAPPING #-} QListQAbstractButtonValue ([M184.QAbstractButton])
#else
instance QListQAbstractButtonValue ([M184.QAbstractButton])
#endif
...
instance HoppyFHR.Encodable QListQAbstractButton (([M184.QAbstractButton]))
instance HoppyFHR.Encodable QListQAbstractButtonConst (([M184.QAbstractButton]))

instance HoppyFHR.Decodable QListQAbstractButton (([M184.QAbstractButton]))
instance HoppyFHR.Decodable QListQAbstractButtonConst (([M184.QAbstractButton]))