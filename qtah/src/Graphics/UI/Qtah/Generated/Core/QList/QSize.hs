...
foreign import ccall "genpop__QListQSize_append" append' ::  HoppyF.Ptr QListQSize -> HoppyF.Ptr M48.QSizeConst -> HoppyP.IO ()
foreign import ccall "genpop__QListQSize_appendList" appendList' ::  HoppyF.Ptr QListQSize -> HoppyF.Ptr QListQSizeConst -> HoppyP.IO ()
foreign import ccall "genpop__QListQSize_at" at' ::  HoppyF.Ptr QListQSize -> HoppyFC.CInt -> HoppyP.IO (HoppyF.Ptr M48.QSize)
foreign import ccall "genpop__QListQSize_atConst" atConst' ::  HoppyF.Ptr QListQSizeConst -> HoppyFC.CInt -> HoppyP.IO (HoppyF.Ptr M48.QSizeConst)
foreign import ccall "genpop__QListQSize_clear" clear' ::  HoppyF.Ptr QListQSize -> HoppyP.IO ()
foreign import ccall "genpop__QListQSize_contains" contains' ::  HoppyF.Ptr QListQSizeConst -> HoppyF.Ptr M48.QSizeConst -> HoppyP.IO HoppyFHR.CBool
foreign import ccall "genpop__QListQSize_count" count' ::  HoppyF.Ptr QListQSizeConst -> HoppyF.Ptr M48.QSizeConst -> HoppyP.IO HoppyFC.CInt
foreign import ccall "genpop__QListQSize_endsWith" endsWith' ::  HoppyF.Ptr QListQSizeConst -> HoppyF.Ptr M48.QSizeConst -> HoppyP.IO HoppyFHR.CBool
foreign import ccall "genpop__QListQSize_first" first' ::  HoppyF.Ptr QListQSize -> HoppyP.IO (HoppyF.Ptr M48.QSize)
foreign import ccall "genpop__QListQSize_firstConst" firstConst' ::  HoppyF.Ptr QListQSizeConst -> HoppyP.IO (HoppyF.Ptr M48.QSizeConst)
foreign import ccall "genpop__QListQSize_get" get' ::  HoppyF.Ptr QListQSizeConst -> HoppyFC.CInt -> HoppyP.IO (HoppyF.Ptr M48.QSizeConst)
foreign import ccall "genpop__QListQSize_indexOf" indexOf' ::  HoppyF.Ptr QListQSizeConst -> HoppyF.Ptr M48.QSizeConst -> HoppyP.IO HoppyFC.CInt
foreign import ccall "genpop__QListQSize_indexOfFrom" indexOfFrom' ::  HoppyF.Ptr QListQSizeConst -> HoppyF.Ptr M48.QSizeConst -> HoppyFC.CInt -> HoppyP.IO HoppyFC.CInt
foreign import ccall "genpop__QListQSize_insert" insert' ::  HoppyF.Ptr QListQSize -> HoppyFC.CInt -> HoppyF.Ptr M48.QSizeConst -> HoppyP.IO ()
foreign import ccall "genpop__QListQSize_isEmpty" isEmpty' ::  HoppyF.Ptr QListQSizeConst -> HoppyP.IO HoppyFHR.CBool
foreign import ccall "genpop__QListQSize_last" last' ::  HoppyF.Ptr QListQSize -> HoppyP.IO (HoppyF.Ptr M48.QSize)
foreign import ccall "genpop__QListQSize_lastConst" lastConst' ::  HoppyF.Ptr QListQSizeConst -> HoppyP.IO (HoppyF.Ptr M48.QSizeConst)
foreign import ccall "genpop__QListQSize_lastIndexOf" lastIndexOf' ::  HoppyF.Ptr QListQSizeConst -> HoppyF.Ptr M48.QSizeConst -> HoppyP.IO HoppyFC.CInt
foreign import ccall "genpop__QListQSize_lastIndexOfFrom" lastIndexOfFrom' ::  HoppyF.Ptr QListQSizeConst -> HoppyF.Ptr M48.QSizeConst -> HoppyFC.CInt -> HoppyP.IO HoppyFC.CInt
...
foreign import ccall "genpop__QListQSize_prepend" prepend' ::  HoppyF.Ptr QListQSize -> HoppyF.Ptr M48.QSizeConst -> HoppyP.IO ()
foreign import ccall "genpop__QListQSize_removeAll" removeAll' ::  HoppyF.Ptr QListQSize -> HoppyF.Ptr M48.QSizeConst -> HoppyP.IO HoppyFC.CInt
...
foreign import ccall "genpop__QListQSize_removeOne" removeOne' ::  HoppyF.Ptr QListQSize -> HoppyF.Ptr M48.QSizeConst -> HoppyP.IO HoppyFHR.CBool
foreign import ccall "genpop__QListQSize_replace" replace' ::  HoppyF.Ptr QListQSize -> HoppyFC.CInt -> HoppyF.Ptr M48.QSizeConst -> HoppyP.IO ()
...
foreign import ccall "genpop__QListQSize_startsWith" startsWith' ::  HoppyF.Ptr QListQSizeConst -> HoppyF.Ptr M48.QSizeConst -> HoppyP.IO HoppyFHR.CBool
foreign import ccall "genpop__QListQSize_swap" swap' ::  HoppyF.Ptr QListQSize -> HoppyFC.CInt -> HoppyFC.CInt -> HoppyP.IO ()
foreign import ccall "genpop__QListQSize_takeAt" takeAt' ::  HoppyF.Ptr QListQSize -> HoppyFC.CInt -> HoppyP.IO (HoppyF.Ptr M48.QSizeConst)
foreign import ccall "genpop__QListQSize_takeFirst" takeFirst' ::  HoppyF.Ptr QListQSize -> HoppyP.IO (HoppyF.Ptr M48.QSizeConst)
foreign import ccall "genpop__QListQSize_takeLast" takeLast' ::  HoppyF.Ptr QListQSize -> HoppyP.IO (HoppyF.Ptr M48.QSizeConst)
foreign import ccall "genpop__QListQSize_value" value' ::  HoppyF.Ptr QListQSizeConst -> HoppyFC.CInt -> HoppyP.IO (HoppyF.Ptr M48.QSizeConst)
foreign import ccall "genpop__QListQSize_valueOr" valueOr' ::  HoppyF.Ptr QListQSizeConst -> HoppyFC.CInt -> HoppyF.Ptr M48.QSizeConst -> HoppyP.IO (HoppyF.Ptr M48.QSizeConst)
...
atConst :: (QListQSizeValue arg'1) => arg'1 -> HoppyP.Int -> HoppyP.IO M48.QSizeConst
atConst arg'1 arg'2 =
  withQListQSizePtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
  let arg'2' = HoppyFHR.coerceIntegral arg'2 in
  HoppyP.fmap M48.QSizeConst
  (atConst' arg'1' arg'2')

contains :: (QListQSizeValue arg'1, M48.QSizeValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO HoppyP.Bool
...
count :: (QListQSizeValue arg'1, M48.QSizeValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO HoppyP.Int
count arg'1 arg'2 =
  withQListQSizePtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
  M48.withQSizePtr arg'2 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'2' ->
...
endsWith :: (QListQSizeValue arg'1, M48.QSizeValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO HoppyP.Bool
...
firstConst :: (QListQSizeValue arg'1) => arg'1 -> HoppyP.IO M48.QSizeConst
firstConst arg'1 =
  withQListQSizePtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
  HoppyP.fmap M48.QSizeConst
  (firstConst' arg'1')
...
indexOf :: (QListQSizeValue arg'1, M48.QSizeValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO HoppyP.Int
indexOf arg'1 arg'2 =
  withQListQSizePtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
  M48.withQSizePtr arg'2 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'2' ->
  HoppyP.fmap HoppyFHR.coerceIntegral
...
indexOfFrom :: (QListQSizeValue arg'1, M48.QSizeValue arg'2) => arg'1 -> arg'2 -> HoppyP.Int -> HoppyP.IO HoppyP.Int
...
lastConst :: (QListQSizeValue arg'1) => arg'1 -> HoppyP.IO M48.QSizeConst
lastConst arg'1 =
  withQListQSizePtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
  HoppyP.fmap M48.QSizeConst
  (lastConst' arg'1')

lastIndexOf :: (QListQSizeValue arg'1, M48.QSizeValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO HoppyP.Int
...
lastIndexOfFrom :: (QListQSizeValue arg'1, M48.QSizeValue arg'2) => arg'1 -> arg'2 -> HoppyP.Int -> HoppyP.IO HoppyP.Int
...
startsWith :: (QListQSizeValue arg'1, M48.QSizeValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO HoppyP.Bool
...
valueOr :: (QListQSizeValue arg'1, M48.QSizeValue arg'3) => arg'1 -> HoppyP.Int -> arg'3 -> HoppyP.IO HSize.HSize
...
append :: (QListQSizePtr arg'1, M48.QSizeValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO ()
append arg'1 arg'2 =
...
at :: (QListQSizePtr arg'1) => arg'1 -> HoppyP.Int -> HoppyP.IO M48.QSize
at arg'1 arg'2 =
  HoppyFHR.withCppPtr (toQListQSize arg'1) $ \arg'1' ->
  let arg'2' = HoppyFHR.coerceIntegral arg'2 in
  HoppyP.fmap M48.QSize
  (at' arg'1' arg'2')
...
first :: (QListQSizePtr arg'1) => arg'1 -> HoppyP.IO M48.QSize
first arg'1 =
  HoppyFHR.withCppPtr (toQListQSize arg'1) $ \arg'1' ->
  HoppyP.fmap M48.QSize
  (first' arg'1')

insert :: (QListQSizePtr arg'1, M48.QSizeValue arg'3) => arg'1 -> HoppyP.Int -> arg'3 -> HoppyP.IO ()
...
last :: (QListQSizePtr arg'1) => arg'1 -> HoppyP.IO M48.QSize
last arg'1 =
  HoppyFHR.withCppPtr (toQListQSize arg'1) $ \arg'1' ->
  HoppyP.fmap M48.QSize
  (last' arg'1')
...
prepend :: (QListQSizePtr arg'1, M48.QSizeValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO ()
prepend arg'1 arg'2 =
  HoppyFHR.withCppPtr (toQListQSize arg'1) $ \arg'1' ->
  M48.withQSizePtr arg'2 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'2' ->
  (prepend' arg'1' arg'2')

removeAll :: (QListQSizePtr arg'1, M48.QSizeValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO HoppyP.Int
...
removeOne :: (QListQSizePtr arg'1, M48.QSizeValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO HoppyP.Bool
...
replace :: (QListQSizePtr arg'1, M48.QSizeValue arg'3) => arg'1 -> HoppyP.Int -> arg'3 -> HoppyP.IO ()
