...
foreign import ccall "genpop__QListQStandardItem_append" append' ::  HoppyF.Ptr QListQStandardItem -> HoppyF.Ptr M160.QStandardItem -> HoppyP.IO ()
...
foreign import ccall "genpop__QListQStandardItem_at" at' ::  HoppyF.Ptr QListQStandardItem -> HoppyFC.CInt -> HoppyP.IO (HoppyF.Ptr (HoppyF.Ptr M160.QStandardItem))
foreign import ccall "genpop__QListQStandardItem_atConst" atConst' ::  HoppyF.Ptr QListQStandardItemConst -> HoppyFC.CInt -> HoppyP.IO (HoppyF.Ptr (HoppyF.Ptr M160.QStandardItem))
foreign import ccall "genpop__QListQStandardItem_clear" clear' ::  HoppyF.Ptr QListQStandardItem -> HoppyP.IO ()
foreign import ccall "genpop__QListQStandardItem_contains" contains' ::  HoppyF.Ptr QListQStandardItemConst -> HoppyF.Ptr M160.QStandardItem -> HoppyP.IO HoppyFHR.CBool
foreign import ccall "genpop__QListQStandardItem_count" count' ::  HoppyF.Ptr QListQStandardItemConst -> HoppyF.Ptr M160.QStandardItem -> HoppyP.IO HoppyFC.CInt
foreign import ccall "genpop__QListQStandardItem_endsWith" endsWith' ::  HoppyF.Ptr QListQStandardItemConst -> HoppyF.Ptr M160.QStandardItem -> HoppyP.IO HoppyFHR.CBool
foreign import ccall "genpop__QListQStandardItem_first" first' ::  HoppyF.Ptr QListQStandardItem -> HoppyP.IO (HoppyF.Ptr (HoppyF.Ptr M160.QStandardItem))
foreign import ccall "genpop__QListQStandardItem_firstConst" firstConst' ::  HoppyF.Ptr QListQStandardItemConst -> HoppyP.IO (HoppyF.Ptr (HoppyF.Ptr M160.QStandardItem))
foreign import ccall "genpop__QListQStandardItem_get" get' ::  HoppyF.Ptr QListQStandardItemConst -> HoppyFC.CInt -> HoppyP.IO (HoppyF.Ptr M160.QStandardItem)
foreign import ccall "genpop__QListQStandardItem_indexOf" indexOf' ::  HoppyF.Ptr QListQStandardItemConst -> HoppyF.Ptr M160.QStandardItem -> HoppyP.IO HoppyFC.CInt
foreign import ccall "genpop__QListQStandardItem_indexOfFrom" indexOfFrom' ::  HoppyF.Ptr QListQStandardItemConst -> HoppyF.Ptr M160.QStandardItem -> HoppyFC.CInt -> HoppyP.IO HoppyFC.CInt
foreign import ccall "genpop__QListQStandardItem_insert" insert' ::  HoppyF.Ptr QListQStandardItem -> HoppyFC.CInt -> HoppyF.Ptr M160.QStandardItem -> HoppyP.IO ()
...
foreign import ccall "genpop__QListQStandardItem_last" last' ::  HoppyF.Ptr QListQStandardItem -> HoppyP.IO (HoppyF.Ptr (HoppyF.Ptr M160.QStandardItem))
foreign import ccall "genpop__QListQStandardItem_lastConst" lastConst' ::  HoppyF.Ptr QListQStandardItemConst -> HoppyP.IO (HoppyF.Ptr (HoppyF.Ptr M160.QStandardItem))
foreign import ccall "genpop__QListQStandardItem_lastIndexOf" lastIndexOf' ::  HoppyF.Ptr QListQStandardItemConst -> HoppyF.Ptr M160.QStandardItem -> HoppyP.IO HoppyFC.CInt
foreign import ccall "genpop__QListQStandardItem_lastIndexOfFrom" lastIndexOfFrom' ::  HoppyF.Ptr QListQStandardItemConst -> HoppyF.Ptr M160.QStandardItem -> HoppyFC.CInt -> HoppyP.IO HoppyFC.CInt
...
foreign import ccall "genpop__QListQStandardItem_prepend" prepend' ::  HoppyF.Ptr QListQStandardItem -> HoppyF.Ptr M160.QStandardItem -> HoppyP.IO ()
foreign import ccall "genpop__QListQStandardItem_removeAll" removeAll' ::  HoppyF.Ptr QListQStandardItem -> HoppyF.Ptr M160.QStandardItem -> HoppyP.IO HoppyFC.CInt
...
foreign import ccall "genpop__QListQStandardItem_removeOne" removeOne' ::  HoppyF.Ptr QListQStandardItem -> HoppyF.Ptr M160.QStandardItem -> HoppyP.IO HoppyFHR.CBool
foreign import ccall "genpop__QListQStandardItem_replace" replace' ::  HoppyF.Ptr QListQStandardItem -> HoppyFC.CInt -> HoppyF.Ptr M160.QStandardItem -> HoppyP.IO ()
...
foreign import ccall "genpop__QListQStandardItem_startsWith" startsWith' ::  HoppyF.Ptr QListQStandardItemConst -> HoppyF.Ptr M160.QStandardItem -> HoppyP.IO HoppyFHR.CBool
...
foreign import ccall "genpop__QListQStandardItem_takeAt" takeAt' ::  HoppyF.Ptr QListQStandardItem -> HoppyFC.CInt -> HoppyP.IO (HoppyF.Ptr M160.QStandardItem)
foreign import ccall "genpop__QListQStandardItem_takeFirst" takeFirst' ::  HoppyF.Ptr QListQStandardItem -> HoppyP.IO (HoppyF.Ptr M160.QStandardItem)
foreign import ccall "genpop__QListQStandardItem_takeLast" takeLast' ::  HoppyF.Ptr QListQStandardItem -> HoppyP.IO (HoppyF.Ptr M160.QStandardItem)
foreign import ccall "genpop__QListQStandardItem_value" value' ::  HoppyF.Ptr QListQStandardItemConst -> HoppyFC.CInt -> HoppyP.IO (HoppyF.Ptr M160.QStandardItem)
foreign import ccall "genpop__QListQStandardItem_valueOr" valueOr' ::  HoppyF.Ptr QListQStandardItemConst -> HoppyFC.CInt -> HoppyF.Ptr M160.QStandardItem -> HoppyP.IO (HoppyF.Ptr M160.QStandardItem)
...
#if MIN_VERSION_base(4,8,0)
instance {-# OVERLAPPING #-} QListQStandardItemValue ([M160.QStandardItem]) where
#else
instance QListQStandardItemValue ([M160.QStandardItem]) where
#endif
...
atConst :: (QListQStandardItemValue arg'1) => arg'1 -> HoppyP.Int -> HoppyP.IO (HoppyF.Ptr (HoppyF.Ptr M160.QStandardItem))
atConst arg'1 arg'2 =
  withQListQStandardItemPtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
  let arg'2' = HoppyFHR.coerceIntegral arg'2 in
  (atConst' arg'1' arg'2')

contains :: (QListQStandardItemValue arg'1, M160.QStandardItemPtr arg'2) => arg'1 -> arg'2 -> HoppyP.IO HoppyP.Bool
...
count :: (QListQStandardItemValue arg'1, M160.QStandardItemPtr arg'2) => arg'1 -> arg'2 -> HoppyP.IO HoppyP.Int
count arg'1 arg'2 =
  withQListQStandardItemPtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
  HoppyFHR.withCppPtr (M160.toQStandardItem arg'2) $ \arg'2' ->
...
endsWith :: (QListQStandardItemValue arg'1, M160.QStandardItemPtr arg'2) => arg'1 -> arg'2 -> HoppyP.IO HoppyP.Bool
...
firstConst :: (QListQStandardItemValue arg'1) => arg'1 -> HoppyP.IO (HoppyF.Ptr (HoppyF.Ptr M160.QStandardItem))
firstConst arg'1 =
  withQListQStandardItemPtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
  (firstConst' arg'1')

get :: (QListQStandardItemValue arg'1) => arg'1 -> HoppyP.Int -> HoppyP.IO M160.QStandardItem
get arg'1 arg'2 =
  withQListQStandardItemPtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
  let arg'2' = HoppyFHR.coerceIntegral arg'2 in
...
indexOf :: (QListQStandardItemValue arg'1, M160.QStandardItemPtr arg'2) => arg'1 -> arg'2 -> HoppyP.IO HoppyP.Int
indexOf arg'1 arg'2 =
  withQListQStandardItemPtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
  HoppyFHR.withCppPtr (M160.toQStandardItem arg'2) $ \arg'2' ->
  HoppyP.fmap HoppyFHR.coerceIntegral
...
indexOfFrom :: (QListQStandardItemValue arg'1, M160.QStandardItemPtr arg'2) => arg'1 -> arg'2 -> HoppyP.Int -> HoppyP.IO HoppyP.Int
...
lastConst :: (QListQStandardItemValue arg'1) => arg'1 -> HoppyP.IO (HoppyF.Ptr (HoppyF.Ptr M160.QStandardItem))
lastConst arg'1 =
  withQListQStandardItemPtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
  (lastConst' arg'1')

lastIndexOf :: (QListQStandardItemValue arg'1, M160.QStandardItemPtr arg'2) => arg'1 -> arg'2 -> HoppyP.IO HoppyP.Int
...
lastIndexOfFrom :: (QListQStandardItemValue arg'1, M160.QStandardItemPtr arg'2) => arg'1 -> arg'2 -> HoppyP.Int -> HoppyP.IO HoppyP.Int
...
startsWith :: (QListQStandardItemValue arg'1, M160.QStandardItemPtr arg'2) => arg'1 -> arg'2 -> HoppyP.IO HoppyP.Bool
...
value :: (QListQStandardItemValue arg'1) => arg'1 -> HoppyP.Int -> HoppyP.IO M160.QStandardItem
value arg'1 arg'2 =
  withQListQStandardItemPtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
  let arg'2' = HoppyFHR.coerceIntegral arg'2 in
  HoppyP.fmap M160.QStandardItem
...
valueOr :: (QListQStandardItemValue arg'1, M160.QStandardItemPtr arg'3) => arg'1 -> HoppyP.Int -> arg'3 -> HoppyP.IO M160.QStandardItem
...
append :: (QListQStandardItemPtr arg'1, M160.QStandardItemPtr arg'2) => arg'1 -> arg'2 -> HoppyP.IO ()
append arg'1 arg'2 =
...
at :: (QListQStandardItemPtr arg'1) => arg'1 -> HoppyP.Int -> HoppyP.IO (HoppyF.Ptr (HoppyF.Ptr M160.QStandardItem))
at arg'1 arg'2 =
  HoppyFHR.withCppPtr (toQListQStandardItem arg'1) $ \arg'1' ->
  let arg'2' = HoppyFHR.coerceIntegral arg'2 in
  (at' arg'1' arg'2')
...
first :: (QListQStandardItemPtr arg'1) => arg'1 -> HoppyP.IO (HoppyF.Ptr (HoppyF.Ptr M160.QStandardItem))
first arg'1 =
  HoppyFHR.withCppPtr (toQListQStandardItem arg'1) $ \arg'1' ->
  (first' arg'1')

insert :: (QListQStandardItemPtr arg'1, M160.QStandardItemPtr arg'3) => arg'1 -> HoppyP.Int -> arg'3 -> HoppyP.IO ()
...
last :: (QListQStandardItemPtr arg'1) => arg'1 -> HoppyP.IO (HoppyF.Ptr (HoppyF.Ptr M160.QStandardItem))
last arg'1 =
  HoppyFHR.withCppPtr (toQListQStandardItem arg'1) $ \arg'1' ->
  (last' arg'1')
...
prepend :: (QListQStandardItemPtr arg'1, M160.QStandardItemPtr arg'2) => arg'1 -> arg'2 -> HoppyP.IO ()
prepend arg'1 arg'2 =
  HoppyFHR.withCppPtr (toQListQStandardItem arg'1) $ \arg'1' ->
  HoppyFHR.withCppPtr (M160.toQStandardItem arg'2) $ \arg'2' ->
  (prepend' arg'1' arg'2')

removeAll :: (QListQStandardItemPtr arg'1, M160.QStandardItemPtr arg'2) => arg'1 -> arg'2 -> HoppyP.IO HoppyP.Int
...
removeOne :: (QListQStandardItemPtr arg'1, M160.QStandardItemPtr arg'2) => arg'1 -> arg'2 -> HoppyP.IO HoppyP.Bool
...
replace :: (QListQStandardItemPtr arg'1, M160.QStandardItemPtr arg'3) => arg'1 -> HoppyP.Int -> arg'3 -> HoppyP.IO ()
...
takeAt :: (QListQStandardItemPtr arg'1) => arg'1 -> HoppyP.Int -> HoppyP.IO M160.QStandardItem
takeAt arg'1 arg'2 =
  HoppyFHR.withCppPtr (toQListQStandardItem arg'1) $ \arg'1' ->
  let arg'2' = HoppyFHR.coerceIntegral arg'2 in
  HoppyP.fmap M160.QStandardItem
...
takeFirst :: (QListQStandardItemPtr arg'1) => arg'1 -> HoppyP.IO M160.QStandardItem
takeFirst arg'1 =
  HoppyFHR.withCppPtr (toQListQStandardItem arg'1) $ \arg'1' ->
  HoppyP.fmap M160.QStandardItem
  (takeFirst' arg'1')

takeLast :: (QListQStandardItemPtr arg'1) => arg'1 -> HoppyP.IO M160.QStandardItem
takeLast arg'1 =
  HoppyFHR.withCppPtr (toQListQStandardItem arg'1) $ \arg'1' ->
  HoppyP.fmap M160.QStandardItem
  (takeLast' arg'1')
...
instance HoppyFHR.Encodable QListQStandardItem ([M160.QStandardItem]) where
  encode =
    QtahFHR.fromContents

instance HoppyFHR.Encodable QListQStandardItemConst ([M160.QStandardItem]) where
  encode = HoppyP.fmap (toQListQStandardItemConst) . HoppyFHR.encodeAs (HoppyP.undefined :: QListQStandardItem)

instance HoppyFHR.Decodable QListQStandardItem ([M160.QStandardItem]) where
  decode = HoppyFHR.decode . toQListQStandardItemConst

instance HoppyFHR.Decodable QListQStandardItemConst ([M160.QStandardItem]) where
  decode =
    QtahFHR.toContents

instance QtahFHR.HasContents QListQStandardItemConst (M160.QStandardItem) where
  toContents this' = do
    size' <- size this'
    QtahP.mapM (QtahFHR.decode <=< atConst this') [0..size'-1]

instance QtahFHR.HasContents QListQStandardItem (M160.QStandardItem) where
  toContents this' = do
    size' <- size this'
    QtahP.mapM (QtahFHR.decode <=< at this') [0..size'-1]

instance QtahFHR.FromContents QListQStandardItem (M160.QStandardItem) where
