...
#if MIN_VERSION_base(4,8,0)
instance {-# OVERLAPPING #-} QListQStandardItemValue ([M160.QStandardItem])
#else
instance QListQStandardItemValue ([M160.QStandardItem])
#endif
...
instance HoppyFHR.Encodable QListQStandardItem (([M160.QStandardItem]))
instance HoppyFHR.Encodable QListQStandardItemConst (([M160.QStandardItem]))

instance HoppyFHR.Decodable QListQStandardItem (([M160.QStandardItem]))
instance HoppyFHR.Decodable QListQStandardItemConst (([M160.QStandardItem]))