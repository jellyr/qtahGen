...
foreign import ccall "genpop__QListQVariant_append" append' ::  HoppyF.Ptr QListQVariant -> HoppyF.Ptr M64.QVariantConst -> HoppyP.IO ()
...
foreign import ccall "genpop__QListQVariant_at" at' ::  HoppyF.Ptr QListQVariant -> HoppyFC.CInt -> HoppyP.IO (HoppyF.Ptr M64.QVariant)
foreign import ccall "genpop__QListQVariant_atConst" atConst' ::  HoppyF.Ptr QListQVariantConst -> HoppyFC.CInt -> HoppyP.IO (HoppyF.Ptr M64.QVariantConst)
foreign import ccall "genpop__QListQVariant_clear" clear' ::  HoppyF.Ptr QListQVariant -> HoppyP.IO ()
foreign import ccall "genpop__QListQVariant_contains" contains' ::  HoppyF.Ptr QListQVariantConst -> HoppyF.Ptr M64.QVariantConst -> HoppyP.IO HoppyFHR.CBool
foreign import ccall "genpop__QListQVariant_count" count' ::  HoppyF.Ptr QListQVariantConst -> HoppyF.Ptr M64.QVariantConst -> HoppyP.IO HoppyFC.CInt
foreign import ccall "genpop__QListQVariant_endsWith" endsWith' ::  HoppyF.Ptr QListQVariantConst -> HoppyF.Ptr M64.QVariantConst -> HoppyP.IO HoppyFHR.CBool
foreign import ccall "genpop__QListQVariant_first" first' ::  HoppyF.Ptr QListQVariant -> HoppyP.IO (HoppyF.Ptr M64.QVariant)
foreign import ccall "genpop__QListQVariant_firstConst" firstConst' ::  HoppyF.Ptr QListQVariantConst -> HoppyP.IO (HoppyF.Ptr M64.QVariantConst)
foreign import ccall "genpop__QListQVariant_get" get' ::  HoppyF.Ptr QListQVariantConst -> HoppyFC.CInt -> HoppyP.IO (HoppyF.Ptr M64.QVariantConst)
foreign import ccall "genpop__QListQVariant_indexOf" indexOf' ::  HoppyF.Ptr QListQVariantConst -> HoppyF.Ptr M64.QVariantConst -> HoppyP.IO HoppyFC.CInt
foreign import ccall "genpop__QListQVariant_indexOfFrom" indexOfFrom' ::  HoppyF.Ptr QListQVariantConst -> HoppyF.Ptr M64.QVariantConst -> HoppyFC.CInt -> HoppyP.IO HoppyFC.CInt
foreign import ccall "genpop__QListQVariant_insert" insert' ::  HoppyF.Ptr QListQVariant -> HoppyFC.CInt -> HoppyF.Ptr M64.QVariantConst -> HoppyP.IO ()
foreign import ccall "genpop__QListQVariant_isEmpty" isEmpty' ::  HoppyF.Ptr QListQVariantConst -> HoppyP.IO HoppyFHR.CBool
foreign import ccall "genpop__QListQVariant_last" last' ::  HoppyF.Ptr QListQVariant -> HoppyP.IO (HoppyF.Ptr M64.QVariant)
foreign import ccall "genpop__QListQVariant_lastConst" lastConst' ::  HoppyF.Ptr QListQVariantConst -> HoppyP.IO (HoppyF.Ptr M64.QVariantConst)
foreign import ccall "genpop__QListQVariant_lastIndexOf" lastIndexOf' ::  HoppyF.Ptr QListQVariantConst -> HoppyF.Ptr M64.QVariantConst -> HoppyP.IO HoppyFC.CInt
foreign import ccall "genpop__QListQVariant_lastIndexOfFrom" lastIndexOfFrom' ::  HoppyF.Ptr QListQVariantConst -> HoppyF.Ptr M64.QVariantConst -> HoppyFC.CInt -> HoppyP.IO HoppyFC.CInt
...
foreign import ccall "genpop__QListQVariant_prepend" prepend' ::  HoppyF.Ptr QListQVariant -> HoppyF.Ptr M64.QVariantConst -> HoppyP.IO ()
foreign import ccall "genpop__QListQVariant_removeAll" removeAll' ::  HoppyF.Ptr QListQVariant -> HoppyF.Ptr M64.QVariantConst -> HoppyP.IO HoppyFC.CInt
...
foreign import ccall "genpop__QListQVariant_removeOne" removeOne' ::  HoppyF.Ptr QListQVariant -> HoppyF.Ptr M64.QVariantConst -> HoppyP.IO HoppyFHR.CBool
foreign import ccall "genpop__QListQVariant_replace" replace' ::  HoppyF.Ptr QListQVariant -> HoppyFC.CInt -> HoppyF.Ptr M64.QVariantConst -> HoppyP.IO ()
...
foreign import ccall "genpop__QListQVariant_startsWith" startsWith' ::  HoppyF.Ptr QListQVariantConst -> HoppyF.Ptr M64.QVariantConst -> HoppyP.IO HoppyFHR.CBool
foreign import ccall "genpop__QListQVariant_swap" swap' ::  HoppyF.Ptr QListQVariant -> HoppyFC.CInt -> HoppyFC.CInt -> HoppyP.IO ()
foreign import ccall "genpop__QListQVariant_takeAt" takeAt' ::  HoppyF.Ptr QListQVariant -> HoppyFC.CInt -> HoppyP.IO (HoppyF.Ptr M64.QVariantConst)
foreign import ccall "genpop__QListQVariant_takeFirst" takeFirst' ::  HoppyF.Ptr QListQVariant -> HoppyP.IO (HoppyF.Ptr M64.QVariantConst)
foreign import ccall "genpop__QListQVariant_takeLast" takeLast' ::  HoppyF.Ptr QListQVariant -> HoppyP.IO (HoppyF.Ptr M64.QVariantConst)
foreign import ccall "genpop__QListQVariant_value" value' ::  HoppyF.Ptr QListQVariantConst -> HoppyFC.CInt -> HoppyP.IO (HoppyF.Ptr M64.QVariantConst)
foreign import ccall "genpop__QListQVariant_valueOr" valueOr' ::  HoppyF.Ptr QListQVariantConst -> HoppyFC.CInt -> HoppyF.Ptr M64.QVariantConst -> HoppyP.IO (HoppyF.Ptr M64.QVariantConst)
...
#if MIN_VERSION_base(4,8,0)
instance {-# OVERLAPPING #-} QListQVariantValue ([M64.QVariant]) where
#else
instance QListQVariantValue ([M64.QVariant]) where
#endif
...
atConst :: (QListQVariantValue arg'1) => arg'1 -> HoppyP.Int -> HoppyP.IO M64.QVariantConst
atConst arg'1 arg'2 =
  withQListQVariantPtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
  let arg'2' = HoppyFHR.coerceIntegral arg'2 in
  HoppyP.fmap M64.QVariantConst
  (atConst' arg'1' arg'2')

contains :: (QListQVariantValue arg'1, M64.QVariantValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO HoppyP.Bool
...
count :: (QListQVariantValue arg'1, M64.QVariantValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO HoppyP.Int
count arg'1 arg'2 =
  withQListQVariantPtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
  M64.withQVariantPtr arg'2 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'2' ->
...
endsWith :: (QListQVariantValue arg'1, M64.QVariantValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO HoppyP.Bool
...
firstConst :: (QListQVariantValue arg'1) => arg'1 -> HoppyP.IO M64.QVariantConst
firstConst arg'1 =
  withQListQVariantPtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
  HoppyP.fmap M64.QVariantConst
  (firstConst' arg'1')

get :: (QListQVariantValue arg'1) => arg'1 -> HoppyP.Int -> HoppyP.IO M64.QVariant
get arg'1 arg'2 =
  withQListQVariantPtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
  let arg'2' = HoppyFHR.coerceIntegral arg'2 in
...
indexOf :: (QListQVariantValue arg'1, M64.QVariantValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO HoppyP.Int
indexOf arg'1 arg'2 =
  withQListQVariantPtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
  M64.withQVariantPtr arg'2 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'2' ->
  HoppyP.fmap HoppyFHR.coerceIntegral
...
indexOfFrom :: (QListQVariantValue arg'1, M64.QVariantValue arg'2) => arg'1 -> arg'2 -> HoppyP.Int -> HoppyP.IO HoppyP.Int
...
lastConst :: (QListQVariantValue arg'1) => arg'1 -> HoppyP.IO M64.QVariantConst
lastConst arg'1 =
  withQListQVariantPtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
  HoppyP.fmap M64.QVariantConst
  (lastConst' arg'1')

lastIndexOf :: (QListQVariantValue arg'1, M64.QVariantValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO HoppyP.Int
...
lastIndexOfFrom :: (QListQVariantValue arg'1, M64.QVariantValue arg'2) => arg'1 -> arg'2 -> HoppyP.Int -> HoppyP.IO HoppyP.Int
...
startsWith :: (QListQVariantValue arg'1, M64.QVariantValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO HoppyP.Bool
...
value :: (QListQVariantValue arg'1) => arg'1 -> HoppyP.Int -> HoppyP.IO M64.QVariant
value arg'1 arg'2 =
  withQListQVariantPtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
  let arg'2' = HoppyFHR.coerceIntegral arg'2 in
  (HoppyFHR.decodeAndDelete . M64.QVariantConst) =<<
...
valueOr :: (QListQVariantValue arg'1, M64.QVariantValue arg'3) => arg'1 -> HoppyP.Int -> arg'3 -> HoppyP.IO M64.QVariant
valueOr arg'1 arg'2 arg'3 =
  withQListQVariantPtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
  let arg'2' = HoppyFHR.coerceIntegral arg'2 in
  M64.withQVariantPtr arg'3 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'3' ->
  (HoppyFHR.decodeAndDelete . M64.QVariantConst) =<<
  (valueOr' arg'1' arg'2' arg'3')
...
append :: (QListQVariantPtr arg'1, M64.QVariantValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO ()
append arg'1 arg'2 =
...
at :: (QListQVariantPtr arg'1) => arg'1 -> HoppyP.Int -> HoppyP.IO M64.QVariant
at arg'1 arg'2 =
  HoppyFHR.withCppPtr (toQListQVariant arg'1) $ \arg'1' ->
  let arg'2' = HoppyFHR.coerceIntegral arg'2 in
  HoppyP.fmap M64.QVariant
  (at' arg'1' arg'2')
...
first :: (QListQVariantPtr arg'1) => arg'1 -> HoppyP.IO M64.QVariant
first arg'1 =
  HoppyFHR.withCppPtr (toQListQVariant arg'1) $ \arg'1' ->
  HoppyP.fmap M64.QVariant
  (first' arg'1')

insert :: (QListQVariantPtr arg'1, M64.QVariantValue arg'3) => arg'1 -> HoppyP.Int -> arg'3 -> HoppyP.IO ()
...
last :: (QListQVariantPtr arg'1) => arg'1 -> HoppyP.IO M64.QVariant
last arg'1 =
  HoppyFHR.withCppPtr (toQListQVariant arg'1) $ \arg'1' ->
  HoppyP.fmap M64.QVariant
  (last' arg'1')
...
prepend :: (QListQVariantPtr arg'1, M64.QVariantValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO ()
prepend arg'1 arg'2 =
  HoppyFHR.withCppPtr (toQListQVariant arg'1) $ \arg'1' ->
  M64.withQVariantPtr arg'2 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'2' ->
  (prepend' arg'1' arg'2')

removeAll :: (QListQVariantPtr arg'1, M64.QVariantValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO HoppyP.Int
...
removeOne :: (QListQVariantPtr arg'1, M64.QVariantValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO HoppyP.Bool
...
replace :: (QListQVariantPtr arg'1, M64.QVariantValue arg'3) => arg'1 -> HoppyP.Int -> arg'3 -> HoppyP.IO ()
...
takeAt :: (QListQVariantPtr arg'1) => arg'1 -> HoppyP.Int -> HoppyP.IO M64.QVariant
takeAt arg'1 arg'2 =
  HoppyFHR.withCppPtr (toQListQVariant arg'1) $ \arg'1' ->
  let arg'2' = HoppyFHR.coerceIntegral arg'2 in
  (HoppyFHR.decodeAndDelete . M64.QVariantConst) =<<
...
takeFirst :: (QListQVariantPtr arg'1) => arg'1 -> HoppyP.IO M64.QVariant
takeFirst arg'1 =
  HoppyFHR.withCppPtr (toQListQVariant arg'1) $ \arg'1' ->
  (HoppyFHR.decodeAndDelete . M64.QVariantConst) =<<
  (takeFirst' arg'1')

takeLast :: (QListQVariantPtr arg'1) => arg'1 -> HoppyP.IO M64.QVariant
takeLast arg'1 =
  HoppyFHR.withCppPtr (toQListQVariant arg'1) $ \arg'1' ->
  (HoppyFHR.decodeAndDelete . M64.QVariantConst) =<<
  (takeLast' arg'1')
...
instance HoppyFHR.Encodable QListQVariant ([M64.QVariant]) where
  encode =
    QtahFHR.fromContents

instance HoppyFHR.Encodable QListQVariantConst ([M64.QVariant]) where
  encode = HoppyP.fmap (toQListQVariantConst) . HoppyFHR.encodeAs (HoppyP.undefined :: QListQVariant)

instance HoppyFHR.Decodable QListQVariant ([M64.QVariant]) where
  decode = HoppyFHR.decode . toQListQVariantConst

instance HoppyFHR.Decodable QListQVariantConst ([M64.QVariant]) where
  decode =
    QtahFHR.toContents

instance QtahFHR.HasContents QListQVariantConst (M64.QVariant) where
  toContents this' = do
    size' <- size this'
    QtahP.mapM (QtahFHR.decode <=< atConst this') [0..size'-1]

instance QtahFHR.HasContents QListQVariant (M64.QVariant) where
  toContents this' = do
    size' <- size this'
    QtahP.mapM (QtahFHR.decode <=< at this') [0..size'-1]

instance QtahFHR.FromContents QListQVariant (M64.QVariant) where
