...
import qualified Graphics.UI.Qtah.Generated.Core.QList.QString as M82
...
foreign import ccall "genpop__QStringList_containsCase" containsCase' ::  HoppyF.Ptr QStringListConst -> HoppyF.Ptr M52.QStringConst -> HoppyFC.CInt -> HoppyP.IO HoppyFHR.CBool
foreign import ccall "genpop__QStringList_filter" filter' ::  HoppyF.Ptr QStringListConst -> HoppyF.Ptr M52.QStringConst -> HoppyP.IO (HoppyF.Ptr QStringListConst)
foreign import ccall "genpop__QStringList_filterCase" filterCase' ::  HoppyF.Ptr QStringListConst -> HoppyF.Ptr M52.QStringConst -> HoppyFC.CInt -> HoppyP.IO (HoppyF.Ptr QStringListConst)
foreign import ccall "genpop__QStringList_joinString" joinString' ::  HoppyF.Ptr QStringListConst -> HoppyF.Ptr M52.QStringConst -> HoppyP.IO (HoppyF.Ptr M52.QStringConst)
foreign import ccall "genpop__QStringList_joinChar" joinChar' ::  HoppyF.Ptr QStringListConst -> HoppyF.Ptr M10.QCharConst -> HoppyP.IO (HoppyF.Ptr M52.QStringConst)
...
foreign import ccall "gencast__QStringList__QListQString" castQStringListToQListQString :: HoppyF.Ptr QStringListConst -> HoppyF.Ptr M82.QListQStringConst
...
class (M82.QListQStringConstPtr this) => QStringListConstPtr this where
  toQStringListConst :: this -> QStringListConst

containsCase :: (QStringListValue arg'1, M52.QStringValue arg'2) => arg'1 -> arg'2 -> M66.QtCaseSensitivity -> HoppyP.IO HoppyP.Bool
...
filter :: (QStringListValue arg'1, M52.QStringValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO [QtahP.String]
filter arg'1 arg'2 =
  withQStringListPtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
  M52.withQStringPtr arg'2 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'2' ->
...
filterCase :: (QStringListValue arg'1, M52.QStringValue arg'2) => arg'1 -> arg'2 -> M66.QtCaseSensitivity -> HoppyP.IO [QtahP.String]
...
joinString :: (QStringListValue arg'1, M52.QStringValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO QtahP.String
...
class (QStringListConstPtr this, M82.QListQStringPtr this) => QStringListPtr this where
...
sortCase :: (QStringListPtr arg'1) => arg'1 -> M66.QtCaseSensitivity -> HoppyP.IO ()
...
instance M82.QListQStringConstPtr QStringListConst where
  toQListQStringConst (QStringListConst ptr') = M82.QListQStringConst $ castQStringListToQListQString ptr'
  toQListQStringConst (QStringListConstGc fptr' ptr') = M82.QListQStringConstGc fptr' $ castQStringListToQListQString ptr'
...
instance M82.QListQStringConstPtr QStringList where
  toQListQStringConst (QStringList ptr') = M82.QListQStringConst $ castQStringListToQListQString $ (HoppyF.castPtr :: HoppyF.Ptr QStringList -> HoppyF.Ptr QStringListConst) ptr'
  toQListQStringConst (QStringListGc fptr' ptr') = M82.QListQStringConstGc fptr' $ castQStringListToQListQString $ (HoppyF.castPtr :: HoppyF.Ptr QStringList -> HoppyF.Ptr QStringListConst) ptr'

instance M82.QListQStringPtr QStringList where
  toQListQString (QStringList ptr') = M82.QListQString $ (HoppyF.castPtr :: HoppyF.Ptr M82.QListQStringConst -> HoppyF.Ptr M82.QListQString) $ castQStringListToQListQString $ (HoppyF.castPtr :: HoppyF.Ptr QStringList -> HoppyF.Ptr QStringListConst) ptr'
  toQListQString (QStringListGc fptr' ptr') = M82.QListQStringGc fptr' $ (HoppyF.castPtr :: HoppyF.Ptr M82.QListQStringConst -> HoppyF.Ptr M82.QListQString) $ castQStringListToQListQString $ (HoppyF.castPtr :: HoppyF.Ptr QStringList -> HoppyF.Ptr QStringListConst) ptr'
...
instance QtahFHR.HasContents QStringListConst QtahP.String where
  toContents = QtahFHR.toContents . M82.toQListQStringConst
