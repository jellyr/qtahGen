...
foreign import ccall "genpop__QDate_toStringWithStringFormat" toStringWithStringFormat' ::  HoppyF.Ptr QDateConst -> HoppyF.Ptr M52.QStringConst -> HoppyP.IO (HoppyF.Ptr M52.QStringConst)
foreign import ccall "genpop__QDate_toString" toString' ::  HoppyF.Ptr QDateConst -> HoppyP.IO (HoppyF.Ptr M52.QStringConst)
...
foreign import ccall "genpop__QDate_fromString" fromString' ::  HoppyF.Ptr M52.QStringConst -> HoppyP.IO (HoppyF.Ptr QDateConst)
foreign import ccall "genpop__QDate_fromStringWithStringFormat" fromStringWithStringFormat' ::  HoppyF.Ptr M52.QStringConst -> HoppyF.Ptr M52.QStringConst -> HoppyP.IO (HoppyF.Ptr QDateConst)
...
toStringWithStringFormat :: (QDateValue arg'1, M52.QStringValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO QtahP.String
...
fromString :: (M52.QStringValue arg'1) => arg'1 -> HoppyP.IO QDate
fromString arg'1 =
  M52.withQStringPtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
  (HoppyFHR.decodeAndDelete . QDateConst) =<<
  (fromString' arg'1')

fromStringWithStringFormat :: (M52.QStringValue arg'1, M52.QStringValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO QDate
