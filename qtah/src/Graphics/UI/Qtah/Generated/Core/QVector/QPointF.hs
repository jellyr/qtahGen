...
foreign import ccall "genpop__QVectorQPointF_newWithSizeAndValue" newWithSizeAndValue' ::  HoppyFC.CInt -> HoppyF.Ptr M40.QPointFConst -> HoppyP.IO (HoppyF.Ptr QVectorQPointF)
...
foreign import ccall "genpop__QVectorQPointF_append" append' ::  HoppyF.Ptr QVectorQPointF -> HoppyF.Ptr M40.QPointFConst -> HoppyP.IO ()
...
foreign import ccall "genpop__QVectorQPointF_at" at' ::  HoppyF.Ptr QVectorQPointF -> HoppyFC.CInt -> HoppyP.IO (HoppyF.Ptr M40.QPointF)
foreign import ccall "genpop__QVectorQPointF_atConst" atConst' ::  HoppyF.Ptr QVectorQPointFConst -> HoppyFC.CInt -> HoppyP.IO (HoppyF.Ptr M40.QPointFConst)
...
foreign import ccall "genpop__QVectorQPointF_contains" contains' ::  HoppyF.Ptr QVectorQPointFConst -> HoppyF.Ptr M40.QPointFConst -> HoppyP.IO HoppyFHR.CBool
foreign import ccall "genpop__QVectorQPointF_count" count' ::  HoppyF.Ptr QVectorQPointFConst -> HoppyF.Ptr M40.QPointFConst -> HoppyP.IO HoppyFC.CInt
foreign import ccall "genpop__QVectorQPointF_array" array' ::  HoppyF.Ptr QVectorQPointF -> HoppyP.IO (HoppyF.Ptr M40.QPointF)
foreign import ccall "genpop__QVectorQPointF_arrayConst" arrayConst' ::  HoppyF.Ptr QVectorQPointFConst -> HoppyP.IO (HoppyF.Ptr M40.QPointFConst)
foreign import ccall "genpop__QVectorQPointF_endsWith" endsWith' ::  HoppyF.Ptr QVectorQPointFConst -> HoppyF.Ptr M40.QPointFConst -> HoppyP.IO HoppyFHR.CBool
foreign import ccall "genpop__QVectorQPointF_fill" fill' ::  HoppyF.Ptr QVectorQPointF -> HoppyF.Ptr M40.QPointFConst -> HoppyP.IO ()
foreign import ccall "genpop__QVectorQPointF_fillResize" fillResize' ::  HoppyF.Ptr QVectorQPointF -> HoppyF.Ptr M40.QPointFConst -> HoppyFC.CInt -> HoppyP.IO ()
foreign import ccall "genpop__QVectorQPointF_first" first' ::  HoppyF.Ptr QVectorQPointF -> HoppyP.IO (HoppyF.Ptr M40.QPointF)
foreign import ccall "genpop__QVectorQPointF_firstConst" firstConst' ::  HoppyF.Ptr QVectorQPointFConst -> HoppyP.IO (HoppyF.Ptr M40.QPointFConst)
foreign import ccall "genpop__QVectorQPointF_get" get' ::  HoppyF.Ptr QVectorQPointFConst -> HoppyFC.CInt -> HoppyP.IO (HoppyF.Ptr M40.QPointFConst)
foreign import ccall "genpop__QVectorQPointF_indexOf" indexOf' ::  HoppyF.Ptr QVectorQPointFConst -> HoppyF.Ptr M40.QPointFConst -> HoppyP.IO HoppyFC.CInt
foreign import ccall "genpop__QVectorQPointF_indexOfFrom" indexOfFrom' ::  HoppyF.Ptr QVectorQPointFConst -> HoppyF.Ptr M40.QPointFConst -> HoppyFC.CInt -> HoppyP.IO HoppyFC.CInt
foreign import ccall "genpop__QVectorQPointF_insert" insert' ::  HoppyF.Ptr QVectorQPointF -> HoppyFC.CInt -> HoppyF.Ptr M40.QPointFConst -> HoppyP.IO ()
foreign import ccall "genpop__QVectorQPointF_insertMany" insertMany' ::  HoppyF.Ptr QVectorQPointF -> HoppyFC.CInt -> HoppyFC.CInt -> HoppyF.Ptr M40.QPointFConst -> HoppyP.IO ()
foreign import ccall "genpop__QVectorQPointF_isEmpty" isEmpty' ::  HoppyF.Ptr QVectorQPointFConst -> HoppyP.IO HoppyFHR.CBool
foreign import ccall "genpop__QVectorQPointF_last" last' ::  HoppyF.Ptr QVectorQPointF -> HoppyP.IO (HoppyF.Ptr M40.QPointF)
foreign import ccall "genpop__QVectorQPointF_lastConst" lastConst' ::  HoppyF.Ptr QVectorQPointFConst -> HoppyP.IO (HoppyF.Ptr M40.QPointFConst)
foreign import ccall "genpop__QVectorQPointF_lastIndexOf" lastIndexOf' ::  HoppyF.Ptr QVectorQPointFConst -> HoppyF.Ptr M40.QPointFConst -> HoppyP.IO HoppyFC.CInt
foreign import ccall "genpop__QVectorQPointF_lastIndexOfFrom" lastIndexOfFrom' ::  HoppyF.Ptr QVectorQPointFConst -> HoppyF.Ptr M40.QPointFConst -> HoppyFC.CInt -> HoppyP.IO HoppyFC.CInt
...
foreign import ccall "genpop__QVectorQPointF_prepend" prepend' ::  HoppyF.Ptr QVectorQPointF -> HoppyF.Ptr M40.QPointFConst -> HoppyP.IO ()
...
foreign import ccall "genpop__QVectorQPointF_removeAll" removeAll' ::  HoppyF.Ptr QVectorQPointF -> HoppyF.Ptr M40.QPointFConst -> HoppyP.IO HoppyFC.CInt
...
foreign import ccall "genpop__QVectorQPointF_removeOne" removeOne' ::  HoppyF.Ptr QVectorQPointF -> HoppyF.Ptr M40.QPointFConst -> HoppyP.IO HoppyFHR.CBool
foreign import ccall "genpop__QVectorQPointF_replace" replace' ::  HoppyF.Ptr QVectorQPointF -> HoppyFC.CInt -> HoppyF.Ptr M40.QPointFConst -> HoppyP.IO ()
...
foreign import ccall "genpop__QVectorQPointF_startsWith" startsWith' ::  HoppyF.Ptr QVectorQPointFConst -> HoppyF.Ptr M40.QPointFConst -> HoppyP.IO HoppyFHR.CBool
foreign import ccall "genpop__QVectorQPointF_swap" swap' ::  HoppyF.Ptr QVectorQPointF -> HoppyF.Ptr QVectorQPointF -> HoppyP.IO ()
foreign import ccall "genpop__QVectorQPointF_takeAt" takeAt' ::  HoppyF.Ptr QVectorQPointF -> HoppyFC.CInt -> HoppyP.IO (HoppyF.Ptr M40.QPointFConst)
foreign import ccall "genpop__QVectorQPointF_takeFirst" takeFirst' ::  HoppyF.Ptr QVectorQPointF -> HoppyP.IO (HoppyF.Ptr M40.QPointFConst)
foreign import ccall "genpop__QVectorQPointF_takeLast" takeLast' ::  HoppyF.Ptr QVectorQPointF -> HoppyP.IO (HoppyF.Ptr M40.QPointFConst)
foreign import ccall "genpop__QVectorQPointF_value" value' ::  HoppyF.Ptr QVectorQPointFConst -> HoppyFC.CInt -> HoppyP.IO (HoppyF.Ptr M40.QPointFConst)
foreign import ccall "genpop__QVectorQPointF_valueOr" valueOr' ::  HoppyF.Ptr QVectorQPointFConst -> HoppyFC.CInt -> HoppyF.Ptr M40.QPointFConst -> HoppyP.IO (HoppyF.Ptr M40.QPointFConst)
...
atConst :: (QVectorQPointFValue arg'1) => arg'1 -> HoppyP.Int -> HoppyP.IO M40.QPointFConst
atConst arg'1 arg'2 =
  withQVectorQPointFPtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
  let arg'2' = HoppyFHR.coerceIntegral arg'2 in
  HoppyP.fmap M40.QPointFConst
  (atConst' arg'1' arg'2')
...
contains :: (QVectorQPointFValue arg'1, M40.QPointFValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO HoppyP.Bool
...
count :: (QVectorQPointFValue arg'1, M40.QPointFValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO HoppyP.Int
count arg'1 arg'2 =
  withQVectorQPointFPtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
  M40.withQPointFPtr arg'2 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'2' ->
  HoppyP.fmap HoppyFHR.coerceIntegral
...
arrayConst :: (QVectorQPointFValue arg'1) => arg'1 -> HoppyP.IO M40.QPointFConst
arrayConst arg'1 =
  withQVectorQPointFPtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
  HoppyP.fmap M40.QPointFConst
  (arrayConst' arg'1')

endsWith :: (QVectorQPointFValue arg'1, M40.QPointFValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO HoppyP.Bool
...
firstConst :: (QVectorQPointFValue arg'1) => arg'1 -> HoppyP.IO M40.QPointFConst
firstConst arg'1 =
  withQVectorQPointFPtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
  HoppyP.fmap M40.QPointFConst
  (firstConst' arg'1')
...
indexOf :: (QVectorQPointFValue arg'1, M40.QPointFValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO HoppyP.Int
indexOf arg'1 arg'2 =
  withQVectorQPointFPtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
  M40.withQPointFPtr arg'2 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'2' ->
  HoppyP.fmap HoppyFHR.coerceIntegral
...
indexOfFrom :: (QVectorQPointFValue arg'1, M40.QPointFValue arg'2) => arg'1 -> arg'2 -> HoppyP.Int -> HoppyP.IO HoppyP.Int
...
lastConst :: (QVectorQPointFValue arg'1) => arg'1 -> HoppyP.IO M40.QPointFConst
lastConst arg'1 =
  withQVectorQPointFPtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
  HoppyP.fmap M40.QPointFConst
  (lastConst' arg'1')

lastIndexOf :: (QVectorQPointFValue arg'1, M40.QPointFValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO HoppyP.Int
...
lastIndexOfFrom :: (QVectorQPointFValue arg'1, M40.QPointFValue arg'2) => arg'1 -> arg'2 -> HoppyP.Int -> HoppyP.IO HoppyP.Int
...
startsWith :: (QVectorQPointFValue arg'1, M40.QPointFValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO HoppyP.Bool
...
valueOr :: (QVectorQPointFValue arg'1, M40.QPointFValue arg'3) => arg'1 -> HoppyP.Int -> arg'3 -> HoppyP.IO HPointF.HPointF
...
append :: (QVectorQPointFPtr arg'1, M40.QPointFValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO ()
append arg'1 arg'2 =
...
at :: (QVectorQPointFPtr arg'1) => arg'1 -> HoppyP.Int -> HoppyP.IO M40.QPointF
at arg'1 arg'2 =
  HoppyFHR.withCppPtr (toQVectorQPointF arg'1) $ \arg'1' ->
  let arg'2' = HoppyFHR.coerceIntegral arg'2 in
  HoppyP.fmap M40.QPointF
  (at' arg'1' arg'2')
...
array :: (QVectorQPointFPtr arg'1) => arg'1 -> HoppyP.IO M40.QPointF
array arg'1 =
  HoppyFHR.withCppPtr (toQVectorQPointF arg'1) $ \arg'1' ->
  HoppyP.fmap M40.QPointF
  (array' arg'1')

fill :: (QVectorQPointFPtr arg'1, M40.QPointFValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO ()
fill arg'1 arg'2 =
  HoppyFHR.withCppPtr (toQVectorQPointF arg'1) $ \arg'1' ->
  M40.withQPointFPtr arg'2 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'2' ->
  (fill' arg'1' arg'2')

fillResize :: (QVectorQPointFPtr arg'1, M40.QPointFValue arg'2) => arg'1 -> arg'2 -> HoppyP.Int -> HoppyP.IO ()
...
first :: (QVectorQPointFPtr arg'1) => arg'1 -> HoppyP.IO M40.QPointF
first arg'1 =
  HoppyFHR.withCppPtr (toQVectorQPointF arg'1) $ \arg'1' ->
  HoppyP.fmap M40.QPointF
  (first' arg'1')

insert :: (QVectorQPointFPtr arg'1, M40.QPointFValue arg'3) => arg'1 -> HoppyP.Int -> arg'3 -> HoppyP.IO ()
...
insertMany :: (QVectorQPointFPtr arg'1, M40.QPointFValue arg'4) => arg'1 -> HoppyP.Int -> HoppyP.Int -> arg'4 -> HoppyP.IO ()
...
last :: (QVectorQPointFPtr arg'1) => arg'1 -> HoppyP.IO M40.QPointF
last arg'1 =
  HoppyFHR.withCppPtr (toQVectorQPointF arg'1) $ \arg'1' ->
  HoppyP.fmap M40.QPointF
  (last' arg'1')

prepend :: (QVectorQPointFPtr arg'1, M40.QPointFValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO ()
prepend arg'1 arg'2 =
  HoppyFHR.withCppPtr (toQVectorQPointF arg'1) $ \arg'1' ->
  M40.withQPointFPtr arg'2 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'2' ->
  (prepend' arg'1' arg'2')
...
removeAll :: (QVectorQPointFPtr arg'1, M40.QPointFValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO HoppyP.Int
...
removeOne :: (QVectorQPointFPtr arg'1, M40.QPointFValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO HoppyP.Bool
...
replace :: (QVectorQPointFPtr arg'1, M40.QPointFValue arg'3) => arg'1 -> HoppyP.Int -> arg'3 -> HoppyP.IO ()
...
newWithSizeAndValue :: (M40.QPointFValue arg'2) => HoppyP.Int -> arg'2 -> HoppyP.IO QVectorQPointF
