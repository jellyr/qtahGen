...
foreign import ccall "genpop__QToolBox_newWithParent" newWithParent' ::  HoppyF.Ptr M322.QWidget -> HoppyP.IO (HoppyF.Ptr QToolBox)
foreign import ccall "genpop__QToolBox_newWithParentAndFlags" newWithParentAndFlags' ::  HoppyF.Ptr M322.QWidget -> HoppyFC.CInt -> HoppyP.IO (HoppyF.Ptr QToolBox)
...
foreign import ccall "genpop__QToolBox_addItemWithIcon" addItemWithIcon' ::  HoppyF.Ptr QToolBox -> HoppyF.Ptr M322.QWidget -> HoppyF.Ptr M120.QIconConst -> HoppyF.Ptr M52.QStringConst -> HoppyP.IO HoppyFC.CInt
foreign import ccall "genpop__QToolBox_addItem" addItem' ::  HoppyF.Ptr QToolBox -> HoppyF.Ptr M322.QWidget -> HoppyF.Ptr M52.QStringConst -> HoppyP.IO HoppyFC.CInt
foreign import ccall "genpop__QToolBox_currentWidget" currentWidget' ::  HoppyF.Ptr QToolBoxConst -> HoppyP.IO (HoppyF.Ptr M322.QWidget)
foreign import ccall "genpop__QToolBox_indexOf" indexOf' ::  HoppyF.Ptr QToolBoxConst -> HoppyF.Ptr M322.QWidget -> HoppyP.IO HoppyFC.CInt
foreign import ccall "genpop__QToolBox_insertItemWithIcon" insertItemWithIcon' ::  HoppyF.Ptr QToolBox -> HoppyFC.CInt -> HoppyF.Ptr M322.QWidget -> HoppyF.Ptr M120.QIconConst -> HoppyF.Ptr M52.QStringConst -> HoppyP.IO HoppyFC.CInt
foreign import ccall "genpop__QToolBox_insertItem" insertItem' ::  HoppyF.Ptr QToolBox -> HoppyFC.CInt -> HoppyF.Ptr M322.QWidget -> HoppyF.Ptr M52.QStringConst -> HoppyP.IO HoppyFC.CInt
...
foreign import ccall "genpop__QToolBox_itemIcon" itemIcon' ::  HoppyF.Ptr QToolBoxConst -> HoppyFC.CInt -> HoppyP.IO (HoppyF.Ptr M120.QIconConst)
foreign import ccall "genpop__QToolBox_itemText" itemText' ::  HoppyF.Ptr QToolBoxConst -> HoppyFC.CInt -> HoppyP.IO (HoppyF.Ptr M52.QStringConst)
foreign import ccall "genpop__QToolBox_itemToolTip" itemToolTip' ::  HoppyF.Ptr QToolBoxConst -> HoppyFC.CInt -> HoppyP.IO (HoppyF.Ptr M52.QStringConst)
...
foreign import ccall "genpop__QToolBox_setItemIcon" setItemIcon' ::  HoppyF.Ptr QToolBox -> HoppyFC.CInt -> HoppyF.Ptr M120.QIconConst -> HoppyP.IO ()
foreign import ccall "genpop__QToolBox_setItemText" setItemText' ::  HoppyF.Ptr QToolBox -> HoppyFC.CInt -> HoppyF.Ptr M52.QStringConst -> HoppyP.IO ()
foreign import ccall "genpop__QToolBox_setItemToolTip" setItemToolTip' ::  HoppyF.Ptr QToolBox -> HoppyFC.CInt -> HoppyF.Ptr M52.QStringConst -> HoppyP.IO ()
foreign import ccall "genpop__QToolBox_widget" widget' ::  HoppyF.Ptr QToolBoxConst -> HoppyFC.CInt -> HoppyP.IO (HoppyF.Ptr M322.QWidget)
foreign import ccall "genpop__QToolBox_setCurrentIndex" setCurrentIndex' ::  HoppyF.Ptr QToolBox -> HoppyFC.CInt -> HoppyP.IO ()
foreign import ccall "genpop__QToolBox_setCurrentWidget" setCurrentWidget' ::  HoppyF.Ptr QToolBox -> HoppyF.Ptr M322.QWidget -> HoppyP.IO ()
foreign import ccall "gencast__QToolBox__QFrame" castQToolBoxToQFrame :: HoppyF.Ptr QToolBoxConst -> HoppyF.Ptr M226.QFrameConst
foreign import ccall "gencast__QFrame__QToolBox" castQFrameToQToolBox :: HoppyF.Ptr M226.QFrameConst -> HoppyF.Ptr QToolBoxConst
foreign import ccall "gencast__QToolBox__QWidget" castQToolBoxToQWidget :: HoppyF.Ptr QToolBoxConst -> HoppyF.Ptr M322.QWidgetConst
foreign import ccall "gencast__QWidget__QToolBox" castQWidgetToQToolBox :: HoppyF.Ptr M322.QWidgetConst -> HoppyF.Ptr QToolBoxConst
...
class (M226.QFrameConstPtr this) => QToolBoxConstPtr this where
...
currentWidget :: (QToolBoxValue arg'1) => arg'1 -> HoppyP.IO M322.QWidget
currentWidget arg'1 =
  withQToolBoxPtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
  HoppyP.fmap M322.QWidget
  (currentWidget' arg'1')

indexOf :: (QToolBoxValue arg'1, M322.QWidgetPtr arg'2) => arg'1 -> arg'2 -> HoppyP.IO HoppyP.Int
indexOf arg'1 arg'2 =
  withQToolBoxPtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
...
itemIcon :: (QToolBoxValue arg'1) => arg'1 -> HoppyP.Int -> HoppyP.IO M120.QIcon
...
widget :: (QToolBoxValue arg'1) => arg'1 -> HoppyP.Int -> HoppyP.IO M322.QWidget
widget arg'1 arg'2 =
  withQToolBoxPtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
  let arg'2' = HoppyFHR.coerceIntegral arg'2 in
  HoppyP.fmap M322.QWidget
...
class (QToolBoxConstPtr this, M226.QFramePtr this) => QToolBoxPtr this where
  toQToolBox :: this -> QToolBox

addItemWithIcon :: (QToolBoxPtr arg'1, M322.QWidgetPtr arg'2, M120.QIconValue arg'3, M52.QStringValue arg'4) => arg'1 -> arg'2 -> arg'3 -> arg'4 -> HoppyP.IO HoppyP.Int
...
addItem :: (QToolBoxPtr arg'1, M322.QWidgetPtr arg'2, M52.QStringValue arg'3) => arg'1 -> arg'2 -> arg'3 -> HoppyP.IO HoppyP.Int
...
insertItemWithIcon :: (QToolBoxPtr arg'1, M322.QWidgetPtr arg'3, M120.QIconValue arg'4, M52.QStringValue arg'5) => arg'1 -> HoppyP.Int -> arg'3 -> arg'4 -> arg'5 -> HoppyP.IO HoppyP.Int
insertItemWithIcon arg'1 arg'2 arg'3 arg'4 arg'5 =
  HoppyFHR.withCppPtr (toQToolBox arg'1) $ \arg'1' ->
  let arg'2' = HoppyFHR.coerceIntegral arg'2 in
  HoppyFHR.withCppPtr (M322.toQWidget arg'3) $ \arg'3' ->
  M120.withQIconPtr arg'4 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'4' ->
  M52.withQStringPtr arg'5 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'5' ->
  HoppyP.fmap HoppyFHR.coerceIntegral
  (insertItemWithIcon' arg'1' arg'2' arg'3' arg'4' arg'5')

insertItem :: (QToolBoxPtr arg'1, M322.QWidgetPtr arg'3, M52.QStringValue arg'4) => arg'1 -> HoppyP.Int -> arg'3 -> arg'4 -> HoppyP.IO HoppyP.Int
...
setItemIcon :: (QToolBoxPtr arg'1, M120.QIconValue arg'3) => arg'1 -> HoppyP.Int -> arg'3 -> HoppyP.IO ()
...
setItemText :: (QToolBoxPtr arg'1, M52.QStringValue arg'3) => arg'1 -> HoppyP.Int -> arg'3 -> HoppyP.IO ()
...
setItemToolTip :: (QToolBoxPtr arg'1, M52.QStringValue arg'3) => arg'1 -> HoppyP.Int -> arg'3 -> HoppyP.IO ()
...
setCurrentWidget :: (QToolBoxPtr arg'1, M322.QWidgetPtr arg'2) => arg'1 -> arg'2 -> HoppyP.IO ()
...
instance M226.QFrameConstPtr QToolBoxConst where
  toQFrameConst (QToolBoxConst ptr') = M226.QFrameConst $ castQToolBoxToQFrame ptr'
  toQFrameConst (QToolBoxConstGc fptr' ptr') = M226.QFrameConstGc fptr' $ castQToolBoxToQFrame ptr'

instance M322.QWidgetConstPtr QToolBoxConst where
  toQWidgetConst (QToolBoxConst ptr') = M322.QWidgetConst $ castQToolBoxToQWidget ptr'
  toQWidgetConst (QToolBoxConstGc fptr' ptr') = M322.QWidgetConstGc fptr' $ castQToolBoxToQWidget ptr'
...
instance M226.QFrameConstPtr QToolBox where
  toQFrameConst (QToolBox ptr') = M226.QFrameConst $ castQToolBoxToQFrame $ (HoppyF.castPtr :: HoppyF.Ptr QToolBox -> HoppyF.Ptr QToolBoxConst) ptr'
  toQFrameConst (QToolBoxGc fptr' ptr') = M226.QFrameConstGc fptr' $ castQToolBoxToQFrame $ (HoppyF.castPtr :: HoppyF.Ptr QToolBox -> HoppyF.Ptr QToolBoxConst) ptr'

instance M226.QFramePtr QToolBox where
  toQFrame (QToolBox ptr') = M226.QFrame $ (HoppyF.castPtr :: HoppyF.Ptr M226.QFrameConst -> HoppyF.Ptr M226.QFrame) $ castQToolBoxToQFrame $ (HoppyF.castPtr :: HoppyF.Ptr QToolBox -> HoppyF.Ptr QToolBoxConst) ptr'
  toQFrame (QToolBoxGc fptr' ptr') = M226.QFrameGc fptr' $ (HoppyF.castPtr :: HoppyF.Ptr M226.QFrameConst -> HoppyF.Ptr M226.QFrame) $ castQToolBoxToQFrame $ (HoppyF.castPtr :: HoppyF.Ptr QToolBox -> HoppyF.Ptr QToolBoxConst) ptr'

instance M322.QWidgetConstPtr QToolBox where
  toQWidgetConst (QToolBox ptr') = M322.QWidgetConst $ castQToolBoxToQWidget $ (HoppyF.castPtr :: HoppyF.Ptr QToolBox -> HoppyF.Ptr QToolBoxConst) ptr'
  toQWidgetConst (QToolBoxGc fptr' ptr') = M322.QWidgetConstGc fptr' $ castQToolBoxToQWidget $ (HoppyF.castPtr :: HoppyF.Ptr QToolBox -> HoppyF.Ptr QToolBoxConst) ptr'

instance M322.QWidgetPtr QToolBox where
  toQWidget (QToolBox ptr') = M322.QWidget $ (HoppyF.castPtr :: HoppyF.Ptr M322.QWidgetConst -> HoppyF.Ptr M322.QWidget) $ castQToolBoxToQWidget $ (HoppyF.castPtr :: HoppyF.Ptr QToolBox -> HoppyF.Ptr QToolBoxConst) ptr'
  toQWidget (QToolBoxGc fptr' ptr') = M322.QWidgetGc fptr' $ (HoppyF.castPtr :: HoppyF.Ptr M322.QWidgetConst -> HoppyF.Ptr M322.QWidget) $ castQToolBoxToQWidget $ (HoppyF.castPtr :: HoppyF.Ptr QToolBox -> HoppyF.Ptr QToolBoxConst) ptr'
...
newWithParent :: (M322.QWidgetPtr arg'1) => arg'1 -> HoppyP.IO QToolBox
newWithParent arg'1 =
  HoppyFHR.withCppPtr (M322.toQWidget arg'1) $ \arg'1' ->
  HoppyP.fmap QToolBox
  (newWithParent' arg'1')

newWithParentAndFlags :: (M322.QWidgetPtr arg'1, M66.IsQtWindowFlags arg'2) => arg'1 -> arg'2 -> HoppyP.IO QToolBox
...
instance QToolBoxSuper M226.QFrame where
  downToQToolBox = castQToolBoxToNonconst . cast' . M226.castQFrameToConst
    where
      cast' (M226.QFrameConst ptr') = QToolBoxConst $ castQFrameToQToolBox ptr'
      cast' (M226.QFrameConstGc fptr' ptr') = QToolBoxConstGc fptr' $ castQFrameToQToolBox ptr'
instance QToolBoxSuper M322.QWidget where
  downToQToolBox = castQToolBoxToNonconst . cast' . M322.castQWidgetToConst
    where
      cast' (M322.QWidgetConst ptr') = QToolBoxConst $ castQWidgetToQToolBox ptr'
      cast' (M322.QWidgetConstGc fptr' ptr') = QToolBoxConstGc fptr' $ castQWidgetToQToolBox ptr'
...
instance QToolBoxSuperConst M226.QFrameConst where
  downToQToolBoxConst = cast'
    where
      cast' (M226.QFrameConst ptr') = QToolBoxConst $ castQFrameToQToolBox ptr'
      cast' (M226.QFrameConstGc fptr' ptr') = QToolBoxConstGc fptr' $ castQFrameToQToolBox ptr'
instance QToolBoxSuperConst M322.QWidgetConst where
  downToQToolBoxConst = cast'
    where
      cast' (M322.QWidgetConst ptr') = QToolBoxConst $ castQWidgetToQToolBox ptr'
      cast' (M322.QWidgetConstGc fptr' ptr') = QToolBoxConstGc fptr' $ castQWidgetToQToolBox ptr'
