...
foreign import ccall "genpop__QSystemTrayIcon_newWithIcon" newWithIcon' ::  HoppyF.Ptr M120.QIconConst -> HoppyP.IO (HoppyF.Ptr QSystemTrayIcon)
foreign import ccall "genpop__QSystemTrayIcon_newWithIconAndParent" newWithIconAndParent' ::  HoppyF.Ptr M120.QIconConst -> HoppyF.Ptr M34.QObject -> HoppyP.IO (HoppyF.Ptr QSystemTrayIcon)
foreign import ccall "genpop__QSystemTrayIcon_contextMenu" contextMenu' ::  HoppyF.Ptr QSystemTrayIconConst -> HoppyP.IO (HoppyF.Ptr M266.QMenu)
foreign import ccall "genpop__QSystemTrayIcon_setContextMenu" setContextMenu' ::  HoppyF.Ptr QSystemTrayIcon -> HoppyF.Ptr M266.QMenu -> HoppyP.IO ()
foreign import ccall "genpop__QSystemTrayIcon_geometry" geometry' ::  HoppyF.Ptr QSystemTrayIconConst -> HoppyP.IO (HoppyF.Ptr M42.QRectConst)
foreign import ccall "genpop__QSystemTrayIcon_hide" hide' ::  HoppyF.Ptr QSystemTrayIcon -> HoppyP.IO ()
foreign import ccall "genpop__QSystemTrayIcon_icon" icon' ::  HoppyF.Ptr QSystemTrayIconConst -> HoppyP.IO (HoppyF.Ptr M120.QIconConst)
foreign import ccall "genpop__QSystemTrayIcon_setIcon" setIcon' ::  HoppyF.Ptr QSystemTrayIcon -> HoppyF.Ptr M120.QIconConst -> HoppyP.IO ()
...
foreign import ccall "genpop__QSystemTrayIcon_showMessage" showMessage' ::  HoppyF.Ptr QSystemTrayIcon -> HoppyF.Ptr M52.QStringConst -> HoppyF.Ptr M52.QStringConst -> HoppyP.IO ()
foreign import ccall "genpop__QSystemTrayIcon_showMessageAll" showMessageAll' ::  HoppyF.Ptr QSystemTrayIcon -> HoppyF.Ptr M52.QStringConst -> HoppyF.Ptr M52.QStringConst -> HoppyFC.CInt -> HoppyFC.CInt -> HoppyP.IO ()
foreign import ccall "genpop__QSystemTrayIcon_supportsMessages" supportsMessages' ::  HoppyP.IO HoppyFHR.CBool
foreign import ccall "genpop__QSystemTrayIcon_toolTip" toolTip' ::  HoppyF.Ptr QSystemTrayIconConst -> HoppyP.IO (HoppyF.Ptr M52.QStringConst)
foreign import ccall "genpop__QSystemTrayIcon_setToolTip" setToolTip' ::  HoppyF.Ptr QSystemTrayIcon -> HoppyF.Ptr M52.QStringConst -> HoppyP.IO ()
...
contextMenu :: (QSystemTrayIconValue arg'1) => arg'1 -> HoppyP.IO M266.QMenu
contextMenu arg'1 =
...
icon :: (QSystemTrayIconValue arg'1) => arg'1 -> HoppyP.IO M120.QIcon
icon arg'1 =
  withQSystemTrayIconPtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
...
setContextMenu :: (QSystemTrayIconPtr arg'1, M266.QMenuPtr arg'2) => arg'1 -> arg'2 -> HoppyP.IO ()
...
setIcon :: (QSystemTrayIconPtr arg'1, M120.QIconValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO ()
setIcon arg'1 arg'2 =
  HoppyFHR.withCppPtr (toQSystemTrayIcon arg'1) $ \arg'1' ->
...
showMessage :: (QSystemTrayIconPtr arg'1, M52.QStringValue arg'2, M52.QStringValue arg'3) => arg'1 -> arg'2 -> arg'3 -> HoppyP.IO ()
...
showMessageAll :: (QSystemTrayIconPtr arg'1, M52.QStringValue arg'2, M52.QStringValue arg'3) => arg'1 -> arg'2 -> arg'3 -> QSystemTrayIconMessageIcon -> HoppyP.Int -> HoppyP.IO ()
...
setToolTip :: (QSystemTrayIconPtr arg'1, M52.QStringValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO ()
...
newWithIcon :: (M120.QIconValue arg'1) => arg'1 -> HoppyP.IO QSystemTrayIcon
newWithIcon arg'1 =
  M120.withQIconPtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
  HoppyP.fmap QSystemTrayIcon
  (newWithIcon' arg'1')

newWithIconAndParent :: (M120.QIconValue arg'1, M34.QObjectPtr arg'2) => arg'1 -> arg'2 -> HoppyP.IO QSystemTrayIcon
