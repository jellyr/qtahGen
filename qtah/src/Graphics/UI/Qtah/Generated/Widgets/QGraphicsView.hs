...
import qualified Graphics.UI.Qtah.Generated.Gui.QPainter as M140
...
import qualified Graphics.UI.Qtah.Generated.Widgets.QGraphicsScene as M236
...
foreign import ccall "genpop__QGraphicsView_newWithScene" newWithScene' ::  HoppyF.Ptr M236.QGraphicsScene -> HoppyP.IO (HoppyF.Ptr QGraphicsView)
foreign import ccall "genpop__QGraphicsView_newWithParent" newWithParent' ::  HoppyF.Ptr M322.QWidget -> HoppyP.IO (HoppyF.Ptr QGraphicsView)
foreign import ccall "genpop__QGraphicsView_newWithSceneAndParent" newWithSceneAndParent' ::  HoppyF.Ptr M236.QGraphicsScene -> HoppyF.Ptr M322.QWidget -> HoppyP.IO (HoppyF.Ptr QGraphicsView)
foreign import ccall "genpop__QGraphicsView_alignment" alignment' ::  HoppyF.Ptr QGraphicsViewConst -> HoppyP.IO HoppyFC.CInt
foreign import ccall "genpop__QGraphicsView_backgroundBrush" backgroundBrush' ::  HoppyF.Ptr QGraphicsViewConst -> HoppyP.IO (HoppyF.Ptr M98.QBrushConst)
foreign import ccall "genpop__QGraphicsView_cacheMode" cacheMode' ::  HoppyF.Ptr QGraphicsViewConst -> HoppyP.IO HoppyFC.CInt
foreign import ccall "genpop__QGraphicsView_centerOnPointF" centerOnPointF' ::  HoppyF.Ptr QGraphicsView -> HoppyF.Ptr M40.QPointFConst -> HoppyP.IO ()
...
foreign import ccall "genpop__QGraphicsView_centerOnItem" centerOnItem' ::  HoppyF.Ptr QGraphicsView -> HoppyF.Ptr M230.QGraphicsItemConst -> HoppyP.IO ()
foreign import ccall "genpop__QGraphicsView_dragMode" dragMode' ::  HoppyF.Ptr QGraphicsViewConst -> HoppyP.IO HoppyFC.CInt
foreign import ccall "genpop__QGraphicsView_ensureVisibleRectF" ensureVisibleRectF' ::  HoppyF.Ptr QGraphicsView -> HoppyF.Ptr M44.QRectFConst -> HoppyP.IO ()
...
foreign import ccall "genpop__QGraphicsView_ensureVisibleItem" ensureVisibleItem' ::  HoppyF.Ptr QGraphicsView -> HoppyF.Ptr M230.QGraphicsItemConst -> HoppyP.IO ()
foreign import ccall "genpop__QGraphicsView_ensureVisibleRectFAll" ensureVisibleRectFAll' ::  HoppyF.Ptr QGraphicsView -> HoppyF.Ptr M44.QRectFConst -> HoppyFC.CInt -> HoppyFC.CInt -> HoppyP.IO ()
...
foreign import ccall "genpop__QGraphicsView_ensureVisibleItemAll" ensureVisibleItemAll' ::  HoppyF.Ptr QGraphicsView -> HoppyF.Ptr M230.QGraphicsItemConst -> HoppyFC.CInt -> HoppyFC.CInt -> HoppyP.IO ()
foreign import ccall "genpop__QGraphicsView_fitInViewRectF" fitInViewRectF' ::  HoppyF.Ptr QGraphicsView -> HoppyF.Ptr M44.QRectFConst -> HoppyP.IO ()
...
foreign import ccall "genpop__QGraphicsView_fitInViewItem" fitInViewItem' ::  HoppyF.Ptr QGraphicsView -> HoppyF.Ptr M230.QGraphicsItemConst -> HoppyP.IO ()
foreign import ccall "genpop__QGraphicsView_fitInViewRectFAll" fitInViewRectFAll' ::  HoppyF.Ptr QGraphicsView -> HoppyF.Ptr M44.QRectFConst -> HoppyFC.CInt -> HoppyP.IO ()
...
foreign import ccall "genpop__QGraphicsView_fitInViewItemAll" fitInViewItemAll' ::  HoppyF.Ptr QGraphicsView -> HoppyF.Ptr M230.QGraphicsItemConst -> HoppyFC.CInt -> HoppyP.IO ()
foreign import ccall "genpop__QGraphicsView_foregroundBrush" foregroundBrush' ::  HoppyF.Ptr QGraphicsViewConst -> HoppyP.IO (HoppyF.Ptr M98.QBrushConst)
...
foreign import ccall "genpop__QGraphicsView_itemAtPoint" itemAtPoint' ::  HoppyF.Ptr QGraphicsViewConst -> HoppyF.Ptr M38.QPointConst -> HoppyP.IO (HoppyF.Ptr M230.QGraphicsItem)
foreign import ccall "genpop__QGraphicsView_itemAtRaw" itemAtRaw' ::  HoppyF.Ptr QGraphicsViewConst -> HoppyFC.CInt -> HoppyFC.CInt -> HoppyP.IO (HoppyF.Ptr M230.QGraphicsItem)
foreign import ccall "genpop__QGraphicsView_mapFromScenePointF" mapFromScenePointF' ::  HoppyF.Ptr QGraphicsViewConst -> HoppyF.Ptr M40.QPointFConst -> HoppyP.IO (HoppyF.Ptr M38.QPointConst)
foreign import ccall "genpop__QGraphicsView_mapFromSceneRectF" mapFromSceneRectF' ::  HoppyF.Ptr QGraphicsViewConst -> HoppyF.Ptr M44.QRectFConst -> HoppyP.IO (HoppyF.Ptr M148.QPolygonConst)
foreign import ccall "genpop__QGraphicsView_mapFromScenePolygonF" mapFromScenePolygonF' ::  HoppyF.Ptr QGraphicsViewConst -> HoppyF.Ptr M150.QPolygonFConst -> HoppyP.IO (HoppyF.Ptr M148.QPolygonConst)
foreign import ccall "genpop__QGraphicsView_mapFromScenePainterPath" mapFromScenePainterPath' ::  HoppyF.Ptr QGraphicsViewConst -> HoppyF.Ptr M142.QPainterPathConst -> HoppyP.IO (HoppyF.Ptr M142.QPainterPathConst)
foreign import ccall "genpop__QGraphicsView_mapFromScenePointFRaw" mapFromScenePointFRaw' ::  HoppyF.Ptr QGraphicsViewConst -> HoppyFC.CDouble -> HoppyFC.CDouble -> HoppyP.IO (HoppyF.Ptr M38.QPointConst)
foreign import ccall "genpop__QGraphicsView_mapFromSceneRectFRaw" mapFromSceneRectFRaw' ::  HoppyF.Ptr QGraphicsViewConst -> HoppyFC.CDouble -> HoppyFC.CDouble -> HoppyFC.CDouble -> HoppyFC.CDouble -> HoppyP.IO (HoppyF.Ptr M148.QPolygonConst)
foreign import ccall "genpop__QGraphicsView_mapToScenePoint" mapToScenePoint' ::  HoppyF.Ptr QGraphicsViewConst -> HoppyF.Ptr M38.QPointConst -> HoppyP.IO (HoppyF.Ptr M40.QPointFConst)
foreign import ccall "genpop__QGraphicsView_mapToSceneRect" mapToSceneRect' ::  HoppyF.Ptr QGraphicsViewConst -> HoppyF.Ptr M42.QRectConst -> HoppyP.IO (HoppyF.Ptr M150.QPolygonFConst)
foreign import ccall "genpop__QGraphicsView_mapToScenePolygon" mapToScenePolygon' ::  HoppyF.Ptr QGraphicsViewConst -> HoppyF.Ptr M148.QPolygonConst -> HoppyP.IO (HoppyF.Ptr M150.QPolygonFConst)
foreign import ccall "genpop__QGraphicsView_mapToScenePainterPath" mapToScenePainterPath' ::  HoppyF.Ptr QGraphicsViewConst -> HoppyF.Ptr M142.QPainterPathConst -> HoppyP.IO (HoppyF.Ptr M142.QPainterPathConst)
foreign import ccall "genpop__QGraphicsView_mapToScenePointRaw" mapToScenePointRaw' ::  HoppyF.Ptr QGraphicsViewConst -> HoppyFC.CInt -> HoppyFC.CInt -> HoppyP.IO (HoppyF.Ptr M40.QPointFConst)
foreign import ccall "genpop__QGraphicsView_mapToSceneRectRaw" mapToSceneRectRaw' ::  HoppyF.Ptr QGraphicsViewConst -> HoppyFC.CInt -> HoppyFC.CInt -> HoppyFC.CInt -> HoppyFC.CInt -> HoppyP.IO (HoppyF.Ptr M150.QPolygonFConst)
...
foreign import ccall "genpop__QGraphicsView_render" render' ::  HoppyF.Ptr QGraphicsView -> HoppyF.Ptr M140.QPainter -> HoppyP.IO ()
foreign import ccall "genpop__QGraphicsView_renderAll" renderAll' ::  HoppyF.Ptr QGraphicsView -> HoppyF.Ptr M140.QPainter -> HoppyF.Ptr M44.QRectFConst -> HoppyF.Ptr M42.QRectConst -> HoppyFC.CInt -> HoppyP.IO ()
...
foreign import ccall "genpop__QGraphicsView_scene" scene' ::  HoppyF.Ptr QGraphicsViewConst -> HoppyP.IO (HoppyF.Ptr M236.QGraphicsScene)
foreign import ccall "genpop__QGraphicsView_sceneRect" sceneRect' ::  HoppyF.Ptr QGraphicsViewConst -> HoppyP.IO (HoppyF.Ptr M44.QRectFConst)
foreign import ccall "genpop__QGraphicsView_setAlignment" setAlignment' ::  HoppyF.Ptr QGraphicsView -> HoppyFC.CInt -> HoppyP.IO ()
foreign import ccall "genpop__QGraphicsView_setBackgroundBrush" setBackgroundBrush' ::  HoppyF.Ptr QGraphicsView -> HoppyF.Ptr M98.QBrushConst -> HoppyP.IO ()
...
foreign import ccall "genpop__QGraphicsView_setForegroundBrush" setForegroundBrush' ::  HoppyF.Ptr QGraphicsView -> HoppyF.Ptr M98.QBrushConst -> HoppyP.IO ()
...
foreign import ccall "genpop__QGraphicsView_setScene" setScene' ::  HoppyF.Ptr QGraphicsView -> HoppyF.Ptr M236.QGraphicsScene -> HoppyP.IO ()
foreign import ccall "genpop__QGraphicsView_setSceneRectF" setSceneRectF' ::  HoppyF.Ptr QGraphicsView -> HoppyF.Ptr M44.QRectFConst -> HoppyP.IO ()
...
foreign import ccall "genpop__QGraphicsView_setTransform" setTransform' ::  HoppyF.Ptr QGraphicsView -> HoppyF.Ptr M166.QTransformConst -> HoppyP.IO ()
foreign import ccall "genpop__QGraphicsView_setTransformAll" setTransformAll' ::  HoppyF.Ptr QGraphicsView -> HoppyF.Ptr M166.QTransformConst -> HoppyFHR.CBool -> HoppyP.IO ()
...
foreign import ccall "genpop__QGraphicsView_transform" transform' ::  HoppyF.Ptr QGraphicsViewConst -> HoppyP.IO (HoppyF.Ptr M166.QTransformConst)
...
foreign import ccall "genpop__QGraphicsView_viewportTransform" viewportTransform' ::  HoppyF.Ptr QGraphicsViewConst -> HoppyP.IO (HoppyF.Ptr M166.QTransformConst)
foreign import ccall "gencast__QGraphicsView__QAbstractScrollArea" castQGraphicsViewToQAbstractScrollArea :: HoppyF.Ptr QGraphicsViewConst -> HoppyF.Ptr M192.QAbstractScrollAreaConst
foreign import ccall "gencast__QAbstractScrollArea__QGraphicsView" castQAbstractScrollAreaToQGraphicsView :: HoppyF.Ptr M192.QAbstractScrollAreaConst -> HoppyF.Ptr QGraphicsViewConst
foreign import ccall "gencast__QGraphicsView__QWidget" castQGraphicsViewToQWidget :: HoppyF.Ptr QGraphicsViewConst -> HoppyF.Ptr M322.QWidgetConst
foreign import ccall "gencast__QWidget__QGraphicsView" castQWidgetToQGraphicsView :: HoppyF.Ptr M322.QWidgetConst -> HoppyF.Ptr QGraphicsViewConst
...
class (M192.QAbstractScrollAreaConstPtr this) => QGraphicsViewConstPtr this where
  toQGraphicsViewConst :: this -> QGraphicsViewConst

alignment :: (QGraphicsViewValue arg'1) => arg'1 -> HoppyP.IO M66.QtAlignment
alignment arg'1 =
  withQGraphicsViewPtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
  HoppyP.fmap M66.QtAlignment
  (alignment' arg'1')

backgroundBrush :: (QGraphicsViewValue arg'1) => arg'1 -> HoppyP.IO M98.QBrush
...
foregroundBrush :: (QGraphicsViewValue arg'1) => arg'1 -> HoppyP.IO M98.QBrush
...
itemAtPoint :: (QGraphicsViewValue arg'1, M38.QPointValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO M230.QGraphicsItem
itemAtPoint arg'1 arg'2 =
  withQGraphicsViewPtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
  M38.withQPointPtr arg'2 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'2' ->
  HoppyP.fmap M230.QGraphicsItem
  (itemAtPoint' arg'1' arg'2')

itemAtRaw :: (QGraphicsViewValue arg'1) => arg'1 -> HoppyP.Int -> HoppyP.Int -> HoppyP.IO M230.QGraphicsItem
...
mapFromScenePointF :: (QGraphicsViewValue arg'1, M40.QPointFValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO HPoint.HPoint
...
mapFromSceneRectF :: (QGraphicsViewValue arg'1, M44.QRectFValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO M148.QPolygon
mapFromSceneRectF arg'1 arg'2 =
  withQGraphicsViewPtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
  M44.withQRectFPtr arg'2 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'2' ->
  (HoppyFHR.decodeAndDelete . M148.QPolygonConst) =<<
  (mapFromSceneRectF' arg'1' arg'2')

mapFromScenePolygonF :: (QGraphicsViewValue arg'1, M150.QPolygonFValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO M148.QPolygon
mapFromScenePolygonF arg'1 arg'2 =
  withQGraphicsViewPtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
  M150.withQPolygonFPtr arg'2 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'2' ->
  (HoppyFHR.decodeAndDelete . M148.QPolygonConst) =<<
  (mapFromScenePolygonF' arg'1' arg'2')

mapFromScenePainterPath :: (QGraphicsViewValue arg'1, M142.QPainterPathValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO M142.QPainterPath
mapFromScenePainterPath arg'1 arg'2 =
  withQGraphicsViewPtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
  M142.withQPainterPathPtr arg'2 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'2' ->
  (HoppyFHR.decodeAndDelete . M142.QPainterPathConst) =<<
  (mapFromScenePainterPath' arg'1' arg'2')
...
mapFromSceneRectFRaw :: (QGraphicsViewValue arg'1) => arg'1 -> HoppyP.Double -> HoppyP.Double -> HoppyP.Double -> HoppyP.Double -> HoppyP.IO M148.QPolygon
...
mapToScenePoint :: (QGraphicsViewValue arg'1, M38.QPointValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO HPointF.HPointF
...
mapToSceneRect :: (QGraphicsViewValue arg'1, M42.QRectValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO M150.QPolygonF
mapToSceneRect arg'1 arg'2 =
  withQGraphicsViewPtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
  M42.withQRectPtr arg'2 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'2' ->
  (HoppyFHR.decodeAndDelete . M150.QPolygonFConst) =<<
  (mapToSceneRect' arg'1' arg'2')

mapToScenePolygon :: (QGraphicsViewValue arg'1, M148.QPolygonValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO M150.QPolygonF
mapToScenePolygon arg'1 arg'2 =
  withQGraphicsViewPtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
  M148.withQPolygonPtr arg'2 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'2' ->
  (HoppyFHR.decodeAndDelete . M150.QPolygonFConst) =<<
  (mapToScenePolygon' arg'1' arg'2')

mapToScenePainterPath :: (QGraphicsViewValue arg'1, M142.QPainterPathValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO M142.QPainterPath
...
mapToSceneRectRaw :: (QGraphicsViewValue arg'1) => arg'1 -> HoppyP.Int -> HoppyP.Int -> HoppyP.Int -> HoppyP.Int -> HoppyP.IO M150.QPolygonF
...
renderHints :: (QGraphicsViewValue arg'1) => arg'1 -> HoppyP.IO M140.QPainterRenderHints
renderHints arg'1 =
  withQGraphicsViewPtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
  HoppyP.fmap M140.QPainterRenderHints
  (renderHints' arg'1')
...
scene :: (QGraphicsViewValue arg'1) => arg'1 -> HoppyP.IO M236.QGraphicsScene
scene arg'1 =
  withQGraphicsViewPtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
  HoppyP.fmap M236.QGraphicsScene
  (scene' arg'1')

sceneRect :: (QGraphicsViewValue arg'1) => arg'1 -> HoppyP.IO M44.QRectF
sceneRect arg'1 =
  withQGraphicsViewPtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
  (HoppyFHR.decodeAndDelete . M44.QRectFConst) =<<
  (sceneRect' arg'1')

transform :: (QGraphicsViewValue arg'1) => arg'1 -> HoppyP.IO M166.QTransform
transform arg'1 =
  withQGraphicsViewPtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
  (HoppyFHR.decodeAndDelete . M166.QTransformConst) =<<
  (transform' arg'1')
...
viewportTransform :: (QGraphicsViewValue arg'1) => arg'1 -> HoppyP.IO M166.QTransform
viewportTransform arg'1 =
  withQGraphicsViewPtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
  (HoppyFHR.decodeAndDelete . M166.QTransformConst) =<<
  (viewportTransform' arg'1')

class (QGraphicsViewConstPtr this, M192.QAbstractScrollAreaPtr this) => QGraphicsViewPtr this where
  toQGraphicsView :: this -> QGraphicsView

centerOnPointF :: (QGraphicsViewPtr arg'1, M40.QPointFValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO ()
...
centerOnItem :: (QGraphicsViewPtr arg'1, M230.QGraphicsItemValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO ()
centerOnItem arg'1 arg'2 =
  HoppyFHR.withCppPtr (toQGraphicsView arg'1) $ \arg'1' ->
  M230.withQGraphicsItemPtr arg'2 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'2' ->
  (centerOnItem' arg'1' arg'2')

ensureVisibleRectF :: (QGraphicsViewPtr arg'1, M44.QRectFValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO ()
...
ensureVisibleItem :: (QGraphicsViewPtr arg'1, M230.QGraphicsItemValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO ()
ensureVisibleItem arg'1 arg'2 =
  HoppyFHR.withCppPtr (toQGraphicsView arg'1) $ \arg'1' ->
  M230.withQGraphicsItemPtr arg'2 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'2' ->
  (ensureVisibleItem' arg'1' arg'2')

ensureVisibleRectFAll :: (QGraphicsViewPtr arg'1, M44.QRectFValue arg'2) => arg'1 -> arg'2 -> HoppyP.Int -> HoppyP.Int -> HoppyP.IO ()
...
ensureVisibleItemAll :: (QGraphicsViewPtr arg'1, M230.QGraphicsItemValue arg'2) => arg'1 -> arg'2 -> HoppyP.Int -> HoppyP.Int -> HoppyP.IO ()
...
fitInViewRectF :: (QGraphicsViewPtr arg'1, M44.QRectFValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO ()
...
fitInViewItem :: (QGraphicsViewPtr arg'1, M230.QGraphicsItemValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO ()
fitInViewItem arg'1 arg'2 =
  HoppyFHR.withCppPtr (toQGraphicsView arg'1) $ \arg'1' ->
  M230.withQGraphicsItemPtr arg'2 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'2' ->
  (fitInViewItem' arg'1' arg'2')

fitInViewRectFAll :: (QGraphicsViewPtr arg'1, M44.QRectFValue arg'2) => arg'1 -> arg'2 -> M66.QtAspectRatioMode -> HoppyP.IO ()
...
fitInViewRectAll :: (QGraphicsViewPtr arg'1) => arg'1 -> HoppyP.Double -> HoppyP.Double -> HoppyP.Double -> HoppyP.Double -> M66.QtAspectRatioMode -> HoppyP.IO ()
...
fitInViewItemAll :: (QGraphicsViewPtr arg'1, M230.QGraphicsItemValue arg'2) => arg'1 -> arg'2 -> M66.QtAspectRatioMode -> HoppyP.IO ()
...
render :: (QGraphicsViewPtr arg'1, M140.QPainterPtr arg'2) => arg'1 -> arg'2 -> HoppyP.IO ()
render arg'1 arg'2 =
  HoppyFHR.withCppPtr (toQGraphicsView arg'1) $ \arg'1' ->
  HoppyFHR.withCppPtr (M140.toQPainter arg'2) $ \arg'2' ->
  (render' arg'1' arg'2')

renderAll :: (QGraphicsViewPtr arg'1, M140.QPainterPtr arg'2, M44.QRectFValue arg'3, M42.QRectValue arg'4) => arg'1 -> arg'2 -> arg'3 -> arg'4 -> M66.QtAspectRatioMode -> HoppyP.IO ()
renderAll arg'1 arg'2 arg'3 arg'4 arg'5 =
  HoppyFHR.withCppPtr (toQGraphicsView arg'1) $ \arg'1' ->
  HoppyFHR.withCppPtr (M140.toQPainter arg'2) $ \arg'2' ->
  M44.withQRectFPtr arg'3 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'3' ->
...
setAlignment :: (QGraphicsViewPtr arg'1, M66.IsQtAlignment arg'2) => arg'1 -> arg'2 -> HoppyP.IO ()
setAlignment arg'1 arg'2 =
  HoppyFHR.withCppPtr (toQGraphicsView arg'1) $ \arg'1' ->
  let arg'2' = M66.fromQtAlignment $ M66.toQtAlignment arg'2 in
  (setAlignment' arg'1' arg'2')

setBackgroundBrush :: (QGraphicsViewPtr arg'1, M98.QBrushValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO ()
...
setForegroundBrush :: (QGraphicsViewPtr arg'1, M98.QBrushValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO ()
...
setRenderHint :: (QGraphicsViewPtr arg'1) => arg'1 -> M140.QPainterRenderHint -> HoppyP.IO ()
setRenderHint arg'1 arg'2 =
  HoppyFHR.withCppPtr (toQGraphicsView arg'1) $ \arg'1' ->
  let arg'2' = HoppyFHR.coerceIntegral $ HoppyP.fromEnum arg'2 in
  (setRenderHint' arg'1' arg'2')

setRenderHintAll :: (QGraphicsViewPtr arg'1) => arg'1 -> M140.QPainterRenderHint -> HoppyP.Bool -> HoppyP.IO ()
...
setRenderHints :: (QGraphicsViewPtr arg'1, M140.IsQPainterRenderHints arg'2) => arg'1 -> arg'2 -> HoppyP.IO ()
setRenderHints arg'1 arg'2 =
  HoppyFHR.withCppPtr (toQGraphicsView arg'1) $ \arg'1' ->
  let arg'2' = M140.fromQPainterRenderHints $ M140.toQPainterRenderHints arg'2 in
  (setRenderHints' arg'1' arg'2')
...
setScene :: (QGraphicsViewPtr arg'1, M236.QGraphicsScenePtr arg'2) => arg'1 -> arg'2 -> HoppyP.IO ()
setScene arg'1 arg'2 =
  HoppyFHR.withCppPtr (toQGraphicsView arg'1) $ \arg'1' ->
  HoppyFHR.withCppPtr (M236.toQGraphicsScene arg'2) $ \arg'2' ->
  (setScene' arg'1' arg'2')

setSceneRectF :: (QGraphicsViewPtr arg'1, M44.QRectFValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO ()
...
setTransform :: (QGraphicsViewPtr arg'1, M166.QTransformValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO ()
setTransform arg'1 arg'2 =
  HoppyFHR.withCppPtr (toQGraphicsView arg'1) $ \arg'1' ->
  M166.withQTransformPtr arg'2 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'2' ->
  (setTransform' arg'1' arg'2')

setTransformAll :: (QGraphicsViewPtr arg'1, M166.QTransformValue arg'2) => arg'1 -> arg'2 -> HoppyP.Bool -> HoppyP.IO ()
...
instance M192.QAbstractScrollAreaConstPtr QGraphicsViewConst where
  toQAbstractScrollAreaConst (QGraphicsViewConst ptr') = M192.QAbstractScrollAreaConst $ castQGraphicsViewToQAbstractScrollArea ptr'
  toQAbstractScrollAreaConst (QGraphicsViewConstGc fptr' ptr') = M192.QAbstractScrollAreaConstGc fptr' $ castQGraphicsViewToQAbstractScrollArea ptr'

instance M322.QWidgetConstPtr QGraphicsViewConst where
  toQWidgetConst (QGraphicsViewConst ptr') = M322.QWidgetConst $ castQGraphicsViewToQWidget ptr'
  toQWidgetConst (QGraphicsViewConstGc fptr' ptr') = M322.QWidgetConstGc fptr' $ castQGraphicsViewToQWidget ptr'
...
instance M192.QAbstractScrollAreaConstPtr QGraphicsView where
  toQAbstractScrollAreaConst (QGraphicsView ptr') = M192.QAbstractScrollAreaConst $ castQGraphicsViewToQAbstractScrollArea $ (HoppyF.castPtr :: HoppyF.Ptr QGraphicsView -> HoppyF.Ptr QGraphicsViewConst) ptr'
  toQAbstractScrollAreaConst (QGraphicsViewGc fptr' ptr') = M192.QAbstractScrollAreaConstGc fptr' $ castQGraphicsViewToQAbstractScrollArea $ (HoppyF.castPtr :: HoppyF.Ptr QGraphicsView -> HoppyF.Ptr QGraphicsViewConst) ptr'

instance M192.QAbstractScrollAreaPtr QGraphicsView where
  toQAbstractScrollArea (QGraphicsView ptr') = M192.QAbstractScrollArea $ (HoppyF.castPtr :: HoppyF.Ptr M192.QAbstractScrollAreaConst -> HoppyF.Ptr M192.QAbstractScrollArea) $ castQGraphicsViewToQAbstractScrollArea $ (HoppyF.castPtr :: HoppyF.Ptr QGraphicsView -> HoppyF.Ptr QGraphicsViewConst) ptr'
  toQAbstractScrollArea (QGraphicsViewGc fptr' ptr') = M192.QAbstractScrollAreaGc fptr' $ (HoppyF.castPtr :: HoppyF.Ptr M192.QAbstractScrollAreaConst -> HoppyF.Ptr M192.QAbstractScrollArea) $ castQGraphicsViewToQAbstractScrollArea $ (HoppyF.castPtr :: HoppyF.Ptr QGraphicsView -> HoppyF.Ptr QGraphicsViewConst) ptr'

instance M322.QWidgetConstPtr QGraphicsView where
  toQWidgetConst (QGraphicsView ptr') = M322.QWidgetConst $ castQGraphicsViewToQWidget $ (HoppyF.castPtr :: HoppyF.Ptr QGraphicsView -> HoppyF.Ptr QGraphicsViewConst) ptr'
  toQWidgetConst (QGraphicsViewGc fptr' ptr') = M322.QWidgetConstGc fptr' $ castQGraphicsViewToQWidget $ (HoppyF.castPtr :: HoppyF.Ptr QGraphicsView -> HoppyF.Ptr QGraphicsViewConst) ptr'

instance M322.QWidgetPtr QGraphicsView where
  toQWidget (QGraphicsView ptr') = M322.QWidget $ (HoppyF.castPtr :: HoppyF.Ptr M322.QWidgetConst -> HoppyF.Ptr M322.QWidget) $ castQGraphicsViewToQWidget $ (HoppyF.castPtr :: HoppyF.Ptr QGraphicsView -> HoppyF.Ptr QGraphicsViewConst) ptr'
  toQWidget (QGraphicsViewGc fptr' ptr') = M322.QWidgetGc fptr' $ (HoppyF.castPtr :: HoppyF.Ptr M322.QWidgetConst -> HoppyF.Ptr M322.QWidget) $ castQGraphicsViewToQWidget $ (HoppyF.castPtr :: HoppyF.Ptr QGraphicsView -> HoppyF.Ptr QGraphicsViewConst) ptr'
...
newWithScene :: (M236.QGraphicsScenePtr arg'1) => arg'1 -> HoppyP.IO QGraphicsView
newWithScene arg'1 =
  HoppyFHR.withCppPtr (M236.toQGraphicsScene arg'1) $ \arg'1' ->
  HoppyP.fmap QGraphicsView
  (newWithScene' arg'1')

newWithParent :: (M322.QWidgetPtr arg'1) => arg'1 -> HoppyP.IO QGraphicsView
newWithParent arg'1 =
  HoppyFHR.withCppPtr (M322.toQWidget arg'1) $ \arg'1' ->
  HoppyP.fmap QGraphicsView
  (newWithParent' arg'1')

newWithSceneAndParent :: (M236.QGraphicsScenePtr arg'1, M322.QWidgetPtr arg'2) => arg'1 -> arg'2 -> HoppyP.IO QGraphicsView
...
instance QGraphicsViewSuper M192.QAbstractScrollArea where
  downToQGraphicsView = castQGraphicsViewToNonconst . cast' . M192.castQAbstractScrollAreaToConst
    where
      cast' (M192.QAbstractScrollAreaConst ptr') = QGraphicsViewConst $ castQAbstractScrollAreaToQGraphicsView ptr'
      cast' (M192.QAbstractScrollAreaConstGc fptr' ptr') = QGraphicsViewConstGc fptr' $ castQAbstractScrollAreaToQGraphicsView ptr'
instance QGraphicsViewSuper M322.QWidget where
  downToQGraphicsView = castQGraphicsViewToNonconst . cast' . M322.castQWidgetToConst
    where
      cast' (M322.QWidgetConst ptr') = QGraphicsViewConst $ castQWidgetToQGraphicsView ptr'
      cast' (M322.QWidgetConstGc fptr' ptr') = QGraphicsViewConstGc fptr' $ castQWidgetToQGraphicsView ptr'
...
instance QGraphicsViewSuperConst M192.QAbstractScrollAreaConst where
  downToQGraphicsViewConst = cast'
    where
      cast' (M192.QAbstractScrollAreaConst ptr') = QGraphicsViewConst $ castQAbstractScrollAreaToQGraphicsView ptr'
      cast' (M192.QAbstractScrollAreaConstGc fptr' ptr') = QGraphicsViewConstGc fptr' $ castQAbstractScrollAreaToQGraphicsView ptr'
instance QGraphicsViewSuperConst M322.QWidgetConst where
  downToQGraphicsViewConst = cast'
    where
      cast' (M322.QWidgetConst ptr') = QGraphicsViewConst $ castQWidgetToQGraphicsView ptr'
      cast' (M322.QWidgetConstGc fptr' ptr') = QGraphicsViewConstGc fptr' $ castQWidgetToQGraphicsView ptr'
