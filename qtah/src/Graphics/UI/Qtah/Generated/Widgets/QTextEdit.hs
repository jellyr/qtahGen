...
foreign import ccall "genpop__QTextEdit_newWithParent" newWithParent' ::  HoppyF.Ptr M322.QWidget -> HoppyP.IO (HoppyF.Ptr QTextEdit)
foreign import ccall "genpop__QTextEdit_newWithText" newWithText' ::  HoppyF.Ptr M52.QStringConst -> HoppyP.IO (HoppyF.Ptr QTextEdit)
foreign import ccall "genpop__QTextEdit_newWithTextAndParent" newWithTextAndParent' ::  HoppyF.Ptr M52.QStringConst -> HoppyF.Ptr M322.QWidget -> HoppyP.IO (HoppyF.Ptr QTextEdit)
...
foreign import ccall "genpop__QTextEdit_anchorAt" anchorAt' ::  HoppyF.Ptr QTextEditConst -> HoppyF.Ptr M38.QPointConst -> HoppyP.IO (HoppyF.Ptr M52.QStringConst)
foreign import ccall "genpop__QTextEdit_append" append' ::  HoppyF.Ptr QTextEdit -> HoppyF.Ptr M52.QStringConst -> HoppyP.IO ()
...
foreign import ccall "genpop__QTextEdit_createStandardContextMenu" createStandardContextMenu' ::  HoppyF.Ptr QTextEdit -> HoppyP.IO (HoppyF.Ptr M266.QMenu)
foreign import ccall "genpop__QTextEdit_createStandardContextMenuAt" createStandardContextMenuAt' ::  HoppyF.Ptr QTextEdit -> HoppyF.Ptr M38.QPointConst -> HoppyP.IO (HoppyF.Ptr M266.QMenu)
foreign import ccall "genpop__QTextEdit_currentFont" currentFont' ::  HoppyF.Ptr QTextEditConst -> HoppyP.IO (HoppyF.Ptr M114.QFontConst)
foreign import ccall "genpop__QTextEdit_setCurrentFont" setCurrentFont' ::  HoppyF.Ptr QTextEdit -> HoppyF.Ptr M114.QFontConst -> HoppyP.IO ()
foreign import ccall "genpop__QTextEdit_cursorRect" cursorRect' ::  HoppyF.Ptr QTextEditConst -> HoppyP.IO (HoppyF.Ptr M42.QRectConst)
...
foreign import ccall "genpop__QTextEdit_documentTitle" documentTitle' ::  HoppyF.Ptr QTextEditConst -> HoppyP.IO (HoppyF.Ptr M52.QStringConst)
foreign import ccall "genpop__QTextEdit_setDocumentTitle" setDocumentTitle' ::  HoppyF.Ptr QTextEdit -> HoppyF.Ptr M52.QStringConst -> HoppyP.IO ()
foreign import ccall "genpop__QTextEdit_ensureCursorVisible" ensureCursorVisible' ::  HoppyF.Ptr QTextEdit -> HoppyP.IO ()
foreign import ccall "genpop__QTextEdit_find" find' ::  HoppyF.Ptr QTextEdit -> HoppyF.Ptr M52.QStringConst -> HoppyP.IO HoppyFHR.CBool
foreign import ccall "genpop__QTextEdit_fontFamily" fontFamily' ::  HoppyF.Ptr QTextEditConst -> HoppyP.IO (HoppyF.Ptr M52.QStringConst)
foreign import ccall "genpop__QTextEdit_setFontFamily" setFontFamily' ::  HoppyF.Ptr QTextEdit -> HoppyF.Ptr M52.QStringConst -> HoppyP.IO ()
...
foreign import ccall "genpop__QTextEdit_insertHtml" insertHtml' ::  HoppyF.Ptr QTextEdit -> HoppyF.Ptr M52.QStringConst -> HoppyP.IO ()
foreign import ccall "genpop__QTextEdit_insertPlainText" insertPlainText' ::  HoppyF.Ptr QTextEdit -> HoppyF.Ptr M52.QStringConst -> HoppyP.IO ()
...
foreign import ccall "genpop__QTextEdit_scrollToAnchor" scrollToAnchor' ::  HoppyF.Ptr QTextEdit -> HoppyF.Ptr M52.QStringConst -> HoppyP.IO ()
foreign import ccall "genpop__QTextEdit_selectAll" selectAll' ::  HoppyF.Ptr QTextEdit -> HoppyP.IO ()
foreign import ccall "genpop__QTextEdit_setHtml" setHtml' ::  HoppyF.Ptr QTextEdit -> HoppyF.Ptr M52.QStringConst -> HoppyP.IO ()
foreign import ccall "genpop__QTextEdit_setPlainText" setPlainText' ::  HoppyF.Ptr QTextEdit -> HoppyF.Ptr M52.QStringConst -> HoppyP.IO ()
foreign import ccall "genpop__QTextEdit_setText" setText' ::  HoppyF.Ptr QTextEdit -> HoppyF.Ptr M52.QStringConst -> HoppyP.IO ()
...
foreign import ccall "genpop__QTextEdit_textBackgroundColor" textBackgroundColor' ::  HoppyF.Ptr QTextEditConst -> HoppyP.IO (HoppyF.Ptr M104.QColorConst)
foreign import ccall "genpop__QTextEdit_setTextBackgroundColor" setTextBackgroundColor' ::  HoppyF.Ptr QTextEdit -> HoppyF.Ptr M104.QColorConst -> HoppyP.IO ()
foreign import ccall "genpop__QTextEdit_textColor" textColor' ::  HoppyF.Ptr QTextEditConst -> HoppyP.IO (HoppyF.Ptr M104.QColorConst)
foreign import ccall "genpop__QTextEdit_setTextColor" setTextColor' ::  HoppyF.Ptr QTextEdit -> HoppyF.Ptr M104.QColorConst -> HoppyP.IO ()
foreign import ccall "genpop__QTextEdit_toHtml" toHtml' ::  HoppyF.Ptr QTextEditConst -> HoppyP.IO (HoppyF.Ptr M52.QStringConst)
foreign import ccall "genpop__QTextEdit_toPlainText" toPlainText' ::  HoppyF.Ptr QTextEditConst -> HoppyP.IO (HoppyF.Ptr M52.QStringConst)
...
foreign import ccall "gencast__QTextEdit__QAbstractScrollArea" castQTextEditToQAbstractScrollArea :: HoppyF.Ptr QTextEditConst -> HoppyF.Ptr M192.QAbstractScrollAreaConst
foreign import ccall "gencast__QAbstractScrollArea__QTextEdit" castQAbstractScrollAreaToQTextEdit :: HoppyF.Ptr M192.QAbstractScrollAreaConst -> HoppyF.Ptr QTextEditConst
foreign import ccall "gencast__QTextEdit__QWidget" castQTextEditToQWidget :: HoppyF.Ptr QTextEditConst -> HoppyF.Ptr M322.QWidgetConst
foreign import ccall "gencast__QWidget__QTextEdit" castQWidgetToQTextEdit :: HoppyF.Ptr M322.QWidgetConst -> HoppyF.Ptr QTextEditConst
...
class (M192.QAbstractScrollAreaConstPtr this) => QTextEditConstPtr this where
...
alignment :: (QTextEditValue arg'1) => arg'1 -> HoppyP.IO M66.QtAlignment
alignment arg'1 =
  withQTextEditPtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
  HoppyP.fmap M66.QtAlignment
  (alignment' arg'1')

anchorAt :: (QTextEditValue arg'1, M38.QPointValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO QtahP.String
...
currentFont :: (QTextEditValue arg'1) => arg'1 -> HoppyP.IO M114.QFont
currentFont arg'1 =
  withQTextEditPtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
...
class (QTextEditConstPtr this, M192.QAbstractScrollAreaPtr this) => QTextEditPtr this where
...
setAlignment :: (QTextEditPtr arg'1, M66.IsQtAlignment arg'2) => arg'1 -> arg'2 -> HoppyP.IO ()
setAlignment arg'1 arg'2 =
  HoppyFHR.withCppPtr (toQTextEdit arg'1) $ \arg'1' ->
  let arg'2' = M66.fromQtAlignment $ M66.toQtAlignment arg'2 in
  (setAlignment' arg'1' arg'2')

append :: (QTextEditPtr arg'1, M52.QStringValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO ()
append arg'1 arg'2 =
  HoppyFHR.withCppPtr (toQTextEdit arg'1) $ \arg'1' ->
...
createStandardContextMenu :: (QTextEditPtr arg'1) => arg'1 -> HoppyP.IO M266.QMenu
createStandardContextMenu arg'1 =
  HoppyFHR.withCppPtr (toQTextEdit arg'1) $ \arg'1' ->
  HoppyP.fmap M266.QMenu
  (createStandardContextMenu' arg'1')

createStandardContextMenuAt :: (QTextEditPtr arg'1, M38.QPointValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO M266.QMenu
...
setCurrentFont :: (QTextEditPtr arg'1, M114.QFontValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO ()
...
setDocumentTitle :: (QTextEditPtr arg'1, M52.QStringValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO ()
...
find :: (QTextEditPtr arg'1, M52.QStringValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO HoppyP.Bool
find arg'1 arg'2 =
  HoppyFHR.withCppPtr (toQTextEdit arg'1) $ \arg'1' ->
  M52.withQStringPtr arg'2 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'2' ->
  HoppyP.fmap (/= 0)
...
setFontFamily :: (QTextEditPtr arg'1, M52.QStringValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO ()
...
insertHtml :: (QTextEditPtr arg'1, M52.QStringValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO ()
insertHtml arg'1 arg'2 =
  HoppyFHR.withCppPtr (toQTextEdit arg'1) $ \arg'1' ->
  M52.withQStringPtr arg'2 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'2' ->
  (insertHtml' arg'1' arg'2')

insertPlainText :: (QTextEditPtr arg'1, M52.QStringValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO ()
...
scrollToAnchor :: (QTextEditPtr arg'1, M52.QStringValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO ()
...
setHtml :: (QTextEditPtr arg'1, M52.QStringValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO ()
setHtml arg'1 arg'2 =
  HoppyFHR.withCppPtr (toQTextEdit arg'1) $ \arg'1' ->
  M52.withQStringPtr arg'2 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'2' ->
  (setHtml' arg'1' arg'2')

setPlainText :: (QTextEditPtr arg'1, M52.QStringValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO ()
setPlainText arg'1 arg'2 =
  HoppyFHR.withCppPtr (toQTextEdit arg'1) $ \arg'1' ->
  M52.withQStringPtr arg'2 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'2' ->
  (setPlainText' arg'1' arg'2')

setText :: (QTextEditPtr arg'1, M52.QStringValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO ()
setText arg'1 arg'2 =
  HoppyFHR.withCppPtr (toQTextEdit arg'1) $ \arg'1' ->
  M52.withQStringPtr arg'2 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'2' ->
  (setText' arg'1' arg'2')
...
setTextBackgroundColor :: (QTextEditPtr arg'1, M104.QColorValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO ()
setTextBackgroundColor arg'1 arg'2 =
  HoppyFHR.withCppPtr (toQTextEdit arg'1) $ \arg'1' ->
  M104.withQColorPtr arg'2 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'2' ->
  (setTextBackgroundColor' arg'1' arg'2')

setTextColor :: (QTextEditPtr arg'1, M104.QColorValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO ()
...
instance M192.QAbstractScrollAreaConstPtr QTextEditConst where
  toQAbstractScrollAreaConst (QTextEditConst ptr') = M192.QAbstractScrollAreaConst $ castQTextEditToQAbstractScrollArea ptr'
  toQAbstractScrollAreaConst (QTextEditConstGc fptr' ptr') = M192.QAbstractScrollAreaConstGc fptr' $ castQTextEditToQAbstractScrollArea ptr'

instance M322.QWidgetConstPtr QTextEditConst where
  toQWidgetConst (QTextEditConst ptr') = M322.QWidgetConst $ castQTextEditToQWidget ptr'
  toQWidgetConst (QTextEditConstGc fptr' ptr') = M322.QWidgetConstGc fptr' $ castQTextEditToQWidget ptr'
...
instance M192.QAbstractScrollAreaConstPtr QTextEdit where
  toQAbstractScrollAreaConst (QTextEdit ptr') = M192.QAbstractScrollAreaConst $ castQTextEditToQAbstractScrollArea $ (HoppyF.castPtr :: HoppyF.Ptr QTextEdit -> HoppyF.Ptr QTextEditConst) ptr'
  toQAbstractScrollAreaConst (QTextEditGc fptr' ptr') = M192.QAbstractScrollAreaConstGc fptr' $ castQTextEditToQAbstractScrollArea $ (HoppyF.castPtr :: HoppyF.Ptr QTextEdit -> HoppyF.Ptr QTextEditConst) ptr'

instance M192.QAbstractScrollAreaPtr QTextEdit where
  toQAbstractScrollArea (QTextEdit ptr') = M192.QAbstractScrollArea $ (HoppyF.castPtr :: HoppyF.Ptr M192.QAbstractScrollAreaConst -> HoppyF.Ptr M192.QAbstractScrollArea) $ castQTextEditToQAbstractScrollArea $ (HoppyF.castPtr :: HoppyF.Ptr QTextEdit -> HoppyF.Ptr QTextEditConst) ptr'
  toQAbstractScrollArea (QTextEditGc fptr' ptr') = M192.QAbstractScrollAreaGc fptr' $ (HoppyF.castPtr :: HoppyF.Ptr M192.QAbstractScrollAreaConst -> HoppyF.Ptr M192.QAbstractScrollArea) $ castQTextEditToQAbstractScrollArea $ (HoppyF.castPtr :: HoppyF.Ptr QTextEdit -> HoppyF.Ptr QTextEditConst) ptr'

instance M322.QWidgetConstPtr QTextEdit where
  toQWidgetConst (QTextEdit ptr') = M322.QWidgetConst $ castQTextEditToQWidget $ (HoppyF.castPtr :: HoppyF.Ptr QTextEdit -> HoppyF.Ptr QTextEditConst) ptr'
  toQWidgetConst (QTextEditGc fptr' ptr') = M322.QWidgetConstGc fptr' $ castQTextEditToQWidget $ (HoppyF.castPtr :: HoppyF.Ptr QTextEdit -> HoppyF.Ptr QTextEditConst) ptr'

instance M322.QWidgetPtr QTextEdit where
  toQWidget (QTextEdit ptr') = M322.QWidget $ (HoppyF.castPtr :: HoppyF.Ptr M322.QWidgetConst -> HoppyF.Ptr M322.QWidget) $ castQTextEditToQWidget $ (HoppyF.castPtr :: HoppyF.Ptr QTextEdit -> HoppyF.Ptr QTextEditConst) ptr'
  toQWidget (QTextEditGc fptr' ptr') = M322.QWidgetGc fptr' $ (HoppyF.castPtr :: HoppyF.Ptr M322.QWidgetConst -> HoppyF.Ptr M322.QWidget) $ castQTextEditToQWidget $ (HoppyF.castPtr :: HoppyF.Ptr QTextEdit -> HoppyF.Ptr QTextEditConst) ptr'
...
newWithParent :: (M322.QWidgetPtr arg'1) => arg'1 -> HoppyP.IO QTextEdit
newWithParent arg'1 =
  HoppyFHR.withCppPtr (M322.toQWidget arg'1) $ \arg'1' ->
  HoppyP.fmap QTextEdit
  (newWithParent' arg'1')

newWithText :: (M52.QStringValue arg'1) => arg'1 -> HoppyP.IO QTextEdit
newWithText arg'1 =
  M52.withQStringPtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
  HoppyP.fmap QTextEdit
  (newWithText' arg'1')

newWithTextAndParent :: (M52.QStringValue arg'1, M322.QWidgetPtr arg'2) => arg'1 -> arg'2 -> HoppyP.IO QTextEdit
...
instance QTextEditSuper M192.QAbstractScrollArea where
  downToQTextEdit = castQTextEditToNonconst . cast' . M192.castQAbstractScrollAreaToConst
    where
      cast' (M192.QAbstractScrollAreaConst ptr') = QTextEditConst $ castQAbstractScrollAreaToQTextEdit ptr'
      cast' (M192.QAbstractScrollAreaConstGc fptr' ptr') = QTextEditConstGc fptr' $ castQAbstractScrollAreaToQTextEdit ptr'
instance QTextEditSuper M322.QWidget where
  downToQTextEdit = castQTextEditToNonconst . cast' . M322.castQWidgetToConst
    where
      cast' (M322.QWidgetConst ptr') = QTextEditConst $ castQWidgetToQTextEdit ptr'
      cast' (M322.QWidgetConstGc fptr' ptr') = QTextEditConstGc fptr' $ castQWidgetToQTextEdit ptr'
...
instance QTextEditSuperConst M192.QAbstractScrollAreaConst where
  downToQTextEditConst = cast'
    where
      cast' (M192.QAbstractScrollAreaConst ptr') = QTextEditConst $ castQAbstractScrollAreaToQTextEdit ptr'
      cast' (M192.QAbstractScrollAreaConstGc fptr' ptr') = QTextEditConstGc fptr' $ castQAbstractScrollAreaToQTextEdit ptr'
instance QTextEditSuperConst M322.QWidgetConst where
  downToQTextEditConst = cast'
    where
      cast' (M322.QWidgetConst ptr') = QTextEditConst $ castQWidgetToQTextEdit ptr'
      cast' (M322.QWidgetConstGc fptr' ptr') = QTextEditConstGc fptr' $ castQWidgetToQTextEdit ptr'
