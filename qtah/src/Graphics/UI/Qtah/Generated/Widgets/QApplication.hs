...
import qualified Graphics.UI.Qtah.Generated.Core.QList.QWidget as M86
...
foreign import ccall "genpop__QApplication_new" new' ::  HoppyF.Ptr M54.QStringListConst -> HoppyP.IO (HoppyF.Ptr QApplication)
foreign import ccall "genpop__QApplication_aboutQt" aboutQt' ::  HoppyP.IO ()
foreign import ccall "genpop__QApplication_activeModalWidget" activeModalWidget' ::  HoppyP.IO (HoppyF.Ptr M322.QWidget)
foreign import ccall "genpop__QApplication_activePopupWidget" activePopupWidget' ::  HoppyP.IO (HoppyF.Ptr M322.QWidget)
foreign import ccall "genpop__QApplication_activeWindow" activeWindow' ::  HoppyP.IO (HoppyF.Ptr M322.QWidget)
foreign import ccall "genpop__QApplication_setActiveWindow" setActiveWindow' ::  HoppyF.Ptr M322.QWidget -> HoppyP.IO ()
foreign import ccall "genpop__QApplication_alert" alert' ::  HoppyF.Ptr M322.QWidget -> HoppyFC.CInt -> HoppyP.IO ()
foreign import ccall "genpop__QApplication_allWidgets" allWidgets' ::  HoppyP.IO (HoppyF.Ptr M86.QListQWidgetConst)
...
foreign import ccall "genpop__QApplication_clipboard" clipboard' ::  HoppyP.IO (HoppyF.Ptr M100.QClipboard)
...
foreign import ccall "genpop__QApplication_focusWidget" focusWidget' ::  HoppyP.IO (HoppyF.Ptr M322.QWidget)
foreign import ccall "genpop__QApplication_font" font' ::  HoppyP.IO (HoppyF.Ptr M114.QFontConst)
foreign import ccall "genpop__QApplication_fontWithWidget" fontWithWidget' ::  HoppyF.Ptr M322.QWidget -> HoppyP.IO (HoppyF.Ptr M114.QFontConst)
foreign import ccall "genpop__QApplication_fontWithClass" fontWithClass' ::  HoppyF.Ptr M52.QStringConst -> HoppyP.IO (HoppyF.Ptr M114.QFontConst)
foreign import ccall "genpop__QApplication_globalStrut" globalStrut' ::  HoppyP.IO (HoppyF.Ptr M48.QSizeConst)
foreign import ccall "genpop__QApplication_setGlobalStrut" setGlobalStrut' ::  HoppyF.Ptr M48.QSizeConst -> HoppyP.IO ()
...
foreign import ccall "genpop__QApplication_sessionId" sessionId' ::  HoppyF.Ptr QApplicationConst -> HoppyP.IO (HoppyF.Ptr M52.QStringConst)
foreign import ccall "genpop__QApplication_sessionKey" sessionKey' ::  HoppyF.Ptr QApplicationConst -> HoppyP.IO (HoppyF.Ptr M52.QStringConst)
foreign import ccall "genpop__QApplication_setFont" setFont' ::  HoppyF.Ptr M114.QFontConst -> HoppyP.IO ()
foreign import ccall "genpop__QApplication_setFontWithClass" setFontWithClass' ::  HoppyF.Ptr M114.QFontConst -> HoppyF.Ptr M52.QStringConst -> HoppyP.IO ()
...
foreign import ccall "genpop__QApplication_styleSheet" styleSheet' ::  HoppyF.Ptr QApplicationConst -> HoppyP.IO (HoppyF.Ptr M52.QStringConst)
foreign import ccall "genpop__QApplication_setStyleSheet" setStyleSheet' ::  HoppyF.Ptr QApplication -> HoppyF.Ptr M52.QStringConst -> HoppyP.IO ()
foreign import ccall "genpop__QApplication_topLevelAtPoint" topLevelAtPoint' ::  HoppyF.Ptr M38.QPointConst -> HoppyP.IO (HoppyF.Ptr M322.QWidget)
foreign import ccall "genpop__QApplication_topLevelAtRaw" topLevelAtRaw' ::  HoppyFC.CInt -> HoppyFC.CInt -> HoppyP.IO (HoppyF.Ptr M322.QWidget)
...
foreign import ccall "genpop__QApplication_widgetAtPoint" widgetAtPoint' ::  HoppyF.Ptr M38.QPointConst -> HoppyP.IO (HoppyF.Ptr M322.QWidget)
foreign import ccall "genpop__QApplication_widgetAtRaw" widgetAtRaw' ::  HoppyFC.CInt -> HoppyFC.CInt -> HoppyP.IO (HoppyF.Ptr M322.QWidget)
foreign import ccall "genpop__QApplication_windowIcon" windowIcon' ::  HoppyF.Ptr QApplicationConst -> HoppyP.IO (HoppyF.Ptr M120.QIconConst)
foreign import ccall "genpop__QApplication_setWindowIcon" setWindowIcon' ::  HoppyF.Ptr QApplication -> HoppyF.Ptr M120.QIconConst -> HoppyP.IO ()
...
windowIcon :: (QApplicationValue arg'1) => arg'1 -> HoppyP.IO M120.QIcon
windowIcon arg'1 =
  withQApplicationPtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
...
setStyleSheet :: (QApplicationPtr arg'1, M52.QStringValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO ()
setStyleSheet arg'1 arg'2 =
  HoppyFHR.withCppPtr (toQApplication arg'1) $ \arg'1' ->
  M52.withQStringPtr arg'2 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'2' ->
  (setStyleSheet' arg'1' arg'2')

setWindowIcon :: (QApplicationPtr arg'1, M120.QIconValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO ()
setWindowIcon arg'1 arg'2 =
  HoppyFHR.withCppPtr (toQApplication arg'1) $ \arg'1' ->
  M120.withQIconPtr arg'2 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'2' ->
  (setWindowIcon' arg'1' arg'2')

new :: (M54.QStringListValue arg'1) => arg'1 -> HoppyP.IO QApplication
new arg'1 =
...
activeModalWidget ::  HoppyP.IO M322.QWidget
activeModalWidget =
  HoppyP.fmap M322.QWidget
  (activeModalWidget')

activePopupWidget ::  HoppyP.IO M322.QWidget
activePopupWidget =
  HoppyP.fmap M322.QWidget
  (activePopupWidget')

activeWindow ::  HoppyP.IO M322.QWidget
activeWindow =
  HoppyP.fmap M322.QWidget
  (activeWindow')

setActiveWindow :: (M322.QWidgetPtr arg'1) => arg'1 -> HoppyP.IO ()
setActiveWindow arg'1 =
  HoppyFHR.withCppPtr (M322.toQWidget arg'1) $ \arg'1' ->
  (setActiveWindow' arg'1')

alert :: (M322.QWidgetPtr arg'1) => arg'1 -> HoppyP.Int -> HoppyP.IO ()
alert arg'1 arg'2 =
  HoppyFHR.withCppPtr (M322.toQWidget arg'1) $ \arg'1' ->
  let arg'2' = HoppyFHR.coerceIntegral arg'2 in
  (alert' arg'1' arg'2')

allWidgets ::  HoppyP.IO [M322.QWidget]
allWidgets =
  (HoppyFHR.decodeAndDelete . M86.QListQWidgetConst) =<<
  (allWidgets')
...
clipboard ::  HoppyP.IO M100.QClipboard
clipboard =
  HoppyP.fmap M100.QClipboard
  (clipboard')
...
focusWidget ::  HoppyP.IO M322.QWidget
focusWidget =
  HoppyP.fmap M322.QWidget
  (focusWidget')

font ::  HoppyP.IO M114.QFont
font =
  (HoppyFHR.decodeAndDelete . M114.QFontConst) =<<
  (font')

fontWithWidget :: (M322.QWidgetPtr arg'1) => arg'1 -> HoppyP.IO M114.QFont
fontWithWidget arg'1 =
  HoppyFHR.withCppPtr (M322.toQWidget arg'1) $ \arg'1' ->
  (HoppyFHR.decodeAndDelete . M114.QFontConst) =<<
  (fontWithWidget' arg'1')

fontWithClass :: (M52.QStringValue arg'1) => arg'1 -> HoppyP.IO M114.QFont
fontWithClass arg'1 =
...
setGlobalStrut :: (M48.QSizeValue arg'1) => arg'1 -> HoppyP.IO ()
...
layoutDirection ::  HoppyP.IO M66.QtLayoutDirection
layoutDirection =
...
setFont :: (M114.QFontValue arg'1) => arg'1 -> HoppyP.IO ()
setFont arg'1 =
  M114.withQFontPtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
  (setFont' arg'1')

setFontWithClass :: (M114.QFontValue arg'1, M52.QStringValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO ()
...
setLayoutDirection ::  M66.QtLayoutDirection -> HoppyP.IO ()
...
topLevelAtPoint :: (M38.QPointValue arg'1) => arg'1 -> HoppyP.IO M322.QWidget
topLevelAtPoint arg'1 =
  M38.withQPointPtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
  HoppyP.fmap M322.QWidget
  (topLevelAtPoint' arg'1')

topLevelAtRaw ::  HoppyP.Int -> HoppyP.Int -> HoppyP.IO M322.QWidget
...
widgetAtPoint :: (M38.QPointValue arg'1) => arg'1 -> HoppyP.IO M322.QWidget
widgetAtPoint arg'1 =
  M38.withQPointPtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
  HoppyP.fmap M322.QWidget
  (widgetAtPoint' arg'1')

widgetAtRaw ::  HoppyP.Int -> HoppyP.Int -> HoppyP.IO M322.QWidget
