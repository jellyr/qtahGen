...
foreign import ccall "genpop__QFrame_newWithParent" newWithParent' ::  HoppyF.Ptr M322.QWidget -> HoppyP.IO (HoppyF.Ptr QFrame)
foreign import ccall "genpop__QFrame_frameRect" frameRect' ::  HoppyF.Ptr QFrameConst -> HoppyP.IO (HoppyF.Ptr M42.QRectConst)
foreign import ccall "genpop__QFrame_setFrameRect" setFrameRect' ::  HoppyF.Ptr QFrame -> HoppyF.Ptr M42.QRectConst -> HoppyP.IO ()
...
foreign import ccall "gencast__QFrame__QWidget" castQFrameToQWidget :: HoppyF.Ptr QFrameConst -> HoppyF.Ptr M322.QWidgetConst
foreign import ccall "gencast__QWidget__QFrame" castQWidgetToQFrame :: HoppyF.Ptr M322.QWidgetConst -> HoppyF.Ptr QFrameConst
...
class (M322.QWidgetConstPtr this) => QFrameConstPtr this where
...
class (QFrameConstPtr this, M322.QWidgetPtr this) => QFramePtr this where
  toQFrame :: this -> QFrame

setFrameRect :: (QFramePtr arg'1, M42.QRectValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO ()
...
instance M322.QWidgetConstPtr QFrameConst where
  toQWidgetConst (QFrameConst ptr') = M322.QWidgetConst $ castQFrameToQWidget ptr'
  toQWidgetConst (QFrameConstGc fptr' ptr') = M322.QWidgetConstGc fptr' $ castQFrameToQWidget ptr'
...
instance M322.QWidgetConstPtr QFrame where
  toQWidgetConst (QFrame ptr') = M322.QWidgetConst $ castQFrameToQWidget $ (HoppyF.castPtr :: HoppyF.Ptr QFrame -> HoppyF.Ptr QFrameConst) ptr'
  toQWidgetConst (QFrameGc fptr' ptr') = M322.QWidgetConstGc fptr' $ castQFrameToQWidget $ (HoppyF.castPtr :: HoppyF.Ptr QFrame -> HoppyF.Ptr QFrameConst) ptr'

instance M322.QWidgetPtr QFrame where
  toQWidget (QFrame ptr') = M322.QWidget $ (HoppyF.castPtr :: HoppyF.Ptr M322.QWidgetConst -> HoppyF.Ptr M322.QWidget) $ castQFrameToQWidget $ (HoppyF.castPtr :: HoppyF.Ptr QFrame -> HoppyF.Ptr QFrameConst) ptr'
  toQWidget (QFrameGc fptr' ptr') = M322.QWidgetGc fptr' $ (HoppyF.castPtr :: HoppyF.Ptr M322.QWidgetConst -> HoppyF.Ptr M322.QWidget) $ castQFrameToQWidget $ (HoppyF.castPtr :: HoppyF.Ptr QFrame -> HoppyF.Ptr QFrameConst) ptr'
...
newWithParent :: (M322.QWidgetPtr arg'1) => arg'1 -> HoppyP.IO QFrame
newWithParent arg'1 =
...
instance QFrameSuper M322.QWidget where
  downToQFrame = castQFrameToNonconst . cast' . M322.castQWidgetToConst
    where
      cast' (M322.QWidgetConst ptr') = QFrameConst $ castQWidgetToQFrame ptr'
      cast' (M322.QWidgetConstGc fptr' ptr') = QFrameConstGc fptr' $ castQWidgetToQFrame ptr'
...
instance QFrameSuperConst M322.QWidgetConst where
