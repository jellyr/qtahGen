...
foreign import ccall "genpop__QDial_newWithParent" newWithParent' ::  HoppyF.Ptr M322.QWidget -> HoppyP.IO (HoppyF.Ptr QDial)
...
foreign import ccall "gencast__QDial__QAbstractSlider" castQDialToQAbstractSlider :: HoppyF.Ptr QDialConst -> HoppyF.Ptr M194.QAbstractSliderConst
foreign import ccall "gencast__QAbstractSlider__QDial" castQAbstractSliderToQDial :: HoppyF.Ptr M194.QAbstractSliderConst -> HoppyF.Ptr QDialConst
foreign import ccall "gencast__QDial__QWidget" castQDialToQWidget :: HoppyF.Ptr QDialConst -> HoppyF.Ptr M322.QWidgetConst
foreign import ccall "gencast__QWidget__QDial" castQWidgetToQDial :: HoppyF.Ptr M322.QWidgetConst -> HoppyF.Ptr QDialConst
...
class (M194.QAbstractSliderConstPtr this) => QDialConstPtr this where
...
class (QDialConstPtr this, M194.QAbstractSliderPtr this) => QDialPtr this where
  toQDial :: this -> QDial
...
instance M194.QAbstractSliderConstPtr QDialConst where
  toQAbstractSliderConst (QDialConst ptr') = M194.QAbstractSliderConst $ castQDialToQAbstractSlider ptr'
  toQAbstractSliderConst (QDialConstGc fptr' ptr') = M194.QAbstractSliderConstGc fptr' $ castQDialToQAbstractSlider ptr'

instance M322.QWidgetConstPtr QDialConst where
  toQWidgetConst (QDialConst ptr') = M322.QWidgetConst $ castQDialToQWidget ptr'
  toQWidgetConst (QDialConstGc fptr' ptr') = M322.QWidgetConstGc fptr' $ castQDialToQWidget ptr'
...
instance M194.QAbstractSliderConstPtr QDial where
  toQAbstractSliderConst (QDial ptr') = M194.QAbstractSliderConst $ castQDialToQAbstractSlider $ (HoppyF.castPtr :: HoppyF.Ptr QDial -> HoppyF.Ptr QDialConst) ptr'
  toQAbstractSliderConst (QDialGc fptr' ptr') = M194.QAbstractSliderConstGc fptr' $ castQDialToQAbstractSlider $ (HoppyF.castPtr :: HoppyF.Ptr QDial -> HoppyF.Ptr QDialConst) ptr'

instance M194.QAbstractSliderPtr QDial where
  toQAbstractSlider (QDial ptr') = M194.QAbstractSlider $ (HoppyF.castPtr :: HoppyF.Ptr M194.QAbstractSliderConst -> HoppyF.Ptr M194.QAbstractSlider) $ castQDialToQAbstractSlider $ (HoppyF.castPtr :: HoppyF.Ptr QDial -> HoppyF.Ptr QDialConst) ptr'
  toQAbstractSlider (QDialGc fptr' ptr') = M194.QAbstractSliderGc fptr' $ (HoppyF.castPtr :: HoppyF.Ptr M194.QAbstractSliderConst -> HoppyF.Ptr M194.QAbstractSlider) $ castQDialToQAbstractSlider $ (HoppyF.castPtr :: HoppyF.Ptr QDial -> HoppyF.Ptr QDialConst) ptr'

instance M322.QWidgetConstPtr QDial where
  toQWidgetConst (QDial ptr') = M322.QWidgetConst $ castQDialToQWidget $ (HoppyF.castPtr :: HoppyF.Ptr QDial -> HoppyF.Ptr QDialConst) ptr'
  toQWidgetConst (QDialGc fptr' ptr') = M322.QWidgetConstGc fptr' $ castQDialToQWidget $ (HoppyF.castPtr :: HoppyF.Ptr QDial -> HoppyF.Ptr QDialConst) ptr'

instance M322.QWidgetPtr QDial where
  toQWidget (QDial ptr') = M322.QWidget $ (HoppyF.castPtr :: HoppyF.Ptr M322.QWidgetConst -> HoppyF.Ptr M322.QWidget) $ castQDialToQWidget $ (HoppyF.castPtr :: HoppyF.Ptr QDial -> HoppyF.Ptr QDialConst) ptr'
  toQWidget (QDialGc fptr' ptr') = M322.QWidgetGc fptr' $ (HoppyF.castPtr :: HoppyF.Ptr M322.QWidgetConst -> HoppyF.Ptr M322.QWidget) $ castQDialToQWidget $ (HoppyF.castPtr :: HoppyF.Ptr QDial -> HoppyF.Ptr QDialConst) ptr'
...
newWithParent :: (M322.QWidgetPtr arg'1) => arg'1 -> HoppyP.IO QDial
newWithParent arg'1 =
...
instance QDialSuper M194.QAbstractSlider where
  downToQDial = castQDialToNonconst . cast' . M194.castQAbstractSliderToConst
    where
      cast' (M194.QAbstractSliderConst ptr') = QDialConst $ castQAbstractSliderToQDial ptr'
      cast' (M194.QAbstractSliderConstGc fptr' ptr') = QDialConstGc fptr' $ castQAbstractSliderToQDial ptr'
instance QDialSuper M322.QWidget where
  downToQDial = castQDialToNonconst . cast' . M322.castQWidgetToConst
    where
      cast' (M322.QWidgetConst ptr') = QDialConst $ castQWidgetToQDial ptr'
      cast' (M322.QWidgetConstGc fptr' ptr') = QDialConstGc fptr' $ castQWidgetToQDial ptr'
...
instance QDialSuperConst M194.QAbstractSliderConst where
  downToQDialConst = cast'
    where
      cast' (M194.QAbstractSliderConst ptr') = QDialConst $ castQAbstractSliderToQDial ptr'
      cast' (M194.QAbstractSliderConstGc fptr' ptr') = QDialConstGc fptr' $ castQAbstractSliderToQDial ptr'
instance QDialSuperConst M322.QWidgetConst where
  downToQDialConst = cast'
    where
      cast' (M322.QWidgetConst ptr') = QDialConst $ castQWidgetToQDial ptr'
      cast' (M322.QWidgetConstGc fptr' ptr') = QDialConstGc fptr' $ castQWidgetToQDial ptr'
