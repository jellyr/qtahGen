...
foreign import ccall "genpop__QStackedLayout_newWithParent" newWithParent' ::  HoppyF.Ptr M322.QWidget -> HoppyP.IO (HoppyF.Ptr QStackedLayout)
foreign import ccall "genpop__QStackedLayout_newWithLayout" newWithLayout' ::  HoppyF.Ptr M256.QLayout -> HoppyP.IO (HoppyF.Ptr QStackedLayout)
foreign import ccall "genpop__QStackedLayout_addWidget" addWidget' ::  HoppyF.Ptr QStackedLayout -> HoppyF.Ptr M322.QWidget -> HoppyP.IO HoppyFC.CInt
...
foreign import ccall "genpop__QStackedLayout_currentWidget" currentWidget' ::  HoppyF.Ptr QStackedLayoutConst -> HoppyP.IO (HoppyF.Ptr M322.QWidget)
foreign import ccall "genpop__QStackedLayout_setCurrentWidget" setCurrentWidget' ::  HoppyF.Ptr QStackedLayout -> HoppyF.Ptr M322.QWidget -> HoppyP.IO ()
foreign import ccall "genpop__QStackedLayout_insertWidget" insertWidget' ::  HoppyF.Ptr QStackedLayout -> HoppyFC.CInt -> HoppyF.Ptr M322.QWidget -> HoppyP.IO HoppyFC.CInt
...
foreign import ccall "genpop__QStackedLayout_widget" widget' ::  HoppyF.Ptr QStackedLayoutConst -> HoppyFC.CInt -> HoppyP.IO (HoppyF.Ptr M322.QWidget)
foreign import ccall "gencast__QStackedLayout__QLayout" castQStackedLayoutToQLayout :: HoppyF.Ptr QStackedLayoutConst -> HoppyF.Ptr M256.QLayoutConst
foreign import ccall "gencast__QLayout__QStackedLayout" castQLayoutToQStackedLayout :: HoppyF.Ptr M256.QLayoutConst -> HoppyF.Ptr QStackedLayoutConst
...
foreign import ccall "gencast__QStackedLayout__QLayoutItem" castQStackedLayoutToQLayoutItem :: HoppyF.Ptr QStackedLayoutConst -> HoppyF.Ptr M258.QLayoutItemConst
foreign import ccall "gencast__QLayoutItem__QStackedLayout" castQLayoutItemToQStackedLayout :: HoppyF.Ptr M258.QLayoutItemConst -> HoppyF.Ptr QStackedLayoutConst
...
class (M256.QLayoutConstPtr this) => QStackedLayoutConstPtr this where
...
currentWidget :: (QStackedLayoutValue arg'1) => arg'1 -> HoppyP.IO M322.QWidget
currentWidget arg'1 =
  withQStackedLayoutPtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
...
widget :: (QStackedLayoutValue arg'1) => arg'1 -> HoppyP.Int -> HoppyP.IO M322.QWidget
widget arg'1 arg'2 =
  withQStackedLayoutPtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
...
class (QStackedLayoutConstPtr this, M256.QLayoutPtr this) => QStackedLayoutPtr this where
  toQStackedLayout :: this -> QStackedLayout

addWidget :: (QStackedLayoutPtr arg'1, M322.QWidgetPtr arg'2) => arg'1 -> arg'2 -> HoppyP.IO HoppyP.Int
...
setCurrentWidget :: (QStackedLayoutPtr arg'1, M322.QWidgetPtr arg'2) => arg'1 -> arg'2 -> HoppyP.IO ()
setCurrentWidget arg'1 arg'2 =
  HoppyFHR.withCppPtr (toQStackedLayout arg'1) $ \arg'1' ->
  HoppyFHR.withCppPtr (M322.toQWidget arg'2) $ \arg'2' ->
  (setCurrentWidget' arg'1' arg'2')

insertWidget :: (QStackedLayoutPtr arg'1, M322.QWidgetPtr arg'3) => arg'1 -> HoppyP.Int -> arg'3 -> HoppyP.IO HoppyP.Int
...
instance M256.QLayoutConstPtr QStackedLayoutConst where
  toQLayoutConst (QStackedLayoutConst ptr') = M256.QLayoutConst $ castQStackedLayoutToQLayout ptr'
  toQLayoutConst (QStackedLayoutConstGc fptr' ptr') = M256.QLayoutConstGc fptr' $ castQStackedLayoutToQLayout ptr'
...
instance M258.QLayoutItemConstPtr QStackedLayoutConst where
  toQLayoutItemConst (QStackedLayoutConst ptr') = M258.QLayoutItemConst $ castQStackedLayoutToQLayoutItem ptr'
  toQLayoutItemConst (QStackedLayoutConstGc fptr' ptr') = M258.QLayoutItemConstGc fptr' $ castQStackedLayoutToQLayoutItem ptr'
...
instance M256.QLayoutConstPtr QStackedLayout where
  toQLayoutConst (QStackedLayout ptr') = M256.QLayoutConst $ castQStackedLayoutToQLayout $ (HoppyF.castPtr :: HoppyF.Ptr QStackedLayout -> HoppyF.Ptr QStackedLayoutConst) ptr'
  toQLayoutConst (QStackedLayoutGc fptr' ptr') = M256.QLayoutConstGc fptr' $ castQStackedLayoutToQLayout $ (HoppyF.castPtr :: HoppyF.Ptr QStackedLayout -> HoppyF.Ptr QStackedLayoutConst) ptr'

instance M256.QLayoutPtr QStackedLayout where
  toQLayout (QStackedLayout ptr') = M256.QLayout $ (HoppyF.castPtr :: HoppyF.Ptr M256.QLayoutConst -> HoppyF.Ptr M256.QLayout) $ castQStackedLayoutToQLayout $ (HoppyF.castPtr :: HoppyF.Ptr QStackedLayout -> HoppyF.Ptr QStackedLayoutConst) ptr'
  toQLayout (QStackedLayoutGc fptr' ptr') = M256.QLayoutGc fptr' $ (HoppyF.castPtr :: HoppyF.Ptr M256.QLayoutConst -> HoppyF.Ptr M256.QLayout) $ castQStackedLayoutToQLayout $ (HoppyF.castPtr :: HoppyF.Ptr QStackedLayout -> HoppyF.Ptr QStackedLayoutConst) ptr'
...
instance M258.QLayoutItemConstPtr QStackedLayout where
  toQLayoutItemConst (QStackedLayout ptr') = M258.QLayoutItemConst $ castQStackedLayoutToQLayoutItem $ (HoppyF.castPtr :: HoppyF.Ptr QStackedLayout -> HoppyF.Ptr QStackedLayoutConst) ptr'
  toQLayoutItemConst (QStackedLayoutGc fptr' ptr') = M258.QLayoutItemConstGc fptr' $ castQStackedLayoutToQLayoutItem $ (HoppyF.castPtr :: HoppyF.Ptr QStackedLayout -> HoppyF.Ptr QStackedLayoutConst) ptr'

instance M258.QLayoutItemPtr QStackedLayout where
  toQLayoutItem (QStackedLayout ptr') = M258.QLayoutItem $ (HoppyF.castPtr :: HoppyF.Ptr M258.QLayoutItemConst -> HoppyF.Ptr M258.QLayoutItem) $ castQStackedLayoutToQLayoutItem $ (HoppyF.castPtr :: HoppyF.Ptr QStackedLayout -> HoppyF.Ptr QStackedLayoutConst) ptr'
  toQLayoutItem (QStackedLayoutGc fptr' ptr') = M258.QLayoutItemGc fptr' $ (HoppyF.castPtr :: HoppyF.Ptr M258.QLayoutItemConst -> HoppyF.Ptr M258.QLayoutItem) $ castQStackedLayoutToQLayoutItem $ (HoppyF.castPtr :: HoppyF.Ptr QStackedLayout -> HoppyF.Ptr QStackedLayoutConst) ptr'
...
newWithParent :: (M322.QWidgetPtr arg'1) => arg'1 -> HoppyP.IO QStackedLayout
newWithParent arg'1 =
  HoppyFHR.withCppPtr (M322.toQWidget arg'1) $ \arg'1' ->
  HoppyP.fmap QStackedLayout
  (newWithParent' arg'1')

newWithLayout :: (M256.QLayoutPtr arg'1) => arg'1 -> HoppyP.IO QStackedLayout
newWithLayout arg'1 =
  HoppyFHR.withCppPtr (M256.toQLayout arg'1) $ \arg'1' ->
  HoppyP.fmap QStackedLayout
  (newWithLayout' arg'1')
...
instance QStackedLayoutSuper M256.QLayout where
  downToQStackedLayout = castQStackedLayoutToNonconst . cast' . M256.castQLayoutToConst
    where
      cast' (M256.QLayoutConst ptr') = QStackedLayoutConst $ castQLayoutToQStackedLayout ptr'
      cast' (M256.QLayoutConstGc fptr' ptr') = QStackedLayoutConstGc fptr' $ castQLayoutToQStackedLayout ptr'
...
instance QStackedLayoutSuper M258.QLayoutItem where
  downToQStackedLayout = castQStackedLayoutToNonconst . cast' . M258.castQLayoutItemToConst
    where
      cast' (M258.QLayoutItemConst ptr') = QStackedLayoutConst $ castQLayoutItemToQStackedLayout ptr'
      cast' (M258.QLayoutItemConstGc fptr' ptr') = QStackedLayoutConstGc fptr' $ castQLayoutItemToQStackedLayout ptr'

class QStackedLayoutSuperConst a where
  downToQStackedLayoutConst :: a -> QStackedLayoutConst

instance QStackedLayoutSuperConst M256.QLayoutConst where
...
instance QStackedLayoutSuperConst M34.QObjectConst where
  downToQStackedLayoutConst = cast'
    where
      cast' (M34.QObjectConst ptr') = QStackedLayoutConst $ castQObjectToQStackedLayout ptr'
      cast' (M34.QObjectConstGc fptr' ptr') = QStackedLayoutConstGc fptr' $ castQObjectToQStackedLayout ptr'
instance QStackedLayoutSuperConst M258.QLayoutItemConst where
  downToQStackedLayoutConst = cast'
    where
      cast' (M258.QLayoutItemConst ptr') = QStackedLayoutConst $ castQLayoutItemToQStackedLayout ptr'
      cast' (M258.QLayoutItemConstGc fptr' ptr') = QStackedLayoutConstGc fptr' $ castQLayoutItemToQStackedLayout ptr'
