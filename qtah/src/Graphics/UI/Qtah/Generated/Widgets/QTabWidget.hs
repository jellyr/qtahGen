...
foreign import ccall "genpop__QTabWidget_newWithParent" newWithParent' ::  HoppyF.Ptr M322.QWidget -> HoppyP.IO (HoppyF.Ptr QTabWidget)
foreign import ccall "genpop__QTabWidget_addTab" addTab' ::  HoppyF.Ptr QTabWidget -> HoppyF.Ptr M322.QWidget -> HoppyF.Ptr M52.QStringConst -> HoppyP.IO HoppyFC.CInt
foreign import ccall "genpop__QTabWidget_addTabWithIcon" addTabWithIcon' ::  HoppyF.Ptr QTabWidget -> HoppyF.Ptr M322.QWidget -> HoppyF.Ptr M120.QIconConst -> HoppyF.Ptr M52.QStringConst -> HoppyP.IO HoppyFC.CInt
foreign import ccall "genpop__QTabWidget_clear" clear' ::  HoppyF.Ptr QTabWidget -> HoppyP.IO ()
foreign import ccall "genpop__QTabWidget_cornerWidget" cornerWidget' ::  HoppyF.Ptr QTabWidgetConst -> HoppyFC.CInt -> HoppyP.IO (HoppyF.Ptr M322.QWidget)
...
foreign import ccall "genpop__QTabWidget_currentWidget" currentWidget' ::  HoppyF.Ptr QTabWidgetConst -> HoppyP.IO (HoppyF.Ptr M322.QWidget)
foreign import ccall "genpop__QTabWidget_setCurrentWidget" setCurrentWidget' ::  HoppyF.Ptr QTabWidget -> HoppyF.Ptr M322.QWidget -> HoppyP.IO ()
...
foreign import ccall "genpop__QTabWidget_iconSize" iconSize' ::  HoppyF.Ptr QTabWidgetConst -> HoppyP.IO (HoppyF.Ptr M48.QSizeConst)
foreign import ccall "genpop__QTabWidget_setIconSize" setIconSize' ::  HoppyF.Ptr QTabWidget -> HoppyF.Ptr M48.QSizeConst -> HoppyP.IO ()
foreign import ccall "genpop__QTabWidget_indexOf" indexOf' ::  HoppyF.Ptr QTabWidgetConst -> HoppyF.Ptr M322.QWidget -> HoppyP.IO HoppyFC.CInt
foreign import ccall "genpop__QTabWidget_insertTab" insertTab' ::  HoppyF.Ptr QTabWidget -> HoppyFC.CInt -> HoppyF.Ptr M322.QWidget -> HoppyF.Ptr M52.QStringConst -> HoppyP.IO HoppyFC.CInt
foreign import ccall "genpop__QTabWidget_insertTabWithIcon" insertTabWithIcon' ::  HoppyF.Ptr QTabWidget -> HoppyFC.CInt -> HoppyF.Ptr M322.QWidget -> HoppyF.Ptr M120.QIconConst -> HoppyF.Ptr M52.QStringConst -> HoppyP.IO HoppyFC.CInt
...
foreign import ccall "genpop__QTabWidget_setCornerWidget" setCornerWidget' ::  HoppyF.Ptr QTabWidget -> HoppyF.Ptr M322.QWidget -> HoppyFC.CInt -> HoppyP.IO ()
...
foreign import ccall "genpop__QTabWidget_setTabIcon" setTabIcon' ::  HoppyF.Ptr QTabWidget -> HoppyFC.CInt -> HoppyF.Ptr M120.QIconConst -> HoppyP.IO ()
foreign import ccall "genpop__QTabWidget_setTabText" setTabText' ::  HoppyF.Ptr QTabWidget -> HoppyFC.CInt -> HoppyF.Ptr M52.QStringConst -> HoppyP.IO ()
foreign import ccall "genpop__QTabWidget_setTabToolTip" setTabToolTip' ::  HoppyF.Ptr QTabWidget -> HoppyFC.CInt -> HoppyF.Ptr M52.QStringConst -> HoppyP.IO ()
foreign import ccall "genpop__QTabWidget_setTabWhatsThis" setTabWhatsThis' ::  HoppyF.Ptr QTabWidget -> HoppyFC.CInt -> HoppyF.Ptr M52.QStringConst -> HoppyP.IO ()
...
foreign import ccall "genpop__QTabWidget_tabIcon" tabIcon' ::  HoppyF.Ptr QTabWidgetConst -> HoppyFC.CInt -> HoppyP.IO (HoppyF.Ptr M120.QIconConst)
...
foreign import ccall "genpop__QTabWidget_tabText" tabText' ::  HoppyF.Ptr QTabWidgetConst -> HoppyFC.CInt -> HoppyP.IO (HoppyF.Ptr M52.QStringConst)
foreign import ccall "genpop__QTabWidget_tabToolTip" tabToolTip' ::  HoppyF.Ptr QTabWidgetConst -> HoppyFC.CInt -> HoppyP.IO (HoppyF.Ptr M52.QStringConst)
foreign import ccall "genpop__QTabWidget_tabWhatsThis" tabWhatsThis' ::  HoppyF.Ptr QTabWidgetConst -> HoppyFC.CInt -> HoppyP.IO (HoppyF.Ptr M52.QStringConst)
...
foreign import ccall "genpop__QTabWidget_widget" widget' ::  HoppyF.Ptr QTabWidgetConst -> HoppyFC.CInt -> HoppyP.IO (HoppyF.Ptr M322.QWidget)
foreign import ccall "gencast__QTabWidget__QWidget" castQTabWidgetToQWidget :: HoppyF.Ptr QTabWidgetConst -> HoppyF.Ptr M322.QWidgetConst
foreign import ccall "gencast__QWidget__QTabWidget" castQWidgetToQTabWidget :: HoppyF.Ptr M322.QWidgetConst -> HoppyF.Ptr QTabWidgetConst
...
class (M322.QWidgetConstPtr this) => QTabWidgetConstPtr this where
  toQTabWidgetConst :: this -> QTabWidgetConst

cornerWidget :: (QTabWidgetValue arg'1) => arg'1 -> M66.QtCorner -> HoppyP.IO M322.QWidget
...
currentWidget :: (QTabWidgetValue arg'1) => arg'1 -> HoppyP.IO M322.QWidget
currentWidget arg'1 =
  withQTabWidgetPtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
  HoppyP.fmap M322.QWidget
  (currentWidget' arg'1')
...
elideMode :: (QTabWidgetValue arg'1) => arg'1 -> HoppyP.IO M66.QtTextElideMode
elideMode arg'1 =
  withQTabWidgetPtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
...
indexOf :: (QTabWidgetValue arg'1, M322.QWidgetPtr arg'2) => arg'1 -> arg'2 -> HoppyP.IO HoppyP.Int
indexOf arg'1 arg'2 =
  withQTabWidgetPtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
...
tabIcon :: (QTabWidgetValue arg'1) => arg'1 -> HoppyP.Int -> HoppyP.IO M120.QIcon
tabIcon arg'1 arg'2 =
  withQTabWidgetPtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
  let arg'2' = HoppyFHR.coerceIntegral arg'2 in
...
widget :: (QTabWidgetValue arg'1) => arg'1 -> HoppyP.Int -> HoppyP.IO M322.QWidget
widget arg'1 arg'2 =
  withQTabWidgetPtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
  let arg'2' = HoppyFHR.coerceIntegral arg'2 in
  HoppyP.fmap M322.QWidget
...
class (QTabWidgetConstPtr this, M322.QWidgetPtr this) => QTabWidgetPtr this where
  toQTabWidget :: this -> QTabWidget

addTab :: (QTabWidgetPtr arg'1, M322.QWidgetPtr arg'2, M52.QStringValue arg'3) => arg'1 -> arg'2 -> arg'3 -> HoppyP.IO HoppyP.Int
...
addTabWithIcon :: (QTabWidgetPtr arg'1, M322.QWidgetPtr arg'2, M120.QIconValue arg'3, M52.QStringValue arg'4) => arg'1 -> arg'2 -> arg'3 -> arg'4 -> HoppyP.IO HoppyP.Int
...
setCurrentWidget :: (QTabWidgetPtr arg'1, M322.QWidgetPtr arg'2) => arg'1 -> arg'2 -> HoppyP.IO ()
...
setElideMode :: (QTabWidgetPtr arg'1) => arg'1 -> M66.QtTextElideMode -> HoppyP.IO ()
setElideMode arg'1 arg'2 =
  HoppyFHR.withCppPtr (toQTabWidget arg'1) $ \arg'1' ->
  let arg'2' = HoppyFHR.coerceIntegral $ HoppyP.fromEnum arg'2 in
  (setElideMode' arg'1' arg'2')

setIconSize :: (QTabWidgetPtr arg'1, M48.QSizeValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO ()
setIconSize arg'1 arg'2 =
  HoppyFHR.withCppPtr (toQTabWidget arg'1) $ \arg'1' ->
  M48.withQSizePtr arg'2 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'2' ->
  (setIconSize' arg'1' arg'2')

insertTab :: (QTabWidgetPtr arg'1, M322.QWidgetPtr arg'3, M52.QStringValue arg'4) => arg'1 -> HoppyP.Int -> arg'3 -> arg'4 -> HoppyP.IO HoppyP.Int
...
insertTabWithIcon :: (QTabWidgetPtr arg'1, M322.QWidgetPtr arg'3, M120.QIconValue arg'4, M52.QStringValue arg'5) => arg'1 -> HoppyP.Int -> arg'3 -> arg'4 -> arg'5 -> HoppyP.IO HoppyP.Int
...
setCornerWidget :: (QTabWidgetPtr arg'1, M322.QWidgetPtr arg'2) => arg'1 -> arg'2 -> M66.QtCorner -> HoppyP.IO ()
...
setTabIcon :: (QTabWidgetPtr arg'1, M120.QIconValue arg'3) => arg'1 -> HoppyP.Int -> arg'3 -> HoppyP.IO ()
...
setTabText :: (QTabWidgetPtr arg'1, M52.QStringValue arg'3) => arg'1 -> HoppyP.Int -> arg'3 -> HoppyP.IO ()
...
setTabToolTip :: (QTabWidgetPtr arg'1, M52.QStringValue arg'3) => arg'1 -> HoppyP.Int -> arg'3 -> HoppyP.IO ()
...
setTabWhatsThis :: (QTabWidgetPtr arg'1, M52.QStringValue arg'3) => arg'1 -> HoppyP.Int -> arg'3 -> HoppyP.IO ()
...
instance M322.QWidgetConstPtr QTabWidgetConst where
  toQWidgetConst (QTabWidgetConst ptr') = M322.QWidgetConst $ castQTabWidgetToQWidget ptr'
  toQWidgetConst (QTabWidgetConstGc fptr' ptr') = M322.QWidgetConstGc fptr' $ castQTabWidgetToQWidget ptr'
...
instance M322.QWidgetConstPtr QTabWidget where
  toQWidgetConst (QTabWidget ptr') = M322.QWidgetConst $ castQTabWidgetToQWidget $ (HoppyF.castPtr :: HoppyF.Ptr QTabWidget -> HoppyF.Ptr QTabWidgetConst) ptr'
  toQWidgetConst (QTabWidgetGc fptr' ptr') = M322.QWidgetConstGc fptr' $ castQTabWidgetToQWidget $ (HoppyF.castPtr :: HoppyF.Ptr QTabWidget -> HoppyF.Ptr QTabWidgetConst) ptr'

instance M322.QWidgetPtr QTabWidget where
  toQWidget (QTabWidget ptr') = M322.QWidget $ (HoppyF.castPtr :: HoppyF.Ptr M322.QWidgetConst -> HoppyF.Ptr M322.QWidget) $ castQTabWidgetToQWidget $ (HoppyF.castPtr :: HoppyF.Ptr QTabWidget -> HoppyF.Ptr QTabWidgetConst) ptr'
  toQWidget (QTabWidgetGc fptr' ptr') = M322.QWidgetGc fptr' $ (HoppyF.castPtr :: HoppyF.Ptr M322.QWidgetConst -> HoppyF.Ptr M322.QWidget) $ castQTabWidgetToQWidget $ (HoppyF.castPtr :: HoppyF.Ptr QTabWidget -> HoppyF.Ptr QTabWidgetConst) ptr'
...
newWithParent :: (M322.QWidgetPtr arg'1) => arg'1 -> HoppyP.IO QTabWidget
newWithParent arg'1 =
...
instance QTabWidgetSuper M322.QWidget where
  downToQTabWidget = castQTabWidgetToNonconst . cast' . M322.castQWidgetToConst
    where
      cast' (M322.QWidgetConst ptr') = QTabWidgetConst $ castQWidgetToQTabWidget ptr'
      cast' (M322.QWidgetConstGc fptr' ptr') = QTabWidgetConstGc fptr' $ castQWidgetToQTabWidget ptr'
...
instance QTabWidgetSuperConst M322.QWidgetConst where
