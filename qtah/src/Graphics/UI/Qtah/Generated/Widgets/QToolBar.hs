...
foreign import ccall "genpop__QToolBar_newWithParent" newWithParent' ::  HoppyF.Ptr M322.QWidget -> HoppyP.IO (HoppyF.Ptr QToolBar)
foreign import ccall "genpop__QToolBar_newWithTitle" newWithTitle' ::  HoppyF.Ptr M52.QStringConst -> HoppyP.IO (HoppyF.Ptr QToolBar)
foreign import ccall "genpop__QToolBar_newWithTitleAndParent" newWithTitleAndParent' ::  HoppyF.Ptr M52.QStringConst -> HoppyF.Ptr M322.QWidget -> HoppyP.IO (HoppyF.Ptr QToolBar)
foreign import ccall "genpop__QToolBar_addAction" addAction' ::  HoppyF.Ptr QToolBar -> HoppyF.Ptr M52.QStringConst -> HoppyP.IO (HoppyF.Ptr M198.QAction)
foreign import ccall "genpop__QToolBar_addActionWithIcon" addActionWithIcon' ::  HoppyF.Ptr QToolBar -> HoppyF.Ptr M120.QIconConst -> HoppyF.Ptr M52.QStringConst -> HoppyP.IO (HoppyF.Ptr M198.QAction)
foreign import ccall "genpop__QToolBar_addSeparator" addSeparator' ::  HoppyF.Ptr QToolBar -> HoppyP.IO (HoppyF.Ptr M198.QAction)
foreign import ccall "genpop__QToolBar_addWidget" addWidget' ::  HoppyF.Ptr QToolBar -> HoppyF.Ptr M322.QWidget -> HoppyP.IO (HoppyF.Ptr M198.QAction)
...
foreign import ccall "genpop__QToolBar_iconSize" iconSize' ::  HoppyF.Ptr QToolBarConst -> HoppyP.IO (HoppyF.Ptr M48.QSizeConst)
foreign import ccall "genpop__QToolBar_setIconSize" setIconSize' ::  HoppyF.Ptr QToolBar -> HoppyF.Ptr M48.QSizeConst -> HoppyP.IO ()
foreign import ccall "genpop__QToolBar_insertSeparator" insertSeparator' ::  HoppyF.Ptr QToolBar -> HoppyF.Ptr M198.QAction -> HoppyP.IO (HoppyF.Ptr M198.QAction)
foreign import ccall "genpop__QToolBar_insertWidget" insertWidget' ::  HoppyF.Ptr QToolBar -> HoppyF.Ptr M198.QAction -> HoppyF.Ptr M322.QWidget -> HoppyP.IO (HoppyF.Ptr M198.QAction)
...
foreign import ccall "genpop__QToolBar_toggleViewAction" toggleViewAction' ::  HoppyF.Ptr QToolBar -> HoppyP.IO (HoppyF.Ptr M198.QAction)
...
foreign import ccall "genpop__QToolBar_widgetForAction" widgetForAction' ::  HoppyF.Ptr QToolBarConst -> HoppyF.Ptr M198.QAction -> HoppyP.IO (HoppyF.Ptr M322.QWidget)
foreign import ccall "gencast__QToolBar__QWidget" castQToolBarToQWidget :: HoppyF.Ptr QToolBarConst -> HoppyF.Ptr M322.QWidgetConst
foreign import ccall "gencast__QWidget__QToolBar" castQWidgetToQToolBar :: HoppyF.Ptr M322.QWidgetConst -> HoppyF.Ptr QToolBarConst
...
class (M322.QWidgetConstPtr this) => QToolBarConstPtr this where
  toQToolBarConst :: this -> QToolBarConst

allowedAreas :: (QToolBarValue arg'1) => arg'1 -> HoppyP.IO M66.QtToolBarAreas
allowedAreas arg'1 =
  withQToolBarPtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
  HoppyP.fmap M66.QtToolBarAreas
  (allowedAreas' arg'1')
...
isAreaAllowed :: (QToolBarValue arg'1) => arg'1 -> M66.QtToolBarArea -> HoppyP.IO HoppyP.Bool
...
orientation :: (QToolBarValue arg'1) => arg'1 -> HoppyP.IO M66.QtOrientation
orientation arg'1 =
  withQToolBarPtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
  HoppyP.fmap (HoppyP.toEnum . HoppyFHR.coerceIntegral)
  (orientation' arg'1')

toolButtonStyle :: (QToolBarValue arg'1) => arg'1 -> HoppyP.IO M66.QtToolButtonStyle
toolButtonStyle arg'1 =
  withQToolBarPtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
  HoppyP.fmap (HoppyP.toEnum . HoppyFHR.coerceIntegral)
  (toolButtonStyle' arg'1')

widgetForAction :: (QToolBarValue arg'1, M198.QActionPtr arg'2) => arg'1 -> arg'2 -> HoppyP.IO M322.QWidget
...
class (QToolBarConstPtr this, M322.QWidgetPtr this) => QToolBarPtr this where
  toQToolBar :: this -> QToolBar

addAction :: (QToolBarPtr arg'1, M52.QStringValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO M198.QAction
...
addActionWithIcon :: (QToolBarPtr arg'1, M120.QIconValue arg'2, M52.QStringValue arg'3) => arg'1 -> arg'2 -> arg'3 -> HoppyP.IO M198.QAction
...
addSeparator :: (QToolBarPtr arg'1) => arg'1 -> HoppyP.IO M198.QAction
addSeparator arg'1 =
  HoppyFHR.withCppPtr (toQToolBar arg'1) $ \arg'1' ->
  HoppyP.fmap M198.QAction
  (addSeparator' arg'1')

addWidget :: (QToolBarPtr arg'1, M322.QWidgetPtr arg'2) => arg'1 -> arg'2 -> HoppyP.IO M198.QAction
...
setAllowedAreas :: (QToolBarPtr arg'1, M66.IsQtToolBarAreas arg'2) => arg'1 -> arg'2 -> HoppyP.IO ()
setAllowedAreas arg'1 arg'2 =
  HoppyFHR.withCppPtr (toQToolBar arg'1) $ \arg'1' ->
  let arg'2' = M66.fromQtToolBarAreas $ M66.toQtToolBarAreas arg'2 in
  (setAllowedAreas' arg'1' arg'2')
...
setIconSize :: (QToolBarPtr arg'1, M48.QSizeValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO ()
setIconSize arg'1 arg'2 =
  HoppyFHR.withCppPtr (toQToolBar arg'1) $ \arg'1' ->
  M48.withQSizePtr arg'2 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'2' ->
  (setIconSize' arg'1' arg'2')

insertSeparator :: (QToolBarPtr arg'1, M198.QActionPtr arg'2) => arg'1 -> arg'2 -> HoppyP.IO M198.QAction
...
insertWidget :: (QToolBarPtr arg'1, M198.QActionPtr arg'2, M322.QWidgetPtr arg'3) => arg'1 -> arg'2 -> arg'3 -> HoppyP.IO M198.QAction
...
setOrientation :: (QToolBarPtr arg'1) => arg'1 -> M66.QtOrientation -> HoppyP.IO ()
setOrientation arg'1 arg'2 =
  HoppyFHR.withCppPtr (toQToolBar arg'1) $ \arg'1' ->
  let arg'2' = HoppyFHR.coerceIntegral $ HoppyP.fromEnum arg'2 in
  (setOrientation' arg'1' arg'2')

toggleViewAction :: (QToolBarPtr arg'1) => arg'1 -> HoppyP.IO M198.QAction
toggleViewAction arg'1 =
  HoppyFHR.withCppPtr (toQToolBar arg'1) $ \arg'1' ->
  HoppyP.fmap M198.QAction
  (toggleViewAction' arg'1')

setToolButtonStyle :: (QToolBarPtr arg'1) => arg'1 -> M66.QtToolButtonStyle -> HoppyP.IO ()
...
instance M322.QWidgetConstPtr QToolBarConst where
  toQWidgetConst (QToolBarConst ptr') = M322.QWidgetConst $ castQToolBarToQWidget ptr'
  toQWidgetConst (QToolBarConstGc fptr' ptr') = M322.QWidgetConstGc fptr' $ castQToolBarToQWidget ptr'
...
instance M322.QWidgetConstPtr QToolBar where
  toQWidgetConst (QToolBar ptr') = M322.QWidgetConst $ castQToolBarToQWidget $ (HoppyF.castPtr :: HoppyF.Ptr QToolBar -> HoppyF.Ptr QToolBarConst) ptr'
  toQWidgetConst (QToolBarGc fptr' ptr') = M322.QWidgetConstGc fptr' $ castQToolBarToQWidget $ (HoppyF.castPtr :: HoppyF.Ptr QToolBar -> HoppyF.Ptr QToolBarConst) ptr'

instance M322.QWidgetPtr QToolBar where
  toQWidget (QToolBar ptr') = M322.QWidget $ (HoppyF.castPtr :: HoppyF.Ptr M322.QWidgetConst -> HoppyF.Ptr M322.QWidget) $ castQToolBarToQWidget $ (HoppyF.castPtr :: HoppyF.Ptr QToolBar -> HoppyF.Ptr QToolBarConst) ptr'
  toQWidget (QToolBarGc fptr' ptr') = M322.QWidgetGc fptr' $ (HoppyF.castPtr :: HoppyF.Ptr M322.QWidgetConst -> HoppyF.Ptr M322.QWidget) $ castQToolBarToQWidget $ (HoppyF.castPtr :: HoppyF.Ptr QToolBar -> HoppyF.Ptr QToolBarConst) ptr'
...
newWithParent :: (M322.QWidgetPtr arg'1) => arg'1 -> HoppyP.IO QToolBar
newWithParent arg'1 =
  HoppyFHR.withCppPtr (M322.toQWidget arg'1) $ \arg'1' ->
  HoppyP.fmap QToolBar
  (newWithParent' arg'1')

newWithTitle :: (M52.QStringValue arg'1) => arg'1 -> HoppyP.IO QToolBar
newWithTitle arg'1 =
  M52.withQStringPtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
  HoppyP.fmap QToolBar
  (newWithTitle' arg'1')

newWithTitleAndParent :: (M52.QStringValue arg'1, M322.QWidgetPtr arg'2) => arg'1 -> arg'2 -> HoppyP.IO QToolBar
...
instance QToolBarSuper M322.QWidget where
  downToQToolBar = castQToolBarToNonconst . cast' . M322.castQWidgetToConst
    where
      cast' (M322.QWidgetConst ptr') = QToolBarConst $ castQWidgetToQToolBar ptr'
      cast' (M322.QWidgetConstGc fptr' ptr') = QToolBarConstGc fptr' $ castQWidgetToQToolBar ptr'
...
instance QToolBarSuperConst M322.QWidgetConst where
