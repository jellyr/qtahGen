...
foreign import ccall "genpop__QPushButton_newWithParent" newWithParent' ::  HoppyF.Ptr M322.QWidget -> HoppyP.IO (HoppyF.Ptr QPushButton)
foreign import ccall "genpop__QPushButton_newWithText" newWithText' ::  HoppyF.Ptr M52.QStringConst -> HoppyP.IO (HoppyF.Ptr QPushButton)
foreign import ccall "genpop__QPushButton_newWithTextAndParent" newWithTextAndParent' ::  HoppyF.Ptr M52.QStringConst -> HoppyF.Ptr M322.QWidget -> HoppyP.IO (HoppyF.Ptr QPushButton)
foreign import ccall "genpop__QPushButton_newWithIconAndText" newWithIconAndText' ::  HoppyF.Ptr M120.QIconConst -> HoppyF.Ptr M52.QStringConst -> HoppyP.IO (HoppyF.Ptr QPushButton)
foreign import ccall "genpop__QPushButton_newWithIconAndTextAndParent" newWithIconAndTextAndParent' ::  HoppyF.Ptr M120.QIconConst -> HoppyF.Ptr M52.QStringConst -> HoppyF.Ptr M322.QWidget -> HoppyP.IO (HoppyF.Ptr QPushButton)
...
foreign import ccall "genpop__QPushButton_menu" menu' ::  HoppyF.Ptr QPushButtonConst -> HoppyP.IO (HoppyF.Ptr M266.QMenu)
foreign import ccall "genpop__QPushButton_setMenu" setMenu' ::  HoppyF.Ptr QPushButton -> HoppyF.Ptr M266.QMenu -> HoppyP.IO ()
foreign import ccall "genpop__QPushButton_showMenu" showMenu' ::  HoppyF.Ptr QPushButton -> HoppyP.IO ()
foreign import ccall "gencast__QPushButton__QAbstractButton" castQPushButtonToQAbstractButton :: HoppyF.Ptr QPushButtonConst -> HoppyF.Ptr M184.QAbstractButtonConst
foreign import ccall "gencast__QAbstractButton__QPushButton" castQAbstractButtonToQPushButton :: HoppyF.Ptr M184.QAbstractButtonConst -> HoppyF.Ptr QPushButtonConst
foreign import ccall "gencast__QPushButton__QWidget" castQPushButtonToQWidget :: HoppyF.Ptr QPushButtonConst -> HoppyF.Ptr M322.QWidgetConst
foreign import ccall "gencast__QWidget__QPushButton" castQWidgetToQPushButton :: HoppyF.Ptr M322.QWidgetConst -> HoppyF.Ptr QPushButtonConst
...
class (M184.QAbstractButtonConstPtr this) => QPushButtonConstPtr this where
...
menu :: (QPushButtonValue arg'1) => arg'1 -> HoppyP.IO M266.QMenu
menu arg'1 =
  withQPushButtonPtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
  HoppyP.fmap M266.QMenu
  (menu' arg'1')

class (QPushButtonConstPtr this, M184.QAbstractButtonPtr this) => QPushButtonPtr this where
...
setMenu :: (QPushButtonPtr arg'1, M266.QMenuPtr arg'2) => arg'1 -> arg'2 -> HoppyP.IO ()
setMenu arg'1 arg'2 =
  HoppyFHR.withCppPtr (toQPushButton arg'1) $ \arg'1' ->
  HoppyFHR.withCppPtr (M266.toQMenu arg'2) $ \arg'2' ->
  (setMenu' arg'1' arg'2')
...
instance M184.QAbstractButtonConstPtr QPushButtonConst where
  toQAbstractButtonConst (QPushButtonConst ptr') = M184.QAbstractButtonConst $ castQPushButtonToQAbstractButton ptr'
  toQAbstractButtonConst (QPushButtonConstGc fptr' ptr') = M184.QAbstractButtonConstGc fptr' $ castQPushButtonToQAbstractButton ptr'

instance M322.QWidgetConstPtr QPushButtonConst where
  toQWidgetConst (QPushButtonConst ptr') = M322.QWidgetConst $ castQPushButtonToQWidget ptr'
  toQWidgetConst (QPushButtonConstGc fptr' ptr') = M322.QWidgetConstGc fptr' $ castQPushButtonToQWidget ptr'
...
instance M184.QAbstractButtonConstPtr QPushButton where
  toQAbstractButtonConst (QPushButton ptr') = M184.QAbstractButtonConst $ castQPushButtonToQAbstractButton $ (HoppyF.castPtr :: HoppyF.Ptr QPushButton -> HoppyF.Ptr QPushButtonConst) ptr'
  toQAbstractButtonConst (QPushButtonGc fptr' ptr') = M184.QAbstractButtonConstGc fptr' $ castQPushButtonToQAbstractButton $ (HoppyF.castPtr :: HoppyF.Ptr QPushButton -> HoppyF.Ptr QPushButtonConst) ptr'

instance M184.QAbstractButtonPtr QPushButton where
  toQAbstractButton (QPushButton ptr') = M184.QAbstractButton $ (HoppyF.castPtr :: HoppyF.Ptr M184.QAbstractButtonConst -> HoppyF.Ptr M184.QAbstractButton) $ castQPushButtonToQAbstractButton $ (HoppyF.castPtr :: HoppyF.Ptr QPushButton -> HoppyF.Ptr QPushButtonConst) ptr'
  toQAbstractButton (QPushButtonGc fptr' ptr') = M184.QAbstractButtonGc fptr' $ (HoppyF.castPtr :: HoppyF.Ptr M184.QAbstractButtonConst -> HoppyF.Ptr M184.QAbstractButton) $ castQPushButtonToQAbstractButton $ (HoppyF.castPtr :: HoppyF.Ptr QPushButton -> HoppyF.Ptr QPushButtonConst) ptr'

instance M322.QWidgetConstPtr QPushButton where
  toQWidgetConst (QPushButton ptr') = M322.QWidgetConst $ castQPushButtonToQWidget $ (HoppyF.castPtr :: HoppyF.Ptr QPushButton -> HoppyF.Ptr QPushButtonConst) ptr'
  toQWidgetConst (QPushButtonGc fptr' ptr') = M322.QWidgetConstGc fptr' $ castQPushButtonToQWidget $ (HoppyF.castPtr :: HoppyF.Ptr QPushButton -> HoppyF.Ptr QPushButtonConst) ptr'

instance M322.QWidgetPtr QPushButton where
  toQWidget (QPushButton ptr') = M322.QWidget $ (HoppyF.castPtr :: HoppyF.Ptr M322.QWidgetConst -> HoppyF.Ptr M322.QWidget) $ castQPushButtonToQWidget $ (HoppyF.castPtr :: HoppyF.Ptr QPushButton -> HoppyF.Ptr QPushButtonConst) ptr'
  toQWidget (QPushButtonGc fptr' ptr') = M322.QWidgetGc fptr' $ (HoppyF.castPtr :: HoppyF.Ptr M322.QWidgetConst -> HoppyF.Ptr M322.QWidget) $ castQPushButtonToQWidget $ (HoppyF.castPtr :: HoppyF.Ptr QPushButton -> HoppyF.Ptr QPushButtonConst) ptr'
...
newWithParent :: (M322.QWidgetPtr arg'1) => arg'1 -> HoppyP.IO QPushButton
newWithParent arg'1 =
  HoppyFHR.withCppPtr (M322.toQWidget arg'1) $ \arg'1' ->
  HoppyP.fmap QPushButton
  (newWithParent' arg'1')

newWithText :: (M52.QStringValue arg'1) => arg'1 -> HoppyP.IO QPushButton
newWithText arg'1 =
  M52.withQStringPtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
  HoppyP.fmap QPushButton
  (newWithText' arg'1')

newWithTextAndParent :: (M52.QStringValue arg'1, M322.QWidgetPtr arg'2) => arg'1 -> arg'2 -> HoppyP.IO QPushButton
...
newWithIconAndText :: (M120.QIconValue arg'1, M52.QStringValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO QPushButton
...
newWithIconAndTextAndParent :: (M120.QIconValue arg'1, M52.QStringValue arg'2, M322.QWidgetPtr arg'3) => arg'1 -> arg'2 -> arg'3 -> HoppyP.IO QPushButton
...
instance QPushButtonSuper M184.QAbstractButton where
  downToQPushButton = castQPushButtonToNonconst . cast' . M184.castQAbstractButtonToConst
    where
      cast' (M184.QAbstractButtonConst ptr') = QPushButtonConst $ castQAbstractButtonToQPushButton ptr'
      cast' (M184.QAbstractButtonConstGc fptr' ptr') = QPushButtonConstGc fptr' $ castQAbstractButtonToQPushButton ptr'
instance QPushButtonSuper M322.QWidget where
  downToQPushButton = castQPushButtonToNonconst . cast' . M322.castQWidgetToConst
    where
      cast' (M322.QWidgetConst ptr') = QPushButtonConst $ castQWidgetToQPushButton ptr'
      cast' (M322.QWidgetConstGc fptr' ptr') = QPushButtonConstGc fptr' $ castQWidgetToQPushButton ptr'
...
instance QPushButtonSuperConst M184.QAbstractButtonConst where
  downToQPushButtonConst = cast'
    where
      cast' (M184.QAbstractButtonConst ptr') = QPushButtonConst $ castQAbstractButtonToQPushButton ptr'
      cast' (M184.QAbstractButtonConstGc fptr' ptr') = QPushButtonConstGc fptr' $ castQAbstractButtonToQPushButton ptr'
instance QPushButtonSuperConst M322.QWidgetConst where
  downToQPushButtonConst = cast'
    where
      cast' (M322.QWidgetConst ptr') = QPushButtonConst $ castQWidgetToQPushButton ptr'
      cast' (M322.QWidgetConstGc fptr' ptr') = QPushButtonConstGc fptr' $ castQWidgetToQPushButton ptr'
