...
foreign import ccall "genpop__QScrollBar_newWithParent" newWithParent' ::  HoppyF.Ptr M322.QWidget -> HoppyP.IO (HoppyF.Ptr QScrollBar)
...
foreign import ccall "genpop__QScrollBar_newWithOrientationAndParent" newWithOrientationAndParent' ::  HoppyFC.CInt -> HoppyF.Ptr M322.QWidget -> HoppyP.IO (HoppyF.Ptr QScrollBar)
foreign import ccall "gencast__QScrollBar__QAbstractSlider" castQScrollBarToQAbstractSlider :: HoppyF.Ptr QScrollBarConst -> HoppyF.Ptr M194.QAbstractSliderConst
foreign import ccall "gencast__QAbstractSlider__QScrollBar" castQAbstractSliderToQScrollBar :: HoppyF.Ptr M194.QAbstractSliderConst -> HoppyF.Ptr QScrollBarConst
foreign import ccall "gencast__QScrollBar__QWidget" castQScrollBarToQWidget :: HoppyF.Ptr QScrollBarConst -> HoppyF.Ptr M322.QWidgetConst
foreign import ccall "gencast__QWidget__QScrollBar" castQWidgetToQScrollBar :: HoppyF.Ptr M322.QWidgetConst -> HoppyF.Ptr QScrollBarConst
...
class (M194.QAbstractSliderConstPtr this) => QScrollBarConstPtr this where
  toQScrollBarConst :: this -> QScrollBarConst

class (QScrollBarConstPtr this, M194.QAbstractSliderPtr this) => QScrollBarPtr this where
...
instance M194.QAbstractSliderConstPtr QScrollBarConst where
  toQAbstractSliderConst (QScrollBarConst ptr') = M194.QAbstractSliderConst $ castQScrollBarToQAbstractSlider ptr'
  toQAbstractSliderConst (QScrollBarConstGc fptr' ptr') = M194.QAbstractSliderConstGc fptr' $ castQScrollBarToQAbstractSlider ptr'

instance M322.QWidgetConstPtr QScrollBarConst where
  toQWidgetConst (QScrollBarConst ptr') = M322.QWidgetConst $ castQScrollBarToQWidget ptr'
  toQWidgetConst (QScrollBarConstGc fptr' ptr') = M322.QWidgetConstGc fptr' $ castQScrollBarToQWidget ptr'
...
instance M194.QAbstractSliderConstPtr QScrollBar where
  toQAbstractSliderConst (QScrollBar ptr') = M194.QAbstractSliderConst $ castQScrollBarToQAbstractSlider $ (HoppyF.castPtr :: HoppyF.Ptr QScrollBar -> HoppyF.Ptr QScrollBarConst) ptr'
  toQAbstractSliderConst (QScrollBarGc fptr' ptr') = M194.QAbstractSliderConstGc fptr' $ castQScrollBarToQAbstractSlider $ (HoppyF.castPtr :: HoppyF.Ptr QScrollBar -> HoppyF.Ptr QScrollBarConst) ptr'

instance M194.QAbstractSliderPtr QScrollBar where
  toQAbstractSlider (QScrollBar ptr') = M194.QAbstractSlider $ (HoppyF.castPtr :: HoppyF.Ptr M194.QAbstractSliderConst -> HoppyF.Ptr M194.QAbstractSlider) $ castQScrollBarToQAbstractSlider $ (HoppyF.castPtr :: HoppyF.Ptr QScrollBar -> HoppyF.Ptr QScrollBarConst) ptr'
  toQAbstractSlider (QScrollBarGc fptr' ptr') = M194.QAbstractSliderGc fptr' $ (HoppyF.castPtr :: HoppyF.Ptr M194.QAbstractSliderConst -> HoppyF.Ptr M194.QAbstractSlider) $ castQScrollBarToQAbstractSlider $ (HoppyF.castPtr :: HoppyF.Ptr QScrollBar -> HoppyF.Ptr QScrollBarConst) ptr'

instance M322.QWidgetConstPtr QScrollBar where
  toQWidgetConst (QScrollBar ptr') = M322.QWidgetConst $ castQScrollBarToQWidget $ (HoppyF.castPtr :: HoppyF.Ptr QScrollBar -> HoppyF.Ptr QScrollBarConst) ptr'
  toQWidgetConst (QScrollBarGc fptr' ptr') = M322.QWidgetConstGc fptr' $ castQScrollBarToQWidget $ (HoppyF.castPtr :: HoppyF.Ptr QScrollBar -> HoppyF.Ptr QScrollBarConst) ptr'

instance M322.QWidgetPtr QScrollBar where
  toQWidget (QScrollBar ptr') = M322.QWidget $ (HoppyF.castPtr :: HoppyF.Ptr M322.QWidgetConst -> HoppyF.Ptr M322.QWidget) $ castQScrollBarToQWidget $ (HoppyF.castPtr :: HoppyF.Ptr QScrollBar -> HoppyF.Ptr QScrollBarConst) ptr'
  toQWidget (QScrollBarGc fptr' ptr') = M322.QWidgetGc fptr' $ (HoppyF.castPtr :: HoppyF.Ptr M322.QWidgetConst -> HoppyF.Ptr M322.QWidget) $ castQScrollBarToQWidget $ (HoppyF.castPtr :: HoppyF.Ptr QScrollBar -> HoppyF.Ptr QScrollBarConst) ptr'
...
newWithParent :: (M322.QWidgetPtr arg'1) => arg'1 -> HoppyP.IO QScrollBar
newWithParent arg'1 =
  HoppyFHR.withCppPtr (M322.toQWidget arg'1) $ \arg'1' ->
  HoppyP.fmap QScrollBar
  (newWithParent' arg'1')

newWithOrientation ::  M66.QtOrientation -> HoppyP.IO QScrollBar
newWithOrientation arg'1 =
  let arg'1' = HoppyFHR.coerceIntegral $ HoppyP.fromEnum arg'1 in
  HoppyP.fmap QScrollBar
  (newWithOrientation' arg'1')

newWithOrientationAndParent :: (M322.QWidgetPtr arg'2) => M66.QtOrientation -> arg'2 -> HoppyP.IO QScrollBar
...
instance QScrollBarSuper M194.QAbstractSlider where
  downToQScrollBar = castQScrollBarToNonconst . cast' . M194.castQAbstractSliderToConst
    where
      cast' (M194.QAbstractSliderConst ptr') = QScrollBarConst $ castQAbstractSliderToQScrollBar ptr'
      cast' (M194.QAbstractSliderConstGc fptr' ptr') = QScrollBarConstGc fptr' $ castQAbstractSliderToQScrollBar ptr'
instance QScrollBarSuper M322.QWidget where
  downToQScrollBar = castQScrollBarToNonconst . cast' . M322.castQWidgetToConst
    where
      cast' (M322.QWidgetConst ptr') = QScrollBarConst $ castQWidgetToQScrollBar ptr'
      cast' (M322.QWidgetConstGc fptr' ptr') = QScrollBarConstGc fptr' $ castQWidgetToQScrollBar ptr'
...
instance QScrollBarSuperConst M194.QAbstractSliderConst where
  downToQScrollBarConst = cast'
    where
      cast' (M194.QAbstractSliderConst ptr') = QScrollBarConst $ castQAbstractSliderToQScrollBar ptr'
      cast' (M194.QAbstractSliderConstGc fptr' ptr') = QScrollBarConstGc fptr' $ castQAbstractSliderToQScrollBar ptr'
instance QScrollBarSuperConst M322.QWidgetConst where
  downToQScrollBarConst = cast'
    where
      cast' (M322.QWidgetConst ptr') = QScrollBarConst $ castQWidgetToQScrollBar ptr'
      cast' (M322.QWidgetConstGc fptr' ptr') = QScrollBarConstGc fptr' $ castQWidgetToQScrollBar ptr'
