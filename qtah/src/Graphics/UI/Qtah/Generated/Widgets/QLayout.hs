...
import {-# SOURCE #-} qualified Graphics.UI.Qtah.Generated.Widgets.QLayoutItem as M258
...
foreign import ccall "genpop__QLayout_addItem" addItem' ::  HoppyF.Ptr QLayout -> HoppyF.Ptr M258.QLayoutItem -> HoppyP.IO ()
foreign import ccall "genpop__QLayout_addWidget" addWidget' ::  HoppyF.Ptr QLayout -> HoppyF.Ptr M322.QWidget -> HoppyP.IO ()
foreign import ccall "genpop__QLayout_closestAcceptableSize" closestAcceptableSize' ::  HoppyF.Ptr M322.QWidget -> HoppyF.Ptr M48.QSizeConst -> HoppyP.IO (HoppyF.Ptr M48.QSizeConst)
...
foreign import ccall "genpop__QLayout_contentsRect" contentsRect' ::  HoppyF.Ptr QLayoutConst -> HoppyP.IO (HoppyF.Ptr M42.QRectConst)
...
foreign import ccall "genpop__QLayout_indexOf" indexOf' ::  HoppyF.Ptr QLayoutConst -> HoppyF.Ptr M322.QWidget -> HoppyP.IO HoppyFC.CInt
foreign import ccall "genpop__QLayout_itemAt" itemAt' ::  HoppyF.Ptr QLayoutConst -> HoppyFC.CInt -> HoppyP.IO (HoppyF.Ptr M258.QLayoutItem)
foreign import ccall "genpop__QLayout_menuBar" menuBar' ::  HoppyF.Ptr QLayoutConst -> HoppyP.IO (HoppyF.Ptr M322.QWidget)
foreign import ccall "genpop__QLayout_setMenuBar" setMenuBar' ::  HoppyF.Ptr QLayout -> HoppyF.Ptr M322.QWidget -> HoppyP.IO ()
foreign import ccall "genpop__QLayout_parentWidget" parentWidget' ::  HoppyF.Ptr QLayoutConst -> HoppyP.IO (HoppyF.Ptr M322.QWidget)
foreign import ccall "genpop__QLayout_removeItem" removeItem' ::  HoppyF.Ptr QLayout -> HoppyF.Ptr M258.QLayoutItem -> HoppyP.IO ()
foreign import ccall "genpop__QLayout_removeWidget" removeWidget' ::  HoppyF.Ptr QLayout -> HoppyF.Ptr M322.QWidget -> HoppyP.IO ()
...
foreign import ccall "genpop__QLayout_setWidgetAlignment" setWidgetAlignment' ::  HoppyF.Ptr QLayout -> HoppyF.Ptr M322.QWidget -> HoppyFC.CInt -> HoppyP.IO HoppyFHR.CBool
...
foreign import ccall "genpop__QLayout_takeAt" takeAt' ::  HoppyF.Ptr QLayout -> HoppyFC.CInt -> HoppyP.IO (HoppyF.Ptr M258.QLayoutItem)
...
foreign import ccall "gencast__QLayout__QLayoutItem" castQLayoutToQLayoutItem :: HoppyF.Ptr QLayoutConst -> HoppyF.Ptr M258.QLayoutItemConst
foreign import ccall "gencast__QLayoutItem__QLayout" castQLayoutItemToQLayout :: HoppyF.Ptr M258.QLayoutItemConst -> HoppyF.Ptr QLayoutConst
...
class (M34.QObjectConstPtr this, M258.QLayoutItemConstPtr this) => QLayoutConstPtr this where
...
indexOf :: (QLayoutValue arg'1, M322.QWidgetPtr arg'2) => arg'1 -> arg'2 -> HoppyP.IO HoppyP.Int
indexOf arg'1 arg'2 =
  withQLayoutPtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
...
itemAt :: (QLayoutValue arg'1) => arg'1 -> HoppyP.Int -> HoppyP.IO M258.QLayoutItem
itemAt arg'1 arg'2 =
  withQLayoutPtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
...
menuBar :: (QLayoutValue arg'1) => arg'1 -> HoppyP.IO M322.QWidget
menuBar arg'1 =
  withQLayoutPtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
  HoppyP.fmap M322.QWidget
  (menuBar' arg'1')

parentWidget :: (QLayoutValue arg'1) => arg'1 -> HoppyP.IO M322.QWidget
parentWidget arg'1 =
  withQLayoutPtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
  HoppyP.fmap M322.QWidget
  (parentWidget' arg'1')
...
class (QLayoutConstPtr this, M34.QObjectPtr this, M258.QLayoutItemPtr this) => QLayoutPtr this where
...
addItem :: (QLayoutPtr arg'1, M258.QLayoutItemPtr arg'2) => arg'1 -> arg'2 -> HoppyP.IO ()
addItem arg'1 arg'2 =
  HoppyFHR.withCppPtr (toQLayout arg'1) $ \arg'1' ->
  HoppyFHR.withCppPtr (M258.toQLayoutItem arg'2) $ \arg'2' ->
  (addItem' arg'1' arg'2')

addWidget :: (QLayoutPtr arg'1, M322.QWidgetPtr arg'2) => arg'1 -> arg'2 -> HoppyP.IO ()
...
setMenuBar :: (QLayoutPtr arg'1, M322.QWidgetPtr arg'2) => arg'1 -> arg'2 -> HoppyP.IO ()
setMenuBar arg'1 arg'2 =
  HoppyFHR.withCppPtr (toQLayout arg'1) $ \arg'1' ->
  HoppyFHR.withCppPtr (M322.toQWidget arg'2) $ \arg'2' ->
  (setMenuBar' arg'1' arg'2')

removeItem :: (QLayoutPtr arg'1, M258.QLayoutItemPtr arg'2) => arg'1 -> arg'2 -> HoppyP.IO ()
removeItem arg'1 arg'2 =
  HoppyFHR.withCppPtr (toQLayout arg'1) $ \arg'1' ->
  HoppyFHR.withCppPtr (M258.toQLayoutItem arg'2) $ \arg'2' ->
  (removeItem' arg'1' arg'2')

removeWidget :: (QLayoutPtr arg'1, M322.QWidgetPtr arg'2) => arg'1 -> arg'2 -> HoppyP.IO ()
removeWidget arg'1 arg'2 =
  HoppyFHR.withCppPtr (toQLayout arg'1) $ \arg'1' ->
  HoppyFHR.withCppPtr (M322.toQWidget arg'2) $ \arg'2' ->
  (removeWidget' arg'1' arg'2')

setAlignment :: (QLayoutPtr arg'1, M66.IsQtAlignment arg'2) => arg'1 -> arg'2 -> HoppyP.IO ()
setAlignment arg'1 arg'2 =
  HoppyFHR.withCppPtr (toQLayout arg'1) $ \arg'1' ->
  let arg'2' = M66.fromQtAlignment $ M66.toQtAlignment arg'2 in
  (setAlignment' arg'1' arg'2')

setLayoutAlignment :: (QLayoutPtr arg'1, QLayoutPtr arg'2, M66.IsQtAlignment arg'3) => arg'1 -> arg'2 -> arg'3 -> HoppyP.IO HoppyP.Bool
...
setWidgetAlignment :: (QLayoutPtr arg'1, M322.QWidgetPtr arg'2, M66.IsQtAlignment arg'3) => arg'1 -> arg'2 -> arg'3 -> HoppyP.IO HoppyP.Bool
...
takeAt :: (QLayoutPtr arg'1) => arg'1 -> HoppyP.Int -> HoppyP.IO M258.QLayoutItem
takeAt arg'1 arg'2 =
  HoppyFHR.withCppPtr (toQLayout arg'1) $ \arg'1' ->
  let arg'2' = HoppyFHR.coerceIntegral arg'2 in
  HoppyP.fmap M258.QLayoutItem
...
closestAcceptableSize :: (M322.QWidgetPtr arg'1, M48.QSizeValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO HSize.HSize
...
instance M258.QLayoutItemConstPtr QLayoutConst where
  toQLayoutItemConst (QLayoutConst ptr') = M258.QLayoutItemConst $ castQLayoutToQLayoutItem ptr'
  toQLayoutItemConst (QLayoutConstGc fptr' ptr') = M258.QLayoutItemConstGc fptr' $ castQLayoutToQLayoutItem ptr'
...
instance M258.QLayoutItemConstPtr QLayout where
  toQLayoutItemConst (QLayout ptr') = M258.QLayoutItemConst $ castQLayoutToQLayoutItem $ (HoppyF.castPtr :: HoppyF.Ptr QLayout -> HoppyF.Ptr QLayoutConst) ptr'
  toQLayoutItemConst (QLayoutGc fptr' ptr') = M258.QLayoutItemConstGc fptr' $ castQLayoutToQLayoutItem $ (HoppyF.castPtr :: HoppyF.Ptr QLayout -> HoppyF.Ptr QLayoutConst) ptr'

instance M258.QLayoutItemPtr QLayout where
  toQLayoutItem (QLayout ptr') = M258.QLayoutItem $ (HoppyF.castPtr :: HoppyF.Ptr M258.QLayoutItemConst -> HoppyF.Ptr M258.QLayoutItem) $ castQLayoutToQLayoutItem $ (HoppyF.castPtr :: HoppyF.Ptr QLayout -> HoppyF.Ptr QLayoutConst) ptr'
  toQLayoutItem (QLayoutGc fptr' ptr') = M258.QLayoutItemGc fptr' $ (HoppyF.castPtr :: HoppyF.Ptr M258.QLayoutItemConst -> HoppyF.Ptr M258.QLayoutItem) $ castQLayoutToQLayoutItem $ (HoppyF.castPtr :: HoppyF.Ptr QLayout -> HoppyF.Ptr QLayoutConst) ptr'
...
instance QLayoutSuper M258.QLayoutItem where
  downToQLayout = castQLayoutToNonconst . cast' . M258.castQLayoutItemToConst
    where
      cast' (M258.QLayoutItemConst ptr') = QLayoutConst $ castQLayoutItemToQLayout ptr'
      cast' (M258.QLayoutItemConstGc fptr' ptr') = QLayoutConstGc fptr' $ castQLayoutItemToQLayout ptr'
...
instance QLayoutSuperConst M34.QObjectConst where
  downToQLayoutConst = cast'
    where
      cast' (M34.QObjectConst ptr') = QLayoutConst $ castQObjectToQLayout ptr'
      cast' (M34.QObjectConstGc fptr' ptr') = QLayoutConstGc fptr' $ castQObjectToQLayout ptr'
instance QLayoutSuperConst M258.QLayoutItemConst where
  downToQLayoutConst = cast'
    where
      cast' (M258.QLayoutItemConst ptr') = QLayoutConst $ castQLayoutItemToQLayout ptr'
      cast' (M258.QLayoutItemConstGc fptr' ptr') = QLayoutConstGc fptr' $ castQLayoutItemToQLayout ptr'
