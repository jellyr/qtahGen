...
foreign import ccall "genpop__QSlider_newWithParent" newWithParent' ::  HoppyF.Ptr M322.QWidget -> HoppyP.IO (HoppyF.Ptr QSlider)
foreign import ccall "genpop__QSlider_newWithOrientation" newWithOrientation' ::  HoppyFC.CInt -> HoppyP.IO (HoppyF.Ptr QSlider)
foreign import ccall "genpop__QSlider_newWithOrientationAndParent" newWithOrientationAndParent' ::  HoppyFC.CInt -> HoppyF.Ptr M322.QWidget -> HoppyP.IO (HoppyF.Ptr QSlider)
...
foreign import ccall "gencast__QSlider__QAbstractSlider" castQSliderToQAbstractSlider :: HoppyF.Ptr QSliderConst -> HoppyF.Ptr M194.QAbstractSliderConst
foreign import ccall "gencast__QAbstractSlider__QSlider" castQAbstractSliderToQSlider :: HoppyF.Ptr M194.QAbstractSliderConst -> HoppyF.Ptr QSliderConst
foreign import ccall "gencast__QSlider__QWidget" castQSliderToQWidget :: HoppyF.Ptr QSliderConst -> HoppyF.Ptr M322.QWidgetConst
foreign import ccall "gencast__QWidget__QSlider" castQWidgetToQSlider :: HoppyF.Ptr M322.QWidgetConst -> HoppyF.Ptr QSliderConst
...
class (M194.QAbstractSliderConstPtr this) => QSliderConstPtr this where
...
class (QSliderConstPtr this, M194.QAbstractSliderPtr this) => QSliderPtr this where
...
instance M194.QAbstractSliderConstPtr QSliderConst where
  toQAbstractSliderConst (QSliderConst ptr') = M194.QAbstractSliderConst $ castQSliderToQAbstractSlider ptr'
  toQAbstractSliderConst (QSliderConstGc fptr' ptr') = M194.QAbstractSliderConstGc fptr' $ castQSliderToQAbstractSlider ptr'

instance M322.QWidgetConstPtr QSliderConst where
  toQWidgetConst (QSliderConst ptr') = M322.QWidgetConst $ castQSliderToQWidget ptr'
  toQWidgetConst (QSliderConstGc fptr' ptr') = M322.QWidgetConstGc fptr' $ castQSliderToQWidget ptr'
...
instance M194.QAbstractSliderConstPtr QSlider where
  toQAbstractSliderConst (QSlider ptr') = M194.QAbstractSliderConst $ castQSliderToQAbstractSlider $ (HoppyF.castPtr :: HoppyF.Ptr QSlider -> HoppyF.Ptr QSliderConst) ptr'
  toQAbstractSliderConst (QSliderGc fptr' ptr') = M194.QAbstractSliderConstGc fptr' $ castQSliderToQAbstractSlider $ (HoppyF.castPtr :: HoppyF.Ptr QSlider -> HoppyF.Ptr QSliderConst) ptr'

instance M194.QAbstractSliderPtr QSlider where
  toQAbstractSlider (QSlider ptr') = M194.QAbstractSlider $ (HoppyF.castPtr :: HoppyF.Ptr M194.QAbstractSliderConst -> HoppyF.Ptr M194.QAbstractSlider) $ castQSliderToQAbstractSlider $ (HoppyF.castPtr :: HoppyF.Ptr QSlider -> HoppyF.Ptr QSliderConst) ptr'
  toQAbstractSlider (QSliderGc fptr' ptr') = M194.QAbstractSliderGc fptr' $ (HoppyF.castPtr :: HoppyF.Ptr M194.QAbstractSliderConst -> HoppyF.Ptr M194.QAbstractSlider) $ castQSliderToQAbstractSlider $ (HoppyF.castPtr :: HoppyF.Ptr QSlider -> HoppyF.Ptr QSliderConst) ptr'

instance M322.QWidgetConstPtr QSlider where
  toQWidgetConst (QSlider ptr') = M322.QWidgetConst $ castQSliderToQWidget $ (HoppyF.castPtr :: HoppyF.Ptr QSlider -> HoppyF.Ptr QSliderConst) ptr'
  toQWidgetConst (QSliderGc fptr' ptr') = M322.QWidgetConstGc fptr' $ castQSliderToQWidget $ (HoppyF.castPtr :: HoppyF.Ptr QSlider -> HoppyF.Ptr QSliderConst) ptr'

instance M322.QWidgetPtr QSlider where
  toQWidget (QSlider ptr') = M322.QWidget $ (HoppyF.castPtr :: HoppyF.Ptr M322.QWidgetConst -> HoppyF.Ptr M322.QWidget) $ castQSliderToQWidget $ (HoppyF.castPtr :: HoppyF.Ptr QSlider -> HoppyF.Ptr QSliderConst) ptr'
  toQWidget (QSliderGc fptr' ptr') = M322.QWidgetGc fptr' $ (HoppyF.castPtr :: HoppyF.Ptr M322.QWidgetConst -> HoppyF.Ptr M322.QWidget) $ castQSliderToQWidget $ (HoppyF.castPtr :: HoppyF.Ptr QSlider -> HoppyF.Ptr QSliderConst) ptr'
...
newWithParent :: (M322.QWidgetPtr arg'1) => arg'1 -> HoppyP.IO QSlider
newWithParent arg'1 =
  HoppyFHR.withCppPtr (M322.toQWidget arg'1) $ \arg'1' ->
  HoppyP.fmap QSlider
  (newWithParent' arg'1')

newWithOrientation ::  M66.QtOrientation -> HoppyP.IO QSlider
newWithOrientation arg'1 =
  let arg'1' = HoppyFHR.coerceIntegral $ HoppyP.fromEnum arg'1 in
  HoppyP.fmap QSlider
  (newWithOrientation' arg'1')

newWithOrientationAndParent :: (M322.QWidgetPtr arg'2) => M66.QtOrientation -> arg'2 -> HoppyP.IO QSlider
...
instance QSliderSuper M194.QAbstractSlider where
  downToQSlider = castQSliderToNonconst . cast' . M194.castQAbstractSliderToConst
    where
      cast' (M194.QAbstractSliderConst ptr') = QSliderConst $ castQAbstractSliderToQSlider ptr'
      cast' (M194.QAbstractSliderConstGc fptr' ptr') = QSliderConstGc fptr' $ castQAbstractSliderToQSlider ptr'
instance QSliderSuper M322.QWidget where
  downToQSlider = castQSliderToNonconst . cast' . M322.castQWidgetToConst
    where
      cast' (M322.QWidgetConst ptr') = QSliderConst $ castQWidgetToQSlider ptr'
      cast' (M322.QWidgetConstGc fptr' ptr') = QSliderConstGc fptr' $ castQWidgetToQSlider ptr'
...
instance QSliderSuperConst M194.QAbstractSliderConst where
  downToQSliderConst = cast'
    where
      cast' (M194.QAbstractSliderConst ptr') = QSliderConst $ castQAbstractSliderToQSlider ptr'
      cast' (M194.QAbstractSliderConstGc fptr' ptr') = QSliderConstGc fptr' $ castQAbstractSliderToQSlider ptr'
instance QSliderSuperConst M322.QWidgetConst where
  downToQSliderConst = cast'
    where
      cast' (M322.QWidgetConst ptr') = QSliderConst $ castQWidgetToQSlider ptr'
      cast' (M322.QWidgetConstGc fptr' ptr') = QSliderConstGc fptr' $ castQWidgetToQSlider ptr'
