...
foreign import ccall "genpop__QActionGroup_addAction" addAction' ::  HoppyF.Ptr QActionGroup -> HoppyF.Ptr M198.QAction -> HoppyP.IO (HoppyF.Ptr M198.QAction)
foreign import ccall "genpop__QActionGroup_addNewAction" addNewAction' ::  HoppyF.Ptr QActionGroup -> HoppyF.Ptr M52.QStringConst -> HoppyP.IO (HoppyF.Ptr M198.QAction)
foreign import ccall "genpop__QActionGroup_addNewActionWithIcon" addNewActionWithIcon' ::  HoppyF.Ptr QActionGroup -> HoppyF.Ptr M120.QIconConst -> HoppyF.Ptr M52.QStringConst -> HoppyP.IO (HoppyF.Ptr M198.QAction)
foreign import ccall "genpop__QActionGroup_checkedAction" checkedAction' ::  HoppyF.Ptr QActionGroupConst -> HoppyP.IO (HoppyF.Ptr M198.QAction)
...
foreign import ccall "genpop__QActionGroup_removeAction" removeAction' ::  HoppyF.Ptr QActionGroup -> HoppyF.Ptr M198.QAction -> HoppyP.IO ()
...
checkedAction :: (QActionGroupValue arg'1) => arg'1 -> HoppyP.IO M198.QAction
checkedAction arg'1 =
...
addAction :: (QActionGroupPtr arg'1, M198.QActionPtr arg'2) => arg'1 -> arg'2 -> HoppyP.IO M198.QAction
...
addNewAction :: (QActionGroupPtr arg'1, M52.QStringValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO M198.QAction
...
addNewActionWithIcon :: (QActionGroupPtr arg'1, M120.QIconValue arg'2, M52.QStringValue arg'3) => arg'1 -> arg'2 -> arg'3 -> HoppyP.IO M198.QAction
...
removeAction :: (QActionGroupPtr arg'1, M198.QActionPtr arg'2) => arg'1 -> arg'2 -> HoppyP.IO ()
