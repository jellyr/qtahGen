...
import qualified Graphics.UI.Qtah.Generated.Widgets.QAbstractItemDelegate as M188
...
foreign import ccall "genpop__QAbstractItemView_iconSize" iconSize' ::  HoppyF.Ptr QAbstractItemViewConst -> HoppyP.IO (HoppyF.Ptr M48.QSizeConst)
foreign import ccall "genpop__QAbstractItemView_setIconSize" setIconSize' ::  HoppyF.Ptr QAbstractItemView -> HoppyF.Ptr M48.QSizeConst -> HoppyP.IO ()
foreign import ccall "genpop__QAbstractItemView_indexAt" indexAt' ::  HoppyF.Ptr QAbstractItemViewConst -> HoppyF.Ptr M38.QPointConst -> HoppyP.IO (HoppyF.Ptr M32.QModelIndexConst)
foreign import ccall "genpop__QAbstractItemView_indexWidget" indexWidget' ::  HoppyF.Ptr QAbstractItemViewConst -> HoppyF.Ptr M32.QModelIndexConst -> HoppyP.IO (HoppyF.Ptr M322.QWidget)
foreign import ccall "genpop__QAbstractItemView_itemDelegate" itemDelegate' ::  HoppyF.Ptr QAbstractItemViewConst -> HoppyP.IO (HoppyF.Ptr M188.QAbstractItemDelegate)
foreign import ccall "genpop__QAbstractItemView_itemDelegateAt" itemDelegateAt' ::  HoppyF.Ptr QAbstractItemViewConst -> HoppyF.Ptr M32.QModelIndexConst -> HoppyP.IO (HoppyF.Ptr M188.QAbstractItemDelegate)
foreign import ccall "genpop__QAbstractItemView_itemDelegateForColumn" itemDelegateForColumn' ::  HoppyF.Ptr QAbstractItemViewConst -> HoppyFC.CInt -> HoppyP.IO (HoppyF.Ptr M188.QAbstractItemDelegate)
foreign import ccall "genpop__QAbstractItemView_itemDelegateForRow" itemDelegateForRow' ::  HoppyF.Ptr QAbstractItemViewConst -> HoppyFC.CInt -> HoppyP.IO (HoppyF.Ptr M188.QAbstractItemDelegate)
foreign import ccall "genpop__QAbstractItemView_keyboardSearch" keyboardSearch' ::  HoppyF.Ptr QAbstractItemView -> HoppyF.Ptr M52.QStringConst -> HoppyP.IO ()
...
foreign import ccall "genpop__QAbstractItemView_setIndexWidget" setIndexWidget' ::  HoppyF.Ptr QAbstractItemView -> HoppyF.Ptr M32.QModelIndexConst -> HoppyF.Ptr M322.QWidget -> HoppyP.IO ()
foreign import ccall "genpop__QAbstractItemView_setItemDelegate" setItemDelegate' ::  HoppyF.Ptr QAbstractItemView -> HoppyF.Ptr M188.QAbstractItemDelegate -> HoppyP.IO ()
foreign import ccall "genpop__QAbstractItemView_setItemDelegateForColumn" setItemDelegateForColumn' ::  HoppyF.Ptr QAbstractItemView -> HoppyFC.CInt -> HoppyF.Ptr M188.QAbstractItemDelegate -> HoppyP.IO ()
foreign import ccall "genpop__QAbstractItemView_setItemDelegateForRow" setItemDelegateForRow' ::  HoppyF.Ptr QAbstractItemView -> HoppyFC.CInt -> HoppyF.Ptr M188.QAbstractItemDelegate -> HoppyP.IO ()
...
foreign import ccall "genpop__QAbstractItemView_sizeHintForIndex" sizeHintForIndex' ::  HoppyF.Ptr QAbstractItemViewConst -> HoppyF.Ptr M32.QModelIndexConst -> HoppyP.IO (HoppyF.Ptr M48.QSizeConst)
...
foreign import ccall "genpop__QAbstractItemView_visualRect" visualRect' ::  HoppyF.Ptr QAbstractItemViewConst -> HoppyF.Ptr M32.QModelIndexConst -> HoppyP.IO (HoppyF.Ptr M42.QRectConst)
foreign import ccall "gencast__QAbstractItemView__QAbstractScrollArea" castQAbstractItemViewToQAbstractScrollArea :: HoppyF.Ptr QAbstractItemViewConst -> HoppyF.Ptr M192.QAbstractScrollAreaConst
foreign import ccall "gencast__QAbstractScrollArea__QAbstractItemView" castQAbstractScrollAreaToQAbstractItemView :: HoppyF.Ptr M192.QAbstractScrollAreaConst -> HoppyF.Ptr QAbstractItemViewConst
foreign import ccall "gencast__QAbstractItemView__QWidget" castQAbstractItemViewToQWidget :: HoppyF.Ptr QAbstractItemViewConst -> HoppyF.Ptr M322.QWidgetConst
foreign import ccall "gencast__QWidget__QAbstractItemView" castQWidgetToQAbstractItemView :: HoppyF.Ptr M322.QWidgetConst -> HoppyF.Ptr QAbstractItemViewConst
...
defaultDropAction :: (QAbstractItemViewValue arg'1) => arg'1 -> HoppyP.IO M66.QtDropAction
...
indexAt :: (QAbstractItemViewValue arg'1, M38.QPointValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO M32.QModelIndex
indexAt arg'1 arg'2 =
  withQAbstractItemViewPtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
...
indexWidget :: (QAbstractItemViewValue arg'1, M32.QModelIndexValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO M322.QWidget
...
itemDelegate :: (QAbstractItemViewValue arg'1) => arg'1 -> HoppyP.IO M188.QAbstractItemDelegate
itemDelegate arg'1 =
  withQAbstractItemViewPtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
  HoppyP.fmap M188.QAbstractItemDelegate
  (itemDelegate' arg'1')

itemDelegateAt :: (QAbstractItemViewValue arg'1, M32.QModelIndexValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO M188.QAbstractItemDelegate
...
itemDelegateForColumn :: (QAbstractItemViewValue arg'1) => arg'1 -> HoppyP.Int -> HoppyP.IO M188.QAbstractItemDelegate
...
itemDelegateForRow :: (QAbstractItemViewValue arg'1) => arg'1 -> HoppyP.Int -> HoppyP.IO M188.QAbstractItemDelegate
...
textElideMode :: (QAbstractItemViewValue arg'1) => arg'1 -> HoppyP.IO M66.QtTextElideMode
textElideMode arg'1 =
  withQAbstractItemViewPtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
  HoppyP.fmap (HoppyP.toEnum . HoppyFHR.coerceIntegral)
  (textElideMode' arg'1')
...
setDefaultDropAction :: (QAbstractItemViewPtr arg'1) => arg'1 -> M66.QtDropAction -> HoppyP.IO ()
...
setIconSize :: (QAbstractItemViewPtr arg'1, M48.QSizeValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO ()
setIconSize arg'1 arg'2 =
  HoppyFHR.withCppPtr (toQAbstractItemView arg'1) $ \arg'1' ->
  M48.withQSizePtr arg'2 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'2' ->
  (setIconSize' arg'1' arg'2')

keyboardSearch :: (QAbstractItemViewPtr arg'1, M52.QStringValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO ()
...
setIndexWidget :: (QAbstractItemViewPtr arg'1, M32.QModelIndexValue arg'2, M322.QWidgetPtr arg'3) => arg'1 -> arg'2 -> arg'3 -> HoppyP.IO ()
...
setItemDelegate :: (QAbstractItemViewPtr arg'1, M188.QAbstractItemDelegatePtr arg'2) => arg'1 -> arg'2 -> HoppyP.IO ()
setItemDelegate arg'1 arg'2 =
  HoppyFHR.withCppPtr (toQAbstractItemView arg'1) $ \arg'1' ->
  HoppyFHR.withCppPtr (M188.toQAbstractItemDelegate arg'2) $ \arg'2' ->
  (setItemDelegate' arg'1' arg'2')

setItemDelegateForColumn :: (QAbstractItemViewPtr arg'1, M188.QAbstractItemDelegatePtr arg'3) => arg'1 -> HoppyP.Int -> arg'3 -> HoppyP.IO ()
setItemDelegateForColumn arg'1 arg'2 arg'3 =
  HoppyFHR.withCppPtr (toQAbstractItemView arg'1) $ \arg'1' ->
  let arg'2' = HoppyFHR.coerceIntegral arg'2 in
  HoppyFHR.withCppPtr (M188.toQAbstractItemDelegate arg'3) $ \arg'3' ->
  (setItemDelegateForColumn' arg'1' arg'2' arg'3')

setItemDelegateForRow :: (QAbstractItemViewPtr arg'1, M188.QAbstractItemDelegatePtr arg'3) => arg'1 -> HoppyP.Int -> arg'3 -> HoppyP.IO ()
...
setTextElideMode :: (QAbstractItemViewPtr arg'1) => arg'1 -> M66.QtTextElideMode -> HoppyP.IO ()
...
instance M192.QAbstractScrollAreaConstPtr QAbstractItemViewConst where
  toQAbstractScrollAreaConst (QAbstractItemViewConst ptr') = M192.QAbstractScrollAreaConst $ castQAbstractItemViewToQAbstractScrollArea ptr'
  toQAbstractScrollAreaConst (QAbstractItemViewConstGc fptr' ptr') = M192.QAbstractScrollAreaConstGc fptr' $ castQAbstractItemViewToQAbstractScrollArea ptr'

instance M322.QWidgetConstPtr QAbstractItemViewConst where
  toQWidgetConst (QAbstractItemViewConst ptr') = M322.QWidgetConst $ castQAbstractItemViewToQWidget ptr'
  toQWidgetConst (QAbstractItemViewConstGc fptr' ptr') = M322.QWidgetConstGc fptr' $ castQAbstractItemViewToQWidget ptr'
...
instance M192.QAbstractScrollAreaConstPtr QAbstractItemView where
  toQAbstractScrollAreaConst (QAbstractItemView ptr') = M192.QAbstractScrollAreaConst $ castQAbstractItemViewToQAbstractScrollArea $ (HoppyF.castPtr :: HoppyF.Ptr QAbstractItemView -> HoppyF.Ptr QAbstractItemViewConst) ptr'
  toQAbstractScrollAreaConst (QAbstractItemViewGc fptr' ptr') = M192.QAbstractScrollAreaConstGc fptr' $ castQAbstractItemViewToQAbstractScrollArea $ (HoppyF.castPtr :: HoppyF.Ptr QAbstractItemView -> HoppyF.Ptr QAbstractItemViewConst) ptr'

instance M192.QAbstractScrollAreaPtr QAbstractItemView where
  toQAbstractScrollArea (QAbstractItemView ptr') = M192.QAbstractScrollArea $ (HoppyF.castPtr :: HoppyF.Ptr M192.QAbstractScrollAreaConst -> HoppyF.Ptr M192.QAbstractScrollArea) $ castQAbstractItemViewToQAbstractScrollArea $ (HoppyF.castPtr :: HoppyF.Ptr QAbstractItemView -> HoppyF.Ptr QAbstractItemViewConst) ptr'
  toQAbstractScrollArea (QAbstractItemViewGc fptr' ptr') = M192.QAbstractScrollAreaGc fptr' $ (HoppyF.castPtr :: HoppyF.Ptr M192.QAbstractScrollAreaConst -> HoppyF.Ptr M192.QAbstractScrollArea) $ castQAbstractItemViewToQAbstractScrollArea $ (HoppyF.castPtr :: HoppyF.Ptr QAbstractItemView -> HoppyF.Ptr QAbstractItemViewConst) ptr'

instance M322.QWidgetConstPtr QAbstractItemView where
  toQWidgetConst (QAbstractItemView ptr') = M322.QWidgetConst $ castQAbstractItemViewToQWidget $ (HoppyF.castPtr :: HoppyF.Ptr QAbstractItemView -> HoppyF.Ptr QAbstractItemViewConst) ptr'
  toQWidgetConst (QAbstractItemViewGc fptr' ptr') = M322.QWidgetConstGc fptr' $ castQAbstractItemViewToQWidget $ (HoppyF.castPtr :: HoppyF.Ptr QAbstractItemView -> HoppyF.Ptr QAbstractItemViewConst) ptr'

instance M322.QWidgetPtr QAbstractItemView where
  toQWidget (QAbstractItemView ptr') = M322.QWidget $ (HoppyF.castPtr :: HoppyF.Ptr M322.QWidgetConst -> HoppyF.Ptr M322.QWidget) $ castQAbstractItemViewToQWidget $ (HoppyF.castPtr :: HoppyF.Ptr QAbstractItemView -> HoppyF.Ptr QAbstractItemViewConst) ptr'
  toQWidget (QAbstractItemViewGc fptr' ptr') = M322.QWidgetGc fptr' $ (HoppyF.castPtr :: HoppyF.Ptr M322.QWidgetConst -> HoppyF.Ptr M322.QWidget) $ castQAbstractItemViewToQWidget $ (HoppyF.castPtr :: HoppyF.Ptr QAbstractItemView -> HoppyF.Ptr QAbstractItemViewConst) ptr'
...
instance QAbstractItemViewSuper M192.QAbstractScrollArea where
  downToQAbstractItemView = castQAbstractItemViewToNonconst . cast' . M192.castQAbstractScrollAreaToConst
    where
      cast' (M192.QAbstractScrollAreaConst ptr') = QAbstractItemViewConst $ castQAbstractScrollAreaToQAbstractItemView ptr'
      cast' (M192.QAbstractScrollAreaConstGc fptr' ptr') = QAbstractItemViewConstGc fptr' $ castQAbstractScrollAreaToQAbstractItemView ptr'
instance QAbstractItemViewSuper M322.QWidget where
  downToQAbstractItemView = castQAbstractItemViewToNonconst . cast' . M322.castQWidgetToConst
    where
      cast' (M322.QWidgetConst ptr') = QAbstractItemViewConst $ castQWidgetToQAbstractItemView ptr'
      cast' (M322.QWidgetConstGc fptr' ptr') = QAbstractItemViewConstGc fptr' $ castQWidgetToQAbstractItemView ptr'
...
instance QAbstractItemViewSuperConst M192.QAbstractScrollAreaConst where
  downToQAbstractItemViewConst = cast'
    where
      cast' (M192.QAbstractScrollAreaConst ptr') = QAbstractItemViewConst $ castQAbstractScrollAreaToQAbstractItemView ptr'
      cast' (M192.QAbstractScrollAreaConstGc fptr' ptr') = QAbstractItemViewConstGc fptr' $ castQAbstractScrollAreaToQAbstractItemView ptr'
instance QAbstractItemViewSuperConst M322.QWidgetConst where
  downToQAbstractItemViewConst = cast'
    where
      cast' (M322.QWidgetConst ptr') = QAbstractItemViewConst $ castQWidgetToQAbstractItemView ptr'
      cast' (M322.QWidgetConstGc fptr' ptr') = QAbstractItemViewConstGc fptr' $ castQWidgetToQAbstractItemView ptr'
