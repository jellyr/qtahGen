...
foreign import ccall "genpop__QGridLayout_newWithParent" newWithParent' ::  HoppyF.Ptr M322.QWidget -> HoppyP.IO (HoppyF.Ptr QGridLayout)
foreign import ccall "genpop__QGridLayout_addItem" addItem' ::  HoppyF.Ptr QGridLayout -> HoppyF.Ptr M258.QLayoutItem -> HoppyFC.CInt -> HoppyFC.CInt -> HoppyP.IO ()
foreign import ccall "genpop__QGridLayout_addItemWithSpan" addItemWithSpan' ::  HoppyF.Ptr QGridLayout -> HoppyF.Ptr M258.QLayoutItem -> HoppyFC.CInt -> HoppyFC.CInt -> HoppyFC.CInt -> HoppyFC.CInt -> HoppyP.IO ()
foreign import ccall "genpop__QGridLayout_addItemWithSpanAndAlignment" addItemWithSpanAndAlignment' ::  HoppyF.Ptr QGridLayout -> HoppyF.Ptr M258.QLayoutItem -> HoppyFC.CInt -> HoppyFC.CInt -> HoppyFC.CInt -> HoppyFC.CInt -> HoppyFC.CInt -> HoppyP.IO ()
foreign import ccall "genpop__QGridLayout_addLayout" addLayout' ::  HoppyF.Ptr QGridLayout -> HoppyF.Ptr M256.QLayout -> HoppyFC.CInt -> HoppyFC.CInt -> HoppyP.IO ()
foreign import ccall "genpop__QGridLayout_addLayoutWithSpan" addLayoutWithSpan' ::  HoppyF.Ptr QGridLayout -> HoppyF.Ptr M256.QLayout -> HoppyFC.CInt -> HoppyFC.CInt -> HoppyFC.CInt -> HoppyFC.CInt -> HoppyP.IO ()
foreign import ccall "genpop__QGridLayout_addLayoutWithSpanAndAlignment" addLayoutWithSpanAndAlignment' ::  HoppyF.Ptr QGridLayout -> HoppyF.Ptr M256.QLayout -> HoppyFC.CInt -> HoppyFC.CInt -> HoppyFC.CInt -> HoppyFC.CInt -> HoppyFC.CInt -> HoppyP.IO ()
foreign import ccall "genpop__QGridLayout_addWidget" addWidget' ::  HoppyF.Ptr QGridLayout -> HoppyF.Ptr M322.QWidget -> HoppyFC.CInt -> HoppyFC.CInt -> HoppyP.IO ()
foreign import ccall "genpop__QGridLayout_addWidgetWithSpan" addWidgetWithSpan' ::  HoppyF.Ptr QGridLayout -> HoppyF.Ptr M322.QWidget -> HoppyFC.CInt -> HoppyFC.CInt -> HoppyFC.CInt -> HoppyFC.CInt -> HoppyP.IO ()
foreign import ccall "genpop__QGridLayout_addWidgetWithSpanAndAlignment" addWidgetWithSpanAndAlignment' ::  HoppyF.Ptr QGridLayout -> HoppyF.Ptr M322.QWidget -> HoppyFC.CInt -> HoppyFC.CInt -> HoppyFC.CInt -> HoppyFC.CInt -> HoppyFC.CInt -> HoppyP.IO ()
foreign import ccall "genpop__QGridLayout_cellRect" cellRect' ::  HoppyF.Ptr QGridLayoutConst -> HoppyFC.CInt -> HoppyFC.CInt -> HoppyP.IO (HoppyF.Ptr M42.QRectConst)
...
foreign import ccall "genpop__QGridLayout_itemAtPosition" itemAtPosition' ::  HoppyF.Ptr QGridLayoutConst -> HoppyFC.CInt -> HoppyFC.CInt -> HoppyP.IO (HoppyF.Ptr M258.QLayoutItem)
...
foreign import ccall "gencast__QGridLayout__QLayout" castQGridLayoutToQLayout :: HoppyF.Ptr QGridLayoutConst -> HoppyF.Ptr M256.QLayoutConst
foreign import ccall "gencast__QLayout__QGridLayout" castQLayoutToQGridLayout :: HoppyF.Ptr M256.QLayoutConst -> HoppyF.Ptr QGridLayoutConst
...
foreign import ccall "gencast__QGridLayout__QLayoutItem" castQGridLayoutToQLayoutItem :: HoppyF.Ptr QGridLayoutConst -> HoppyF.Ptr M258.QLayoutItemConst
foreign import ccall "gencast__QLayoutItem__QGridLayout" castQLayoutItemToQGridLayout :: HoppyF.Ptr M258.QLayoutItemConst -> HoppyF.Ptr QGridLayoutConst
...
class (M256.QLayoutConstPtr this) => QGridLayoutConstPtr this where
...
itemAtPosition :: (QGridLayoutValue arg'1) => arg'1 -> HoppyP.Int -> HoppyP.Int -> HoppyP.IO M258.QLayoutItem
...
originCorner :: (QGridLayoutValue arg'1) => arg'1 -> HoppyP.IO M66.QtCorner
originCorner arg'1 =
  withQGridLayoutPtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
...
class (QGridLayoutConstPtr this, M256.QLayoutPtr this) => QGridLayoutPtr this where
  toQGridLayout :: this -> QGridLayout

addItem :: (QGridLayoutPtr arg'1, M258.QLayoutItemPtr arg'2) => arg'1 -> arg'2 -> HoppyP.Int -> HoppyP.Int -> HoppyP.IO ()
addItem arg'1 arg'2 arg'3 arg'4 =
  HoppyFHR.withCppPtr (toQGridLayout arg'1) $ \arg'1' ->
  HoppyFHR.withCppPtr (M258.toQLayoutItem arg'2) $ \arg'2' ->
  let arg'3' = HoppyFHR.coerceIntegral arg'3 in
  let arg'4' = HoppyFHR.coerceIntegral arg'4 in
  (addItem' arg'1' arg'2' arg'3' arg'4')

addItemWithSpan :: (QGridLayoutPtr arg'1, M258.QLayoutItemPtr arg'2) => arg'1 -> arg'2 -> HoppyP.Int -> HoppyP.Int -> HoppyP.Int -> HoppyP.Int -> HoppyP.IO ()
...
addItemWithSpanAndAlignment :: (QGridLayoutPtr arg'1, M258.QLayoutItemPtr arg'2, M66.IsQtAlignment arg'7) => arg'1 -> arg'2 -> HoppyP.Int -> HoppyP.Int -> HoppyP.Int -> HoppyP.Int -> arg'7 -> HoppyP.IO ()
...
addLayout :: (QGridLayoutPtr arg'1, M256.QLayoutPtr arg'2) => arg'1 -> arg'2 -> HoppyP.Int -> HoppyP.Int -> HoppyP.IO ()
...
addLayoutWithSpan :: (QGridLayoutPtr arg'1, M256.QLayoutPtr arg'2) => arg'1 -> arg'2 -> HoppyP.Int -> HoppyP.Int -> HoppyP.Int -> HoppyP.Int -> HoppyP.IO ()
...
addLayoutWithSpanAndAlignment :: (QGridLayoutPtr arg'1, M256.QLayoutPtr arg'2, M66.IsQtAlignment arg'7) => arg'1 -> arg'2 -> HoppyP.Int -> HoppyP.Int -> HoppyP.Int -> HoppyP.Int -> arg'7 -> HoppyP.IO ()
...
addWidget :: (QGridLayoutPtr arg'1, M322.QWidgetPtr arg'2) => arg'1 -> arg'2 -> HoppyP.Int -> HoppyP.Int -> HoppyP.IO ()
...
addWidgetWithSpan :: (QGridLayoutPtr arg'1, M322.QWidgetPtr arg'2) => arg'1 -> arg'2 -> HoppyP.Int -> HoppyP.Int -> HoppyP.Int -> HoppyP.Int -> HoppyP.IO ()
...
addWidgetWithSpanAndAlignment :: (QGridLayoutPtr arg'1, M322.QWidgetPtr arg'2, M66.IsQtAlignment arg'7) => arg'1 -> arg'2 -> HoppyP.Int -> HoppyP.Int -> HoppyP.Int -> HoppyP.Int -> arg'7 -> HoppyP.IO ()
...
setOriginCorner :: (QGridLayoutPtr arg'1) => arg'1 -> M66.QtCorner -> HoppyP.IO ()
...
instance M256.QLayoutConstPtr QGridLayoutConst where
  toQLayoutConst (QGridLayoutConst ptr') = M256.QLayoutConst $ castQGridLayoutToQLayout ptr'
  toQLayoutConst (QGridLayoutConstGc fptr' ptr') = M256.QLayoutConstGc fptr' $ castQGridLayoutToQLayout ptr'
...
instance M258.QLayoutItemConstPtr QGridLayoutConst where
  toQLayoutItemConst (QGridLayoutConst ptr') = M258.QLayoutItemConst $ castQGridLayoutToQLayoutItem ptr'
  toQLayoutItemConst (QGridLayoutConstGc fptr' ptr') = M258.QLayoutItemConstGc fptr' $ castQGridLayoutToQLayoutItem ptr'
...
instance M256.QLayoutConstPtr QGridLayout where
  toQLayoutConst (QGridLayout ptr') = M256.QLayoutConst $ castQGridLayoutToQLayout $ (HoppyF.castPtr :: HoppyF.Ptr QGridLayout -> HoppyF.Ptr QGridLayoutConst) ptr'
  toQLayoutConst (QGridLayoutGc fptr' ptr') = M256.QLayoutConstGc fptr' $ castQGridLayoutToQLayout $ (HoppyF.castPtr :: HoppyF.Ptr QGridLayout -> HoppyF.Ptr QGridLayoutConst) ptr'

instance M256.QLayoutPtr QGridLayout where
  toQLayout (QGridLayout ptr') = M256.QLayout $ (HoppyF.castPtr :: HoppyF.Ptr M256.QLayoutConst -> HoppyF.Ptr M256.QLayout) $ castQGridLayoutToQLayout $ (HoppyF.castPtr :: HoppyF.Ptr QGridLayout -> HoppyF.Ptr QGridLayoutConst) ptr'
  toQLayout (QGridLayoutGc fptr' ptr') = M256.QLayoutGc fptr' $ (HoppyF.castPtr :: HoppyF.Ptr M256.QLayoutConst -> HoppyF.Ptr M256.QLayout) $ castQGridLayoutToQLayout $ (HoppyF.castPtr :: HoppyF.Ptr QGridLayout -> HoppyF.Ptr QGridLayoutConst) ptr'
...
instance M258.QLayoutItemConstPtr QGridLayout where
  toQLayoutItemConst (QGridLayout ptr') = M258.QLayoutItemConst $ castQGridLayoutToQLayoutItem $ (HoppyF.castPtr :: HoppyF.Ptr QGridLayout -> HoppyF.Ptr QGridLayoutConst) ptr'
  toQLayoutItemConst (QGridLayoutGc fptr' ptr') = M258.QLayoutItemConstGc fptr' $ castQGridLayoutToQLayoutItem $ (HoppyF.castPtr :: HoppyF.Ptr QGridLayout -> HoppyF.Ptr QGridLayoutConst) ptr'

instance M258.QLayoutItemPtr QGridLayout where
  toQLayoutItem (QGridLayout ptr') = M258.QLayoutItem $ (HoppyF.castPtr :: HoppyF.Ptr M258.QLayoutItemConst -> HoppyF.Ptr M258.QLayoutItem) $ castQGridLayoutToQLayoutItem $ (HoppyF.castPtr :: HoppyF.Ptr QGridLayout -> HoppyF.Ptr QGridLayoutConst) ptr'
  toQLayoutItem (QGridLayoutGc fptr' ptr') = M258.QLayoutItemGc fptr' $ (HoppyF.castPtr :: HoppyF.Ptr M258.QLayoutItemConst -> HoppyF.Ptr M258.QLayoutItem) $ castQGridLayoutToQLayoutItem $ (HoppyF.castPtr :: HoppyF.Ptr QGridLayout -> HoppyF.Ptr QGridLayoutConst) ptr'
...
newWithParent :: (M322.QWidgetPtr arg'1) => arg'1 -> HoppyP.IO QGridLayout
newWithParent arg'1 =
...
instance QGridLayoutSuper M256.QLayout where
  downToQGridLayout = castQGridLayoutToNonconst . cast' . M256.castQLayoutToConst
    where
      cast' (M256.QLayoutConst ptr') = QGridLayoutConst $ castQLayoutToQGridLayout ptr'
      cast' (M256.QLayoutConstGc fptr' ptr') = QGridLayoutConstGc fptr' $ castQLayoutToQGridLayout ptr'
...
instance QGridLayoutSuper M258.QLayoutItem where
  downToQGridLayout = castQGridLayoutToNonconst . cast' . M258.castQLayoutItemToConst
    where
      cast' (M258.QLayoutItemConst ptr') = QGridLayoutConst $ castQLayoutItemToQGridLayout ptr'
      cast' (M258.QLayoutItemConstGc fptr' ptr') = QGridLayoutConstGc fptr' $ castQLayoutItemToQGridLayout ptr'

class QGridLayoutSuperConst a where
  downToQGridLayoutConst :: a -> QGridLayoutConst

instance QGridLayoutSuperConst M256.QLayoutConst where
...
instance QGridLayoutSuperConst M34.QObjectConst where
  downToQGridLayoutConst = cast'
    where
      cast' (M34.QObjectConst ptr') = QGridLayoutConst $ castQObjectToQGridLayout ptr'
      cast' (M34.QObjectConstGc fptr' ptr') = QGridLayoutConstGc fptr' $ castQObjectToQGridLayout ptr'
instance QGridLayoutSuperConst M258.QLayoutItemConst where
  downToQGridLayoutConst = cast'
    where
      cast' (M258.QLayoutItemConst ptr') = QGridLayoutConst $ castQLayoutItemToQGridLayout ptr'
      cast' (M258.QLayoutItemConstGc fptr' ptr') = QGridLayoutConstGc fptr' $ castQLayoutItemToQGridLayout ptr'
