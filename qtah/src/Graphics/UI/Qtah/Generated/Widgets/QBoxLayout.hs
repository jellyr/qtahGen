...
foreign import ccall "genpop__QBoxLayout_newWithParent" newWithParent' ::  HoppyFC.CInt -> HoppyF.Ptr M322.QWidget -> HoppyP.IO (HoppyF.Ptr QBoxLayout)
foreign import ccall "genpop__QBoxLayout_addLayout" addLayout' ::  HoppyF.Ptr QBoxLayout -> HoppyF.Ptr M256.QLayout -> HoppyP.IO ()
foreign import ccall "genpop__QBoxLayout_addLayoutWithStretch" addLayoutWithStretch' ::  HoppyF.Ptr QBoxLayout -> HoppyF.Ptr M256.QLayout -> HoppyFC.CInt -> HoppyP.IO ()
...
foreign import ccall "genpop__QBoxLayout_addWidget" addWidget' ::  HoppyF.Ptr QBoxLayout -> HoppyF.Ptr M322.QWidget -> HoppyP.IO ()
foreign import ccall "genpop__QBoxLayout_addWidgetWithStretch" addWidgetWithStretch' ::  HoppyF.Ptr QBoxLayout -> HoppyF.Ptr M322.QWidget -> HoppyFC.CInt -> HoppyP.IO ()
foreign import ccall "genpop__QBoxLayout_addWidgetWithStretchAndAlignment" addWidgetWithStretchAndAlignment' ::  HoppyF.Ptr QBoxLayout -> HoppyF.Ptr M322.QWidget -> HoppyFC.CInt -> HoppyFC.CInt -> HoppyP.IO ()
...
foreign import ccall "genpop__QBoxLayout_insertLayout" insertLayout' ::  HoppyF.Ptr QBoxLayout -> HoppyFC.CInt -> HoppyF.Ptr M256.QLayout -> HoppyP.IO ()
foreign import ccall "genpop__QBoxLayout_insertLayoutWithStretch" insertLayoutWithStretch' ::  HoppyF.Ptr QBoxLayout -> HoppyFC.CInt -> HoppyF.Ptr M256.QLayout -> HoppyFC.CInt -> HoppyP.IO ()
...
foreign import ccall "genpop__QBoxLayout_insertWidget" insertWidget' ::  HoppyF.Ptr QBoxLayout -> HoppyFC.CInt -> HoppyF.Ptr M322.QWidget -> HoppyP.IO ()
foreign import ccall "genpop__QBoxLayout_insertWidgetWithStretch" insertWidgetWithStretch' ::  HoppyF.Ptr QBoxLayout -> HoppyFC.CInt -> HoppyF.Ptr M322.QWidget -> HoppyFC.CInt -> HoppyP.IO ()
foreign import ccall "genpop__QBoxLayout_insertWidgetWithStretchAndAlignment" insertWidgetWithStretchAndAlignment' ::  HoppyF.Ptr QBoxLayout -> HoppyFC.CInt -> HoppyF.Ptr M322.QWidget -> HoppyFC.CInt -> HoppyFC.CInt -> HoppyP.IO ()
foreign import ccall "genpop__QBoxLayout_setStretch" setStretch' ::  HoppyF.Ptr QBoxLayout -> HoppyFC.CInt -> HoppyFC.CInt -> HoppyP.IO ()
foreign import ccall "genpop__QBoxLayout_setWidgetStretchFactor" setWidgetStretchFactor' ::  HoppyF.Ptr QBoxLayout -> HoppyF.Ptr M322.QWidget -> HoppyFC.CInt -> HoppyP.IO HoppyFHR.CBool
foreign import ccall "genpop__QBoxLayout_setLayoutStretchFactor" setLayoutStretchFactor' ::  HoppyF.Ptr QBoxLayout -> HoppyF.Ptr M256.QLayout -> HoppyFC.CInt -> HoppyP.IO HoppyFHR.CBool
...
foreign import ccall "gencast__QBoxLayout__QLayout" castQBoxLayoutToQLayout :: HoppyF.Ptr QBoxLayoutConst -> HoppyF.Ptr M256.QLayoutConst
foreign import ccall "gencast__QLayout__QBoxLayout" castQLayoutToQBoxLayout :: HoppyF.Ptr M256.QLayoutConst -> HoppyF.Ptr QBoxLayoutConst
...
foreign import ccall "gencast__QBoxLayout__QLayoutItem" castQBoxLayoutToQLayoutItem :: HoppyF.Ptr QBoxLayoutConst -> HoppyF.Ptr M258.QLayoutItemConst
foreign import ccall "gencast__QLayoutItem__QBoxLayout" castQLayoutItemToQBoxLayout :: HoppyF.Ptr M258.QLayoutItemConst -> HoppyF.Ptr QBoxLayoutConst
...
class (M256.QLayoutConstPtr this) => QBoxLayoutConstPtr this where
...
class (QBoxLayoutConstPtr this, M256.QLayoutPtr this) => QBoxLayoutPtr this where
  toQBoxLayout :: this -> QBoxLayout

addLayout :: (QBoxLayoutPtr arg'1, M256.QLayoutPtr arg'2) => arg'1 -> arg'2 -> HoppyP.IO ()
addLayout arg'1 arg'2 =
  HoppyFHR.withCppPtr (toQBoxLayout arg'1) $ \arg'1' ->
  HoppyFHR.withCppPtr (M256.toQLayout arg'2) $ \arg'2' ->
  (addLayout' arg'1' arg'2')

addLayoutWithStretch :: (QBoxLayoutPtr arg'1, M256.QLayoutPtr arg'2) => arg'1 -> arg'2 -> HoppyP.Int -> HoppyP.IO ()
...
addWidget :: (QBoxLayoutPtr arg'1, M322.QWidgetPtr arg'2) => arg'1 -> arg'2 -> HoppyP.IO ()
addWidget arg'1 arg'2 =
  HoppyFHR.withCppPtr (toQBoxLayout arg'1) $ \arg'1' ->
  HoppyFHR.withCppPtr (M322.toQWidget arg'2) $ \arg'2' ->
  (addWidget' arg'1' arg'2')

addWidgetWithStretch :: (QBoxLayoutPtr arg'1, M322.QWidgetPtr arg'2) => arg'1 -> arg'2 -> HoppyP.Int -> HoppyP.IO ()
...
addWidgetWithStretchAndAlignment :: (QBoxLayoutPtr arg'1, M322.QWidgetPtr arg'2, M66.IsQtAlignment arg'4) => arg'1 -> arg'2 -> HoppyP.Int -> arg'4 -> HoppyP.IO ()
...
insertLayout :: (QBoxLayoutPtr arg'1, M256.QLayoutPtr arg'3) => arg'1 -> HoppyP.Int -> arg'3 -> HoppyP.IO ()
...
insertLayoutWithStretch :: (QBoxLayoutPtr arg'1, M256.QLayoutPtr arg'3) => arg'1 -> HoppyP.Int -> arg'3 -> HoppyP.Int -> HoppyP.IO ()
...
insertWidget :: (QBoxLayoutPtr arg'1, M322.QWidgetPtr arg'3) => arg'1 -> HoppyP.Int -> arg'3 -> HoppyP.IO ()
...
insertWidgetWithStretch :: (QBoxLayoutPtr arg'1, M322.QWidgetPtr arg'3) => arg'1 -> HoppyP.Int -> arg'3 -> HoppyP.Int -> HoppyP.IO ()
...
insertWidgetWithStretchAndAlignment :: (QBoxLayoutPtr arg'1, M322.QWidgetPtr arg'3, M66.IsQtAlignment arg'5) => arg'1 -> HoppyP.Int -> arg'3 -> HoppyP.Int -> arg'5 -> HoppyP.IO ()
insertWidgetWithStretchAndAlignment arg'1 arg'2 arg'3 arg'4 arg'5 =
  HoppyFHR.withCppPtr (toQBoxLayout arg'1) $ \arg'1' ->
  let arg'2' = HoppyFHR.coerceIntegral arg'2 in
  HoppyFHR.withCppPtr (M322.toQWidget arg'3) $ \arg'3' ->
  let arg'4' = HoppyFHR.coerceIntegral arg'4 in
  let arg'5' = M66.fromQtAlignment $ M66.toQtAlignment arg'5 in
  (insertWidgetWithStretchAndAlignment' arg'1' arg'2' arg'3' arg'4' arg'5')
...
setWidgetStretchFactor :: (QBoxLayoutPtr arg'1, M322.QWidgetPtr arg'2) => arg'1 -> arg'2 -> HoppyP.Int -> HoppyP.IO HoppyP.Bool
...
setLayoutStretchFactor :: (QBoxLayoutPtr arg'1, M256.QLayoutPtr arg'2) => arg'1 -> arg'2 -> HoppyP.Int -> HoppyP.IO HoppyP.Bool
...
instance M256.QLayoutConstPtr QBoxLayoutConst where
  toQLayoutConst (QBoxLayoutConst ptr') = M256.QLayoutConst $ castQBoxLayoutToQLayout ptr'
  toQLayoutConst (QBoxLayoutConstGc fptr' ptr') = M256.QLayoutConstGc fptr' $ castQBoxLayoutToQLayout ptr'
...
instance M258.QLayoutItemConstPtr QBoxLayoutConst where
  toQLayoutItemConst (QBoxLayoutConst ptr') = M258.QLayoutItemConst $ castQBoxLayoutToQLayoutItem ptr'
  toQLayoutItemConst (QBoxLayoutConstGc fptr' ptr') = M258.QLayoutItemConstGc fptr' $ castQBoxLayoutToQLayoutItem ptr'
...
instance M256.QLayoutConstPtr QBoxLayout where
  toQLayoutConst (QBoxLayout ptr') = M256.QLayoutConst $ castQBoxLayoutToQLayout $ (HoppyF.castPtr :: HoppyF.Ptr QBoxLayout -> HoppyF.Ptr QBoxLayoutConst) ptr'
  toQLayoutConst (QBoxLayoutGc fptr' ptr') = M256.QLayoutConstGc fptr' $ castQBoxLayoutToQLayout $ (HoppyF.castPtr :: HoppyF.Ptr QBoxLayout -> HoppyF.Ptr QBoxLayoutConst) ptr'

instance M256.QLayoutPtr QBoxLayout where
  toQLayout (QBoxLayout ptr') = M256.QLayout $ (HoppyF.castPtr :: HoppyF.Ptr M256.QLayoutConst -> HoppyF.Ptr M256.QLayout) $ castQBoxLayoutToQLayout $ (HoppyF.castPtr :: HoppyF.Ptr QBoxLayout -> HoppyF.Ptr QBoxLayoutConst) ptr'
  toQLayout (QBoxLayoutGc fptr' ptr') = M256.QLayoutGc fptr' $ (HoppyF.castPtr :: HoppyF.Ptr M256.QLayoutConst -> HoppyF.Ptr M256.QLayout) $ castQBoxLayoutToQLayout $ (HoppyF.castPtr :: HoppyF.Ptr QBoxLayout -> HoppyF.Ptr QBoxLayoutConst) ptr'
...
instance M258.QLayoutItemConstPtr QBoxLayout where
  toQLayoutItemConst (QBoxLayout ptr') = M258.QLayoutItemConst $ castQBoxLayoutToQLayoutItem $ (HoppyF.castPtr :: HoppyF.Ptr QBoxLayout -> HoppyF.Ptr QBoxLayoutConst) ptr'
  toQLayoutItemConst (QBoxLayoutGc fptr' ptr') = M258.QLayoutItemConstGc fptr' $ castQBoxLayoutToQLayoutItem $ (HoppyF.castPtr :: HoppyF.Ptr QBoxLayout -> HoppyF.Ptr QBoxLayoutConst) ptr'

instance M258.QLayoutItemPtr QBoxLayout where
  toQLayoutItem (QBoxLayout ptr') = M258.QLayoutItem $ (HoppyF.castPtr :: HoppyF.Ptr M258.QLayoutItemConst -> HoppyF.Ptr M258.QLayoutItem) $ castQBoxLayoutToQLayoutItem $ (HoppyF.castPtr :: HoppyF.Ptr QBoxLayout -> HoppyF.Ptr QBoxLayoutConst) ptr'
  toQLayoutItem (QBoxLayoutGc fptr' ptr') = M258.QLayoutItemGc fptr' $ (HoppyF.castPtr :: HoppyF.Ptr M258.QLayoutItemConst -> HoppyF.Ptr M258.QLayoutItem) $ castQBoxLayoutToQLayoutItem $ (HoppyF.castPtr :: HoppyF.Ptr QBoxLayout -> HoppyF.Ptr QBoxLayoutConst) ptr'
...
newWithParent :: (M322.QWidgetPtr arg'2) => QBoxLayoutDirection -> arg'2 -> HoppyP.IO QBoxLayout
...
instance QBoxLayoutSuper M256.QLayout where
  downToQBoxLayout = castQBoxLayoutToNonconst . cast' . M256.castQLayoutToConst
    where
      cast' (M256.QLayoutConst ptr') = QBoxLayoutConst $ castQLayoutToQBoxLayout ptr'
      cast' (M256.QLayoutConstGc fptr' ptr') = QBoxLayoutConstGc fptr' $ castQLayoutToQBoxLayout ptr'
...
instance QBoxLayoutSuper M258.QLayoutItem where
  downToQBoxLayout = castQBoxLayoutToNonconst . cast' . M258.castQLayoutItemToConst
    where
      cast' (M258.QLayoutItemConst ptr') = QBoxLayoutConst $ castQLayoutItemToQBoxLayout ptr'
      cast' (M258.QLayoutItemConstGc fptr' ptr') = QBoxLayoutConstGc fptr' $ castQLayoutItemToQBoxLayout ptr'

class QBoxLayoutSuperConst a where
  downToQBoxLayoutConst :: a -> QBoxLayoutConst

instance QBoxLayoutSuperConst M256.QLayoutConst where
...
instance QBoxLayoutSuperConst M34.QObjectConst where
  downToQBoxLayoutConst = cast'
    where
      cast' (M34.QObjectConst ptr') = QBoxLayoutConst $ castQObjectToQBoxLayout ptr'
      cast' (M34.QObjectConstGc fptr' ptr') = QBoxLayoutConstGc fptr' $ castQObjectToQBoxLayout ptr'
instance QBoxLayoutSuperConst M258.QLayoutItemConst where
  downToQBoxLayoutConst = cast'
    where
      cast' (M258.QLayoutItemConst ptr') = QBoxLayoutConst $ castQLayoutItemToQBoxLayout ptr'
      cast' (M258.QLayoutItemConstGc fptr' ptr') = QBoxLayoutConstGc fptr' $ castQLayoutItemToQBoxLayout ptr'
