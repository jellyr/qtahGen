...
foreign import ccall "genpop__QSpacerItem_sizePolicy" sizePolicy' ::  HoppyF.Ptr QSpacerItemConst -> HoppyP.IO (HoppyF.Ptr M286.QSizePolicyConst)
foreign import ccall "gencast__QSpacerItem__QLayoutItem" castQSpacerItemToQLayoutItem :: HoppyF.Ptr QSpacerItemConst -> HoppyF.Ptr M258.QLayoutItemConst
foreign import ccall "gencast__QLayoutItem__QSpacerItem" castQLayoutItemToQSpacerItem :: HoppyF.Ptr M258.QLayoutItemConst -> HoppyF.Ptr QSpacerItemConst
...
class (M258.QLayoutItemConstPtr this) => QSpacerItemConstPtr this where
  toQSpacerItemConst :: this -> QSpacerItemConst

sizePolicy :: (QSpacerItemValue arg'1) => arg'1 -> HoppyP.IO M286.QSizePolicy
sizePolicy arg'1 =
  withQSpacerItemPtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
  (HoppyFHR.decodeAndDelete . M286.QSizePolicyConst) =<<
  (sizePolicy' arg'1')

class (QSpacerItemConstPtr this, M258.QLayoutItemPtr this) => QSpacerItemPtr this where
...
changeSizeWithOptions :: (QSpacerItemPtr arg'1) => arg'1 -> HoppyP.Int -> HoppyP.Int -> M286.QSizePolicyPolicy -> M286.QSizePolicyPolicy -> HoppyP.IO ()
...
instance M258.QLayoutItemConstPtr QSpacerItemConst where
  toQLayoutItemConst (QSpacerItemConst ptr') = M258.QLayoutItemConst $ castQSpacerItemToQLayoutItem ptr'
  toQLayoutItemConst (QSpacerItemConstGc fptr' ptr') = M258.QLayoutItemConstGc fptr' $ castQSpacerItemToQLayoutItem ptr'
...
instance M258.QLayoutItemConstPtr QSpacerItem where
  toQLayoutItemConst (QSpacerItem ptr') = M258.QLayoutItemConst $ castQSpacerItemToQLayoutItem $ (HoppyF.castPtr :: HoppyF.Ptr QSpacerItem -> HoppyF.Ptr QSpacerItemConst) ptr'
  toQLayoutItemConst (QSpacerItemGc fptr' ptr') = M258.QLayoutItemConstGc fptr' $ castQSpacerItemToQLayoutItem $ (HoppyF.castPtr :: HoppyF.Ptr QSpacerItem -> HoppyF.Ptr QSpacerItemConst) ptr'

instance M258.QLayoutItemPtr QSpacerItem where
  toQLayoutItem (QSpacerItem ptr') = M258.QLayoutItem $ (HoppyF.castPtr :: HoppyF.Ptr M258.QLayoutItemConst -> HoppyF.Ptr M258.QLayoutItem) $ castQSpacerItemToQLayoutItem $ (HoppyF.castPtr :: HoppyF.Ptr QSpacerItem -> HoppyF.Ptr QSpacerItemConst) ptr'
  toQLayoutItem (QSpacerItemGc fptr' ptr') = M258.QLayoutItemGc fptr' $ (HoppyF.castPtr :: HoppyF.Ptr M258.QLayoutItemConst -> HoppyF.Ptr M258.QLayoutItem) $ castQSpacerItemToQLayoutItem $ (HoppyF.castPtr :: HoppyF.Ptr QSpacerItem -> HoppyF.Ptr QSpacerItemConst) ptr'
...
newWithOptions ::  HoppyP.Int -> HoppyP.Int -> M286.QSizePolicyPolicy -> M286.QSizePolicyPolicy -> HoppyP.IO QSpacerItem
...
instance QSpacerItemSuper M258.QLayoutItem where
  downToQSpacerItem = castQSpacerItemToNonconst . cast' . M258.castQLayoutItemToConst
    where
      cast' (M258.QLayoutItemConst ptr') = QSpacerItemConst $ castQLayoutItemToQSpacerItem ptr'
      cast' (M258.QLayoutItemConstGc fptr' ptr') = QSpacerItemConstGc fptr' $ castQLayoutItemToQSpacerItem ptr'

class QSpacerItemSuperConst a where
  downToQSpacerItemConst :: a -> QSpacerItemConst

instance QSpacerItemSuperConst M258.QLayoutItemConst where
