...
import qualified Graphics.UI.Qtah.Generated.Widgets.QAbstractSpinBox as M196
import qualified Graphics.UI.Qtah.Generated.Widgets.QDateTimeEdit as M212
...
foreign import ccall "genpop__QDateEdit_newWithParent" newWithParent' ::  HoppyF.Ptr M322.QWidget -> HoppyP.IO (HoppyF.Ptr QDateEdit)
foreign import ccall "genpop__QDateEdit_newWithDate" newWithDate' ::  HoppyF.Ptr M16.QDateConst -> HoppyP.IO (HoppyF.Ptr QDateEdit)
foreign import ccall "genpop__QDateEdit_newWithDateAndParent" newWithDateAndParent' ::  HoppyF.Ptr M16.QDateConst -> HoppyF.Ptr M322.QWidget -> HoppyP.IO (HoppyF.Ptr QDateEdit)
foreign import ccall "gencast__QDateEdit__QDateTimeEdit" castQDateEditToQDateTimeEdit :: HoppyF.Ptr QDateEditConst -> HoppyF.Ptr M212.QDateTimeEditConst
foreign import ccall "gencast__QDateTimeEdit__QDateEdit" castQDateTimeEditToQDateEdit :: HoppyF.Ptr M212.QDateTimeEditConst -> HoppyF.Ptr QDateEditConst
foreign import ccall "gencast__QDateEdit__QAbstractSpinBox" castQDateEditToQAbstractSpinBox :: HoppyF.Ptr QDateEditConst -> HoppyF.Ptr M196.QAbstractSpinBoxConst
foreign import ccall "gencast__QAbstractSpinBox__QDateEdit" castQAbstractSpinBoxToQDateEdit :: HoppyF.Ptr M196.QAbstractSpinBoxConst -> HoppyF.Ptr QDateEditConst
foreign import ccall "gencast__QDateEdit__QWidget" castQDateEditToQWidget :: HoppyF.Ptr QDateEditConst -> HoppyF.Ptr M322.QWidgetConst
foreign import ccall "gencast__QWidget__QDateEdit" castQWidgetToQDateEdit :: HoppyF.Ptr M322.QWidgetConst -> HoppyF.Ptr QDateEditConst
...
class (M212.QDateTimeEditConstPtr this) => QDateEditConstPtr this where
  toQDateEditConst :: this -> QDateEditConst

class (QDateEditConstPtr this, M212.QDateTimeEditPtr this) => QDateEditPtr this where
...
instance M212.QDateTimeEditConstPtr QDateEditConst where
  toQDateTimeEditConst (QDateEditConst ptr') = M212.QDateTimeEditConst $ castQDateEditToQDateTimeEdit ptr'
  toQDateTimeEditConst (QDateEditConstGc fptr' ptr') = M212.QDateTimeEditConstGc fptr' $ castQDateEditToQDateTimeEdit ptr'

instance M196.QAbstractSpinBoxConstPtr QDateEditConst where
  toQAbstractSpinBoxConst (QDateEditConst ptr') = M196.QAbstractSpinBoxConst $ castQDateEditToQAbstractSpinBox ptr'
  toQAbstractSpinBoxConst (QDateEditConstGc fptr' ptr') = M196.QAbstractSpinBoxConstGc fptr' $ castQDateEditToQAbstractSpinBox ptr'

instance M322.QWidgetConstPtr QDateEditConst where
  toQWidgetConst (QDateEditConst ptr') = M322.QWidgetConst $ castQDateEditToQWidget ptr'
  toQWidgetConst (QDateEditConstGc fptr' ptr') = M322.QWidgetConstGc fptr' $ castQDateEditToQWidget ptr'
...
instance M212.QDateTimeEditConstPtr QDateEdit where
  toQDateTimeEditConst (QDateEdit ptr') = M212.QDateTimeEditConst $ castQDateEditToQDateTimeEdit $ (HoppyF.castPtr :: HoppyF.Ptr QDateEdit -> HoppyF.Ptr QDateEditConst) ptr'
  toQDateTimeEditConst (QDateEditGc fptr' ptr') = M212.QDateTimeEditConstGc fptr' $ castQDateEditToQDateTimeEdit $ (HoppyF.castPtr :: HoppyF.Ptr QDateEdit -> HoppyF.Ptr QDateEditConst) ptr'

instance M212.QDateTimeEditPtr QDateEdit where
  toQDateTimeEdit (QDateEdit ptr') = M212.QDateTimeEdit $ (HoppyF.castPtr :: HoppyF.Ptr M212.QDateTimeEditConst -> HoppyF.Ptr M212.QDateTimeEdit) $ castQDateEditToQDateTimeEdit $ (HoppyF.castPtr :: HoppyF.Ptr QDateEdit -> HoppyF.Ptr QDateEditConst) ptr'
  toQDateTimeEdit (QDateEditGc fptr' ptr') = M212.QDateTimeEditGc fptr' $ (HoppyF.castPtr :: HoppyF.Ptr M212.QDateTimeEditConst -> HoppyF.Ptr M212.QDateTimeEdit) $ castQDateEditToQDateTimeEdit $ (HoppyF.castPtr :: HoppyF.Ptr QDateEdit -> HoppyF.Ptr QDateEditConst) ptr'

instance M196.QAbstractSpinBoxConstPtr QDateEdit where
  toQAbstractSpinBoxConst (QDateEdit ptr') = M196.QAbstractSpinBoxConst $ castQDateEditToQAbstractSpinBox $ (HoppyF.castPtr :: HoppyF.Ptr QDateEdit -> HoppyF.Ptr QDateEditConst) ptr'
  toQAbstractSpinBoxConst (QDateEditGc fptr' ptr') = M196.QAbstractSpinBoxConstGc fptr' $ castQDateEditToQAbstractSpinBox $ (HoppyF.castPtr :: HoppyF.Ptr QDateEdit -> HoppyF.Ptr QDateEditConst) ptr'

instance M196.QAbstractSpinBoxPtr QDateEdit where
  toQAbstractSpinBox (QDateEdit ptr') = M196.QAbstractSpinBox $ (HoppyF.castPtr :: HoppyF.Ptr M196.QAbstractSpinBoxConst -> HoppyF.Ptr M196.QAbstractSpinBox) $ castQDateEditToQAbstractSpinBox $ (HoppyF.castPtr :: HoppyF.Ptr QDateEdit -> HoppyF.Ptr QDateEditConst) ptr'
  toQAbstractSpinBox (QDateEditGc fptr' ptr') = M196.QAbstractSpinBoxGc fptr' $ (HoppyF.castPtr :: HoppyF.Ptr M196.QAbstractSpinBoxConst -> HoppyF.Ptr M196.QAbstractSpinBox) $ castQDateEditToQAbstractSpinBox $ (HoppyF.castPtr :: HoppyF.Ptr QDateEdit -> HoppyF.Ptr QDateEditConst) ptr'

instance M322.QWidgetConstPtr QDateEdit where
  toQWidgetConst (QDateEdit ptr') = M322.QWidgetConst $ castQDateEditToQWidget $ (HoppyF.castPtr :: HoppyF.Ptr QDateEdit -> HoppyF.Ptr QDateEditConst) ptr'
  toQWidgetConst (QDateEditGc fptr' ptr') = M322.QWidgetConstGc fptr' $ castQDateEditToQWidget $ (HoppyF.castPtr :: HoppyF.Ptr QDateEdit -> HoppyF.Ptr QDateEditConst) ptr'

instance M322.QWidgetPtr QDateEdit where
  toQWidget (QDateEdit ptr') = M322.QWidget $ (HoppyF.castPtr :: HoppyF.Ptr M322.QWidgetConst -> HoppyF.Ptr M322.QWidget) $ castQDateEditToQWidget $ (HoppyF.castPtr :: HoppyF.Ptr QDateEdit -> HoppyF.Ptr QDateEditConst) ptr'
  toQWidget (QDateEditGc fptr' ptr') = M322.QWidgetGc fptr' $ (HoppyF.castPtr :: HoppyF.Ptr M322.QWidgetConst -> HoppyF.Ptr M322.QWidget) $ castQDateEditToQWidget $ (HoppyF.castPtr :: HoppyF.Ptr QDateEdit -> HoppyF.Ptr QDateEditConst) ptr'
...
newWithParent :: (M322.QWidgetPtr arg'1) => arg'1 -> HoppyP.IO QDateEdit
newWithParent arg'1 =
...
newWithDateAndParent :: (M16.QDateValue arg'1, M322.QWidgetPtr arg'2) => arg'1 -> arg'2 -> HoppyP.IO QDateEdit
...
instance QDateEditSuper M212.QDateTimeEdit where
  downToQDateEdit = castQDateEditToNonconst . cast' . M212.castQDateTimeEditToConst
    where
      cast' (M212.QDateTimeEditConst ptr') = QDateEditConst $ castQDateTimeEditToQDateEdit ptr'
      cast' (M212.QDateTimeEditConstGc fptr' ptr') = QDateEditConstGc fptr' $ castQDateTimeEditToQDateEdit ptr'
instance QDateEditSuper M196.QAbstractSpinBox where
  downToQDateEdit = castQDateEditToNonconst . cast' . M196.castQAbstractSpinBoxToConst
    where
      cast' (M196.QAbstractSpinBoxConst ptr') = QDateEditConst $ castQAbstractSpinBoxToQDateEdit ptr'
      cast' (M196.QAbstractSpinBoxConstGc fptr' ptr') = QDateEditConstGc fptr' $ castQAbstractSpinBoxToQDateEdit ptr'
instance QDateEditSuper M322.QWidget where
  downToQDateEdit = castQDateEditToNonconst . cast' . M322.castQWidgetToConst
    where
      cast' (M322.QWidgetConst ptr') = QDateEditConst $ castQWidgetToQDateEdit ptr'
      cast' (M322.QWidgetConstGc fptr' ptr') = QDateEditConstGc fptr' $ castQWidgetToQDateEdit ptr'
...
instance QDateEditSuperConst M212.QDateTimeEditConst where
  downToQDateEditConst = cast'
    where
      cast' (M212.QDateTimeEditConst ptr') = QDateEditConst $ castQDateTimeEditToQDateEdit ptr'
      cast' (M212.QDateTimeEditConstGc fptr' ptr') = QDateEditConstGc fptr' $ castQDateTimeEditToQDateEdit ptr'
instance QDateEditSuperConst M196.QAbstractSpinBoxConst where
  downToQDateEditConst = cast'
    where
      cast' (M196.QAbstractSpinBoxConst ptr') = QDateEditConst $ castQAbstractSpinBoxToQDateEdit ptr'
      cast' (M196.QAbstractSpinBoxConstGc fptr' ptr') = QDateEditConstGc fptr' $ castQAbstractSpinBoxToQDateEdit ptr'
instance QDateEditSuperConst M322.QWidgetConst where
  downToQDateEditConst = cast'
    where
      cast' (M322.QWidgetConst ptr') = QDateEditConst $ castQWidgetToQDateEdit ptr'
      cast' (M322.QWidgetConstGc fptr' ptr') = QDateEditConstGc fptr' $ castQWidgetToQDateEdit ptr'
