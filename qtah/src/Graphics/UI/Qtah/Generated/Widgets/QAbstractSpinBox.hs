...
foreign import ccall "genpop__QAbstractSpinBox_newWithParent" newWithParent' ::  HoppyF.Ptr M322.QWidget -> HoppyP.IO (HoppyF.Ptr QAbstractSpinBox)
...
foreign import ccall "genpop__QAbstractSpinBox_fixup" fixup' ::  HoppyF.Ptr QAbstractSpinBoxConst -> HoppyF.Ptr M52.QString -> HoppyP.IO ()
...
foreign import ccall "genpop__QAbstractSpinBox_specialValueText" specialValueText' ::  HoppyF.Ptr QAbstractSpinBoxConst -> HoppyP.IO (HoppyF.Ptr M52.QStringConst)
foreign import ccall "genpop__QAbstractSpinBox_setSpecialValueText" setSpecialValueText' ::  HoppyF.Ptr QAbstractSpinBox -> HoppyF.Ptr M52.QStringConst -> HoppyP.IO ()
...
foreign import ccall "genpop__QAbstractSpinBox_text" text' ::  HoppyF.Ptr QAbstractSpinBoxConst -> HoppyP.IO (HoppyF.Ptr M52.QStringConst)
...
foreign import ccall "gencast__QAbstractSpinBox__QWidget" castQAbstractSpinBoxToQWidget :: HoppyF.Ptr QAbstractSpinBoxConst -> HoppyF.Ptr M322.QWidgetConst
foreign import ccall "gencast__QWidget__QAbstractSpinBox" castQWidgetToQAbstractSpinBox :: HoppyF.Ptr M322.QWidgetConst -> HoppyF.Ptr QAbstractSpinBoxConst
...
class (M322.QWidgetConstPtr this) => QAbstractSpinBoxConstPtr this where
...
alignment :: (QAbstractSpinBoxValue arg'1) => arg'1 -> HoppyP.IO M66.QtAlignment
alignment arg'1 =
  withQAbstractSpinBoxPtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
...
fixup :: (QAbstractSpinBoxValue arg'1, M52.QStringPtr arg'2) => arg'1 -> arg'2 -> HoppyP.IO ()
fixup arg'1 arg'2 =
  withQAbstractSpinBoxPtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
  HoppyFHR.withCppPtr (M52.toQString arg'2) $ \arg'2' ->
  (fixup' arg'1' arg'2')
...
class (QAbstractSpinBoxConstPtr this, M322.QWidgetPtr this) => QAbstractSpinBoxPtr this where
...
setAlignment :: (QAbstractSpinBoxPtr arg'1, M66.IsQtAlignment arg'2) => arg'1 -> arg'2 -> HoppyP.IO ()
...
setSpecialValueText :: (QAbstractSpinBoxPtr arg'1, M52.QStringValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO ()
...
instance M322.QWidgetConstPtr QAbstractSpinBoxConst where
  toQWidgetConst (QAbstractSpinBoxConst ptr') = M322.QWidgetConst $ castQAbstractSpinBoxToQWidget ptr'
  toQWidgetConst (QAbstractSpinBoxConstGc fptr' ptr') = M322.QWidgetConstGc fptr' $ castQAbstractSpinBoxToQWidget ptr'
...
instance M322.QWidgetConstPtr QAbstractSpinBox where
  toQWidgetConst (QAbstractSpinBox ptr') = M322.QWidgetConst $ castQAbstractSpinBoxToQWidget $ (HoppyF.castPtr :: HoppyF.Ptr QAbstractSpinBox -> HoppyF.Ptr QAbstractSpinBoxConst) ptr'
  toQWidgetConst (QAbstractSpinBoxGc fptr' ptr') = M322.QWidgetConstGc fptr' $ castQAbstractSpinBoxToQWidget $ (HoppyF.castPtr :: HoppyF.Ptr QAbstractSpinBox -> HoppyF.Ptr QAbstractSpinBoxConst) ptr'

instance M322.QWidgetPtr QAbstractSpinBox where
  toQWidget (QAbstractSpinBox ptr') = M322.QWidget $ (HoppyF.castPtr :: HoppyF.Ptr M322.QWidgetConst -> HoppyF.Ptr M322.QWidget) $ castQAbstractSpinBoxToQWidget $ (HoppyF.castPtr :: HoppyF.Ptr QAbstractSpinBox -> HoppyF.Ptr QAbstractSpinBoxConst) ptr'
  toQWidget (QAbstractSpinBoxGc fptr' ptr') = M322.QWidgetGc fptr' $ (HoppyF.castPtr :: HoppyF.Ptr M322.QWidgetConst -> HoppyF.Ptr M322.QWidget) $ castQAbstractSpinBoxToQWidget $ (HoppyF.castPtr :: HoppyF.Ptr QAbstractSpinBox -> HoppyF.Ptr QAbstractSpinBoxConst) ptr'
...
newWithParent :: (M322.QWidgetPtr arg'1) => arg'1 -> HoppyP.IO QAbstractSpinBox
newWithParent arg'1 =
...
instance QAbstractSpinBoxSuper M322.QWidget where
  downToQAbstractSpinBox = castQAbstractSpinBoxToNonconst . cast' . M322.castQWidgetToConst
    where
      cast' (M322.QWidgetConst ptr') = QAbstractSpinBoxConst $ castQWidgetToQAbstractSpinBox ptr'
      cast' (M322.QWidgetConstGc fptr' ptr') = QAbstractSpinBoxConstGc fptr' $ castQWidgetToQAbstractSpinBox ptr'
...
instance QAbstractSpinBoxSuperConst M322.QWidgetConst where
