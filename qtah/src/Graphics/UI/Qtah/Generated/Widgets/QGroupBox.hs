...
foreign import ccall "genpop__QGroupBox_newWithParent" newWithParent' ::  HoppyF.Ptr M322.QWidget -> HoppyP.IO (HoppyF.Ptr QGroupBox)
foreign import ccall "genpop__QGroupBox_newWithTitle" newWithTitle' ::  HoppyF.Ptr M52.QStringConst -> HoppyP.IO (HoppyF.Ptr QGroupBox)
foreign import ccall "genpop__QGroupBox_newWithTitleAndParent" newWithTitleAndParent' ::  HoppyF.Ptr M52.QStringConst -> HoppyF.Ptr M322.QWidget -> HoppyP.IO (HoppyF.Ptr QGroupBox)
...
foreign import ccall "genpop__QGroupBox_title" title' ::  HoppyF.Ptr QGroupBoxConst -> HoppyP.IO (HoppyF.Ptr M52.QStringConst)
foreign import ccall "genpop__QGroupBox_setTitle" setTitle' ::  HoppyF.Ptr QGroupBox -> HoppyF.Ptr M52.QStringConst -> HoppyP.IO ()
foreign import ccall "gencast__QGroupBox__QWidget" castQGroupBoxToQWidget :: HoppyF.Ptr QGroupBoxConst -> HoppyF.Ptr M322.QWidgetConst
foreign import ccall "gencast__QWidget__QGroupBox" castQWidgetToQGroupBox :: HoppyF.Ptr M322.QWidgetConst -> HoppyF.Ptr QGroupBoxConst
...
class (M322.QWidgetConstPtr this) => QGroupBoxConstPtr this where
  toQGroupBoxConst :: this -> QGroupBoxConst

alignment :: (QGroupBoxValue arg'1) => arg'1 -> HoppyP.IO M66.QtAlignment
alignment arg'1 =
...
class (QGroupBoxConstPtr this, M322.QWidgetPtr this) => QGroupBoxPtr this where
  toQGroupBox :: this -> QGroupBox

setAlignment :: (QGroupBoxPtr arg'1, M66.IsQtAlignment arg'2) => arg'1 -> arg'2 -> HoppyP.IO ()
...
setTitle :: (QGroupBoxPtr arg'1, M52.QStringValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO ()
...
instance M322.QWidgetConstPtr QGroupBoxConst where
  toQWidgetConst (QGroupBoxConst ptr') = M322.QWidgetConst $ castQGroupBoxToQWidget ptr'
  toQWidgetConst (QGroupBoxConstGc fptr' ptr') = M322.QWidgetConstGc fptr' $ castQGroupBoxToQWidget ptr'
...
instance M322.QWidgetConstPtr QGroupBox where
  toQWidgetConst (QGroupBox ptr') = M322.QWidgetConst $ castQGroupBoxToQWidget $ (HoppyF.castPtr :: HoppyF.Ptr QGroupBox -> HoppyF.Ptr QGroupBoxConst) ptr'
  toQWidgetConst (QGroupBoxGc fptr' ptr') = M322.QWidgetConstGc fptr' $ castQGroupBoxToQWidget $ (HoppyF.castPtr :: HoppyF.Ptr QGroupBox -> HoppyF.Ptr QGroupBoxConst) ptr'

instance M322.QWidgetPtr QGroupBox where
  toQWidget (QGroupBox ptr') = M322.QWidget $ (HoppyF.castPtr :: HoppyF.Ptr M322.QWidgetConst -> HoppyF.Ptr M322.QWidget) $ castQGroupBoxToQWidget $ (HoppyF.castPtr :: HoppyF.Ptr QGroupBox -> HoppyF.Ptr QGroupBoxConst) ptr'
  toQWidget (QGroupBoxGc fptr' ptr') = M322.QWidgetGc fptr' $ (HoppyF.castPtr :: HoppyF.Ptr M322.QWidgetConst -> HoppyF.Ptr M322.QWidget) $ castQGroupBoxToQWidget $ (HoppyF.castPtr :: HoppyF.Ptr QGroupBox -> HoppyF.Ptr QGroupBoxConst) ptr'
...
newWithParent :: (M322.QWidgetPtr arg'1) => arg'1 -> HoppyP.IO QGroupBox
newWithParent arg'1 =
  HoppyFHR.withCppPtr (M322.toQWidget arg'1) $ \arg'1' ->
  HoppyP.fmap QGroupBox
  (newWithParent' arg'1')

newWithTitle :: (M52.QStringValue arg'1) => arg'1 -> HoppyP.IO QGroupBox
newWithTitle arg'1 =
  M52.withQStringPtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
  HoppyP.fmap QGroupBox
  (newWithTitle' arg'1')

newWithTitleAndParent :: (M52.QStringValue arg'1, M322.QWidgetPtr arg'2) => arg'1 -> arg'2 -> HoppyP.IO QGroupBox
...
instance QGroupBoxSuper M322.QWidget where
  downToQGroupBox = castQGroupBoxToNonconst . cast' . M322.castQWidgetToConst
    where
      cast' (M322.QWidgetConst ptr') = QGroupBoxConst $ castQWidgetToQGroupBox ptr'
      cast' (M322.QWidgetConstGc fptr' ptr') = QGroupBoxConstGc fptr' $ castQWidgetToQGroupBox ptr'
...
instance QGroupBoxSuperConst M322.QWidgetConst where
