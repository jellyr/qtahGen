...
foreign import ccall "genpop__QDateTimeEdit_displayFormat" displayFormat' ::  HoppyF.Ptr QDateTimeEditConst -> HoppyP.IO (HoppyF.Ptr M52.QStringConst)
foreign import ccall "genpop__QDateTimeEdit_setDisplayFormat" setDisplayFormat' ::  HoppyF.Ptr QDateTimeEdit -> HoppyF.Ptr M52.QStringConst -> HoppyP.IO ()
...
foreign import ccall "gencast__QDateTimeEdit__QAbstractSpinBox" castQDateTimeEditToQAbstractSpinBox :: HoppyF.Ptr QDateTimeEditConst -> HoppyF.Ptr M196.QAbstractSpinBoxConst
foreign import ccall "gencast__QAbstractSpinBox__QDateTimeEdit" castQAbstractSpinBoxToQDateTimeEdit :: HoppyF.Ptr M196.QAbstractSpinBoxConst -> HoppyF.Ptr QDateTimeEditConst
foreign import ccall "gencast__QDateTimeEdit__QWidget" castQDateTimeEditToQWidget :: HoppyF.Ptr QDateTimeEditConst -> HoppyF.Ptr M322.QWidgetConst
foreign import ccall "gencast__QWidget__QDateTimeEdit" castQWidgetToQDateTimeEdit :: HoppyF.Ptr M322.QWidgetConst -> HoppyF.Ptr QDateTimeEditConst
...
class (M196.QAbstractSpinBoxConstPtr this) => QDateTimeEditConstPtr this where
...
class (QDateTimeEditConstPtr this, M196.QAbstractSpinBoxPtr this) => QDateTimeEditPtr this where
...
setDisplayFormat :: (QDateTimeEditPtr arg'1, M52.QStringValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO ()
...
instance M196.QAbstractSpinBoxConstPtr QDateTimeEditConst where
  toQAbstractSpinBoxConst (QDateTimeEditConst ptr') = M196.QAbstractSpinBoxConst $ castQDateTimeEditToQAbstractSpinBox ptr'
  toQAbstractSpinBoxConst (QDateTimeEditConstGc fptr' ptr') = M196.QAbstractSpinBoxConstGc fptr' $ castQDateTimeEditToQAbstractSpinBox ptr'

instance M322.QWidgetConstPtr QDateTimeEditConst where
  toQWidgetConst (QDateTimeEditConst ptr') = M322.QWidgetConst $ castQDateTimeEditToQWidget ptr'
  toQWidgetConst (QDateTimeEditConstGc fptr' ptr') = M322.QWidgetConstGc fptr' $ castQDateTimeEditToQWidget ptr'
...
instance M196.QAbstractSpinBoxConstPtr QDateTimeEdit where
  toQAbstractSpinBoxConst (QDateTimeEdit ptr') = M196.QAbstractSpinBoxConst $ castQDateTimeEditToQAbstractSpinBox $ (HoppyF.castPtr :: HoppyF.Ptr QDateTimeEdit -> HoppyF.Ptr QDateTimeEditConst) ptr'
  toQAbstractSpinBoxConst (QDateTimeEditGc fptr' ptr') = M196.QAbstractSpinBoxConstGc fptr' $ castQDateTimeEditToQAbstractSpinBox $ (HoppyF.castPtr :: HoppyF.Ptr QDateTimeEdit -> HoppyF.Ptr QDateTimeEditConst) ptr'

instance M196.QAbstractSpinBoxPtr QDateTimeEdit where
  toQAbstractSpinBox (QDateTimeEdit ptr') = M196.QAbstractSpinBox $ (HoppyF.castPtr :: HoppyF.Ptr M196.QAbstractSpinBoxConst -> HoppyF.Ptr M196.QAbstractSpinBox) $ castQDateTimeEditToQAbstractSpinBox $ (HoppyF.castPtr :: HoppyF.Ptr QDateTimeEdit -> HoppyF.Ptr QDateTimeEditConst) ptr'
  toQAbstractSpinBox (QDateTimeEditGc fptr' ptr') = M196.QAbstractSpinBoxGc fptr' $ (HoppyF.castPtr :: HoppyF.Ptr M196.QAbstractSpinBoxConst -> HoppyF.Ptr M196.QAbstractSpinBox) $ castQDateTimeEditToQAbstractSpinBox $ (HoppyF.castPtr :: HoppyF.Ptr QDateTimeEdit -> HoppyF.Ptr QDateTimeEditConst) ptr'

instance M322.QWidgetConstPtr QDateTimeEdit where
  toQWidgetConst (QDateTimeEdit ptr') = M322.QWidgetConst $ castQDateTimeEditToQWidget $ (HoppyF.castPtr :: HoppyF.Ptr QDateTimeEdit -> HoppyF.Ptr QDateTimeEditConst) ptr'
  toQWidgetConst (QDateTimeEditGc fptr' ptr') = M322.QWidgetConstGc fptr' $ castQDateTimeEditToQWidget $ (HoppyF.castPtr :: HoppyF.Ptr QDateTimeEdit -> HoppyF.Ptr QDateTimeEditConst) ptr'

instance M322.QWidgetPtr QDateTimeEdit where
  toQWidget (QDateTimeEdit ptr') = M322.QWidget $ (HoppyF.castPtr :: HoppyF.Ptr M322.QWidgetConst -> HoppyF.Ptr M322.QWidget) $ castQDateTimeEditToQWidget $ (HoppyF.castPtr :: HoppyF.Ptr QDateTimeEdit -> HoppyF.Ptr QDateTimeEditConst) ptr'
  toQWidget (QDateTimeEditGc fptr' ptr') = M322.QWidgetGc fptr' $ (HoppyF.castPtr :: HoppyF.Ptr M322.QWidgetConst -> HoppyF.Ptr M322.QWidget) $ castQDateTimeEditToQWidget $ (HoppyF.castPtr :: HoppyF.Ptr QDateTimeEdit -> HoppyF.Ptr QDateTimeEditConst) ptr'
...
instance QDateTimeEditSuper M196.QAbstractSpinBox where
  downToQDateTimeEdit = castQDateTimeEditToNonconst . cast' . M196.castQAbstractSpinBoxToConst
    where
      cast' (M196.QAbstractSpinBoxConst ptr') = QDateTimeEditConst $ castQAbstractSpinBoxToQDateTimeEdit ptr'
      cast' (M196.QAbstractSpinBoxConstGc fptr' ptr') = QDateTimeEditConstGc fptr' $ castQAbstractSpinBoxToQDateTimeEdit ptr'
instance QDateTimeEditSuper M322.QWidget where
  downToQDateTimeEdit = castQDateTimeEditToNonconst . cast' . M322.castQWidgetToConst
    where
      cast' (M322.QWidgetConst ptr') = QDateTimeEditConst $ castQWidgetToQDateTimeEdit ptr'
      cast' (M322.QWidgetConstGc fptr' ptr') = QDateTimeEditConstGc fptr' $ castQWidgetToQDateTimeEdit ptr'
...
instance QDateTimeEditSuperConst M196.QAbstractSpinBoxConst where
  downToQDateTimeEditConst = cast'
    where
      cast' (M196.QAbstractSpinBoxConst ptr') = QDateTimeEditConst $ castQAbstractSpinBoxToQDateTimeEdit ptr'
      cast' (M196.QAbstractSpinBoxConstGc fptr' ptr') = QDateTimeEditConstGc fptr' $ castQAbstractSpinBoxToQDateTimeEdit ptr'
instance QDateTimeEditSuperConst M322.QWidgetConst where
  downToQDateTimeEditConst = cast'
    where
      cast' (M322.QWidgetConst ptr') = QDateTimeEditConst $ castQWidgetToQDateTimeEdit ptr'
      cast' (M322.QWidgetConstGc fptr' ptr') = QDateTimeEditConstGc fptr' $ castQWidgetToQDateTimeEdit ptr'
