...
import qualified Graphics.UI.Qtah.Generated.Widgets.QGraphicsSceneEvent as M238
import Prelude (($), (.), (=<<), (==))
...
foreign import ccall "genpop__QGraphicsSceneMouseEvent_buttonDownPos" buttonDownPos' ::  HoppyF.Ptr QGraphicsSceneMouseEventConst -> HoppyFC.CInt -> HoppyP.IO (HoppyF.Ptr M40.QPointFConst)
foreign import ccall "genpop__QGraphicsSceneMouseEvent_buttonDownScenePos" buttonDownScenePos' ::  HoppyF.Ptr QGraphicsSceneMouseEventConst -> HoppyFC.CInt -> HoppyP.IO (HoppyF.Ptr M40.QPointFConst)
foreign import ccall "genpop__QGraphicsSceneMouseEvent_buttonDownScreenPos" buttonDownScreenPos' ::  HoppyF.Ptr QGraphicsSceneMouseEventConst -> HoppyFC.CInt -> HoppyP.IO (HoppyF.Ptr M38.QPointConst)
...
foreign import ccall "genpop__QGraphicsSceneMouseEvent_lastPos" lastPos' ::  HoppyF.Ptr QGraphicsSceneMouseEventConst -> HoppyP.IO (HoppyF.Ptr M40.QPointFConst)
foreign import ccall "genpop__QGraphicsSceneMouseEvent_lastScenePos" lastScenePos' ::  HoppyF.Ptr QGraphicsSceneMouseEventConst -> HoppyP.IO (HoppyF.Ptr M40.QPointFConst)
foreign import ccall "genpop__QGraphicsSceneMouseEvent_lastScreenPos" lastScreenPos' ::  HoppyF.Ptr QGraphicsSceneMouseEventConst -> HoppyP.IO (HoppyF.Ptr M38.QPointConst)
...
foreign import ccall "genpop__QGraphicsSceneMouseEvent_pos" pos' ::  HoppyF.Ptr QGraphicsSceneMouseEventConst -> HoppyP.IO (HoppyF.Ptr M40.QPointFConst)
foreign import ccall "genpop__QGraphicsSceneMouseEvent_scenePos" scenePos' ::  HoppyF.Ptr QGraphicsSceneMouseEventConst -> HoppyP.IO (HoppyF.Ptr M40.QPointFConst)
foreign import ccall "genpop__QGraphicsSceneMouseEvent_screenPos" screenPos' ::  HoppyF.Ptr QGraphicsSceneMouseEventConst -> HoppyP.IO (HoppyF.Ptr M38.QPointConst)
...
foreign import ccall "gencast__QGraphicsSceneMouseEvent__QGraphicsSceneEvent" castQGraphicsSceneMouseEventToQGraphicsSceneEvent :: HoppyF.Ptr QGraphicsSceneMouseEventConst -> HoppyF.Ptr M238.QGraphicsSceneEventConst
foreign import ccall "gencast__QGraphicsSceneEvent__QGraphicsSceneMouseEvent" castQGraphicsSceneEventToQGraphicsSceneMouseEvent :: HoppyF.Ptr M238.QGraphicsSceneEventConst -> HoppyF.Ptr QGraphicsSceneMouseEventConst
...
class (M238.QGraphicsSceneEventConstPtr this) => QGraphicsSceneMouseEventConstPtr this where
  toQGraphicsSceneMouseEventConst :: this -> QGraphicsSceneMouseEventConst

button :: (QGraphicsSceneMouseEventValue arg'1) => arg'1 -> HoppyP.IO M66.QtMouseButton
button arg'1 =
  withQGraphicsSceneMouseEventPtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
  HoppyP.fmap (HoppyP.toEnum . HoppyFHR.coerceIntegral)
  (button' arg'1')

buttonDownPos :: (QGraphicsSceneMouseEventValue arg'1) => arg'1 -> M66.QtMouseButton -> HoppyP.IO HPointF.HPointF
...
buttonDownScenePos :: (QGraphicsSceneMouseEventValue arg'1) => arg'1 -> M66.QtMouseButton -> HoppyP.IO HPointF.HPointF
...
buttonDownScreenPos :: (QGraphicsSceneMouseEventValue arg'1) => arg'1 -> M66.QtMouseButton -> HoppyP.IO HPoint.HPoint
...
buttons :: (QGraphicsSceneMouseEventValue arg'1) => arg'1 -> HoppyP.IO M66.QtMouseButtons
buttons arg'1 =
  withQGraphicsSceneMouseEventPtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
  HoppyP.fmap M66.QtMouseButtons
  (buttons' arg'1')

flags :: (QGraphicsSceneMouseEventValue arg'1) => arg'1 -> HoppyP.IO M66.QtMouseEventFlags
flags arg'1 =
  withQGraphicsSceneMouseEventPtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
...
modifiers :: (QGraphicsSceneMouseEventValue arg'1) => arg'1 -> HoppyP.IO M66.QtKeyboardModifiers
modifiers arg'1 =
  withQGraphicsSceneMouseEventPtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
  HoppyP.fmap M66.QtKeyboardModifiers
  (modifiers' arg'1')
...
source :: (QGraphicsSceneMouseEventValue arg'1) => arg'1 -> HoppyP.IO M66.QtMouseEventSource
source arg'1 =
  withQGraphicsSceneMouseEventPtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
  HoppyP.fmap (HoppyP.toEnum . HoppyFHR.coerceIntegral)
  (source' arg'1')

class (QGraphicsSceneMouseEventConstPtr this, M238.QGraphicsSceneEventPtr this) => QGraphicsSceneMouseEventPtr this where
...
instance M238.QGraphicsSceneEventConstPtr QGraphicsSceneMouseEventConst where
  toQGraphicsSceneEventConst (QGraphicsSceneMouseEventConst ptr') = M238.QGraphicsSceneEventConst $ castQGraphicsSceneMouseEventToQGraphicsSceneEvent ptr'
  toQGraphicsSceneEventConst (QGraphicsSceneMouseEventConstGc fptr' ptr') = M238.QGraphicsSceneEventConstGc fptr' $ castQGraphicsSceneMouseEventToQGraphicsSceneEvent ptr'
...
instance M238.QGraphicsSceneEventConstPtr QGraphicsSceneMouseEvent where
  toQGraphicsSceneEventConst (QGraphicsSceneMouseEvent ptr') = M238.QGraphicsSceneEventConst $ castQGraphicsSceneMouseEventToQGraphicsSceneEvent $ (HoppyF.castPtr :: HoppyF.Ptr QGraphicsSceneMouseEvent -> HoppyF.Ptr QGraphicsSceneMouseEventConst) ptr'
  toQGraphicsSceneEventConst (QGraphicsSceneMouseEventGc fptr' ptr') = M238.QGraphicsSceneEventConstGc fptr' $ castQGraphicsSceneMouseEventToQGraphicsSceneEvent $ (HoppyF.castPtr :: HoppyF.Ptr QGraphicsSceneMouseEvent -> HoppyF.Ptr QGraphicsSceneMouseEventConst) ptr'

instance M238.QGraphicsSceneEventPtr QGraphicsSceneMouseEvent where
  toQGraphicsSceneEvent (QGraphicsSceneMouseEvent ptr') = M238.QGraphicsSceneEvent $ (HoppyF.castPtr :: HoppyF.Ptr M238.QGraphicsSceneEventConst -> HoppyF.Ptr M238.QGraphicsSceneEvent) $ castQGraphicsSceneMouseEventToQGraphicsSceneEvent $ (HoppyF.castPtr :: HoppyF.Ptr QGraphicsSceneMouseEvent -> HoppyF.Ptr QGraphicsSceneMouseEventConst) ptr'
  toQGraphicsSceneEvent (QGraphicsSceneMouseEventGc fptr' ptr') = M238.QGraphicsSceneEventGc fptr' $ (HoppyF.castPtr :: HoppyF.Ptr M238.QGraphicsSceneEventConst -> HoppyF.Ptr M238.QGraphicsSceneEvent) $ castQGraphicsSceneMouseEventToQGraphicsSceneEvent $ (HoppyF.castPtr :: HoppyF.Ptr QGraphicsSceneMouseEvent -> HoppyF.Ptr QGraphicsSceneMouseEventConst) ptr'
...
instance QGraphicsSceneMouseEventSuper M238.QGraphicsSceneEvent where
  downToQGraphicsSceneMouseEvent = castQGraphicsSceneMouseEventToNonconst . cast' . M238.castQGraphicsSceneEventToConst
    where
      cast' (M238.QGraphicsSceneEventConst ptr') = QGraphicsSceneMouseEventConst $ castQGraphicsSceneEventToQGraphicsSceneMouseEvent ptr'
      cast' (M238.QGraphicsSceneEventConstGc fptr' ptr') = QGraphicsSceneMouseEventConstGc fptr' $ castQGraphicsSceneEventToQGraphicsSceneMouseEvent ptr'
...
instance QGraphicsSceneMouseEventSuperConst M238.QGraphicsSceneEventConst where
