...
foreign import ccall "genpop__QRadioButton_newWithParent" newWithParent' ::  HoppyF.Ptr M322.QWidget -> HoppyP.IO (HoppyF.Ptr QRadioButton)
foreign import ccall "genpop__QRadioButton_newWithText" newWithText' ::  HoppyF.Ptr M52.QStringConst -> HoppyP.IO (HoppyF.Ptr QRadioButton)
foreign import ccall "genpop__QRadioButton_newWithTextAndParent" newWithTextAndParent' ::  HoppyF.Ptr M52.QStringConst -> HoppyF.Ptr M322.QWidget -> HoppyP.IO (HoppyF.Ptr QRadioButton)
foreign import ccall "gencast__QRadioButton__QAbstractButton" castQRadioButtonToQAbstractButton :: HoppyF.Ptr QRadioButtonConst -> HoppyF.Ptr M184.QAbstractButtonConst
foreign import ccall "gencast__QAbstractButton__QRadioButton" castQAbstractButtonToQRadioButton :: HoppyF.Ptr M184.QAbstractButtonConst -> HoppyF.Ptr QRadioButtonConst
foreign import ccall "gencast__QRadioButton__QWidget" castQRadioButtonToQWidget :: HoppyF.Ptr QRadioButtonConst -> HoppyF.Ptr M322.QWidgetConst
foreign import ccall "gencast__QWidget__QRadioButton" castQWidgetToQRadioButton :: HoppyF.Ptr M322.QWidgetConst -> HoppyF.Ptr QRadioButtonConst
...
class (M184.QAbstractButtonConstPtr this) => QRadioButtonConstPtr this where
  toQRadioButtonConst :: this -> QRadioButtonConst

class (QRadioButtonConstPtr this, M184.QAbstractButtonPtr this) => QRadioButtonPtr this where
...
instance M184.QAbstractButtonConstPtr QRadioButtonConst where
  toQAbstractButtonConst (QRadioButtonConst ptr') = M184.QAbstractButtonConst $ castQRadioButtonToQAbstractButton ptr'
  toQAbstractButtonConst (QRadioButtonConstGc fptr' ptr') = M184.QAbstractButtonConstGc fptr' $ castQRadioButtonToQAbstractButton ptr'

instance M322.QWidgetConstPtr QRadioButtonConst where
  toQWidgetConst (QRadioButtonConst ptr') = M322.QWidgetConst $ castQRadioButtonToQWidget ptr'
  toQWidgetConst (QRadioButtonConstGc fptr' ptr') = M322.QWidgetConstGc fptr' $ castQRadioButtonToQWidget ptr'
...
instance M184.QAbstractButtonConstPtr QRadioButton where
  toQAbstractButtonConst (QRadioButton ptr') = M184.QAbstractButtonConst $ castQRadioButtonToQAbstractButton $ (HoppyF.castPtr :: HoppyF.Ptr QRadioButton -> HoppyF.Ptr QRadioButtonConst) ptr'
  toQAbstractButtonConst (QRadioButtonGc fptr' ptr') = M184.QAbstractButtonConstGc fptr' $ castQRadioButtonToQAbstractButton $ (HoppyF.castPtr :: HoppyF.Ptr QRadioButton -> HoppyF.Ptr QRadioButtonConst) ptr'

instance M184.QAbstractButtonPtr QRadioButton where
  toQAbstractButton (QRadioButton ptr') = M184.QAbstractButton $ (HoppyF.castPtr :: HoppyF.Ptr M184.QAbstractButtonConst -> HoppyF.Ptr M184.QAbstractButton) $ castQRadioButtonToQAbstractButton $ (HoppyF.castPtr :: HoppyF.Ptr QRadioButton -> HoppyF.Ptr QRadioButtonConst) ptr'
  toQAbstractButton (QRadioButtonGc fptr' ptr') = M184.QAbstractButtonGc fptr' $ (HoppyF.castPtr :: HoppyF.Ptr M184.QAbstractButtonConst -> HoppyF.Ptr M184.QAbstractButton) $ castQRadioButtonToQAbstractButton $ (HoppyF.castPtr :: HoppyF.Ptr QRadioButton -> HoppyF.Ptr QRadioButtonConst) ptr'

instance M322.QWidgetConstPtr QRadioButton where
  toQWidgetConst (QRadioButton ptr') = M322.QWidgetConst $ castQRadioButtonToQWidget $ (HoppyF.castPtr :: HoppyF.Ptr QRadioButton -> HoppyF.Ptr QRadioButtonConst) ptr'
  toQWidgetConst (QRadioButtonGc fptr' ptr') = M322.QWidgetConstGc fptr' $ castQRadioButtonToQWidget $ (HoppyF.castPtr :: HoppyF.Ptr QRadioButton -> HoppyF.Ptr QRadioButtonConst) ptr'

instance M322.QWidgetPtr QRadioButton where
  toQWidget (QRadioButton ptr') = M322.QWidget $ (HoppyF.castPtr :: HoppyF.Ptr M322.QWidgetConst -> HoppyF.Ptr M322.QWidget) $ castQRadioButtonToQWidget $ (HoppyF.castPtr :: HoppyF.Ptr QRadioButton -> HoppyF.Ptr QRadioButtonConst) ptr'
  toQWidget (QRadioButtonGc fptr' ptr') = M322.QWidgetGc fptr' $ (HoppyF.castPtr :: HoppyF.Ptr M322.QWidgetConst -> HoppyF.Ptr M322.QWidget) $ castQRadioButtonToQWidget $ (HoppyF.castPtr :: HoppyF.Ptr QRadioButton -> HoppyF.Ptr QRadioButtonConst) ptr'
...
newWithParent :: (M322.QWidgetPtr arg'1) => arg'1 -> HoppyP.IO QRadioButton
newWithParent arg'1 =
  HoppyFHR.withCppPtr (M322.toQWidget arg'1) $ \arg'1' ->
  HoppyP.fmap QRadioButton
  (newWithParent' arg'1')

newWithText :: (M52.QStringValue arg'1) => arg'1 -> HoppyP.IO QRadioButton
newWithText arg'1 =
  M52.withQStringPtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
  HoppyP.fmap QRadioButton
  (newWithText' arg'1')

newWithTextAndParent :: (M52.QStringValue arg'1, M322.QWidgetPtr arg'2) => arg'1 -> arg'2 -> HoppyP.IO QRadioButton
...
instance QRadioButtonSuper M184.QAbstractButton where
  downToQRadioButton = castQRadioButtonToNonconst . cast' . M184.castQAbstractButtonToConst
    where
      cast' (M184.QAbstractButtonConst ptr') = QRadioButtonConst $ castQAbstractButtonToQRadioButton ptr'
      cast' (M184.QAbstractButtonConstGc fptr' ptr') = QRadioButtonConstGc fptr' $ castQAbstractButtonToQRadioButton ptr'
instance QRadioButtonSuper M322.QWidget where
  downToQRadioButton = castQRadioButtonToNonconst . cast' . M322.castQWidgetToConst
    where
      cast' (M322.QWidgetConst ptr') = QRadioButtonConst $ castQWidgetToQRadioButton ptr'
      cast' (M322.QWidgetConstGc fptr' ptr') = QRadioButtonConstGc fptr' $ castQWidgetToQRadioButton ptr'
...
instance QRadioButtonSuperConst M184.QAbstractButtonConst where
  downToQRadioButtonConst = cast'
    where
      cast' (M184.QAbstractButtonConst ptr') = QRadioButtonConst $ castQAbstractButtonToQRadioButton ptr'
      cast' (M184.QAbstractButtonConstGc fptr' ptr') = QRadioButtonConstGc fptr' $ castQAbstractButtonToQRadioButton ptr'
instance QRadioButtonSuperConst M322.QWidgetConst where
  downToQRadioButtonConst = cast'
    where
      cast' (M322.QWidgetConst ptr') = QRadioButtonConst $ castQWidgetToQRadioButton ptr'
      cast' (M322.QWidgetConstGc fptr' ptr') = QRadioButtonConstGc fptr' $ castQWidgetToQRadioButton ptr'
