...
foreign import ccall "genpop__QFormLayout_newWithParent" newWithParent' ::  HoppyF.Ptr M322.QWidget -> HoppyP.IO (HoppyF.Ptr QFormLayout)
foreign import ccall "genpop__QFormLayout_addRowWidgetWidget" addRowWidgetWidget' ::  HoppyF.Ptr QFormLayout -> HoppyF.Ptr M322.QWidget -> HoppyF.Ptr M322.QWidget -> HoppyP.IO ()
foreign import ccall "genpop__QFormLayout_addRowWidgetLayout" addRowWidgetLayout' ::  HoppyF.Ptr QFormLayout -> HoppyF.Ptr M322.QWidget -> HoppyF.Ptr M256.QLayout -> HoppyP.IO ()
foreign import ccall "genpop__QFormLayout_addRowStringWidget" addRowStringWidget' ::  HoppyF.Ptr QFormLayout -> HoppyF.Ptr M52.QStringConst -> HoppyF.Ptr M322.QWidget -> HoppyP.IO ()
foreign import ccall "genpop__QFormLayout_addRowStringLayout" addRowStringLayout' ::  HoppyF.Ptr QFormLayout -> HoppyF.Ptr M52.QStringConst -> HoppyF.Ptr M256.QLayout -> HoppyP.IO ()
foreign import ccall "genpop__QFormLayout_addRowWidget" addRowWidget' ::  HoppyF.Ptr QFormLayout -> HoppyF.Ptr M322.QWidget -> HoppyP.IO ()
foreign import ccall "genpop__QFormLayout_addRowLayout" addRowLayout' ::  HoppyF.Ptr QFormLayout -> HoppyF.Ptr M256.QLayout -> HoppyP.IO ()
...
foreign import ccall "genpop__QFormLayout_getLayoutRow" getLayoutRow' ::  HoppyF.Ptr QFormLayoutConst -> HoppyF.Ptr M256.QLayout -> HoppyP.IO HoppyFC.CInt
foreign import ccall "genpop__QFormLayout_getLayoutRole" getLayoutRole' ::  HoppyF.Ptr QFormLayoutConst -> HoppyF.Ptr M256.QLayout -> HoppyP.IO HoppyFC.CInt
foreign import ccall "genpop__QFormLayout_getWidgetRow" getWidgetRow' ::  HoppyF.Ptr QFormLayoutConst -> HoppyF.Ptr M322.QWidget -> HoppyP.IO HoppyFC.CInt
foreign import ccall "genpop__QFormLayout_getWidgetRole" getWidgetRole' ::  HoppyF.Ptr QFormLayoutConst -> HoppyF.Ptr M322.QWidget -> HoppyP.IO HoppyFC.CInt
...
foreign import ccall "genpop__QFormLayout_insertRowWidgetWidget" insertRowWidgetWidget' ::  HoppyF.Ptr QFormLayout -> HoppyFC.CInt -> HoppyF.Ptr M322.QWidget -> HoppyF.Ptr M322.QWidget -> HoppyP.IO ()
foreign import ccall "genpop__QFormLayout_insertRowWidgetLayout" insertRowWidgetLayout' ::  HoppyF.Ptr QFormLayout -> HoppyFC.CInt -> HoppyF.Ptr M322.QWidget -> HoppyF.Ptr M256.QLayout -> HoppyP.IO ()
foreign import ccall "genpop__QFormLayout_insertRowStringWidget" insertRowStringWidget' ::  HoppyF.Ptr QFormLayout -> HoppyFC.CInt -> HoppyF.Ptr M52.QStringConst -> HoppyF.Ptr M322.QWidget -> HoppyP.IO ()
foreign import ccall "genpop__QFormLayout_insertRowStringLayout" insertRowStringLayout' ::  HoppyF.Ptr QFormLayout -> HoppyFC.CInt -> HoppyF.Ptr M52.QStringConst -> HoppyF.Ptr M256.QLayout -> HoppyP.IO ()
foreign import ccall "genpop__QFormLayout_insertRowWidget" insertRowWidget' ::  HoppyF.Ptr QFormLayout -> HoppyFC.CInt -> HoppyF.Ptr M322.QWidget -> HoppyP.IO ()
foreign import ccall "genpop__QFormLayout_insertRowLayout" insertRowLayout' ::  HoppyF.Ptr QFormLayout -> HoppyFC.CInt -> HoppyF.Ptr M256.QLayout -> HoppyP.IO ()
foreign import ccall "genpop__QFormLayout_itemAt" itemAt' ::  HoppyF.Ptr QFormLayoutConst -> HoppyFC.CInt -> HoppyFC.CInt -> HoppyP.IO (HoppyF.Ptr M258.QLayoutItem)
...
foreign import ccall "genpop__QFormLayout_labelForFieldWidget" labelForFieldWidget' ::  HoppyF.Ptr QFormLayoutConst -> HoppyF.Ptr M322.QWidget -> HoppyP.IO (HoppyF.Ptr M322.QWidget)
foreign import ccall "genpop__QFormLayout_labelForFieldLayout" labelForFieldLayout' ::  HoppyF.Ptr QFormLayoutConst -> HoppyF.Ptr M256.QLayout -> HoppyP.IO (HoppyF.Ptr M322.QWidget)
...
foreign import ccall "genpop__QFormLayout_setItem" setItem' ::  HoppyF.Ptr QFormLayout -> HoppyFC.CInt -> HoppyFC.CInt -> HoppyF.Ptr M258.QLayoutItem -> HoppyP.IO ()
foreign import ccall "genpop__QFormLayout_setLayout" setLayout' ::  HoppyF.Ptr QFormLayout -> HoppyFC.CInt -> HoppyFC.CInt -> HoppyF.Ptr M256.QLayout -> HoppyP.IO ()
foreign import ccall "genpop__QFormLayout_setWidget" setWidget' ::  HoppyF.Ptr QFormLayout -> HoppyFC.CInt -> HoppyFC.CInt -> HoppyF.Ptr M322.QWidget -> HoppyP.IO ()
...
foreign import ccall "gencast__QFormLayout__QLayout" castQFormLayoutToQLayout :: HoppyF.Ptr QFormLayoutConst -> HoppyF.Ptr M256.QLayoutConst
foreign import ccall "gencast__QLayout__QFormLayout" castQLayoutToQFormLayout :: HoppyF.Ptr M256.QLayoutConst -> HoppyF.Ptr QFormLayoutConst
...
foreign import ccall "gencast__QFormLayout__QLayoutItem" castQFormLayoutToQLayoutItem :: HoppyF.Ptr QFormLayoutConst -> HoppyF.Ptr M258.QLayoutItemConst
foreign import ccall "gencast__QLayoutItem__QFormLayout" castQLayoutItemToQFormLayout :: HoppyF.Ptr M258.QLayoutItemConst -> HoppyF.Ptr QFormLayoutConst
...
class (M256.QLayoutConstPtr this) => QFormLayoutConstPtr this where
...
formAlignment :: (QFormLayoutValue arg'1) => arg'1 -> HoppyP.IO M66.QtAlignment
formAlignment arg'1 =
  withQFormLayoutPtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
...
getLayoutRow :: (QFormLayoutValue arg'1, M256.QLayoutPtr arg'2) => arg'1 -> arg'2 -> HoppyP.IO HoppyP.Int
...
getLayoutRole :: (QFormLayoutValue arg'1, M256.QLayoutPtr arg'2) => arg'1 -> arg'2 -> HoppyP.IO QFormLayoutItemRole
...
getWidgetRow :: (QFormLayoutValue arg'1, M322.QWidgetPtr arg'2) => arg'1 -> arg'2 -> HoppyP.IO HoppyP.Int
...
getWidgetRole :: (QFormLayoutValue arg'1, M322.QWidgetPtr arg'2) => arg'1 -> arg'2 -> HoppyP.IO QFormLayoutItemRole
...
itemAt :: (QFormLayoutValue arg'1) => arg'1 -> HoppyP.Int -> QFormLayoutItemRole -> HoppyP.IO M258.QLayoutItem
itemAt arg'1 arg'2 arg'3 =
  withQFormLayoutPtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
  let arg'2' = HoppyFHR.coerceIntegral arg'2 in
  let arg'3' = HoppyFHR.coerceIntegral $ HoppyP.fromEnum arg'3 in
  HoppyP.fmap M258.QLayoutItem
  (itemAt' arg'1' arg'2' arg'3')

labelAlignment :: (QFormLayoutValue arg'1) => arg'1 -> HoppyP.IO M66.QtAlignment
labelAlignment arg'1 =
  withQFormLayoutPtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
  HoppyP.fmap M66.QtAlignment
  (labelAlignment' arg'1')

labelForFieldWidget :: (QFormLayoutValue arg'1, M322.QWidgetPtr arg'2) => arg'1 -> arg'2 -> HoppyP.IO M322.QWidget
...
labelForFieldLayout :: (QFormLayoutValue arg'1, M256.QLayoutPtr arg'2) => arg'1 -> arg'2 -> HoppyP.IO M322.QWidget
...
class (QFormLayoutConstPtr this, M256.QLayoutPtr this) => QFormLayoutPtr this where
  toQFormLayout :: this -> QFormLayout

addRowWidgetWidget :: (QFormLayoutPtr arg'1, M322.QWidgetPtr arg'2, M322.QWidgetPtr arg'3) => arg'1 -> arg'2 -> arg'3 -> HoppyP.IO ()
...
addRowWidgetLayout :: (QFormLayoutPtr arg'1, M322.QWidgetPtr arg'2, M256.QLayoutPtr arg'3) => arg'1 -> arg'2 -> arg'3 -> HoppyP.IO ()
addRowWidgetLayout arg'1 arg'2 arg'3 =
  HoppyFHR.withCppPtr (toQFormLayout arg'1) $ \arg'1' ->
  HoppyFHR.withCppPtr (M322.toQWidget arg'2) $ \arg'2' ->
  HoppyFHR.withCppPtr (M256.toQLayout arg'3) $ \arg'3' ->
  (addRowWidgetLayout' arg'1' arg'2' arg'3')

addRowStringWidget :: (QFormLayoutPtr arg'1, M52.QStringValue arg'2, M322.QWidgetPtr arg'3) => arg'1 -> arg'2 -> arg'3 -> HoppyP.IO ()
...
addRowStringLayout :: (QFormLayoutPtr arg'1, M52.QStringValue arg'2, M256.QLayoutPtr arg'3) => arg'1 -> arg'2 -> arg'3 -> HoppyP.IO ()
...
addRowWidget :: (QFormLayoutPtr arg'1, M322.QWidgetPtr arg'2) => arg'1 -> arg'2 -> HoppyP.IO ()
addRowWidget arg'1 arg'2 =
  HoppyFHR.withCppPtr (toQFormLayout arg'1) $ \arg'1' ->
  HoppyFHR.withCppPtr (M322.toQWidget arg'2) $ \arg'2' ->
  (addRowWidget' arg'1' arg'2')

addRowLayout :: (QFormLayoutPtr arg'1, M256.QLayoutPtr arg'2) => arg'1 -> arg'2 -> HoppyP.IO ()
...
setFormAlignment :: (QFormLayoutPtr arg'1, M66.IsQtAlignment arg'2) => arg'1 -> arg'2 -> HoppyP.IO ()
...
insertRowWidgetWidget :: (QFormLayoutPtr arg'1, M322.QWidgetPtr arg'3, M322.QWidgetPtr arg'4) => arg'1 -> HoppyP.Int -> arg'3 -> arg'4 -> HoppyP.IO ()
insertRowWidgetWidget arg'1 arg'2 arg'3 arg'4 =
  HoppyFHR.withCppPtr (toQFormLayout arg'1) $ \arg'1' ->
  let arg'2' = HoppyFHR.coerceIntegral arg'2 in
  HoppyFHR.withCppPtr (M322.toQWidget arg'3) $ \arg'3' ->
  HoppyFHR.withCppPtr (M322.toQWidget arg'4) $ \arg'4' ->
  (insertRowWidgetWidget' arg'1' arg'2' arg'3' arg'4')

insertRowWidgetLayout :: (QFormLayoutPtr arg'1, M322.QWidgetPtr arg'3, M256.QLayoutPtr arg'4) => arg'1 -> HoppyP.Int -> arg'3 -> arg'4 -> HoppyP.IO ()
insertRowWidgetLayout arg'1 arg'2 arg'3 arg'4 =
  HoppyFHR.withCppPtr (toQFormLayout arg'1) $ \arg'1' ->
  let arg'2' = HoppyFHR.coerceIntegral arg'2 in
  HoppyFHR.withCppPtr (M322.toQWidget arg'3) $ \arg'3' ->
  HoppyFHR.withCppPtr (M256.toQLayout arg'4) $ \arg'4' ->
  (insertRowWidgetLayout' arg'1' arg'2' arg'3' arg'4')

insertRowStringWidget :: (QFormLayoutPtr arg'1, M52.QStringValue arg'3, M322.QWidgetPtr arg'4) => arg'1 -> HoppyP.Int -> arg'3 -> arg'4 -> HoppyP.IO ()
...
insertRowStringLayout :: (QFormLayoutPtr arg'1, M52.QStringValue arg'3, M256.QLayoutPtr arg'4) => arg'1 -> HoppyP.Int -> arg'3 -> arg'4 -> HoppyP.IO ()
...
insertRowWidget :: (QFormLayoutPtr arg'1, M322.QWidgetPtr arg'3) => arg'1 -> HoppyP.Int -> arg'3 -> HoppyP.IO ()
...
insertRowLayout :: (QFormLayoutPtr arg'1, M256.QLayoutPtr arg'3) => arg'1 -> HoppyP.Int -> arg'3 -> HoppyP.IO ()
...
setLabelAlignment :: (QFormLayoutPtr arg'1, M66.IsQtAlignment arg'2) => arg'1 -> arg'2 -> HoppyP.IO ()
...
setItem :: (QFormLayoutPtr arg'1, M258.QLayoutItemPtr arg'4) => arg'1 -> HoppyP.Int -> QFormLayoutItemRole -> arg'4 -> HoppyP.IO ()
setItem arg'1 arg'2 arg'3 arg'4 =
  HoppyFHR.withCppPtr (toQFormLayout arg'1) $ \arg'1' ->
  let arg'2' = HoppyFHR.coerceIntegral arg'2 in
  let arg'3' = HoppyFHR.coerceIntegral $ HoppyP.fromEnum arg'3 in
  HoppyFHR.withCppPtr (M258.toQLayoutItem arg'4) $ \arg'4' ->
  (setItem' arg'1' arg'2' arg'3' arg'4')

setLayout :: (QFormLayoutPtr arg'1, M256.QLayoutPtr arg'4) => arg'1 -> HoppyP.Int -> QFormLayoutItemRole -> arg'4 -> HoppyP.IO ()
...
setWidget :: (QFormLayoutPtr arg'1, M322.QWidgetPtr arg'4) => arg'1 -> HoppyP.Int -> QFormLayoutItemRole -> arg'4 -> HoppyP.IO ()
...
instance M256.QLayoutConstPtr QFormLayoutConst where
  toQLayoutConst (QFormLayoutConst ptr') = M256.QLayoutConst $ castQFormLayoutToQLayout ptr'
  toQLayoutConst (QFormLayoutConstGc fptr' ptr') = M256.QLayoutConstGc fptr' $ castQFormLayoutToQLayout ptr'
...
instance M258.QLayoutItemConstPtr QFormLayoutConst where
  toQLayoutItemConst (QFormLayoutConst ptr') = M258.QLayoutItemConst $ castQFormLayoutToQLayoutItem ptr'
  toQLayoutItemConst (QFormLayoutConstGc fptr' ptr') = M258.QLayoutItemConstGc fptr' $ castQFormLayoutToQLayoutItem ptr'
...
instance M256.QLayoutConstPtr QFormLayout where
  toQLayoutConst (QFormLayout ptr') = M256.QLayoutConst $ castQFormLayoutToQLayout $ (HoppyF.castPtr :: HoppyF.Ptr QFormLayout -> HoppyF.Ptr QFormLayoutConst) ptr'
  toQLayoutConst (QFormLayoutGc fptr' ptr') = M256.QLayoutConstGc fptr' $ castQFormLayoutToQLayout $ (HoppyF.castPtr :: HoppyF.Ptr QFormLayout -> HoppyF.Ptr QFormLayoutConst) ptr'

instance M256.QLayoutPtr QFormLayout where
  toQLayout (QFormLayout ptr') = M256.QLayout $ (HoppyF.castPtr :: HoppyF.Ptr M256.QLayoutConst -> HoppyF.Ptr M256.QLayout) $ castQFormLayoutToQLayout $ (HoppyF.castPtr :: HoppyF.Ptr QFormLayout -> HoppyF.Ptr QFormLayoutConst) ptr'
  toQLayout (QFormLayoutGc fptr' ptr') = M256.QLayoutGc fptr' $ (HoppyF.castPtr :: HoppyF.Ptr M256.QLayoutConst -> HoppyF.Ptr M256.QLayout) $ castQFormLayoutToQLayout $ (HoppyF.castPtr :: HoppyF.Ptr QFormLayout -> HoppyF.Ptr QFormLayoutConst) ptr'
...
instance M258.QLayoutItemConstPtr QFormLayout where
  toQLayoutItemConst (QFormLayout ptr') = M258.QLayoutItemConst $ castQFormLayoutToQLayoutItem $ (HoppyF.castPtr :: HoppyF.Ptr QFormLayout -> HoppyF.Ptr QFormLayoutConst) ptr'
  toQLayoutItemConst (QFormLayoutGc fptr' ptr') = M258.QLayoutItemConstGc fptr' $ castQFormLayoutToQLayoutItem $ (HoppyF.castPtr :: HoppyF.Ptr QFormLayout -> HoppyF.Ptr QFormLayoutConst) ptr'

instance M258.QLayoutItemPtr QFormLayout where
  toQLayoutItem (QFormLayout ptr') = M258.QLayoutItem $ (HoppyF.castPtr :: HoppyF.Ptr M258.QLayoutItemConst -> HoppyF.Ptr M258.QLayoutItem) $ castQFormLayoutToQLayoutItem $ (HoppyF.castPtr :: HoppyF.Ptr QFormLayout -> HoppyF.Ptr QFormLayoutConst) ptr'
  toQLayoutItem (QFormLayoutGc fptr' ptr') = M258.QLayoutItemGc fptr' $ (HoppyF.castPtr :: HoppyF.Ptr M258.QLayoutItemConst -> HoppyF.Ptr M258.QLayoutItem) $ castQFormLayoutToQLayoutItem $ (HoppyF.castPtr :: HoppyF.Ptr QFormLayout -> HoppyF.Ptr QFormLayoutConst) ptr'
...
newWithParent :: (M322.QWidgetPtr arg'1) => arg'1 -> HoppyP.IO QFormLayout
newWithParent arg'1 =
...
instance QFormLayoutSuper M256.QLayout where
  downToQFormLayout = castQFormLayoutToNonconst . cast' . M256.castQLayoutToConst
    where
      cast' (M256.QLayoutConst ptr') = QFormLayoutConst $ castQLayoutToQFormLayout ptr'
      cast' (M256.QLayoutConstGc fptr' ptr') = QFormLayoutConstGc fptr' $ castQLayoutToQFormLayout ptr'
...
instance QFormLayoutSuper M258.QLayoutItem where
  downToQFormLayout = castQFormLayoutToNonconst . cast' . M258.castQLayoutItemToConst
    where
      cast' (M258.QLayoutItemConst ptr') = QFormLayoutConst $ castQLayoutItemToQFormLayout ptr'
      cast' (M258.QLayoutItemConstGc fptr' ptr') = QFormLayoutConstGc fptr' $ castQLayoutItemToQFormLayout ptr'

class QFormLayoutSuperConst a where
  downToQFormLayoutConst :: a -> QFormLayoutConst

instance QFormLayoutSuperConst M256.QLayoutConst where
...
instance QFormLayoutSuperConst M34.QObjectConst where
  downToQFormLayoutConst = cast'
    where
      cast' (M34.QObjectConst ptr') = QFormLayoutConst $ castQObjectToQFormLayout ptr'
      cast' (M34.QObjectConstGc fptr' ptr') = QFormLayoutConstGc fptr' $ castQObjectToQFormLayout ptr'
instance QFormLayoutSuperConst M258.QLayoutItemConst where
  downToQFormLayoutConst = cast'
    where
      cast' (M258.QLayoutItemConst ptr') = QFormLayoutConst $ castQLayoutItemToQFormLayout ptr'
      cast' (M258.QLayoutItemConstGc fptr' ptr') = QFormLayoutConstGc fptr' $ castQLayoutItemToQFormLayout ptr'
