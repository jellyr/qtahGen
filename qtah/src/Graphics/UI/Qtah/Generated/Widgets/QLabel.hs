...
foreign import ccall "genpop__QLabel_newWithParent" newWithParent' ::  HoppyF.Ptr M322.QWidget -> HoppyP.IO (HoppyF.Ptr QLabel)
foreign import ccall "genpop__QLabel_newWithText" newWithText' ::  HoppyF.Ptr M52.QStringConst -> HoppyP.IO (HoppyF.Ptr QLabel)
foreign import ccall "genpop__QLabel_newWithTextAndParent" newWithTextAndParent' ::  HoppyF.Ptr M52.QStringConst -> HoppyF.Ptr M322.QWidget -> HoppyP.IO (HoppyF.Ptr QLabel)
...
foreign import ccall "genpop__QLabel_buddy" buddy' ::  HoppyF.Ptr QLabelConst -> HoppyP.IO (HoppyF.Ptr M322.QWidget)
foreign import ccall "genpop__QLabel_setBuddy" setBuddy' ::  HoppyF.Ptr QLabel -> HoppyF.Ptr M322.QWidget -> HoppyP.IO ()
...
foreign import ccall "genpop__QLabel_pixmap" pixmap' ::  HoppyF.Ptr QLabelConst -> HoppyP.IO (HoppyF.Ptr M146.QPixmapConst)
...
foreign import ccall "genpop__QLabel_selectedText" selectedText' ::  HoppyF.Ptr QLabelConst -> HoppyP.IO (HoppyF.Ptr M52.QStringConst)
...
foreign import ccall "genpop__QLabel_setPixmap" setPixmap' ::  HoppyF.Ptr QLabel -> HoppyF.Ptr M146.QPixmapConst -> HoppyP.IO ()
foreign import ccall "genpop__QLabel_setSelection" setSelection' ::  HoppyF.Ptr QLabel -> HoppyFC.CInt -> HoppyFC.CInt -> HoppyP.IO ()
foreign import ccall "genpop__QLabel_text" text' ::  HoppyF.Ptr QLabelConst -> HoppyP.IO (HoppyF.Ptr M52.QStringConst)
foreign import ccall "genpop__QLabel_setText" setText' ::  HoppyF.Ptr QLabel -> HoppyF.Ptr M52.QStringConst -> HoppyP.IO ()
...
foreign import ccall "gencast__QLabel__QFrame" castQLabelToQFrame :: HoppyF.Ptr QLabelConst -> HoppyF.Ptr M226.QFrameConst
foreign import ccall "gencast__QFrame__QLabel" castQFrameToQLabel :: HoppyF.Ptr M226.QFrameConst -> HoppyF.Ptr QLabelConst
foreign import ccall "gencast__QLabel__QWidget" castQLabelToQWidget :: HoppyF.Ptr QLabelConst -> HoppyF.Ptr M322.QWidgetConst
foreign import ccall "gencast__QWidget__QLabel" castQWidgetToQLabel :: HoppyF.Ptr M322.QWidgetConst -> HoppyF.Ptr QLabelConst
...
class (M226.QFrameConstPtr this) => QLabelConstPtr this where
  toQLabelConst :: this -> QLabelConst

alignment :: (QLabelValue arg'1) => arg'1 -> HoppyP.IO M66.QtAlignment
alignment arg'1 =
  withQLabelPtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
  HoppyP.fmap M66.QtAlignment
  (alignment' arg'1')

buddy :: (QLabelValue arg'1) => arg'1 -> HoppyP.IO M322.QWidget
buddy arg'1 =
  withQLabelPtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
...
pixmap :: (QLabelValue arg'1) => arg'1 -> HoppyP.IO M146.QPixmapConst
pixmap arg'1 =
  withQLabelPtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
  HoppyP.fmap M146.QPixmapConst
  (pixmap' arg'1')
...
textFormat :: (QLabelValue arg'1) => arg'1 -> HoppyP.IO M66.QtTextFormat
textFormat arg'1 =
  withQLabelPtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
...
class (QLabelConstPtr this, M226.QFramePtr this) => QLabelPtr this where
  toQLabel :: this -> QLabel

setAlignment :: (QLabelPtr arg'1, M66.IsQtAlignment arg'2) => arg'1 -> arg'2 -> HoppyP.IO ()
setAlignment arg'1 arg'2 =
  HoppyFHR.withCppPtr (toQLabel arg'1) $ \arg'1' ->
  let arg'2' = M66.fromQtAlignment $ M66.toQtAlignment arg'2 in
  (setAlignment' arg'1' arg'2')

setBuddy :: (QLabelPtr arg'1, M322.QWidgetPtr arg'2) => arg'1 -> arg'2 -> HoppyP.IO ()
...
setPixmap :: (QLabelPtr arg'1, M146.QPixmapValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO ()
...
setText :: (QLabelPtr arg'1, M52.QStringValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO ()
setText arg'1 arg'2 =
  HoppyFHR.withCppPtr (toQLabel arg'1) $ \arg'1' ->
  M52.withQStringPtr arg'2 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'2' ->
  (setText' arg'1' arg'2')

setTextFormat :: (QLabelPtr arg'1) => arg'1 -> M66.QtTextFormat -> HoppyP.IO ()
...
instance M226.QFrameConstPtr QLabelConst where
  toQFrameConst (QLabelConst ptr') = M226.QFrameConst $ castQLabelToQFrame ptr'
  toQFrameConst (QLabelConstGc fptr' ptr') = M226.QFrameConstGc fptr' $ castQLabelToQFrame ptr'

instance M322.QWidgetConstPtr QLabelConst where
  toQWidgetConst (QLabelConst ptr') = M322.QWidgetConst $ castQLabelToQWidget ptr'
  toQWidgetConst (QLabelConstGc fptr' ptr') = M322.QWidgetConstGc fptr' $ castQLabelToQWidget ptr'
...
instance M226.QFrameConstPtr QLabel where
  toQFrameConst (QLabel ptr') = M226.QFrameConst $ castQLabelToQFrame $ (HoppyF.castPtr :: HoppyF.Ptr QLabel -> HoppyF.Ptr QLabelConst) ptr'
  toQFrameConst (QLabelGc fptr' ptr') = M226.QFrameConstGc fptr' $ castQLabelToQFrame $ (HoppyF.castPtr :: HoppyF.Ptr QLabel -> HoppyF.Ptr QLabelConst) ptr'

instance M226.QFramePtr QLabel where
  toQFrame (QLabel ptr') = M226.QFrame $ (HoppyF.castPtr :: HoppyF.Ptr M226.QFrameConst -> HoppyF.Ptr M226.QFrame) $ castQLabelToQFrame $ (HoppyF.castPtr :: HoppyF.Ptr QLabel -> HoppyF.Ptr QLabelConst) ptr'
  toQFrame (QLabelGc fptr' ptr') = M226.QFrameGc fptr' $ (HoppyF.castPtr :: HoppyF.Ptr M226.QFrameConst -> HoppyF.Ptr M226.QFrame) $ castQLabelToQFrame $ (HoppyF.castPtr :: HoppyF.Ptr QLabel -> HoppyF.Ptr QLabelConst) ptr'

instance M322.QWidgetConstPtr QLabel where
  toQWidgetConst (QLabel ptr') = M322.QWidgetConst $ castQLabelToQWidget $ (HoppyF.castPtr :: HoppyF.Ptr QLabel -> HoppyF.Ptr QLabelConst) ptr'
  toQWidgetConst (QLabelGc fptr' ptr') = M322.QWidgetConstGc fptr' $ castQLabelToQWidget $ (HoppyF.castPtr :: HoppyF.Ptr QLabel -> HoppyF.Ptr QLabelConst) ptr'

instance M322.QWidgetPtr QLabel where
  toQWidget (QLabel ptr') = M322.QWidget $ (HoppyF.castPtr :: HoppyF.Ptr M322.QWidgetConst -> HoppyF.Ptr M322.QWidget) $ castQLabelToQWidget $ (HoppyF.castPtr :: HoppyF.Ptr QLabel -> HoppyF.Ptr QLabelConst) ptr'
  toQWidget (QLabelGc fptr' ptr') = M322.QWidgetGc fptr' $ (HoppyF.castPtr :: HoppyF.Ptr M322.QWidgetConst -> HoppyF.Ptr M322.QWidget) $ castQLabelToQWidget $ (HoppyF.castPtr :: HoppyF.Ptr QLabel -> HoppyF.Ptr QLabelConst) ptr'
...
newWithParent :: (M322.QWidgetPtr arg'1) => arg'1 -> HoppyP.IO QLabel
newWithParent arg'1 =
  HoppyFHR.withCppPtr (M322.toQWidget arg'1) $ \arg'1' ->
  HoppyP.fmap QLabel
  (newWithParent' arg'1')

newWithText :: (M52.QStringValue arg'1) => arg'1 -> HoppyP.IO QLabel
newWithText arg'1 =
  M52.withQStringPtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
  HoppyP.fmap QLabel
  (newWithText' arg'1')

newWithTextAndParent :: (M52.QStringValue arg'1, M322.QWidgetPtr arg'2) => arg'1 -> arg'2 -> HoppyP.IO QLabel
...
instance QLabelSuper M226.QFrame where
  downToQLabel = castQLabelToNonconst . cast' . M226.castQFrameToConst
    where
      cast' (M226.QFrameConst ptr') = QLabelConst $ castQFrameToQLabel ptr'
      cast' (M226.QFrameConstGc fptr' ptr') = QLabelConstGc fptr' $ castQFrameToQLabel ptr'
instance QLabelSuper M322.QWidget where
  downToQLabel = castQLabelToNonconst . cast' . M322.castQWidgetToConst
    where
      cast' (M322.QWidgetConst ptr') = QLabelConst $ castQWidgetToQLabel ptr'
      cast' (M322.QWidgetConstGc fptr' ptr') = QLabelConstGc fptr' $ castQWidgetToQLabel ptr'
...
instance QLabelSuperConst M226.QFrameConst where
  downToQLabelConst = cast'
    where
      cast' (M226.QFrameConst ptr') = QLabelConst $ castQFrameToQLabel ptr'
      cast' (M226.QFrameConstGc fptr' ptr') = QLabelConstGc fptr' $ castQFrameToQLabel ptr'
instance QLabelSuperConst M322.QWidgetConst where
  downToQLabelConst = cast'
    where
      cast' (M322.QWidgetConst ptr') = QLabelConst $ castQWidgetToQLabel ptr'
      cast' (M322.QWidgetConstGc fptr' ptr') = QLabelConstGc fptr' $ castQWidgetToQLabel ptr'
