...
foreign import ccall "genpop__QMenuBar_newWithParent" newWithParent' ::  HoppyF.Ptr M322.QWidget -> HoppyP.IO (HoppyF.Ptr QMenuBar)
foreign import ccall "genpop__QMenuBar_actionAt" actionAt' ::  HoppyF.Ptr QMenuBarConst -> HoppyF.Ptr M38.QPointConst -> HoppyP.IO (HoppyF.Ptr M198.QAction)
foreign import ccall "genpop__QMenuBar_actionGeometry" actionGeometry' ::  HoppyF.Ptr QMenuBarConst -> HoppyF.Ptr M198.QAction -> HoppyP.IO (HoppyF.Ptr M42.QRectConst)
foreign import ccall "genpop__QMenuBar_activeAction" activeAction' ::  HoppyF.Ptr QMenuBarConst -> HoppyP.IO (HoppyF.Ptr M198.QAction)
foreign import ccall "genpop__QMenuBar_setActiveAction" setActiveAction' ::  HoppyF.Ptr QMenuBar -> HoppyF.Ptr M198.QAction -> HoppyP.IO ()
foreign import ccall "genpop__QMenuBar_addAction" addAction' ::  HoppyF.Ptr QMenuBar -> HoppyF.Ptr M198.QAction -> HoppyP.IO ()
foreign import ccall "genpop__QMenuBar_addNewAction" addNewAction' ::  HoppyF.Ptr QMenuBar -> HoppyF.Ptr M52.QStringConst -> HoppyP.IO (HoppyF.Ptr M198.QAction)
foreign import ccall "genpop__QMenuBar_addMenu" addMenu' ::  HoppyF.Ptr QMenuBar -> HoppyF.Ptr M266.QMenu -> HoppyP.IO (HoppyF.Ptr M198.QAction)
foreign import ccall "genpop__QMenuBar_addNewMenu" addNewMenu' ::  HoppyF.Ptr QMenuBar -> HoppyF.Ptr M52.QStringConst -> HoppyP.IO (HoppyF.Ptr M266.QMenu)
foreign import ccall "genpop__QMenuBar_addNewMenuWithIcon" addNewMenuWithIcon' ::  HoppyF.Ptr QMenuBar -> HoppyF.Ptr M120.QIconConst -> HoppyF.Ptr M52.QStringConst -> HoppyP.IO (HoppyF.Ptr M266.QMenu)
foreign import ccall "genpop__QMenuBar_addSeparator" addSeparator' ::  HoppyF.Ptr QMenuBar -> HoppyP.IO (HoppyF.Ptr M198.QAction)
foreign import ccall "genpop__QMenuBar_clear" clear' ::  HoppyF.Ptr QMenuBar -> HoppyP.IO ()
foreign import ccall "genpop__QMenuBar_cornerWidget" cornerWidget' ::  HoppyF.Ptr QMenuBarConst -> HoppyFC.CInt -> HoppyP.IO (HoppyF.Ptr M322.QWidget)
...
foreign import ccall "genpop__QMenuBar_insertMenu" insertMenu' ::  HoppyF.Ptr QMenuBar -> HoppyF.Ptr M198.QAction -> HoppyF.Ptr M266.QMenu -> HoppyP.IO (HoppyF.Ptr M198.QAction)
foreign import ccall "genpop__QMenuBar_insertSeparator" insertSeparator' ::  HoppyF.Ptr QMenuBar -> HoppyF.Ptr M198.QAction -> HoppyP.IO (HoppyF.Ptr M198.QAction)
...
foreign import ccall "genpop__QMenuBar_setCornerWidget" setCornerWidget' ::  HoppyF.Ptr QMenuBar -> HoppyF.Ptr M322.QWidget -> HoppyFC.CInt -> HoppyP.IO ()
foreign import ccall "gencast__QMenuBar__QWidget" castQMenuBarToQWidget :: HoppyF.Ptr QMenuBarConst -> HoppyF.Ptr M322.QWidgetConst
foreign import ccall "gencast__QWidget__QMenuBar" castQWidgetToQMenuBar :: HoppyF.Ptr M322.QWidgetConst -> HoppyF.Ptr QMenuBarConst
...
class (M322.QWidgetConstPtr this) => QMenuBarConstPtr this where
  toQMenuBarConst :: this -> QMenuBarConst

actionAt :: (QMenuBarValue arg'1, M38.QPointValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO M198.QAction
...
actionGeometry :: (QMenuBarValue arg'1, M198.QActionPtr arg'2) => arg'1 -> arg'2 -> HoppyP.IO HRect.HRect
...
activeAction :: (QMenuBarValue arg'1) => arg'1 -> HoppyP.IO M198.QAction
activeAction arg'1 =
  withQMenuBarPtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
  HoppyP.fmap M198.QAction
  (activeAction' arg'1')

cornerWidget :: (QMenuBarValue arg'1) => arg'1 -> M66.QtCorner -> HoppyP.IO M322.QWidget
...
class (QMenuBarConstPtr this, M322.QWidgetPtr this) => QMenuBarPtr this where
  toQMenuBar :: this -> QMenuBar

setActiveAction :: (QMenuBarPtr arg'1, M198.QActionPtr arg'2) => arg'1 -> arg'2 -> HoppyP.IO ()
setActiveAction arg'1 arg'2 =
  HoppyFHR.withCppPtr (toQMenuBar arg'1) $ \arg'1' ->
  HoppyFHR.withCppPtr (M198.toQAction arg'2) $ \arg'2' ->
  (setActiveAction' arg'1' arg'2')

addAction :: (QMenuBarPtr arg'1, M198.QActionPtr arg'2) => arg'1 -> arg'2 -> HoppyP.IO ()
addAction arg'1 arg'2 =
  HoppyFHR.withCppPtr (toQMenuBar arg'1) $ \arg'1' ->
  HoppyFHR.withCppPtr (M198.toQAction arg'2) $ \arg'2' ->
  (addAction' arg'1' arg'2')

addNewAction :: (QMenuBarPtr arg'1, M52.QStringValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO M198.QAction
...
addMenu :: (QMenuBarPtr arg'1, M266.QMenuPtr arg'2) => arg'1 -> arg'2 -> HoppyP.IO M198.QAction
addMenu arg'1 arg'2 =
  HoppyFHR.withCppPtr (toQMenuBar arg'1) $ \arg'1' ->
...
addNewMenu :: (QMenuBarPtr arg'1, M52.QStringValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO M266.QMenu
...
addNewMenuWithIcon :: (QMenuBarPtr arg'1, M120.QIconValue arg'2, M52.QStringValue arg'3) => arg'1 -> arg'2 -> arg'3 -> HoppyP.IO M266.QMenu
...
addSeparator :: (QMenuBarPtr arg'1) => arg'1 -> HoppyP.IO M198.QAction
addSeparator arg'1 =
  HoppyFHR.withCppPtr (toQMenuBar arg'1) $ \arg'1' ->
  HoppyP.fmap M198.QAction
  (addSeparator' arg'1')
...
insertMenu :: (QMenuBarPtr arg'1, M198.QActionPtr arg'2, M266.QMenuPtr arg'3) => arg'1 -> arg'2 -> arg'3 -> HoppyP.IO M198.QAction
insertMenu arg'1 arg'2 arg'3 =
  HoppyFHR.withCppPtr (toQMenuBar arg'1) $ \arg'1' ->
  HoppyFHR.withCppPtr (M198.toQAction arg'2) $ \arg'2' ->
  HoppyFHR.withCppPtr (M266.toQMenu arg'3) $ \arg'3' ->
  HoppyP.fmap M198.QAction
  (insertMenu' arg'1' arg'2' arg'3')

insertSeparator :: (QMenuBarPtr arg'1, M198.QActionPtr arg'2) => arg'1 -> arg'2 -> HoppyP.IO M198.QAction
...
setCornerWidget :: (QMenuBarPtr arg'1, M322.QWidgetPtr arg'2) => arg'1 -> arg'2 -> M66.QtCorner -> HoppyP.IO ()
...
instance M322.QWidgetConstPtr QMenuBarConst where
  toQWidgetConst (QMenuBarConst ptr') = M322.QWidgetConst $ castQMenuBarToQWidget ptr'
  toQWidgetConst (QMenuBarConstGc fptr' ptr') = M322.QWidgetConstGc fptr' $ castQMenuBarToQWidget ptr'
...
instance M322.QWidgetConstPtr QMenuBar where
  toQWidgetConst (QMenuBar ptr') = M322.QWidgetConst $ castQMenuBarToQWidget $ (HoppyF.castPtr :: HoppyF.Ptr QMenuBar -> HoppyF.Ptr QMenuBarConst) ptr'
  toQWidgetConst (QMenuBarGc fptr' ptr') = M322.QWidgetConstGc fptr' $ castQMenuBarToQWidget $ (HoppyF.castPtr :: HoppyF.Ptr QMenuBar -> HoppyF.Ptr QMenuBarConst) ptr'

instance M322.QWidgetPtr QMenuBar where
  toQWidget (QMenuBar ptr') = M322.QWidget $ (HoppyF.castPtr :: HoppyF.Ptr M322.QWidgetConst -> HoppyF.Ptr M322.QWidget) $ castQMenuBarToQWidget $ (HoppyF.castPtr :: HoppyF.Ptr QMenuBar -> HoppyF.Ptr QMenuBarConst) ptr'
  toQWidget (QMenuBarGc fptr' ptr') = M322.QWidgetGc fptr' $ (HoppyF.castPtr :: HoppyF.Ptr M322.QWidgetConst -> HoppyF.Ptr M322.QWidget) $ castQMenuBarToQWidget $ (HoppyF.castPtr :: HoppyF.Ptr QMenuBar -> HoppyF.Ptr QMenuBarConst) ptr'
...
newWithParent :: (M322.QWidgetPtr arg'1) => arg'1 -> HoppyP.IO QMenuBar
newWithParent arg'1 =
...
instance QMenuBarSuper M322.QWidget where
  downToQMenuBar = castQMenuBarToNonconst . cast' . M322.castQWidgetToConst
    where
      cast' (M322.QWidgetConst ptr') = QMenuBarConst $ castQWidgetToQMenuBar ptr'
      cast' (M322.QWidgetConstGc fptr' ptr') = QMenuBarConstGc fptr' $ castQWidgetToQMenuBar ptr'
...
instance QMenuBarSuperConst M322.QWidgetConst where
