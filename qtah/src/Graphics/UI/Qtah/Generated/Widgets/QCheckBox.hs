...
foreign import ccall "genpop__QCheckBox_newWithParent" newWithParent' ::  HoppyF.Ptr M322.QWidget -> HoppyP.IO (HoppyF.Ptr QCheckBox)
foreign import ccall "genpop__QCheckBox_newWithText" newWithText' ::  HoppyF.Ptr M52.QStringConst -> HoppyP.IO (HoppyF.Ptr QCheckBox)
foreign import ccall "genpop__QCheckBox_newWithTextAndParent" newWithTextAndParent' ::  HoppyF.Ptr M52.QStringConst -> HoppyF.Ptr M322.QWidget -> HoppyP.IO (HoppyF.Ptr QCheckBox)
...
foreign import ccall "gencast__QCheckBox__QAbstractButton" castQCheckBoxToQAbstractButton :: HoppyF.Ptr QCheckBoxConst -> HoppyF.Ptr M184.QAbstractButtonConst
foreign import ccall "gencast__QAbstractButton__QCheckBox" castQAbstractButtonToQCheckBox :: HoppyF.Ptr M184.QAbstractButtonConst -> HoppyF.Ptr QCheckBoxConst
foreign import ccall "gencast__QCheckBox__QWidget" castQCheckBoxToQWidget :: HoppyF.Ptr QCheckBoxConst -> HoppyF.Ptr M322.QWidgetConst
foreign import ccall "gencast__QWidget__QCheckBox" castQWidgetToQCheckBox :: HoppyF.Ptr M322.QWidgetConst -> HoppyF.Ptr QCheckBoxConst
...
class (M184.QAbstractButtonConstPtr this) => QCheckBoxConstPtr this where
  toQCheckBoxConst :: this -> QCheckBoxConst

checkState :: (QCheckBoxValue arg'1) => arg'1 -> HoppyP.IO M66.QtCheckState
checkState arg'1 =
...
class (QCheckBoxConstPtr this, M184.QAbstractButtonPtr this) => QCheckBoxPtr this where
  toQCheckBox :: this -> QCheckBox

setCheckState :: (QCheckBoxPtr arg'1) => arg'1 -> M66.QtCheckState -> HoppyP.IO ()
...
instance M184.QAbstractButtonConstPtr QCheckBoxConst where
  toQAbstractButtonConst (QCheckBoxConst ptr') = M184.QAbstractButtonConst $ castQCheckBoxToQAbstractButton ptr'
  toQAbstractButtonConst (QCheckBoxConstGc fptr' ptr') = M184.QAbstractButtonConstGc fptr' $ castQCheckBoxToQAbstractButton ptr'

instance M322.QWidgetConstPtr QCheckBoxConst where
  toQWidgetConst (QCheckBoxConst ptr') = M322.QWidgetConst $ castQCheckBoxToQWidget ptr'
  toQWidgetConst (QCheckBoxConstGc fptr' ptr') = M322.QWidgetConstGc fptr' $ castQCheckBoxToQWidget ptr'
...
instance M184.QAbstractButtonConstPtr QCheckBox where
  toQAbstractButtonConst (QCheckBox ptr') = M184.QAbstractButtonConst $ castQCheckBoxToQAbstractButton $ (HoppyF.castPtr :: HoppyF.Ptr QCheckBox -> HoppyF.Ptr QCheckBoxConst) ptr'
  toQAbstractButtonConst (QCheckBoxGc fptr' ptr') = M184.QAbstractButtonConstGc fptr' $ castQCheckBoxToQAbstractButton $ (HoppyF.castPtr :: HoppyF.Ptr QCheckBox -> HoppyF.Ptr QCheckBoxConst) ptr'

instance M184.QAbstractButtonPtr QCheckBox where
  toQAbstractButton (QCheckBox ptr') = M184.QAbstractButton $ (HoppyF.castPtr :: HoppyF.Ptr M184.QAbstractButtonConst -> HoppyF.Ptr M184.QAbstractButton) $ castQCheckBoxToQAbstractButton $ (HoppyF.castPtr :: HoppyF.Ptr QCheckBox -> HoppyF.Ptr QCheckBoxConst) ptr'
  toQAbstractButton (QCheckBoxGc fptr' ptr') = M184.QAbstractButtonGc fptr' $ (HoppyF.castPtr :: HoppyF.Ptr M184.QAbstractButtonConst -> HoppyF.Ptr M184.QAbstractButton) $ castQCheckBoxToQAbstractButton $ (HoppyF.castPtr :: HoppyF.Ptr QCheckBox -> HoppyF.Ptr QCheckBoxConst) ptr'

instance M322.QWidgetConstPtr QCheckBox where
  toQWidgetConst (QCheckBox ptr') = M322.QWidgetConst $ castQCheckBoxToQWidget $ (HoppyF.castPtr :: HoppyF.Ptr QCheckBox -> HoppyF.Ptr QCheckBoxConst) ptr'
  toQWidgetConst (QCheckBoxGc fptr' ptr') = M322.QWidgetConstGc fptr' $ castQCheckBoxToQWidget $ (HoppyF.castPtr :: HoppyF.Ptr QCheckBox -> HoppyF.Ptr QCheckBoxConst) ptr'

instance M322.QWidgetPtr QCheckBox where
  toQWidget (QCheckBox ptr') = M322.QWidget $ (HoppyF.castPtr :: HoppyF.Ptr M322.QWidgetConst -> HoppyF.Ptr M322.QWidget) $ castQCheckBoxToQWidget $ (HoppyF.castPtr :: HoppyF.Ptr QCheckBox -> HoppyF.Ptr QCheckBoxConst) ptr'
  toQWidget (QCheckBoxGc fptr' ptr') = M322.QWidgetGc fptr' $ (HoppyF.castPtr :: HoppyF.Ptr M322.QWidgetConst -> HoppyF.Ptr M322.QWidget) $ castQCheckBoxToQWidget $ (HoppyF.castPtr :: HoppyF.Ptr QCheckBox -> HoppyF.Ptr QCheckBoxConst) ptr'
...
newWithParent :: (M322.QWidgetPtr arg'1) => arg'1 -> HoppyP.IO QCheckBox
newWithParent arg'1 =
  HoppyFHR.withCppPtr (M322.toQWidget arg'1) $ \arg'1' ->
  HoppyP.fmap QCheckBox
  (newWithParent' arg'1')

newWithText :: (M52.QStringValue arg'1) => arg'1 -> HoppyP.IO QCheckBox
newWithText arg'1 =
  M52.withQStringPtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
  HoppyP.fmap QCheckBox
  (newWithText' arg'1')

newWithTextAndParent :: (M52.QStringValue arg'1, M322.QWidgetPtr arg'2) => arg'1 -> arg'2 -> HoppyP.IO QCheckBox
...
instance QCheckBoxSuper M184.QAbstractButton where
  downToQCheckBox = castQCheckBoxToNonconst . cast' . M184.castQAbstractButtonToConst
    where
      cast' (M184.QAbstractButtonConst ptr') = QCheckBoxConst $ castQAbstractButtonToQCheckBox ptr'
      cast' (M184.QAbstractButtonConstGc fptr' ptr') = QCheckBoxConstGc fptr' $ castQAbstractButtonToQCheckBox ptr'
instance QCheckBoxSuper M322.QWidget where
  downToQCheckBox = castQCheckBoxToNonconst . cast' . M322.castQWidgetToConst
    where
      cast' (M322.QWidgetConst ptr') = QCheckBoxConst $ castQWidgetToQCheckBox ptr'
      cast' (M322.QWidgetConstGc fptr' ptr') = QCheckBoxConstGc fptr' $ castQWidgetToQCheckBox ptr'
...
instance QCheckBoxSuperConst M184.QAbstractButtonConst where
  downToQCheckBoxConst = cast'
    where
      cast' (M184.QAbstractButtonConst ptr') = QCheckBoxConst $ castQAbstractButtonToQCheckBox ptr'
      cast' (M184.QAbstractButtonConstGc fptr' ptr') = QCheckBoxConstGc fptr' $ castQAbstractButtonToQCheckBox ptr'
instance QCheckBoxSuperConst M322.QWidgetConst where
  downToQCheckBoxConst = cast'
    where
      cast' (M322.QWidgetConst ptr') = QCheckBoxConst $ castQWidgetToQCheckBox ptr'
      cast' (M322.QWidgetConstGc fptr' ptr') = QCheckBoxConstGc fptr' $ castQWidgetToQCheckBox ptr'
