...
foreign import ccall "gencast__QStyledItemDelegate__QAbstractItemDelegate" castQStyledItemDelegateToQAbstractItemDelegate :: HoppyF.Ptr QStyledItemDelegateConst -> HoppyF.Ptr M188.QAbstractItemDelegateConst
foreign import ccall "gencast__QAbstractItemDelegate__QStyledItemDelegate" castQAbstractItemDelegateToQStyledItemDelegate :: HoppyF.Ptr M188.QAbstractItemDelegateConst -> HoppyF.Ptr QStyledItemDelegateConst
...
class (M188.QAbstractItemDelegateConstPtr this) => QStyledItemDelegateConstPtr this where
  toQStyledItemDelegateConst :: this -> QStyledItemDelegateConst

class (QStyledItemDelegateConstPtr this, M188.QAbstractItemDelegatePtr this) => QStyledItemDelegatePtr this where
...
instance M188.QAbstractItemDelegateConstPtr QStyledItemDelegateConst where
  toQAbstractItemDelegateConst (QStyledItemDelegateConst ptr') = M188.QAbstractItemDelegateConst $ castQStyledItemDelegateToQAbstractItemDelegate ptr'
  toQAbstractItemDelegateConst (QStyledItemDelegateConstGc fptr' ptr') = M188.QAbstractItemDelegateConstGc fptr' $ castQStyledItemDelegateToQAbstractItemDelegate ptr'
...
instance M188.QAbstractItemDelegateConstPtr QStyledItemDelegate where
  toQAbstractItemDelegateConst (QStyledItemDelegate ptr') = M188.QAbstractItemDelegateConst $ castQStyledItemDelegateToQAbstractItemDelegate $ (HoppyF.castPtr :: HoppyF.Ptr QStyledItemDelegate -> HoppyF.Ptr QStyledItemDelegateConst) ptr'
  toQAbstractItemDelegateConst (QStyledItemDelegateGc fptr' ptr') = M188.QAbstractItemDelegateConstGc fptr' $ castQStyledItemDelegateToQAbstractItemDelegate $ (HoppyF.castPtr :: HoppyF.Ptr QStyledItemDelegate -> HoppyF.Ptr QStyledItemDelegateConst) ptr'

instance M188.QAbstractItemDelegatePtr QStyledItemDelegate where
  toQAbstractItemDelegate (QStyledItemDelegate ptr') = M188.QAbstractItemDelegate $ (HoppyF.castPtr :: HoppyF.Ptr M188.QAbstractItemDelegateConst -> HoppyF.Ptr M188.QAbstractItemDelegate) $ castQStyledItemDelegateToQAbstractItemDelegate $ (HoppyF.castPtr :: HoppyF.Ptr QStyledItemDelegate -> HoppyF.Ptr QStyledItemDelegateConst) ptr'
  toQAbstractItemDelegate (QStyledItemDelegateGc fptr' ptr') = M188.QAbstractItemDelegateGc fptr' $ (HoppyF.castPtr :: HoppyF.Ptr M188.QAbstractItemDelegateConst -> HoppyF.Ptr M188.QAbstractItemDelegate) $ castQStyledItemDelegateToQAbstractItemDelegate $ (HoppyF.castPtr :: HoppyF.Ptr QStyledItemDelegate -> HoppyF.Ptr QStyledItemDelegateConst) ptr'
...
instance QStyledItemDelegateSuper M188.QAbstractItemDelegate where
  downToQStyledItemDelegate = castQStyledItemDelegateToNonconst . cast' . M188.castQAbstractItemDelegateToConst
    where
      cast' (M188.QAbstractItemDelegateConst ptr') = QStyledItemDelegateConst $ castQAbstractItemDelegateToQStyledItemDelegate ptr'
      cast' (M188.QAbstractItemDelegateConstGc fptr' ptr') = QStyledItemDelegateConstGc fptr' $ castQAbstractItemDelegateToQStyledItemDelegate ptr'
...
instance QStyledItemDelegateSuperConst M188.QAbstractItemDelegateConst where
