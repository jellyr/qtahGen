...
import {-# SOURCE #-} qualified Graphics.UI.Qtah.Generated.Widgets.QTreeWidget as M316
import Prelude (($), (++), (.), (/=), (=<<), (==))
...
foreign import ccall "genpop__QTreeWidgetItem_newWithStrings" newWithStrings' ::  HoppyF.Ptr M54.QStringListConst -> HoppyP.IO (HoppyF.Ptr QTreeWidgetItem)
foreign import ccall "genpop__QTreeWidgetItem_newWithStringsAndType" newWithStringsAndType' ::  HoppyF.Ptr M54.QStringListConst -> HoppyFC.CInt -> HoppyP.IO (HoppyF.Ptr QTreeWidgetItem)
foreign import ccall "genpop__QTreeWidgetItem_newWithParentTree" newWithParentTree' ::  HoppyF.Ptr M316.QTreeWidget -> HoppyP.IO (HoppyF.Ptr QTreeWidgetItem)
foreign import ccall "genpop__QTreeWidgetItem_newWithParentTreeAndType" newWithParentTreeAndType' ::  HoppyF.Ptr M316.QTreeWidget -> HoppyFC.CInt -> HoppyP.IO (HoppyF.Ptr QTreeWidgetItem)
foreign import ccall "genpop__QTreeWidgetItem_newWithParentTreeAndStrings" newWithParentTreeAndStrings' ::  HoppyF.Ptr M316.QTreeWidget -> HoppyF.Ptr M54.QStringListConst -> HoppyP.IO (HoppyF.Ptr QTreeWidgetItem)
foreign import ccall "genpop__QTreeWidgetItem_newWithParentTreeAndStringsAndType" newWithParentTreeAndStringsAndType' ::  HoppyF.Ptr M316.QTreeWidget -> HoppyF.Ptr M54.QStringListConst -> HoppyFC.CInt -> HoppyP.IO (HoppyF.Ptr QTreeWidgetItem)
...
foreign import ccall "genpop__QTreeWidgetItem_newWithParentItemAndStrings" newWithParentItemAndStrings' ::  HoppyF.Ptr QTreeWidgetItem -> HoppyF.Ptr M54.QStringListConst -> HoppyP.IO (HoppyF.Ptr QTreeWidgetItem)
foreign import ccall "genpop__QTreeWidgetItem_newWithParentItemAndStringsAndType" newWithParentItemAndStringsAndType' ::  HoppyF.Ptr QTreeWidgetItem -> HoppyF.Ptr M54.QStringListConst -> HoppyFC.CInt -> HoppyP.IO (HoppyF.Ptr QTreeWidgetItem)
...
foreign import ccall "genpop__QTreeWidgetItem_getData" getData' ::  HoppyF.Ptr QTreeWidgetItemConst -> HoppyFC.CInt -> HoppyFC.CInt -> HoppyP.IO (HoppyF.Ptr M64.QVariantConst)
...
foreign import ccall "genpop__QTreeWidgetItem_setData" setData' ::  HoppyF.Ptr QTreeWidgetItem -> HoppyFC.CInt -> HoppyFC.CInt -> HoppyF.Ptr M64.QVariantConst -> HoppyP.IO ()
foreign import ccall "genpop__QTreeWidgetItem_setHidden" setHidden' ::  HoppyF.Ptr QTreeWidgetItem -> HoppyFHR.CBool -> HoppyP.IO ()
foreign import ccall "genpop__QTreeWidgetItem_setIcon" setIcon' ::  HoppyF.Ptr QTreeWidgetItem -> HoppyFC.CInt -> HoppyF.Ptr M120.QIconConst -> HoppyP.IO ()
foreign import ccall "genpop__QTreeWidgetItem_setText" setText' ::  HoppyF.Ptr QTreeWidgetItem -> HoppyFC.CInt -> HoppyF.Ptr M52.QStringConst -> HoppyP.IO ()
foreign import ccall "genpop__QTreeWidgetItem_text" text' ::  HoppyF.Ptr QTreeWidgetItemConst -> HoppyFC.CInt -> HoppyP.IO (HoppyF.Ptr M52.QStringConst)
...
getData :: (QTreeWidgetItemValue arg'1) => arg'1 -> HoppyP.Int -> HoppyP.Int -> HoppyP.IO M64.QVariant
...
setData :: (QTreeWidgetItemPtr arg'1, M64.QVariantValue arg'4) => arg'1 -> HoppyP.Int -> HoppyP.Int -> arg'4 -> HoppyP.IO ()
setData arg'1 arg'2 arg'3 arg'4 =
  HoppyFHR.withCppPtr (toQTreeWidgetItem arg'1) $ \arg'1' ->
  let arg'2' = HoppyFHR.coerceIntegral arg'2 in
  let arg'3' = HoppyFHR.coerceIntegral arg'3 in
  M64.withQVariantPtr arg'4 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'4' ->
  (setData' arg'1' arg'2' arg'3' arg'4')
...
setIcon :: (QTreeWidgetItemPtr arg'1, M120.QIconValue arg'3) => arg'1 -> HoppyP.Int -> arg'3 -> HoppyP.IO ()
...
setText :: (QTreeWidgetItemPtr arg'1, M52.QStringValue arg'3) => arg'1 -> HoppyP.Int -> arg'3 -> HoppyP.IO ()
...
newWithStrings :: (M54.QStringListValue arg'1) => arg'1 -> HoppyP.IO QTreeWidgetItem
newWithStrings arg'1 =
  M54.withQStringListPtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
  HoppyP.fmap QTreeWidgetItem
  (newWithStrings' arg'1')

newWithStringsAndType :: (M54.QStringListValue arg'1) => arg'1 -> HoppyP.Int -> HoppyP.IO QTreeWidgetItem
...
newWithParentTree :: (M316.QTreeWidgetPtr arg'1) => arg'1 -> HoppyP.IO QTreeWidgetItem
newWithParentTree arg'1 =
  HoppyFHR.withCppPtr (M316.toQTreeWidget arg'1) $ \arg'1' ->
  HoppyP.fmap QTreeWidgetItem
  (newWithParentTree' arg'1')

newWithParentTreeAndType :: (M316.QTreeWidgetPtr arg'1) => arg'1 -> HoppyP.Int -> HoppyP.IO QTreeWidgetItem
...
newWithParentTreeAndStrings :: (M316.QTreeWidgetPtr arg'1, M54.QStringListValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO QTreeWidgetItem
...
newWithParentTreeAndStringsAndType :: (M316.QTreeWidgetPtr arg'1, M54.QStringListValue arg'2) => arg'1 -> arg'2 -> HoppyP.Int -> HoppyP.IO QTreeWidgetItem
...
newWithParentItemAndStrings :: (QTreeWidgetItemPtr arg'1, M54.QStringListValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO QTreeWidgetItem
...
newWithParentItemAndStringsAndType :: (QTreeWidgetItemPtr arg'1, M54.QStringListValue arg'2) => arg'1 -> arg'2 -> HoppyP.Int -> HoppyP.IO QTreeWidgetItem
