...
foreign import ccall "genpop__QGraphicsSceneEvent_widget" widget' ::  HoppyF.Ptr QGraphicsSceneEventConst -> HoppyP.IO (HoppyF.Ptr M322.QWidget)
...
widget :: (QGraphicsSceneEventValue arg'1) => arg'1 -> HoppyP.IO M322.QWidget
widget arg'1 =
