...
foreign import ccall "genpop__QRubberBand_newWithParent" newWithParent' ::  HoppyFC.CInt -> HoppyF.Ptr M322.QWidget -> HoppyP.IO (HoppyF.Ptr QRubberBand)
foreign import ccall "genpop__QRubberBand_move" move' ::  HoppyF.Ptr QRubberBand -> HoppyF.Ptr M38.QPointConst -> HoppyP.IO ()
foreign import ccall "genpop__QRubberBand_resize" resize' ::  HoppyF.Ptr QRubberBand -> HoppyF.Ptr M48.QSizeConst -> HoppyP.IO ()
foreign import ccall "genpop__QRubberBand_setGeometry" setGeometry' ::  HoppyF.Ptr QRubberBand -> HoppyF.Ptr M42.QRectConst -> HoppyP.IO ()
foreign import ccall "genpop__QRubberBand_shape" shape' ::  HoppyF.Ptr QRubberBandConst -> HoppyP.IO HoppyFC.CInt
foreign import ccall "gencast__QRubberBand__QWidget" castQRubberBandToQWidget :: HoppyF.Ptr QRubberBandConst -> HoppyF.Ptr M322.QWidgetConst
foreign import ccall "gencast__QWidget__QRubberBand" castQWidgetToQRubberBand :: HoppyF.Ptr M322.QWidgetConst -> HoppyF.Ptr QRubberBandConst
...
class (M322.QWidgetConstPtr this) => QRubberBandConstPtr this where
...
class (QRubberBandConstPtr this, M322.QWidgetPtr this) => QRubberBandPtr this where
  toQRubberBand :: this -> QRubberBand

move :: (QRubberBandPtr arg'1, M38.QPointValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO ()
move arg'1 arg'2 =
  HoppyFHR.withCppPtr (toQRubberBand arg'1) $ \arg'1' ->
  M38.withQPointPtr arg'2 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'2' ->
  (move' arg'1' arg'2')

resize :: (QRubberBandPtr arg'1, M48.QSizeValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO ()
resize arg'1 arg'2 =
  HoppyFHR.withCppPtr (toQRubberBand arg'1) $ \arg'1' ->
  M48.withQSizePtr arg'2 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'2' ->
  (resize' arg'1' arg'2')

setGeometry :: (QRubberBandPtr arg'1, M42.QRectValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO ()
...
instance M322.QWidgetConstPtr QRubberBandConst where
  toQWidgetConst (QRubberBandConst ptr') = M322.QWidgetConst $ castQRubberBandToQWidget ptr'
  toQWidgetConst (QRubberBandConstGc fptr' ptr') = M322.QWidgetConstGc fptr' $ castQRubberBandToQWidget ptr'
...
instance M322.QWidgetConstPtr QRubberBand where
  toQWidgetConst (QRubberBand ptr') = M322.QWidgetConst $ castQRubberBandToQWidget $ (HoppyF.castPtr :: HoppyF.Ptr QRubberBand -> HoppyF.Ptr QRubberBandConst) ptr'
  toQWidgetConst (QRubberBandGc fptr' ptr') = M322.QWidgetConstGc fptr' $ castQRubberBandToQWidget $ (HoppyF.castPtr :: HoppyF.Ptr QRubberBand -> HoppyF.Ptr QRubberBandConst) ptr'

instance M322.QWidgetPtr QRubberBand where
  toQWidget (QRubberBand ptr') = M322.QWidget $ (HoppyF.castPtr :: HoppyF.Ptr M322.QWidgetConst -> HoppyF.Ptr M322.QWidget) $ castQRubberBandToQWidget $ (HoppyF.castPtr :: HoppyF.Ptr QRubberBand -> HoppyF.Ptr QRubberBandConst) ptr'
  toQWidget (QRubberBandGc fptr' ptr') = M322.QWidgetGc fptr' $ (HoppyF.castPtr :: HoppyF.Ptr M322.QWidgetConst -> HoppyF.Ptr M322.QWidget) $ castQRubberBandToQWidget $ (HoppyF.castPtr :: HoppyF.Ptr QRubberBand -> HoppyF.Ptr QRubberBandConst) ptr'
...
newWithParent :: (M322.QWidgetPtr arg'2) => QRubberBandShape -> arg'2 -> HoppyP.IO QRubberBand
...
instance QRubberBandSuper M322.QWidget where
  downToQRubberBand = castQRubberBandToNonconst . cast' . M322.castQWidgetToConst
    where
      cast' (M322.QWidgetConst ptr') = QRubberBandConst $ castQWidgetToQRubberBand ptr'
      cast' (M322.QWidgetConstGc fptr' ptr') = QRubberBandConstGc fptr' $ castQWidgetToQRubberBand ptr'
...
instance QRubberBandSuperConst M322.QWidgetConst where
