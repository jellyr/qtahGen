...
foreign import ccall "genpop__QDialogButtonBox_newWithParent" newWithParent' ::  HoppyF.Ptr M322.QWidget -> HoppyP.IO (HoppyF.Ptr QDialogButtonBox)
foreign import ccall "genpop__QDialogButtonBox_addButton" addButton' ::  HoppyF.Ptr QDialogButtonBox -> HoppyF.Ptr M184.QAbstractButton -> HoppyFC.CInt -> HoppyP.IO ()
foreign import ccall "genpop__QDialogButtonBox_addButtonWithText" addButtonWithText' ::  HoppyF.Ptr QDialogButtonBox -> HoppyF.Ptr M52.QStringConst -> HoppyFC.CInt -> HoppyP.IO (HoppyF.Ptr M276.QPushButton)
foreign import ccall "genpop__QDialogButtonBox_addStandardButton" addStandardButton' ::  HoppyF.Ptr QDialogButtonBox -> HoppyFC.CInt -> HoppyP.IO (HoppyF.Ptr M276.QPushButton)
foreign import ccall "genpop__QDialogButtonBox_button" button' ::  HoppyF.Ptr QDialogButtonBoxConst -> HoppyFC.CInt -> HoppyP.IO (HoppyF.Ptr M276.QPushButton)
foreign import ccall "genpop__QDialogButtonBox_buttonRole" buttonRole' ::  HoppyF.Ptr QDialogButtonBoxConst -> HoppyF.Ptr M184.QAbstractButton -> HoppyP.IO HoppyFC.CInt
foreign import ccall "genpop__QDialogButtonBox_buttons" buttons' ::  HoppyF.Ptr QDialogButtonBoxConst -> HoppyP.IO (HoppyF.Ptr M70.QListQAbstractButtonConst)
...
foreign import ccall "genpop__QDialogButtonBox_removeButton" removeButton' ::  HoppyF.Ptr QDialogButtonBox -> HoppyF.Ptr M184.QAbstractButton -> HoppyP.IO ()
foreign import ccall "genpop__QDialogButtonBox_standardButton" standardButton' ::  HoppyF.Ptr QDialogButtonBoxConst -> HoppyF.Ptr M184.QAbstractButton -> HoppyP.IO HoppyFC.CInt
...
foreign import ccall "gencast__QDialogButtonBox__QWidget" castQDialogButtonBoxToQWidget :: HoppyF.Ptr QDialogButtonBoxConst -> HoppyF.Ptr M322.QWidgetConst
foreign import ccall "gencast__QWidget__QDialogButtonBox" castQWidgetToQDialogButtonBox :: HoppyF.Ptr M322.QWidgetConst -> HoppyF.Ptr QDialogButtonBoxConst
...
class (M322.QWidgetConstPtr this) => QDialogButtonBoxConstPtr this where
  toQDialogButtonBoxConst :: this -> QDialogButtonBoxConst

button :: (QDialogButtonBoxValue arg'1) => arg'1 -> QDialogButtonBoxStandardButton -> HoppyP.IO M276.QPushButton
button arg'1 arg'2 =
...
buttonRole :: (QDialogButtonBoxValue arg'1, M184.QAbstractButtonPtr arg'2) => arg'1 -> arg'2 -> HoppyP.IO QDialogButtonBoxButtonRole
...
buttons :: (QDialogButtonBoxValue arg'1) => arg'1 -> HoppyP.IO [M184.QAbstractButton]
buttons arg'1 =
  withQDialogButtonBoxPtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
...
orientation :: (QDialogButtonBoxValue arg'1) => arg'1 -> HoppyP.IO M66.QtOrientation
orientation arg'1 =
  withQDialogButtonBoxPtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
  HoppyP.fmap (HoppyP.toEnum . HoppyFHR.coerceIntegral)
  (orientation' arg'1')

standardButton :: (QDialogButtonBoxValue arg'1, M184.QAbstractButtonPtr arg'2) => arg'1 -> arg'2 -> HoppyP.IO QDialogButtonBoxStandardButton
...
class (QDialogButtonBoxConstPtr this, M322.QWidgetPtr this) => QDialogButtonBoxPtr this where
  toQDialogButtonBox :: this -> QDialogButtonBox

addButton :: (QDialogButtonBoxPtr arg'1, M184.QAbstractButtonPtr arg'2) => arg'1 -> arg'2 -> QDialogButtonBoxButtonRole -> HoppyP.IO ()
...
addButtonWithText :: (QDialogButtonBoxPtr arg'1, M52.QStringValue arg'2) => arg'1 -> arg'2 -> QDialogButtonBoxButtonRole -> HoppyP.IO M276.QPushButton
...
addStandardButton :: (QDialogButtonBoxPtr arg'1) => arg'1 -> QDialogButtonBoxStandardButton -> HoppyP.IO M276.QPushButton
...
setOrientation :: (QDialogButtonBoxPtr arg'1) => arg'1 -> M66.QtOrientation -> HoppyP.IO ()
setOrientation arg'1 arg'2 =
  HoppyFHR.withCppPtr (toQDialogButtonBox arg'1) $ \arg'1' ->
  let arg'2' = HoppyFHR.coerceIntegral $ HoppyP.fromEnum arg'2 in
  (setOrientation' arg'1' arg'2')

removeButton :: (QDialogButtonBoxPtr arg'1, M184.QAbstractButtonPtr arg'2) => arg'1 -> arg'2 -> HoppyP.IO ()
...
instance M322.QWidgetConstPtr QDialogButtonBoxConst where
  toQWidgetConst (QDialogButtonBoxConst ptr') = M322.QWidgetConst $ castQDialogButtonBoxToQWidget ptr'
  toQWidgetConst (QDialogButtonBoxConstGc fptr' ptr') = M322.QWidgetConstGc fptr' $ castQDialogButtonBoxToQWidget ptr'
...
instance M322.QWidgetConstPtr QDialogButtonBox where
  toQWidgetConst (QDialogButtonBox ptr') = M322.QWidgetConst $ castQDialogButtonBoxToQWidget $ (HoppyF.castPtr :: HoppyF.Ptr QDialogButtonBox -> HoppyF.Ptr QDialogButtonBoxConst) ptr'
  toQWidgetConst (QDialogButtonBoxGc fptr' ptr') = M322.QWidgetConstGc fptr' $ castQDialogButtonBoxToQWidget $ (HoppyF.castPtr :: HoppyF.Ptr QDialogButtonBox -> HoppyF.Ptr QDialogButtonBoxConst) ptr'

instance M322.QWidgetPtr QDialogButtonBox where
  toQWidget (QDialogButtonBox ptr') = M322.QWidget $ (HoppyF.castPtr :: HoppyF.Ptr M322.QWidgetConst -> HoppyF.Ptr M322.QWidget) $ castQDialogButtonBoxToQWidget $ (HoppyF.castPtr :: HoppyF.Ptr QDialogButtonBox -> HoppyF.Ptr QDialogButtonBoxConst) ptr'
  toQWidget (QDialogButtonBoxGc fptr' ptr') = M322.QWidgetGc fptr' $ (HoppyF.castPtr :: HoppyF.Ptr M322.QWidgetConst -> HoppyF.Ptr M322.QWidget) $ castQDialogButtonBoxToQWidget $ (HoppyF.castPtr :: HoppyF.Ptr QDialogButtonBox -> HoppyF.Ptr QDialogButtonBoxConst) ptr'
...
newWithParent :: (M322.QWidgetPtr arg'1) => arg'1 -> HoppyP.IO QDialogButtonBox
newWithParent arg'1 =
...
instance QDialogButtonBoxSuper M322.QWidget where
  downToQDialogButtonBox = castQDialogButtonBoxToNonconst . cast' . M322.castQWidgetToConst
    where
      cast' (M322.QWidgetConst ptr') = QDialogButtonBoxConst $ castQWidgetToQDialogButtonBox ptr'
      cast' (M322.QWidgetConstGc fptr' ptr') = QDialogButtonBoxConstGc fptr' $ castQWidgetToQDialogButtonBox ptr'
...
instance QDialogButtonBoxSuperConst M322.QWidgetConst where
