...
foreign import ccall "genpop__QDialog_newWithParent" newWithParent' ::  HoppyF.Ptr M322.QWidget -> HoppyP.IO (HoppyF.Ptr QDialog)
foreign import ccall "genpop__QDialog_newWithParentAndFlags" newWithParentAndFlags' ::  HoppyF.Ptr M322.QWidget -> HoppyFC.CInt -> HoppyP.IO (HoppyF.Ptr QDialog)
...
foreign import ccall "gencast__QDialog__QWidget" castQDialogToQWidget :: HoppyF.Ptr QDialogConst -> HoppyF.Ptr M322.QWidgetConst
foreign import ccall "gencast__QWidget__QDialog" castQWidgetToQDialog :: HoppyF.Ptr M322.QWidgetConst -> HoppyF.Ptr QDialogConst
...
class (M322.QWidgetConstPtr this) => QDialogConstPtr this where
...
class (QDialogConstPtr this, M322.QWidgetPtr this) => QDialogPtr this where
...
instance M322.QWidgetConstPtr QDialogConst where
  toQWidgetConst (QDialogConst ptr') = M322.QWidgetConst $ castQDialogToQWidget ptr'
  toQWidgetConst (QDialogConstGc fptr' ptr') = M322.QWidgetConstGc fptr' $ castQDialogToQWidget ptr'
...
instance M322.QWidgetConstPtr QDialog where
  toQWidgetConst (QDialog ptr') = M322.QWidgetConst $ castQDialogToQWidget $ (HoppyF.castPtr :: HoppyF.Ptr QDialog -> HoppyF.Ptr QDialogConst) ptr'
  toQWidgetConst (QDialogGc fptr' ptr') = M322.QWidgetConstGc fptr' $ castQDialogToQWidget $ (HoppyF.castPtr :: HoppyF.Ptr QDialog -> HoppyF.Ptr QDialogConst) ptr'

instance M322.QWidgetPtr QDialog where
  toQWidget (QDialog ptr') = M322.QWidget $ (HoppyF.castPtr :: HoppyF.Ptr M322.QWidgetConst -> HoppyF.Ptr M322.QWidget) $ castQDialogToQWidget $ (HoppyF.castPtr :: HoppyF.Ptr QDialog -> HoppyF.Ptr QDialogConst) ptr'
  toQWidget (QDialogGc fptr' ptr') = M322.QWidgetGc fptr' $ (HoppyF.castPtr :: HoppyF.Ptr M322.QWidgetConst -> HoppyF.Ptr M322.QWidget) $ castQDialogToQWidget $ (HoppyF.castPtr :: HoppyF.Ptr QDialog -> HoppyF.Ptr QDialogConst) ptr'
...
newWithParent :: (M322.QWidgetPtr arg'1) => arg'1 -> HoppyP.IO QDialog
newWithParent arg'1 =
  HoppyFHR.withCppPtr (M322.toQWidget arg'1) $ \arg'1' ->
  HoppyP.fmap QDialog
  (newWithParent' arg'1')

newWithParentAndFlags :: (M322.QWidgetPtr arg'1, M66.IsQtWindowFlags arg'2) => arg'1 -> arg'2 -> HoppyP.IO QDialog
...
instance QDialogSuper M322.QWidget where
  downToQDialog = castQDialogToNonconst . cast' . M322.castQWidgetToConst
    where
      cast' (M322.QWidgetConst ptr') = QDialogConst $ castQWidgetToQDialog ptr'
      cast' (M322.QWidgetConstGc fptr' ptr') = QDialogConstGc fptr' $ castQWidgetToQDialog ptr'
...
instance QDialogSuperConst M322.QWidgetConst where
