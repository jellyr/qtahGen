...
import qualified Graphics.UI.Qtah.Generated.Gui.QValidator as M168
...
foreign import ccall "genpop__QLineEdit_newWithParent" newWithParent' ::  HoppyF.Ptr M322.QWidget -> HoppyP.IO (HoppyF.Ptr QLineEdit)
foreign import ccall "genpop__QLineEdit_newWithText" newWithText' ::  HoppyF.Ptr M52.QStringConst -> HoppyP.IO (HoppyF.Ptr QLineEdit)
foreign import ccall "genpop__QLineEdit_newWithTextAndParent" newWithTextAndParent' ::  HoppyF.Ptr M52.QStringConst -> HoppyF.Ptr M322.QWidget -> HoppyP.IO (HoppyF.Ptr QLineEdit)
...
foreign import ccall "genpop__QLineEdit_createStandardContextMenu" createStandardContextMenu' ::  HoppyF.Ptr QLineEdit -> HoppyP.IO (HoppyF.Ptr M266.QMenu)
...
foreign import ccall "genpop__QLineEdit_cursorPositionAt" cursorPositionAt' ::  HoppyF.Ptr QLineEdit -> HoppyF.Ptr M38.QPointConst -> HoppyP.IO HoppyFC.CInt
...
foreign import ccall "genpop__QLineEdit_displayText" displayText' ::  HoppyF.Ptr QLineEditConst -> HoppyP.IO (HoppyF.Ptr M52.QStringConst)
...
foreign import ccall "genpop__QLineEdit_inputMask" inputMask' ::  HoppyF.Ptr QLineEditConst -> HoppyP.IO (HoppyF.Ptr M52.QStringConst)
foreign import ccall "genpop__QLineEdit_setInputMask" setInputMask' ::  HoppyF.Ptr QLineEdit -> HoppyF.Ptr M52.QStringConst -> HoppyP.IO ()
foreign import ccall "genpop__QLineEdit_insert" insert' ::  HoppyF.Ptr QLineEdit -> HoppyF.Ptr M52.QStringConst -> HoppyP.IO ()
...
foreign import ccall "genpop__QLineEdit_placeholderText" placeholderText' ::  HoppyF.Ptr QLineEditConst -> HoppyP.IO (HoppyF.Ptr M52.QStringConst)
foreign import ccall "genpop__QLineEdit_setPlaceholderText" setPlaceholderText' ::  HoppyF.Ptr QLineEdit -> HoppyF.Ptr M52.QStringConst -> HoppyP.IO ()
...
foreign import ccall "genpop__QLineEdit_selectedText" selectedText' ::  HoppyF.Ptr QLineEditConst -> HoppyP.IO (HoppyF.Ptr M52.QStringConst)
...
foreign import ccall "genpop__QLineEdit_text" text' ::  HoppyF.Ptr QLineEditConst -> HoppyP.IO (HoppyF.Ptr M52.QStringConst)
foreign import ccall "genpop__QLineEdit_setText" setText' ::  HoppyF.Ptr QLineEdit -> HoppyF.Ptr M52.QStringConst -> HoppyP.IO ()
...
foreign import ccall "genpop__QLineEdit_validator" validator' ::  HoppyF.Ptr QLineEditConst -> HoppyP.IO (HoppyF.Ptr M168.QValidatorConst)
foreign import ccall "genpop__QLineEdit_setValidator" setValidator' ::  HoppyF.Ptr QLineEdit -> HoppyF.Ptr M168.QValidatorConst -> HoppyP.IO ()
foreign import ccall "gencast__QLineEdit__QWidget" castQLineEditToQWidget :: HoppyF.Ptr QLineEditConst -> HoppyF.Ptr M322.QWidgetConst
foreign import ccall "gencast__QWidget__QLineEdit" castQWidgetToQLineEdit :: HoppyF.Ptr M322.QWidgetConst -> HoppyF.Ptr QLineEditConst
...
class (M322.QWidgetConstPtr this) => QLineEditConstPtr this where
  toQLineEditConst :: this -> QLineEditConst

alignment :: (QLineEditValue arg'1) => arg'1 -> HoppyP.IO M66.QtAlignment
alignment arg'1 =
...
cursorMoveStyle :: (QLineEditValue arg'1) => arg'1 -> HoppyP.IO M66.QtCursorMoveStyle
...
validator :: (QLineEditValue arg'1) => arg'1 -> HoppyP.IO M168.QValidatorConst
validator arg'1 =
  withQLineEditPtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
  HoppyP.fmap M168.QValidatorConst
  (validator' arg'1')

class (QLineEditConstPtr this, M322.QWidgetPtr this) => QLineEditPtr this where
  toQLineEdit :: this -> QLineEdit

setAlignment :: (QLineEditPtr arg'1, M66.IsQtAlignment arg'2) => arg'1 -> arg'2 -> HoppyP.IO ()
...
createStandardContextMenu :: (QLineEditPtr arg'1) => arg'1 -> HoppyP.IO M266.QMenu
...
setCursorMoveStyle :: (QLineEditPtr arg'1) => arg'1 -> M66.QtCursorMoveStyle -> HoppyP.IO ()
...
cursorPositionAt :: (QLineEditPtr arg'1, M38.QPointValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO HoppyP.Int
...
setInputMask :: (QLineEditPtr arg'1, M52.QStringValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO ()
setInputMask arg'1 arg'2 =
  HoppyFHR.withCppPtr (toQLineEdit arg'1) $ \arg'1' ->
  M52.withQStringPtr arg'2 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'2' ->
  (setInputMask' arg'1' arg'2')

insert :: (QLineEditPtr arg'1, M52.QStringValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO ()
insert arg'1 arg'2 =
  HoppyFHR.withCppPtr (toQLineEdit arg'1) $ \arg'1' ->
  M52.withQStringPtr arg'2 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'2' ->
  (insert' arg'1' arg'2')
...
setPlaceholderText :: (QLineEditPtr arg'1, M52.QStringValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO ()
...
setText :: (QLineEditPtr arg'1, M52.QStringValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO ()
setText arg'1 arg'2 =
  HoppyFHR.withCppPtr (toQLineEdit arg'1) $ \arg'1' ->
  M52.withQStringPtr arg'2 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'2' ->
  (setText' arg'1' arg'2')
...
setValidator :: (QLineEditPtr arg'1, M168.QValidatorValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO ()
setValidator arg'1 arg'2 =
  HoppyFHR.withCppPtr (toQLineEdit arg'1) $ \arg'1' ->
  M168.withQValidatorPtr arg'2 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'2' ->
  (setValidator' arg'1' arg'2')
...
instance M322.QWidgetConstPtr QLineEditConst where
  toQWidgetConst (QLineEditConst ptr') = M322.QWidgetConst $ castQLineEditToQWidget ptr'
  toQWidgetConst (QLineEditConstGc fptr' ptr') = M322.QWidgetConstGc fptr' $ castQLineEditToQWidget ptr'
...
instance M322.QWidgetConstPtr QLineEdit where
  toQWidgetConst (QLineEdit ptr') = M322.QWidgetConst $ castQLineEditToQWidget $ (HoppyF.castPtr :: HoppyF.Ptr QLineEdit -> HoppyF.Ptr QLineEditConst) ptr'
  toQWidgetConst (QLineEditGc fptr' ptr') = M322.QWidgetConstGc fptr' $ castQLineEditToQWidget $ (HoppyF.castPtr :: HoppyF.Ptr QLineEdit -> HoppyF.Ptr QLineEditConst) ptr'

instance M322.QWidgetPtr QLineEdit where
  toQWidget (QLineEdit ptr') = M322.QWidget $ (HoppyF.castPtr :: HoppyF.Ptr M322.QWidgetConst -> HoppyF.Ptr M322.QWidget) $ castQLineEditToQWidget $ (HoppyF.castPtr :: HoppyF.Ptr QLineEdit -> HoppyF.Ptr QLineEditConst) ptr'
  toQWidget (QLineEditGc fptr' ptr') = M322.QWidgetGc fptr' $ (HoppyF.castPtr :: HoppyF.Ptr M322.QWidgetConst -> HoppyF.Ptr M322.QWidget) $ castQLineEditToQWidget $ (HoppyF.castPtr :: HoppyF.Ptr QLineEdit -> HoppyF.Ptr QLineEditConst) ptr'
...
newWithParent :: (M322.QWidgetPtr arg'1) => arg'1 -> HoppyP.IO QLineEdit
newWithParent arg'1 =
  HoppyFHR.withCppPtr (M322.toQWidget arg'1) $ \arg'1' ->
  HoppyP.fmap QLineEdit
  (newWithParent' arg'1')

newWithText :: (M52.QStringValue arg'1) => arg'1 -> HoppyP.IO QLineEdit
newWithText arg'1 =
  M52.withQStringPtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
  HoppyP.fmap QLineEdit
  (newWithText' arg'1')

newWithTextAndParent :: (M52.QStringValue arg'1, M322.QWidgetPtr arg'2) => arg'1 -> arg'2 -> HoppyP.IO QLineEdit
...
instance QLineEditSuper M322.QWidget where
  downToQLineEdit = castQLineEditToNonconst . cast' . M322.castQWidgetToConst
    where
      cast' (M322.QWidgetConst ptr') = QLineEditConst $ castQWidgetToQLineEdit ptr'
      cast' (M322.QWidgetConstGc fptr' ptr') = QLineEditConstGc fptr' $ castQWidgetToQLineEdit ptr'
...
instance QLineEditSuperConst M322.QWidgetConst where
