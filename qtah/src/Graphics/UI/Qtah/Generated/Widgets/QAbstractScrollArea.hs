...
import {-# SOURCE #-} qualified Graphics.UI.Qtah.Generated.Widgets.QScrollBar as M284
...
foreign import ccall "genpop__QAbstractScrollArea_newWithParent" newWithParent' ::  HoppyF.Ptr M322.QWidget -> HoppyP.IO (HoppyF.Ptr QAbstractScrollArea)
foreign import ccall "genpop__QAbstractScrollArea_addScrollBarWidget" addScrollBarWidget' ::  HoppyF.Ptr QAbstractScrollArea -> HoppyF.Ptr M322.QWidget -> HoppyFC.CInt -> HoppyP.IO ()
foreign import ccall "genpop__QAbstractScrollArea_cornerWidget" cornerWidget' ::  HoppyF.Ptr QAbstractScrollAreaConst -> HoppyP.IO (HoppyF.Ptr M322.QWidget)
foreign import ccall "genpop__QAbstractScrollArea_horizontalScrollBar" horizontalScrollBar' ::  HoppyF.Ptr QAbstractScrollAreaConst -> HoppyP.IO (HoppyF.Ptr M284.QScrollBar)
...
foreign import ccall "genpop__QAbstractScrollArea_maximumViewportSize" maximumViewportSize' ::  HoppyF.Ptr QAbstractScrollAreaConst -> HoppyP.IO (HoppyF.Ptr M48.QSizeConst)
foreign import ccall "genpop__QAbstractScrollArea_setCornerWidget" setCornerWidget' ::  HoppyF.Ptr QAbstractScrollArea -> HoppyF.Ptr M322.QWidget -> HoppyP.IO ()
foreign import ccall "genpop__QAbstractScrollArea_setHorizontalScrollBar" setHorizontalScrollBar' ::  HoppyF.Ptr QAbstractScrollArea -> HoppyF.Ptr M284.QScrollBar -> HoppyP.IO ()
...
foreign import ccall "genpop__QAbstractScrollArea_setVerticalScrollBar" setVerticalScrollBar' ::  HoppyF.Ptr QAbstractScrollArea -> HoppyF.Ptr M284.QScrollBar -> HoppyP.IO ()
...
foreign import ccall "genpop__QAbstractScrollArea_setViewport" setViewport' ::  HoppyF.Ptr QAbstractScrollArea -> HoppyF.Ptr M322.QWidget -> HoppyP.IO ()
foreign import ccall "genpop__QAbstractScrollArea_verticalScrollBar" verticalScrollBar' ::  HoppyF.Ptr QAbstractScrollAreaConst -> HoppyP.IO (HoppyF.Ptr M284.QScrollBar)
...
foreign import ccall "genpop__QAbstractScrollArea_viewport" viewport' ::  HoppyF.Ptr QAbstractScrollAreaConst -> HoppyP.IO (HoppyF.Ptr M322.QWidget)
foreign import ccall "gencast__QAbstractScrollArea__QWidget" castQAbstractScrollAreaToQWidget :: HoppyF.Ptr QAbstractScrollAreaConst -> HoppyF.Ptr M322.QWidgetConst
foreign import ccall "gencast__QWidget__QAbstractScrollArea" castQWidgetToQAbstractScrollArea :: HoppyF.Ptr M322.QWidgetConst -> HoppyF.Ptr QAbstractScrollAreaConst
...
class (M322.QWidgetConstPtr this) => QAbstractScrollAreaConstPtr this where
  toQAbstractScrollAreaConst :: this -> QAbstractScrollAreaConst

cornerWidget :: (QAbstractScrollAreaValue arg'1) => arg'1 -> HoppyP.IO M322.QWidget
cornerWidget arg'1 =
  withQAbstractScrollAreaPtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
  HoppyP.fmap M322.QWidget
  (cornerWidget' arg'1')

horizontalScrollBar :: (QAbstractScrollAreaValue arg'1) => arg'1 -> HoppyP.IO M284.QScrollBar
horizontalScrollBar arg'1 =
  withQAbstractScrollAreaPtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
  HoppyP.fmap M284.QScrollBar
  (horizontalScrollBar' arg'1')

horizontalScrollBarPolicy :: (QAbstractScrollAreaValue arg'1) => arg'1 -> HoppyP.IO M66.QtScrollBarPolicy
...
verticalScrollBar :: (QAbstractScrollAreaValue arg'1) => arg'1 -> HoppyP.IO M284.QScrollBar
verticalScrollBar arg'1 =
  withQAbstractScrollAreaPtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
  HoppyP.fmap M284.QScrollBar
  (verticalScrollBar' arg'1')

verticalScrollBarPolicy :: (QAbstractScrollAreaValue arg'1) => arg'1 -> HoppyP.IO M66.QtScrollBarPolicy
verticalScrollBarPolicy arg'1 =
  withQAbstractScrollAreaPtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
  HoppyP.fmap (HoppyP.toEnum . HoppyFHR.coerceIntegral)
  (verticalScrollBarPolicy' arg'1')

viewport :: (QAbstractScrollAreaValue arg'1) => arg'1 -> HoppyP.IO M322.QWidget
viewport arg'1 =
  withQAbstractScrollAreaPtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
  HoppyP.fmap M322.QWidget
  (viewport' arg'1')

class (QAbstractScrollAreaConstPtr this, M322.QWidgetPtr this) => QAbstractScrollAreaPtr this where
  toQAbstractScrollArea :: this -> QAbstractScrollArea

addScrollBarWidget :: (QAbstractScrollAreaPtr arg'1, M322.QWidgetPtr arg'2, M66.IsQtAlignment arg'3) => arg'1 -> arg'2 -> arg'3 -> HoppyP.IO ()
addScrollBarWidget arg'1 arg'2 arg'3 =
  ...
  let arg'3' = M66.fromQtAlignment $ M66.toQtAlignment arg'3 in
  (addScrollBarWidget' arg'1' arg'2' arg'3')

setCornerWidget :: (QAbstractScrollAreaPtr arg'1, M322.QWidgetPtr arg'2) => arg'1 -> arg'2 -> HoppyP.IO ()
setCornerWidget arg'1 arg'2 =
  HoppyFHR.withCppPtr (toQAbstractScrollArea arg'1) $ \arg'1' ->
  HoppyFHR.withCppPtr (M322.toQWidget arg'2) $ \arg'2' ->
  (setCornerWidget' arg'1' arg'2')

setHorizontalScrollBar :: (QAbstractScrollAreaPtr arg'1, M284.QScrollBarPtr arg'2) => arg'1 -> arg'2 -> HoppyP.IO ()
setHorizontalScrollBar arg'1 arg'2 =
  HoppyFHR.withCppPtr (toQAbstractScrollArea arg'1) $ \arg'1' ->
  HoppyFHR.withCppPtr (M284.toQScrollBar arg'2) $ \arg'2' ->
  (setHorizontalScrollBar' arg'1' arg'2')

setHorizontalScrollBarPolicy :: (QAbstractScrollAreaPtr arg'1) => arg'1 -> M66.QtScrollBarPolicy -> HoppyP.IO ()
setHorizontalScrollBarPolicy arg'1 arg'2 =
  HoppyFHR.withCppPtr (toQAbstractScrollArea arg'1) $ \arg'1' ->
  let arg'2' = HoppyFHR.coerceIntegral $ HoppyP.fromEnum arg'2 in
  (setHorizontalScrollBarPolicy' arg'1' arg'2')

setVerticalScrollBar :: (QAbstractScrollAreaPtr arg'1, M284.QScrollBarPtr arg'2) => arg'1 -> arg'2 -> HoppyP.IO ()
setVerticalScrollBar arg'1 arg'2 =
  HoppyFHR.withCppPtr (toQAbstractScrollArea arg'1) $ \arg'1' ->
  HoppyFHR.withCppPtr (M284.toQScrollBar arg'2) $ \arg'2' ->
  (setVerticalScrollBar' arg'1' arg'2')

setVerticalScrollBarPolicy :: (QAbstractScrollAreaPtr arg'1) => arg'1 -> M66.QtScrollBarPolicy -> HoppyP.IO ()
setVerticalScrollBarPolicy arg'1 arg'2 =
  HoppyFHR.withCppPtr (toQAbstractScrollArea arg'1) $ \arg'1' ->
  let arg'2' = HoppyFHR.coerceIntegral $ HoppyP.fromEnum arg'2 in
  (setVerticalScrollBarPolicy' arg'1' arg'2')

setViewport :: (QAbstractScrollAreaPtr arg'1, M322.QWidgetPtr arg'2) => arg'1 -> arg'2 -> HoppyP.IO ()
...
instance M322.QWidgetConstPtr QAbstractScrollAreaConst where
  toQWidgetConst (QAbstractScrollAreaConst ptr') = M322.QWidgetConst $ castQAbstractScrollAreaToQWidget ptr'
  toQWidgetConst (QAbstractScrollAreaConstGc fptr' ptr') = M322.QWidgetConstGc fptr' $ castQAbstractScrollAreaToQWidget ptr'
...
instance M322.QWidgetConstPtr QAbstractScrollArea where
  toQWidgetConst (QAbstractScrollArea ptr') = M322.QWidgetConst $ castQAbstractScrollAreaToQWidget $ (HoppyF.castPtr :: HoppyF.Ptr QAbstractScrollArea -> HoppyF.Ptr QAbstractScrollAreaConst) ptr'
  toQWidgetConst (QAbstractScrollAreaGc fptr' ptr') = M322.QWidgetConstGc fptr' $ castQAbstractScrollAreaToQWidget $ (HoppyF.castPtr :: HoppyF.Ptr QAbstractScrollArea -> HoppyF.Ptr QAbstractScrollAreaConst) ptr'

instance M322.QWidgetPtr QAbstractScrollArea where
  toQWidget (QAbstractScrollArea ptr') = M322.QWidget $ (HoppyF.castPtr :: HoppyF.Ptr M322.QWidgetConst -> HoppyF.Ptr M322.QWidget) $ castQAbstractScrollAreaToQWidget $ (HoppyF.castPtr :: HoppyF.Ptr QAbstractScrollArea -> HoppyF.Ptr QAbstractScrollAreaConst) ptr'
  toQWidget (QAbstractScrollAreaGc fptr' ptr') = M322.QWidgetGc fptr' $ (HoppyF.castPtr :: HoppyF.Ptr M322.QWidgetConst -> HoppyF.Ptr M322.QWidget) $ castQAbstractScrollAreaToQWidget $ (HoppyF.castPtr :: HoppyF.Ptr QAbstractScrollArea -> HoppyF.Ptr QAbstractScrollAreaConst) ptr'
...
newWithParent :: (M322.QWidgetPtr arg'1) => arg'1 -> HoppyP.IO QAbstractScrollArea
newWithParent arg'1 =
...
instance QAbstractScrollAreaSuper M322.QWidget where
  downToQAbstractScrollArea = castQAbstractScrollAreaToNonconst . cast' . M322.castQWidgetToConst
    where
      cast' (M322.QWidgetConst ptr') = QAbstractScrollAreaConst $ castQWidgetToQAbstractScrollArea ptr'
      cast' (M322.QWidgetConstGc fptr' ptr') = QAbstractScrollAreaConstGc fptr' $ castQWidgetToQAbstractScrollArea ptr'
...
instance QAbstractScrollAreaSuperConst M322.QWidgetConst where
