...
foreign import ccall "genpop__QStackedWidget_newWithParent" newWithParent' ::  HoppyF.Ptr M322.QWidget -> HoppyP.IO (HoppyF.Ptr QStackedWidget)
foreign import ccall "genpop__QStackedWidget_addWidget" addWidget' ::  HoppyF.Ptr QStackedWidget -> HoppyF.Ptr M322.QWidget -> HoppyP.IO HoppyFC.CInt
...
foreign import ccall "genpop__QStackedWidget_currentWidget" currentWidget' ::  HoppyF.Ptr QStackedWidgetConst -> HoppyP.IO (HoppyF.Ptr M322.QWidget)
foreign import ccall "genpop__QStackedWidget_setCurrentWidget" setCurrentWidget' ::  HoppyF.Ptr QStackedWidget -> HoppyF.Ptr M322.QWidget -> HoppyP.IO ()
foreign import ccall "genpop__QStackedWidget_indexOf" indexOf' ::  HoppyF.Ptr QStackedWidgetConst -> HoppyF.Ptr M322.QWidget -> HoppyP.IO HoppyFC.CInt
foreign import ccall "genpop__QStackedWidget_insertWidget" insertWidget' ::  HoppyF.Ptr QStackedWidget -> HoppyFC.CInt -> HoppyF.Ptr M322.QWidget -> HoppyP.IO HoppyFC.CInt
foreign import ccall "genpop__QStackedWidget_removeWidget" removeWidget' ::  HoppyF.Ptr QStackedWidget -> HoppyF.Ptr M322.QWidget -> HoppyP.IO ()
foreign import ccall "genpop__QStackedWidget_widget" widget' ::  HoppyF.Ptr QStackedWidgetConst -> HoppyFC.CInt -> HoppyP.IO (HoppyF.Ptr M322.QWidget)
foreign import ccall "gencast__QStackedWidget__QFrame" castQStackedWidgetToQFrame :: HoppyF.Ptr QStackedWidgetConst -> HoppyF.Ptr M226.QFrameConst
foreign import ccall "gencast__QFrame__QStackedWidget" castQFrameToQStackedWidget :: HoppyF.Ptr M226.QFrameConst -> HoppyF.Ptr QStackedWidgetConst
foreign import ccall "gencast__QStackedWidget__QWidget" castQStackedWidgetToQWidget :: HoppyF.Ptr QStackedWidgetConst -> HoppyF.Ptr M322.QWidgetConst
foreign import ccall "gencast__QWidget__QStackedWidget" castQWidgetToQStackedWidget :: HoppyF.Ptr M322.QWidgetConst -> HoppyF.Ptr QStackedWidgetConst
...
class (M226.QFrameConstPtr this) => QStackedWidgetConstPtr this where
...
currentWidget :: (QStackedWidgetValue arg'1) => arg'1 -> HoppyP.IO M322.QWidget
currentWidget arg'1 =
  withQStackedWidgetPtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
  HoppyP.fmap M322.QWidget
  (currentWidget' arg'1')

indexOf :: (QStackedWidgetValue arg'1, M322.QWidgetPtr arg'2) => arg'1 -> arg'2 -> HoppyP.IO HoppyP.Int
indexOf arg'1 arg'2 =
  withQStackedWidgetPtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
...
widget :: (QStackedWidgetValue arg'1) => arg'1 -> HoppyP.Int -> HoppyP.IO M322.QWidget
widget arg'1 arg'2 =
  withQStackedWidgetPtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
...
class (QStackedWidgetConstPtr this, M226.QFramePtr this) => QStackedWidgetPtr this where
  toQStackedWidget :: this -> QStackedWidget

addWidget :: (QStackedWidgetPtr arg'1, M322.QWidgetPtr arg'2) => arg'1 -> arg'2 -> HoppyP.IO HoppyP.Int
...
setCurrentWidget :: (QStackedWidgetPtr arg'1, M322.QWidgetPtr arg'2) => arg'1 -> arg'2 -> HoppyP.IO ()
setCurrentWidget arg'1 arg'2 =
  HoppyFHR.withCppPtr (toQStackedWidget arg'1) $ \arg'1' ->
  HoppyFHR.withCppPtr (M322.toQWidget arg'2) $ \arg'2' ->
  (setCurrentWidget' arg'1' arg'2')

insertWidget :: (QStackedWidgetPtr arg'1, M322.QWidgetPtr arg'3) => arg'1 -> HoppyP.Int -> arg'3 -> HoppyP.IO HoppyP.Int
...
removeWidget :: (QStackedWidgetPtr arg'1, M322.QWidgetPtr arg'2) => arg'1 -> arg'2 -> HoppyP.IO ()
...
instance M226.QFrameConstPtr QStackedWidgetConst where
  toQFrameConst (QStackedWidgetConst ptr') = M226.QFrameConst $ castQStackedWidgetToQFrame ptr'
  toQFrameConst (QStackedWidgetConstGc fptr' ptr') = M226.QFrameConstGc fptr' $ castQStackedWidgetToQFrame ptr'

instance M322.QWidgetConstPtr QStackedWidgetConst where
  toQWidgetConst (QStackedWidgetConst ptr') = M322.QWidgetConst $ castQStackedWidgetToQWidget ptr'
  toQWidgetConst (QStackedWidgetConstGc fptr' ptr') = M322.QWidgetConstGc fptr' $ castQStackedWidgetToQWidget ptr'
...
instance M226.QFrameConstPtr QStackedWidget where
  toQFrameConst (QStackedWidget ptr') = M226.QFrameConst $ castQStackedWidgetToQFrame $ (HoppyF.castPtr :: HoppyF.Ptr QStackedWidget -> HoppyF.Ptr QStackedWidgetConst) ptr'
  toQFrameConst (QStackedWidgetGc fptr' ptr') = M226.QFrameConstGc fptr' $ castQStackedWidgetToQFrame $ (HoppyF.castPtr :: HoppyF.Ptr QStackedWidget -> HoppyF.Ptr QStackedWidgetConst) ptr'

instance M226.QFramePtr QStackedWidget where
  toQFrame (QStackedWidget ptr') = M226.QFrame $ (HoppyF.castPtr :: HoppyF.Ptr M226.QFrameConst -> HoppyF.Ptr M226.QFrame) $ castQStackedWidgetToQFrame $ (HoppyF.castPtr :: HoppyF.Ptr QStackedWidget -> HoppyF.Ptr QStackedWidgetConst) ptr'
  toQFrame (QStackedWidgetGc fptr' ptr') = M226.QFrameGc fptr' $ (HoppyF.castPtr :: HoppyF.Ptr M226.QFrameConst -> HoppyF.Ptr M226.QFrame) $ castQStackedWidgetToQFrame $ (HoppyF.castPtr :: HoppyF.Ptr QStackedWidget -> HoppyF.Ptr QStackedWidgetConst) ptr'

instance M322.QWidgetConstPtr QStackedWidget where
  toQWidgetConst (QStackedWidget ptr') = M322.QWidgetConst $ castQStackedWidgetToQWidget $ (HoppyF.castPtr :: HoppyF.Ptr QStackedWidget -> HoppyF.Ptr QStackedWidgetConst) ptr'
  toQWidgetConst (QStackedWidgetGc fptr' ptr') = M322.QWidgetConstGc fptr' $ castQStackedWidgetToQWidget $ (HoppyF.castPtr :: HoppyF.Ptr QStackedWidget -> HoppyF.Ptr QStackedWidgetConst) ptr'

instance M322.QWidgetPtr QStackedWidget where
  toQWidget (QStackedWidget ptr') = M322.QWidget $ (HoppyF.castPtr :: HoppyF.Ptr M322.QWidgetConst -> HoppyF.Ptr M322.QWidget) $ castQStackedWidgetToQWidget $ (HoppyF.castPtr :: HoppyF.Ptr QStackedWidget -> HoppyF.Ptr QStackedWidgetConst) ptr'
  toQWidget (QStackedWidgetGc fptr' ptr') = M322.QWidgetGc fptr' $ (HoppyF.castPtr :: HoppyF.Ptr M322.QWidgetConst -> HoppyF.Ptr M322.QWidget) $ castQStackedWidgetToQWidget $ (HoppyF.castPtr :: HoppyF.Ptr QStackedWidget -> HoppyF.Ptr QStackedWidgetConst) ptr'
...
newWithParent :: (M322.QWidgetPtr arg'1) => arg'1 -> HoppyP.IO QStackedWidget
newWithParent arg'1 =
...
instance QStackedWidgetSuper M226.QFrame where
  downToQStackedWidget = castQStackedWidgetToNonconst . cast' . M226.castQFrameToConst
    where
      cast' (M226.QFrameConst ptr') = QStackedWidgetConst $ castQFrameToQStackedWidget ptr'
      cast' (M226.QFrameConstGc fptr' ptr') = QStackedWidgetConstGc fptr' $ castQFrameToQStackedWidget ptr'
instance QStackedWidgetSuper M322.QWidget where
  downToQStackedWidget = castQStackedWidgetToNonconst . cast' . M322.castQWidgetToConst
    where
      cast' (M322.QWidgetConst ptr') = QStackedWidgetConst $ castQWidgetToQStackedWidget ptr'
      cast' (M322.QWidgetConstGc fptr' ptr') = QStackedWidgetConstGc fptr' $ castQWidgetToQStackedWidget ptr'
...
instance QStackedWidgetSuperConst M226.QFrameConst where
  downToQStackedWidgetConst = cast'
    where
      cast' (M226.QFrameConst ptr') = QStackedWidgetConst $ castQFrameToQStackedWidget ptr'
      cast' (M226.QFrameConstGc fptr' ptr') = QStackedWidgetConstGc fptr' $ castQFrameToQStackedWidget ptr'
instance QStackedWidgetSuperConst M322.QWidgetConst where
  downToQStackedWidgetConst = cast'
    where
      cast' (M322.QWidgetConst ptr') = QStackedWidgetConst $ castQWidgetToQStackedWidget ptr'
      cast' (M322.QWidgetConstGc fptr' ptr') = QStackedWidgetConstGc fptr' $ castQWidgetToQStackedWidget ptr'
