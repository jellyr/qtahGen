...
foreign import ccall "genpop__QAbstractSlider_newWithParent" newWithParent' ::  HoppyF.Ptr M322.QWidget -> HoppyP.IO (HoppyF.Ptr QAbstractSlider)
...
foreign import ccall "gencast__QAbstractSlider__QWidget" castQAbstractSliderToQWidget :: HoppyF.Ptr QAbstractSliderConst -> HoppyF.Ptr M322.QWidgetConst
foreign import ccall "gencast__QWidget__QAbstractSlider" castQWidgetToQAbstractSlider :: HoppyF.Ptr M322.QWidgetConst -> HoppyF.Ptr QAbstractSliderConst
...
class (M322.QWidgetConstPtr this) => QAbstractSliderConstPtr this where
...
orientation :: (QAbstractSliderValue arg'1) => arg'1 -> HoppyP.IO M66.QtOrientation
orientation arg'1 =
  withQAbstractSliderPtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
...
class (QAbstractSliderConstPtr this, M322.QWidgetPtr this) => QAbstractSliderPtr this where
...
setOrientation :: (QAbstractSliderPtr arg'1) => arg'1 -> M66.QtOrientation -> HoppyP.IO ()
...
instance M322.QWidgetConstPtr QAbstractSliderConst where
  toQWidgetConst (QAbstractSliderConst ptr') = M322.QWidgetConst $ castQAbstractSliderToQWidget ptr'
  toQWidgetConst (QAbstractSliderConstGc fptr' ptr') = M322.QWidgetConstGc fptr' $ castQAbstractSliderToQWidget ptr'
...
instance M322.QWidgetConstPtr QAbstractSlider where
  toQWidgetConst (QAbstractSlider ptr') = M322.QWidgetConst $ castQAbstractSliderToQWidget $ (HoppyF.castPtr :: HoppyF.Ptr QAbstractSlider -> HoppyF.Ptr QAbstractSliderConst) ptr'
  toQWidgetConst (QAbstractSliderGc fptr' ptr') = M322.QWidgetConstGc fptr' $ castQAbstractSliderToQWidget $ (HoppyF.castPtr :: HoppyF.Ptr QAbstractSlider -> HoppyF.Ptr QAbstractSliderConst) ptr'

instance M322.QWidgetPtr QAbstractSlider where
  toQWidget (QAbstractSlider ptr') = M322.QWidget $ (HoppyF.castPtr :: HoppyF.Ptr M322.QWidgetConst -> HoppyF.Ptr M322.QWidget) $ castQAbstractSliderToQWidget $ (HoppyF.castPtr :: HoppyF.Ptr QAbstractSlider -> HoppyF.Ptr QAbstractSliderConst) ptr'
  toQWidget (QAbstractSliderGc fptr' ptr') = M322.QWidgetGc fptr' $ (HoppyF.castPtr :: HoppyF.Ptr M322.QWidgetConst -> HoppyF.Ptr M322.QWidget) $ castQAbstractSliderToQWidget $ (HoppyF.castPtr :: HoppyF.Ptr QAbstractSlider -> HoppyF.Ptr QAbstractSliderConst) ptr'
...
newWithParent :: (M322.QWidgetPtr arg'1) => arg'1 -> HoppyP.IO QAbstractSlider
newWithParent arg'1 =
...
instance QAbstractSliderSuper M322.QWidget where
  downToQAbstractSlider = castQAbstractSliderToNonconst . cast' . M322.castQWidgetToConst
    where
      cast' (M322.QWidgetConst ptr') = QAbstractSliderConst $ castQWidgetToQAbstractSlider ptr'
      cast' (M322.QWidgetConstGc fptr' ptr') = QAbstractSliderConstGc fptr' $ castQWidgetToQAbstractSlider ptr'
...
instance QAbstractSliderSuperConst M322.QWidgetConst where
