...
foreign import ccall "genpop__QScrollArea_newWithParent" newWithParent' ::  HoppyF.Ptr M322.QWidget -> HoppyP.IO (HoppyF.Ptr QScrollArea)
...
foreign import ccall "genpop__QScrollArea_ensureWidgetVisible" ensureWidgetVisible' ::  HoppyF.Ptr QScrollArea -> HoppyF.Ptr M322.QWidget -> HoppyP.IO ()
foreign import ccall "genpop__QScrollArea_ensureWidgetVisibleWithMargins" ensureWidgetVisibleWithMargins' ::  HoppyF.Ptr QScrollArea -> HoppyF.Ptr M322.QWidget -> HoppyFC.CInt -> HoppyFC.CInt -> HoppyP.IO ()
foreign import ccall "genpop__QScrollArea_takeWidget" takeWidget' ::  HoppyF.Ptr QScrollArea -> HoppyP.IO (HoppyF.Ptr M322.QWidget)
foreign import ccall "genpop__QScrollArea_widget" widget' ::  HoppyF.Ptr QScrollAreaConst -> HoppyP.IO (HoppyF.Ptr M322.QWidget)
foreign import ccall "genpop__QScrollArea_setWidget" setWidget' ::  HoppyF.Ptr QScrollArea -> HoppyF.Ptr M322.QWidget -> HoppyP.IO ()
...
foreign import ccall "gencast__QScrollArea__QAbstractScrollArea" castQScrollAreaToQAbstractScrollArea :: HoppyF.Ptr QScrollAreaConst -> HoppyF.Ptr M192.QAbstractScrollAreaConst
foreign import ccall "gencast__QAbstractScrollArea__QScrollArea" castQAbstractScrollAreaToQScrollArea :: HoppyF.Ptr M192.QAbstractScrollAreaConst -> HoppyF.Ptr QScrollAreaConst
foreign import ccall "gencast__QScrollArea__QWidget" castQScrollAreaToQWidget :: HoppyF.Ptr QScrollAreaConst -> HoppyF.Ptr M322.QWidgetConst
foreign import ccall "gencast__QWidget__QScrollArea" castQWidgetToQScrollArea :: HoppyF.Ptr M322.QWidgetConst -> HoppyF.Ptr QScrollAreaConst
...
class (M192.QAbstractScrollAreaConstPtr this) => QScrollAreaConstPtr this where
  toQScrollAreaConst :: this -> QScrollAreaConst

alignment :: (QScrollAreaValue arg'1) => arg'1 -> HoppyP.IO M66.QtAlignment
alignment arg'1 =
  withQScrollAreaPtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
  HoppyP.fmap M66.QtAlignment
  (alignment' arg'1')

widget :: (QScrollAreaValue arg'1) => arg'1 -> HoppyP.IO M322.QWidget
widget arg'1 =
  withQScrollAreaPtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
...
class (QScrollAreaConstPtr this, M192.QAbstractScrollAreaPtr this) => QScrollAreaPtr this where
  toQScrollArea :: this -> QScrollArea

setAlignment :: (QScrollAreaPtr arg'1, M66.IsQtAlignment arg'2) => arg'1 -> arg'2 -> HoppyP.IO ()
...
ensureWidgetVisible :: (QScrollAreaPtr arg'1, M322.QWidgetPtr arg'2) => arg'1 -> arg'2 -> HoppyP.IO ()
ensureWidgetVisible arg'1 arg'2 =
  HoppyFHR.withCppPtr (toQScrollArea arg'1) $ \arg'1' ->
  HoppyFHR.withCppPtr (M322.toQWidget arg'2) $ \arg'2' ->
  (ensureWidgetVisible' arg'1' arg'2')

ensureWidgetVisibleWithMargins :: (QScrollAreaPtr arg'1, M322.QWidgetPtr arg'2) => arg'1 -> arg'2 -> HoppyP.Int -> HoppyP.Int -> HoppyP.IO ()
...
takeWidget :: (QScrollAreaPtr arg'1) => arg'1 -> HoppyP.IO M322.QWidget
takeWidget arg'1 =
  HoppyFHR.withCppPtr (toQScrollArea arg'1) $ \arg'1' ->
  HoppyP.fmap M322.QWidget
  (takeWidget' arg'1')

setWidget :: (QScrollAreaPtr arg'1, M322.QWidgetPtr arg'2) => arg'1 -> arg'2 -> HoppyP.IO ()
...
instance M192.QAbstractScrollAreaConstPtr QScrollAreaConst where
  toQAbstractScrollAreaConst (QScrollAreaConst ptr') = M192.QAbstractScrollAreaConst $ castQScrollAreaToQAbstractScrollArea ptr'
  toQAbstractScrollAreaConst (QScrollAreaConstGc fptr' ptr') = M192.QAbstractScrollAreaConstGc fptr' $ castQScrollAreaToQAbstractScrollArea ptr'

instance M322.QWidgetConstPtr QScrollAreaConst where
  toQWidgetConst (QScrollAreaConst ptr') = M322.QWidgetConst $ castQScrollAreaToQWidget ptr'
  toQWidgetConst (QScrollAreaConstGc fptr' ptr') = M322.QWidgetConstGc fptr' $ castQScrollAreaToQWidget ptr'
...
instance M192.QAbstractScrollAreaConstPtr QScrollArea where
  toQAbstractScrollAreaConst (QScrollArea ptr') = M192.QAbstractScrollAreaConst $ castQScrollAreaToQAbstractScrollArea $ (HoppyF.castPtr :: HoppyF.Ptr QScrollArea -> HoppyF.Ptr QScrollAreaConst) ptr'
  toQAbstractScrollAreaConst (QScrollAreaGc fptr' ptr') = M192.QAbstractScrollAreaConstGc fptr' $ castQScrollAreaToQAbstractScrollArea $ (HoppyF.castPtr :: HoppyF.Ptr QScrollArea -> HoppyF.Ptr QScrollAreaConst) ptr'

instance M192.QAbstractScrollAreaPtr QScrollArea where
  toQAbstractScrollArea (QScrollArea ptr') = M192.QAbstractScrollArea $ (HoppyF.castPtr :: HoppyF.Ptr M192.QAbstractScrollAreaConst -> HoppyF.Ptr M192.QAbstractScrollArea) $ castQScrollAreaToQAbstractScrollArea $ (HoppyF.castPtr :: HoppyF.Ptr QScrollArea -> HoppyF.Ptr QScrollAreaConst) ptr'
  toQAbstractScrollArea (QScrollAreaGc fptr' ptr') = M192.QAbstractScrollAreaGc fptr' $ (HoppyF.castPtr :: HoppyF.Ptr M192.QAbstractScrollAreaConst -> HoppyF.Ptr M192.QAbstractScrollArea) $ castQScrollAreaToQAbstractScrollArea $ (HoppyF.castPtr :: HoppyF.Ptr QScrollArea -> HoppyF.Ptr QScrollAreaConst) ptr'

instance M322.QWidgetConstPtr QScrollArea where
  toQWidgetConst (QScrollArea ptr') = M322.QWidgetConst $ castQScrollAreaToQWidget $ (HoppyF.castPtr :: HoppyF.Ptr QScrollArea -> HoppyF.Ptr QScrollAreaConst) ptr'
  toQWidgetConst (QScrollAreaGc fptr' ptr') = M322.QWidgetConstGc fptr' $ castQScrollAreaToQWidget $ (HoppyF.castPtr :: HoppyF.Ptr QScrollArea -> HoppyF.Ptr QScrollAreaConst) ptr'

instance M322.QWidgetPtr QScrollArea where
  toQWidget (QScrollArea ptr') = M322.QWidget $ (HoppyF.castPtr :: HoppyF.Ptr M322.QWidgetConst -> HoppyF.Ptr M322.QWidget) $ castQScrollAreaToQWidget $ (HoppyF.castPtr :: HoppyF.Ptr QScrollArea -> HoppyF.Ptr QScrollAreaConst) ptr'
  toQWidget (QScrollAreaGc fptr' ptr') = M322.QWidgetGc fptr' $ (HoppyF.castPtr :: HoppyF.Ptr M322.QWidgetConst -> HoppyF.Ptr M322.QWidget) $ castQScrollAreaToQWidget $ (HoppyF.castPtr :: HoppyF.Ptr QScrollArea -> HoppyF.Ptr QScrollAreaConst) ptr'
...
newWithParent :: (M322.QWidgetPtr arg'1) => arg'1 -> HoppyP.IO QScrollArea
newWithParent arg'1 =
...
instance QScrollAreaSuper M192.QAbstractScrollArea where
  downToQScrollArea = castQScrollAreaToNonconst . cast' . M192.castQAbstractScrollAreaToConst
    where
      cast' (M192.QAbstractScrollAreaConst ptr') = QScrollAreaConst $ castQAbstractScrollAreaToQScrollArea ptr'
      cast' (M192.QAbstractScrollAreaConstGc fptr' ptr') = QScrollAreaConstGc fptr' $ castQAbstractScrollAreaToQScrollArea ptr'
instance QScrollAreaSuper M322.QWidget where
  downToQScrollArea = castQScrollAreaToNonconst . cast' . M322.castQWidgetToConst
    where
      cast' (M322.QWidgetConst ptr') = QScrollAreaConst $ castQWidgetToQScrollArea ptr'
      cast' (M322.QWidgetConstGc fptr' ptr') = QScrollAreaConstGc fptr' $ castQWidgetToQScrollArea ptr'
...
instance QScrollAreaSuperConst M192.QAbstractScrollAreaConst where
  downToQScrollAreaConst = cast'
    where
      cast' (M192.QAbstractScrollAreaConst ptr') = QScrollAreaConst $ castQAbstractScrollAreaToQScrollArea ptr'
      cast' (M192.QAbstractScrollAreaConstGc fptr' ptr') = QScrollAreaConstGc fptr' $ castQAbstractScrollAreaToQScrollArea ptr'
instance QScrollAreaSuperConst M322.QWidgetConst where
  downToQScrollAreaConst = cast'
    where
      cast' (M322.QWidgetConst ptr') = QScrollAreaConst $ castQWidgetToQScrollArea ptr'
      cast' (M322.QWidgetConstGc fptr' ptr') = QScrollAreaConstGc fptr' $ castQWidgetToQScrollArea ptr'
