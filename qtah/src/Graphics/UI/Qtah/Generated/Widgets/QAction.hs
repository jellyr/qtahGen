...
import {-# SOURCE #-} qualified Graphics.UI.Qtah.Generated.Widgets.QActionGroup as M200
import {-# SOURCE #-} qualified Graphics.UI.Qtah.Generated.Widgets.QMenu as M266
...
foreign import ccall "genpop__QAction_newWithText" newWithText' ::  HoppyF.Ptr M52.QStringConst -> HoppyP.IO (HoppyF.Ptr QAction)
foreign import ccall "genpop__QAction_newWithTextAndParent" newWithTextAndParent' ::  HoppyF.Ptr M52.QStringConst -> HoppyF.Ptr M34.QObject -> HoppyP.IO (HoppyF.Ptr QAction)
foreign import ccall "genpop__QAction_newWithIconAndText" newWithIconAndText' ::  HoppyF.Ptr M120.QIconConst -> HoppyF.Ptr M52.QStringConst -> HoppyP.IO (HoppyF.Ptr QAction)
foreign import ccall "genpop__QAction_newWithIconAndTextAndParent" newWithIconAndTextAndParent' ::  HoppyF.Ptr M120.QIconConst -> HoppyF.Ptr M52.QStringConst -> HoppyF.Ptr M34.QObject -> HoppyP.IO (HoppyF.Ptr QAction)
foreign import ccall "genpop__QAction_actionGroup" actionGroup' ::  HoppyF.Ptr QActionConst -> HoppyP.IO (HoppyF.Ptr M200.QActionGroup)
foreign import ccall "genpop__QAction_setActionGroup" setActionGroup' ::  HoppyF.Ptr QAction -> HoppyF.Ptr M200.QActionGroup -> HoppyP.IO ()
...
foreign import ccall "genpop__QAction_font" font' ::  HoppyF.Ptr QActionConst -> HoppyP.IO (HoppyF.Ptr M114.QFontConst)
foreign import ccall "genpop__QAction_setFont" setFont' ::  HoppyF.Ptr QAction -> HoppyF.Ptr M114.QFontConst -> HoppyP.IO ()
foreign import ccall "genpop__QAction_hover" hover' ::  HoppyF.Ptr QAction -> HoppyP.IO ()
foreign import ccall "genpop__QAction_icon" icon' ::  HoppyF.Ptr QActionConst -> HoppyP.IO (HoppyF.Ptr M120.QIconConst)
foreign import ccall "genpop__QAction_setIcon" setIcon' ::  HoppyF.Ptr QAction -> HoppyF.Ptr M120.QIconConst -> HoppyP.IO ()
foreign import ccall "genpop__QAction_iconText" iconText' ::  HoppyF.Ptr QActionConst -> HoppyP.IO (HoppyF.Ptr M52.QStringConst)
foreign import ccall "genpop__QAction_setIconText" setIconText' ::  HoppyF.Ptr QAction -> HoppyF.Ptr M52.QStringConst -> HoppyP.IO ()
...
foreign import ccall "genpop__QAction_menu" menu' ::  HoppyF.Ptr QActionConst -> HoppyP.IO (HoppyF.Ptr M266.QMenu)
foreign import ccall "genpop__QAction_setMenu" setMenu' ::  HoppyF.Ptr QAction -> HoppyF.Ptr M266.QMenu -> HoppyP.IO ()
...
foreign import ccall "genpop__QAction_parentWidget" parentWidget' ::  HoppyF.Ptr QActionConst -> HoppyP.IO (HoppyF.Ptr M322.QWidget)
...
foreign import ccall "genpop__QAction_showStatusText" showStatusText' ::  HoppyF.Ptr QAction -> HoppyF.Ptr M322.QWidget -> HoppyP.IO HoppyFHR.CBool
foreign import ccall "genpop__QAction_statusTip" statusTip' ::  HoppyF.Ptr QActionConst -> HoppyP.IO (HoppyF.Ptr M52.QStringConst)
foreign import ccall "genpop__QAction_setStatusTip" setStatusTip' ::  HoppyF.Ptr QAction -> HoppyF.Ptr M52.QStringConst -> HoppyP.IO ()
foreign import ccall "genpop__QAction_text" text' ::  HoppyF.Ptr QActionConst -> HoppyP.IO (HoppyF.Ptr M52.QStringConst)
foreign import ccall "genpop__QAction_setText" setText' ::  HoppyF.Ptr QAction -> HoppyF.Ptr M52.QStringConst -> HoppyP.IO ()
foreign import ccall "genpop__QAction_toggle" toggle' ::  HoppyF.Ptr QAction -> HoppyP.IO ()
foreign import ccall "genpop__QAction_toolTip" toolTip' ::  HoppyF.Ptr QActionConst -> HoppyP.IO (HoppyF.Ptr M52.QStringConst)
foreign import ccall "genpop__QAction_setToolTip" setToolTip' ::  HoppyF.Ptr QAction -> HoppyF.Ptr M52.QStringConst -> HoppyP.IO ()
...
foreign import ccall "genpop__QAction_whatsThis" whatsThis' ::  HoppyF.Ptr QActionConst -> HoppyP.IO (HoppyF.Ptr M52.QStringConst)
foreign import ccall "genpop__QAction_setWhatsThis" setWhatsThis' ::  HoppyF.Ptr QAction -> HoppyF.Ptr M52.QStringConst -> HoppyP.IO ()
...
actionGroup :: (QActionValue arg'1) => arg'1 -> HoppyP.IO M200.QActionGroup
actionGroup arg'1 =
  withQActionPtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
  HoppyP.fmap M200.QActionGroup
  (actionGroup' arg'1')
...
font :: (QActionValue arg'1) => arg'1 -> HoppyP.IO M114.QFont
font arg'1 =
  withQActionPtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
  (HoppyFHR.decodeAndDelete . M114.QFontConst) =<<
  (font' arg'1')

icon :: (QActionValue arg'1) => arg'1 -> HoppyP.IO M120.QIcon
icon arg'1 =
  withQActionPtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
...
menu :: (QActionValue arg'1) => arg'1 -> HoppyP.IO M266.QMenu
menu arg'1 =
  withQActionPtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
...
parentWidget :: (QActionValue arg'1) => arg'1 -> HoppyP.IO M322.QWidget
parentWidget arg'1 =
  withQActionPtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
...
setActionGroup :: (QActionPtr arg'1, M200.QActionGroupPtr arg'2) => arg'1 -> arg'2 -> HoppyP.IO ()
setActionGroup arg'1 arg'2 =
  HoppyFHR.withCppPtr (toQAction arg'1) $ \arg'1' ->
  HoppyFHR.withCppPtr (M200.toQActionGroup arg'2) $ \arg'2' ->
  (setActionGroup' arg'1' arg'2')
...
setFont :: (QActionPtr arg'1, M114.QFontValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO ()
setFont arg'1 arg'2 =
  HoppyFHR.withCppPtr (toQAction arg'1) $ \arg'1' ->
...
setIcon :: (QActionPtr arg'1, M120.QIconValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO ()
setIcon arg'1 arg'2 =
  HoppyFHR.withCppPtr (toQAction arg'1) $ \arg'1' ->
  M120.withQIconPtr arg'2 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'2' ->
  (setIcon' arg'1' arg'2')

setIconText :: (QActionPtr arg'1, M52.QStringValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO ()
...
setMenu :: (QActionPtr arg'1, M266.QMenuPtr arg'2) => arg'1 -> arg'2 -> HoppyP.IO ()
setMenu arg'1 arg'2 =
  HoppyFHR.withCppPtr (toQAction arg'1) $ \arg'1' ->
...
showStatusText :: (QActionPtr arg'1, M322.QWidgetPtr arg'2) => arg'1 -> arg'2 -> HoppyP.IO HoppyP.Bool
...
setStatusTip :: (QActionPtr arg'1, M52.QStringValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO ()
setStatusTip arg'1 arg'2 =
  HoppyFHR.withCppPtr (toQAction arg'1) $ \arg'1' ->
  M52.withQStringPtr arg'2 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'2' ->
  (setStatusTip' arg'1' arg'2')

setText :: (QActionPtr arg'1, M52.QStringValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO ()
setText arg'1 arg'2 =
  HoppyFHR.withCppPtr (toQAction arg'1) $ \arg'1' ->
  M52.withQStringPtr arg'2 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'2' ->
  (setText' arg'1' arg'2')
...
setToolTip :: (QActionPtr arg'1, M52.QStringValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO ()
...
setWhatsThis :: (QActionPtr arg'1, M52.QStringValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO ()
...
newWithText :: (M52.QStringValue arg'1) => arg'1 -> HoppyP.IO QAction
newWithText arg'1 =
  M52.withQStringPtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
  HoppyP.fmap QAction
  (newWithText' arg'1')

newWithTextAndParent :: (M52.QStringValue arg'1, M34.QObjectPtr arg'2) => arg'1 -> arg'2 -> HoppyP.IO QAction
...
newWithIconAndText :: (M120.QIconValue arg'1, M52.QStringValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO QAction
...
newWithIconAndTextAndParent :: (M120.QIconValue arg'1, M52.QStringValue arg'2, M34.QObjectPtr arg'3) => arg'1 -> arg'2 -> arg'3 -> HoppyP.IO QAction
