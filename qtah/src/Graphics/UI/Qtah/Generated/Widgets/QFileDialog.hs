...
foreign import ccall "genpop__QFileDialog_newWithParent" newWithParent' ::  HoppyF.Ptr M322.QWidget -> HoppyP.IO (HoppyF.Ptr QFileDialog)
foreign import ccall "genpop__QFileDialog_newWithParentAndFlags" newWithParentAndFlags' ::  HoppyF.Ptr M322.QWidget -> HoppyFC.CInt -> HoppyP.IO (HoppyF.Ptr QFileDialog)
foreign import ccall "genpop__QFileDialog_newWithParentAndCaption" newWithParentAndCaption' ::  HoppyF.Ptr M322.QWidget -> HoppyF.Ptr M52.QStringConst -> HoppyP.IO (HoppyF.Ptr QFileDialog)
foreign import ccall "genpop__QFileDialog_newWithParentAndCaptionAndDirectory" newWithParentAndCaptionAndDirectory' ::  HoppyF.Ptr M322.QWidget -> HoppyF.Ptr M52.QStringConst -> HoppyF.Ptr M52.QStringConst -> HoppyP.IO (HoppyF.Ptr QFileDialog)
foreign import ccall "genpop__QFileDialog_newWithParentAndCaptionAndDirectoryAndFilter" newWithParentAndCaptionAndDirectoryAndFilter' ::  HoppyF.Ptr M322.QWidget -> HoppyF.Ptr M52.QStringConst -> HoppyF.Ptr M52.QStringConst -> HoppyF.Ptr M52.QStringConst -> HoppyP.IO (HoppyF.Ptr QFileDialog)
...
foreign import ccall "genpop__QFileDialog_defaultSuffix" defaultSuffix' ::  HoppyF.Ptr QFileDialogConst -> HoppyP.IO (HoppyF.Ptr M52.QStringConst)
foreign import ccall "genpop__QFileDialog_setDefaultSuffix" setDefaultSuffix' ::  HoppyF.Ptr QFileDialog -> HoppyF.Ptr M52.QStringConst -> HoppyP.IO ()
...
foreign import ccall "genpop__QFileDialog_getExistingDirectory" getExistingDirectory' ::  HoppyF.Ptr M322.QWidget -> HoppyF.Ptr M52.QStringConst -> HoppyF.Ptr M52.QStringConst -> HoppyP.IO (HoppyF.Ptr M52.QStringConst)
foreign import ccall "genpop__QFileDialog_getExistingDirectoryWithOptions" getExistingDirectoryWithOptions' ::  HoppyF.Ptr M322.QWidget -> HoppyF.Ptr M52.QStringConst -> HoppyF.Ptr M52.QStringConst -> HoppyFC.CInt -> HoppyP.IO (HoppyF.Ptr M52.QStringConst)
foreign import ccall "genpop__QFileDialog_getOpenFileName" getOpenFileName' ::  HoppyF.Ptr M322.QWidget -> HoppyF.Ptr M52.QStringConst -> HoppyF.Ptr M52.QStringConst -> HoppyF.Ptr M52.QStringConst -> HoppyP.IO (HoppyF.Ptr M52.QStringConst)
foreign import ccall "genpop__QFileDialog_getOpenFileNameWithOptions" getOpenFileNameWithOptions' ::  HoppyF.Ptr M322.QWidget -> HoppyF.Ptr M52.QStringConst -> HoppyF.Ptr M52.QStringConst -> HoppyF.Ptr M52.QStringConst -> HoppyF.Ptr M52.QString -> HoppyFC.CInt -> HoppyP.IO (HoppyF.Ptr M52.QStringConst)
foreign import ccall "genpop__QFileDialog_getOpenFileNames" getOpenFileNames' ::  HoppyF.Ptr M322.QWidget -> HoppyF.Ptr M52.QStringConst -> HoppyF.Ptr M52.QStringConst -> HoppyF.Ptr M52.QStringConst -> HoppyP.IO (HoppyF.Ptr M54.QStringListConst)
foreign import ccall "genpop__QFileDialog_getOpenFileNamesWithOptions" getOpenFileNamesWithOptions' ::  HoppyF.Ptr M322.QWidget -> HoppyF.Ptr M52.QStringConst -> HoppyF.Ptr M52.QStringConst -> HoppyF.Ptr M52.QStringConst -> HoppyF.Ptr M52.QString -> HoppyFC.CInt -> HoppyP.IO (HoppyF.Ptr M54.QStringListConst)
foreign import ccall "genpop__QFileDialog_getSaveFileName" getSaveFileName' ::  HoppyF.Ptr M322.QWidget -> HoppyF.Ptr M52.QStringConst -> HoppyF.Ptr M52.QStringConst -> HoppyF.Ptr M52.QStringConst -> HoppyP.IO (HoppyF.Ptr M52.QStringConst)
foreign import ccall "genpop__QFileDialog_getSaveFileNameWithOptions" getSaveFileNameWithOptions' ::  HoppyF.Ptr M322.QWidget -> HoppyF.Ptr M52.QStringConst -> HoppyF.Ptr M52.QStringConst -> HoppyF.Ptr M52.QStringConst -> HoppyF.Ptr M52.QString -> HoppyFC.CInt -> HoppyP.IO (HoppyF.Ptr M52.QStringConst)
foreign import ccall "genpop__QFileDialog_history" history' ::  HoppyF.Ptr QFileDialogConst -> HoppyP.IO (HoppyF.Ptr M54.QStringListConst)
foreign import ccall "genpop__QFileDialog_setHistory" setHistory' ::  HoppyF.Ptr QFileDialog -> HoppyF.Ptr M54.QStringListConst -> HoppyP.IO ()
foreign import ccall "genpop__QFileDialog_labelText" labelText' ::  HoppyF.Ptr QFileDialogConst -> HoppyFC.CInt -> HoppyP.IO (HoppyF.Ptr M52.QStringConst)
foreign import ccall "genpop__QFileDialog_mimeTypeFilters" mimeTypeFilters' ::  HoppyF.Ptr QFileDialogConst -> HoppyP.IO (HoppyF.Ptr M54.QStringListConst)
foreign import ccall "genpop__QFileDialog_setMimeTypeFilters" setMimeTypeFilters' ::  HoppyF.Ptr QFileDialog -> HoppyF.Ptr M54.QStringListConst -> HoppyP.IO ()
foreign import ccall "genpop__QFileDialog_nameFilters" nameFilters' ::  HoppyF.Ptr QFileDialogConst -> HoppyP.IO (HoppyF.Ptr M54.QStringListConst)
foreign import ccall "genpop__QFileDialog_setNameFilters" setNameFilters' ::  HoppyF.Ptr QFileDialog -> HoppyF.Ptr M54.QStringListConst -> HoppyP.IO ()
...
foreign import ccall "genpop__QFileDialog_selectFile" selectFile' ::  HoppyF.Ptr QFileDialog -> HoppyF.Ptr M52.QStringConst -> HoppyP.IO ()
foreign import ccall "genpop__QFileDialog_selectNameFilter" selectNameFilter' ::  HoppyF.Ptr QFileDialog -> HoppyF.Ptr M52.QStringConst -> HoppyP.IO ()
foreign import ccall "genpop__QFileDialog_selectedFiles" selectedFiles' ::  HoppyF.Ptr QFileDialogConst -> HoppyP.IO (HoppyF.Ptr M54.QStringListConst)
foreign import ccall "genpop__QFileDialog_selectedNameFilter" selectedNameFilter' ::  HoppyF.Ptr QFileDialogConst -> HoppyP.IO (HoppyF.Ptr M52.QStringConst)
...
foreign import ccall "genpop__QFileDialog_setDirectoryPath" setDirectoryPath' ::  HoppyF.Ptr QFileDialog -> HoppyF.Ptr M52.QStringConst -> HoppyP.IO ()
foreign import ccall "genpop__QFileDialog_setLabelText" setLabelText' ::  HoppyF.Ptr QFileDialog -> HoppyFC.CInt -> HoppyF.Ptr M52.QStringConst -> HoppyP.IO ()
foreign import ccall "genpop__QFileDialog_setNameFilter" setNameFilter' ::  HoppyF.Ptr QFileDialog -> HoppyF.Ptr M52.QStringConst -> HoppyP.IO ()
...
foreign import ccall "gencast__QFileDialog__QDialog" castQFileDialogToQDialog :: HoppyF.Ptr QFileDialogConst -> HoppyF.Ptr M216.QDialogConst
foreign import ccall "gencast__QDialog__QFileDialog" castQDialogToQFileDialog :: HoppyF.Ptr M216.QDialogConst -> HoppyF.Ptr QFileDialogConst
foreign import ccall "gencast__QFileDialog__QWidget" castQFileDialogToQWidget :: HoppyF.Ptr QFileDialogConst -> HoppyF.Ptr M322.QWidgetConst
foreign import ccall "gencast__QWidget__QFileDialog" castQWidgetToQFileDialog :: HoppyF.Ptr M322.QWidgetConst -> HoppyF.Ptr QFileDialogConst
...
class (M216.QDialogConstPtr this) => QFileDialogConstPtr this where
...
history arg'1 =
  withQFileDialogPtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
  (HoppyFHR.decodeAndDelete . M54.QStringListConst) =<<
  (history' arg'1')
...
class (QFileDialogConstPtr this, M216.QDialogPtr this) => QFileDialogPtr this where
...
setDefaultSuffix :: (QFileDialogPtr arg'1, M52.QStringValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO ()
...
setHistory :: (QFileDialogPtr arg'1, M54.QStringListValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO ()
setHistory arg'1 arg'2 =
  HoppyFHR.withCppPtr (toQFileDialog arg'1) $ \arg'1' ->
  M54.withQStringListPtr arg'2 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'2' ->
  (setHistory' arg'1' arg'2')

setMimeTypeFilters :: (QFileDialogPtr arg'1, M54.QStringListValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO ()
setMimeTypeFilters arg'1 arg'2 =
  HoppyFHR.withCppPtr (toQFileDialog arg'1) $ \arg'1' ->
  M54.withQStringListPtr arg'2 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'2' ->
  (setMimeTypeFilters' arg'1' arg'2')

setNameFilters :: (QFileDialogPtr arg'1, M54.QStringListValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO ()
...
selectFile :: (QFileDialogPtr arg'1, M52.QStringValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO ()
selectFile arg'1 arg'2 =
  HoppyFHR.withCppPtr (toQFileDialog arg'1) $ \arg'1' ->
  M52.withQStringPtr arg'2 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'2' ->
  (selectFile' arg'1' arg'2')

selectNameFilter :: (QFileDialogPtr arg'1, M52.QStringValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO ()
...
setDirectoryPath :: (QFileDialogPtr arg'1, M52.QStringValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO ()
setDirectoryPath arg'1 arg'2 =
  HoppyFHR.withCppPtr (toQFileDialog arg'1) $ \arg'1' ->
  M52.withQStringPtr arg'2 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'2' ->
  (setDirectoryPath' arg'1' arg'2')

setLabelText :: (QFileDialogPtr arg'1, M52.QStringValue arg'3) => arg'1 -> QFileDialogDialogLabel -> arg'3 -> HoppyP.IO ()
...
setNameFilter :: (QFileDialogPtr arg'1, M52.QStringValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO ()
...
getExistingDirectory :: (M322.QWidgetPtr arg'1, M52.QStringValue arg'2, M52.QStringValue arg'3) => arg'1 -> arg'2 -> arg'3 -> HoppyP.IO QtahP.String
...
getExistingDirectoryWithOptions :: (M322.QWidgetPtr arg'1, M52.QStringValue arg'2, M52.QStringValue arg'3, IsQFileDialogOptions arg'4) => arg'1 -> arg'2 -> arg'3 -> arg'4 -> HoppyP.IO QtahP.String
...
getOpenFileName :: (M322.QWidgetPtr arg'1, M52.QStringValue arg'2, M52.QStringValue arg'3, M52.QStringValue arg'4) => arg'1 -> arg'2 -> arg'3 -> arg'4 -> HoppyP.IO QtahP.String
getOpenFileName arg'1 arg'2 arg'3 arg'4 =
  HoppyFHR.withCppPtr (M322.toQWidget arg'1) $ \arg'1' ->
  M52.withQStringPtr arg'2 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'2' ->
  M52.withQStringPtr arg'3 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'3' ->
  M52.withQStringPtr arg'4 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'4' ->
  (HoppyFHR.decodeAndDelete . M52.QStringConst) =<<
  (getOpenFileName' arg'1' arg'2' arg'3' arg'4')

getOpenFileNameWithOptions :: (M322.QWidgetPtr arg'1, M52.QStringValue arg'2, M52.QStringValue arg'3, M52.QStringValue arg'4, M52.QStringPtr arg'5, IsQFileDialogOptions arg'6) => arg'1 -> arg'2 -> arg'3 -> arg'4 -> arg'5 -> arg'6 -> HoppyP.IO QtahP.String
getOpenFileNameWithOptions arg'1 arg'2 arg'3 arg'4 arg'5 arg'6 =
  HoppyFHR.withCppPtr (M322.toQWidget arg'1) $ \arg'1' ->
  M52.withQStringPtr arg'2 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'2' ->
  M52.withQStringPtr arg'3 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'3' ->
  M52.withQStringPtr arg'4 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'4' ->
  HoppyFHR.withCppPtr (M52.toQString arg'5) $ \arg'5' ->
  let arg'6' = fromQFileDialogOptions $ toQFileDialogOptions arg'6 in
  (HoppyFHR.decodeAndDelete . M52.QStringConst) =<<
  (getOpenFileNameWithOptions' arg'1' arg'2' arg'3' arg'4' arg'5' arg'6')

getOpenFileNames :: (M322.QWidgetPtr arg'1, M52.QStringValue arg'2, M52.QStringValue arg'3, M52.QStringValue arg'4) => arg'1 -> arg'2 -> arg'3 -> arg'4 -> HoppyP.IO [QtahP.String]
...
getOpenFileNamesWithOptions :: (M322.QWidgetPtr arg'1, M52.QStringValue arg'2, M52.QStringValue arg'3, M52.QStringValue arg'4, M52.QStringPtr arg'5, IsQFileDialogOptions arg'6) => arg'1 -> arg'2 -> arg'3 -> arg'4 -> arg'5 -> arg'6 -> HoppyP.IO [QtahP.String]
...
getSaveFileName :: (M322.QWidgetPtr arg'1, M52.QStringValue arg'2, M52.QStringValue arg'3, M52.QStringValue arg'4) => arg'1 -> arg'2 -> arg'3 -> arg'4 -> HoppyP.IO QtahP.String
...
getSaveFileNameWithOptions :: (M322.QWidgetPtr arg'1, M52.QStringValue arg'2, M52.QStringValue arg'3, M52.QStringValue arg'4, M52.QStringPtr arg'5, IsQFileDialogOptions arg'6) => arg'1 -> arg'2 -> arg'3 -> arg'4 -> arg'5 -> arg'6 -> HoppyP.IO QtahP.String
...
instance M216.QDialogConstPtr QFileDialogConst where
  toQDialogConst (QFileDialogConst ptr') = M216.QDialogConst $ castQFileDialogToQDialog ptr'
  toQDialogConst (QFileDialogConstGc fptr' ptr') = M216.QDialogConstGc fptr' $ castQFileDialogToQDialog ptr'

instance M322.QWidgetConstPtr QFileDialogConst where
  toQWidgetConst (QFileDialogConst ptr') = M322.QWidgetConst $ castQFileDialogToQWidget ptr'
  toQWidgetConst (QFileDialogConstGc fptr' ptr') = M322.QWidgetConstGc fptr' $ castQFileDialogToQWidget ptr'
...
instance M216.QDialogConstPtr QFileDialog where
  toQDialogConst (QFileDialog ptr') = M216.QDialogConst $ castQFileDialogToQDialog $ (HoppyF.castPtr :: HoppyF.Ptr QFileDialog -> HoppyF.Ptr QFileDialogConst) ptr'
  toQDialogConst (QFileDialogGc fptr' ptr') = M216.QDialogConstGc fptr' $ castQFileDialogToQDialog $ (HoppyF.castPtr :: HoppyF.Ptr QFileDialog -> HoppyF.Ptr QFileDialogConst) ptr'

instance M216.QDialogPtr QFileDialog where
  toQDialog (QFileDialog ptr') = M216.QDialog $ (HoppyF.castPtr :: HoppyF.Ptr M216.QDialogConst -> HoppyF.Ptr M216.QDialog) $ castQFileDialogToQDialog $ (HoppyF.castPtr :: HoppyF.Ptr QFileDialog -> HoppyF.Ptr QFileDialogConst) ptr'
  toQDialog (QFileDialogGc fptr' ptr') = M216.QDialogGc fptr' $ (HoppyF.castPtr :: HoppyF.Ptr M216.QDialogConst -> HoppyF.Ptr M216.QDialog) $ castQFileDialogToQDialog $ (HoppyF.castPtr :: HoppyF.Ptr QFileDialog -> HoppyF.Ptr QFileDialogConst) ptr'

instance M322.QWidgetConstPtr QFileDialog where
  toQWidgetConst (QFileDialog ptr') = M322.QWidgetConst $ castQFileDialogToQWidget $ (HoppyF.castPtr :: HoppyF.Ptr QFileDialog -> HoppyF.Ptr QFileDialogConst) ptr'
  toQWidgetConst (QFileDialogGc fptr' ptr') = M322.QWidgetConstGc fptr' $ castQFileDialogToQWidget $ (HoppyF.castPtr :: HoppyF.Ptr QFileDialog -> HoppyF.Ptr QFileDialogConst) ptr'

instance M322.QWidgetPtr QFileDialog where
  toQWidget (QFileDialog ptr') = M322.QWidget $ (HoppyF.castPtr :: HoppyF.Ptr M322.QWidgetConst -> HoppyF.Ptr M322.QWidget) $ castQFileDialogToQWidget $ (HoppyF.castPtr :: HoppyF.Ptr QFileDialog -> HoppyF.Ptr QFileDialogConst) ptr'
  toQWidget (QFileDialogGc fptr' ptr') = M322.QWidgetGc fptr' $ (HoppyF.castPtr :: HoppyF.Ptr M322.QWidgetConst -> HoppyF.Ptr M322.QWidget) $ castQFileDialogToQWidget $ (HoppyF.castPtr :: HoppyF.Ptr QFileDialog -> HoppyF.Ptr QFileDialogConst) ptr'
...
newWithParent :: (M322.QWidgetPtr arg'1) => arg'1 -> HoppyP.IO QFileDialog
newWithParent arg'1 =
  HoppyFHR.withCppPtr (M322.toQWidget arg'1) $ \arg'1' ->
  HoppyP.fmap QFileDialog
  (newWithParent' arg'1')

newWithParentAndFlags :: (M322.QWidgetPtr arg'1, M66.IsQtWindowFlags arg'2) => arg'1 -> arg'2 -> HoppyP.IO QFileDialog
...
newWithParentAndCaption :: (M322.QWidgetPtr arg'1, M52.QStringValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO QFileDialog
...
newWithParentAndCaptionAndDirectory :: (M322.QWidgetPtr arg'1, M52.QStringValue arg'2, M52.QStringValue arg'3) => arg'1 -> arg'2 -> arg'3 -> HoppyP.IO QFileDialog
...
newWithParentAndCaptionAndDirectoryAndFilter :: (M322.QWidgetPtr arg'1, M52.QStringValue arg'2, M52.QStringValue arg'3, M52.QStringValue arg'4) => arg'1 -> arg'2 -> arg'3 -> arg'4 -> HoppyP.IO QFileDialog
...
instance QFileDialogSuper M216.QDialog where
  downToQFileDialog = castQFileDialogToNonconst . cast' . M216.castQDialogToConst
    where
      cast' (M216.QDialogConst ptr') = QFileDialogConst $ castQDialogToQFileDialog ptr'
      cast' (M216.QDialogConstGc fptr' ptr') = QFileDialogConstGc fptr' $ castQDialogToQFileDialog ptr'
instance QFileDialogSuper M322.QWidget where
  downToQFileDialog = castQFileDialogToNonconst . cast' . M322.castQWidgetToConst
    where
      cast' (M322.QWidgetConst ptr') = QFileDialogConst $ castQWidgetToQFileDialog ptr'
      cast' (M322.QWidgetConstGc fptr' ptr') = QFileDialogConstGc fptr' $ castQWidgetToQFileDialog ptr'
...
instance QFileDialogSuperConst M216.QDialogConst where
  downToQFileDialogConst = cast'
    where
      cast' (M216.QDialogConst ptr') = QFileDialogConst $ castQDialogToQFileDialog ptr'
      cast' (M216.QDialogConstGc fptr' ptr') = QFileDialogConstGc fptr' $ castQDialogToQFileDialog ptr'
instance QFileDialogSuperConst M322.QWidgetConst where
  downToQFileDialogConst = cast'
    where
      cast' (M322.QWidgetConst ptr') = QFileDialogConst $ castQWidgetToQFileDialog ptr'
      cast' (M322.QWidgetConstGc fptr' ptr') = QFileDialogConstGc fptr' $ castQWidgetToQFileDialog ptr'
