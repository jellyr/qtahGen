...
foreign import ccall "genpop__QLayoutItem_geometry" geometry' ::  HoppyF.Ptr QLayoutItemConst -> HoppyP.IO (HoppyF.Ptr M42.QRectConst)
foreign import ccall "genpop__QLayoutItem_setGeometry" setGeometry' ::  HoppyF.Ptr QLayoutItem -> HoppyF.Ptr M42.QRectConst -> HoppyP.IO ()
...
foreign import ccall "genpop__QLayoutItem_layout" layout' ::  HoppyF.Ptr QLayoutItem -> HoppyP.IO (HoppyF.Ptr M256.QLayout)
foreign import ccall "genpop__QLayoutItem_maximumSize" maximumSize' ::  HoppyF.Ptr QLayoutItemConst -> HoppyP.IO (HoppyF.Ptr M48.QSizeConst)
...
foreign import ccall "genpop__QLayoutItem_minimumSize" minimumSize' ::  HoppyF.Ptr QLayoutItemConst -> HoppyP.IO (HoppyF.Ptr M48.QSizeConst)
foreign import ccall "genpop__QLayoutItem_sizeHint" sizeHint' ::  HoppyF.Ptr QLayoutItemConst -> HoppyP.IO (HoppyF.Ptr M48.QSizeConst)
foreign import ccall "genpop__QLayoutItem_widget" widget' ::  HoppyF.Ptr QLayoutItem -> HoppyP.IO (HoppyF.Ptr M322.QWidget)
...
alignment :: (QLayoutItemValue arg'1) => arg'1 -> HoppyP.IO M66.QtAlignment
alignment arg'1 =
  withQLayoutItemPtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
  HoppyP.fmap M66.QtAlignment
  (alignment' arg'1')

expandingDirections :: (QLayoutItemValue arg'1) => arg'1 -> HoppyP.IO M66.QtOrientations
expandingDirections arg'1 =
  withQLayoutItemPtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
  HoppyP.fmap M66.QtOrientations
  (expandingDirections' arg'1')
...
setAlignment :: (QLayoutItemPtr arg'1, M66.IsQtAlignment arg'2) => arg'1 -> arg'2 -> HoppyP.IO ()
...
setGeometry :: (QLayoutItemPtr arg'1, M42.QRectValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO ()
...
layout :: (QLayoutItemPtr arg'1) => arg'1 -> HoppyP.IO M256.QLayout
layout arg'1 =
  HoppyFHR.withCppPtr (toQLayoutItem arg'1) $ \arg'1' ->
  HoppyP.fmap M256.QLayout
  (layout' arg'1')

widget :: (QLayoutItemPtr arg'1) => arg'1 -> HoppyP.IO M322.QWidget
widget arg'1 =
  HoppyFHR.withCppPtr (toQLayoutItem arg'1) $ \arg'1' ->
